                ...
                <div class="owl-carousel owl-theme mt-5" data-owl-options='{
                    ...
                    <div class="item">
                        <div class="rose-product-card">
                            <div class="thumbnail">
                                <img src="assets/front/images/product.jpg" alt="">
                            </div>
                            <div class="desc-wrapper">
                                <h3 class="title">دوره جامع حسابدار نخبه</h3>
                                <p class="desc">
                                    نه تنها در کشور ما بلکه در تمامی کشورهای دنیا ، افرادی  که اگاهی و دانش در مسائل مالیدارند
                                    از
                                    درآمد بالایی برخوردارند و  مجموعه آموزشی رز مفتخر است به صورت کامل و جامع در یک دوره
                                    آموزشی...
                                </p>
                            </div>
                            <div class="badge-box">
                            ...
                            <div class="price-wrapper">
                                <p class="price">13.000.000 تومان</p>
                                <p class="sale-price">5.599.000 تومان</p>
                            </div>
                            <a href="#" class="btn btn-default">ثبت نام</a>
                        </div>
                    </div>
                    <div class="item">
                        <div class="rose-product-card">
                    ...
                    <div class="item">
                        <div class="rose-product-card">
                            ...
                            <div class="desc-wrapper">
                                <div class="title">دوره جامع حسابدار نخبه</div>
                                <p class="desc">
                                    نه تنها در کشور ما بلکه در تمامی کشورهای دنیا ، افرادی  که اگاهی و دانش در مسائل مالیدارند
                                    از
                                    درآمد بالایی برخوردارند و  مجموعه آموزشی رز مفتخر است به صورت کامل و جامع در یک دوره
