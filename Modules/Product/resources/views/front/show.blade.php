                                ...
                                <ul class=" rose-playlist-course ">
                                    @if($product->lessons->count())
                                        @foreach($product->lessons as $lesson)
                                            <li>
                                                <a class="select-video @auth is-loggedin @endauth"
                                                   data-video-src="{{$lesson->file}}">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28"
                                                        ...
                                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                                              ...
                                                              stroke="#0FABB5" stroke-width="1.75"
                            ...
                            <div class="col-md-8">
                                <div style="background: url({{$product->image}})" class="h-100 br-default">
                                    <div style="backdrop-filter: blur(30px)"
                                         class="br-default d-flex align-items-center justify-content-center h-100 w-100">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="bg-white br-default p-4 mt-4">
                            ...
                            <div class="comments" id="comments">
                                ...
                                @if(($product->comments->count()) && ($product->comment_status == 1))
                                    @include('comment::components.comments' , ['comments' => $product->comments->where('status' , 'approved')->whereNull('parent_id') , 'children' => false])
                                @endif

                                @auth
                                    <form action="#" class="post-comment br-default">
                                        <h3 class="mt-4 mb-4">نظر خود را بنویسید</h3>
                                        <textarea rows="5" placeholder="نظر خود را بنویسید..."
                        ...
                        <div class="bg-white p-4 br-default single-product-sidebar">
                            ...
                            <div class="product-sidebar-details mt-4">
                                ...
                                <p class="text-justify">
                                    سیستم معاملاتی FIS (Financial Investing System) یک سیستم منحصر به فرد، توسط دکتر
                                    بردیا خسروانی،
                                    مدرس برجسته بازارهای مالی با 15 سال سابقه ی درخشان، طراحی شده است تا راه را برای
                                    سرمایه‌گذاران
                                    در جهت کسب سود پایدار و کم‌ریسک، ایجاد درآمد غیرفعال و بازنشستگی زودهنگام در بورس
                                    ایران هموار
                                    کند.
