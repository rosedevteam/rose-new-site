<!-- Modal -->
<div class="modal fade" id="loginModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" {{$config = null}}>
...
<path fill-rule="evenodd" clip-rule="evenodd"
      ...
      stroke="#A0A3A9" stroke-width="1.38" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
                            </span>
                            </div>
