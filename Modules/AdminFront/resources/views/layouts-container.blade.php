...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>دربرگیرنده - طرح‌ها | فرست - قالب مدیریت بوت‌استرپ</title>
          ...
          <nav class="layout-navbar navbar navbar-expand-xl align-items-center bg-navbar-theme" id="layout-navbar">
            <div class="container-xxl">
              ...
              <div class="navbar-search-wrapper search-input-wrapper d-none">
                <input type="text" class="form-control search-input container-xxl border-0" placeholder="جستجو ..." aria-label="Search...">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="layout-demo-wrapper">
                ...
                <div class="layout-demo-info">
                  <h4 class="secondary-font">طرح دربرگیرنده</h4>
                  <p>طرح دربرگیرنده یک <code>max-width</code> در هر نقطه شکست واکنش‌گرا تنظیم می‌کند.</p>
                </div>
              </div>
              <!--/ Layout Demo -->
            </div>
