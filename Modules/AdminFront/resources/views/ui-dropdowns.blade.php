...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>منوهای کشویی - المان‌های رابط کاربری | فرست - قالب مدیریت بوت‌استرپ</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">المان‌های رابط کاربری /</span> منوهای کشویی
              </h4>

              <div class="card mb-4" id="btn-dropdown-demo">
                <h5 class="card-header heading-color">منوهای کشویی</h5>
                ...
                <!-- Split Dropdowns -->
                <div class="card-body">
                  <small class="text-light fw-semibold">جدا از هم</small>
                  <div class="demo-inline-spacing">
                    <div class="btn-group">
                ...
                <div class="card-body">
                  <div class="row gy-3">
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                      <small class="text-light fw-semibold">فلش پنهان</small>
                      <div class="demo-inline-spacing">
                        <div class="btn-group">
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                      <small class="text-light fw-semibold">هنگام هاور</small>
                      <div class="demo-inline-spacing">
                        <div class="btn-group" id="hover-dropdown-demo">
                          <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown" data-trigger="hover">
                            هاور
                          </button>
                          <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="javascript:void(0);">عمل</a></li>
                    ...
                    <!-- Dropdown with icon -->
                    <div class="col-lg-3 col-sm-6 col-12">
                      <small class="text-light fw-semibold">با آیکن</small>
                      <div class="demo-inline-spacing">
                        <div class="btn-group" id="dropdown-icon-demo">
                          <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                            <i class="bx bx-menu me-1"></i> با آیکن
                          </button>
                          <ul class="dropdown-menu">
                            <li>
                              <a href="javascript:void(0);" class="dropdown-item d-flex align-items-center"><i class="bx bx-chevron-right scaleX-n1-rtl"></i>عمل</a>
                            </li>
                            <li>
                              <a href="javascript:void(0);" class="dropdown-item d-flex align-items-center"><i class="bx bx-chevron-right scaleX-n1-rtl"></i>عمل دیگر</a>
                            </li>
                            <li>
                              <a href="javascript:void(0);" class="dropdown-item d-flex align-items-center"><i class="bx bx-chevron-right scaleX-n1-rtl"></i>یک عمل دیگر</a>
                            </li>
                            <li>
                              <hr class="dropdown-divider">
                            </li>
                            <li>
                              <a href="javascript:void(0);" class="dropdown-item d-flex align-items-center"><i class="bx bx-chevron-right scaleX-n1-rtl"></i>لینک جدا شده</a>
                            </li>
                          </ul>
                        </div>
                      </div>
                    ...
                    <!-- Icon Dropdown -->
                    <div class="col-lg-3 col-sm-6 col-12">
                      <small class="text-light fw-semibold">منوی کشویی آیکن</small>
                      <div class="demo-inline-spacing">
                        <div class="btn-group">
              ...
              <div class="card" id="dropdown-variation-demo">
                <h5 class="card-header heading-color">انواع منوی کشویی</h5>

                <!-- Dropdown Menu Alignment -->
                <div class="card-body">
                  <small class="text-light fw-semibold">تراز منو</small>
                  <div class="demo-inline-spacing">
                    <div class="btn-group">
                      <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        منوی کشویی با تراز پایان
                      </button>
                      <ul class="dropdown-menu dropdown-menu-end">
                        <li><button class="dropdown-item" type="button">عمل</button></li>
                        <li><button class="dropdown-item" type="button">عمل دیگر</button></li>
                        <li><button class="dropdown-item" type="button">یک عمل دیگر</button></li>
                      </ul>
                    </div>
                    <div class="btn-group">
                      <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown" data-bs-display="static" aria-haspopup="true" aria-expanded="false">
                        با تراز شروع اما در اندازه lg با تراز پایان
                      </button>
                    ...
                    <div class="btn-group">
                      <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown" data-bs-display="static" aria-haspopup="true" aria-expanded="false">
                        با تراز پایان اما در اندازه lg با تراز شروع
                      </button>
                ...
                <div class="card-body">
                  <div class="row gy-3">
                    <!-- Dropdown Directions -->
                    <div class="col-xl-6">
                      <small class="text-light fw-semibold">جهت ها</small>
                      <div class="row">
                        <div class="col-md-6">
                          <div class="demo-inline-spacing">
                            <div class="btn-group">
                    ...
                    <div class="col-xl-6">
                      <small class="text-light fw-semibold">محتوای منو</small>
                      <div class="demo-inline-spacing">
                        <div class="btn-group">
                          <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            سرتیتر منوی کشویی
                          ...
                          <ul class="dropdown-menu">
                            <li>
                              <h6 class="dropdown-header">سرتیتر منوی کشویی</h6>
                            </li>
                            <li><a class="dropdown-item" href="javascript:void(0);">عمل</a></li>
                            <li><a class="dropdown-item" href="javascript:void(0);">عمل دیگر</a></li>
                          </ul>
                        ...
                        <div class="btn-group">
                          ...
                          <div class="dropdown-menu">
                            <div class="px-3 py-2 text-muted">
                              <p>چند متن نمونه که در منوی کشویی به صورت آزاد جریان دارد.</p>
                              <p class="mb-0">و این متن نمونه بیشتر است.</p>
                            </div>
                          </div>
                        </div>
                        <div class="btn-group">
                          ...
                          <div class="dropdown-menu dropdown-menu-end w-px-300">
                            <form class="p-4" onsubmit="return false">
                              <div class="mb-3">
                                <label for="exampleDropdownFormEmail1" class="form-label">آدرس ایمیل</label>
                                <input type="email" class="form-control" id="exampleDropdownFormEmail1" placeholder="email@example.com">
                              </div>
                              <div class="mb-3">
                                <label for="exampleDropdownFormPassword1" class="form-label">رمز عبور</label>
                            ...
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="javascript:void(0)">کاربر جدید هستید؟ ثبت نام کنید</a>
                            <a class="dropdown-item" href="javascript:void(0)">رمز عبور را فراموش کردید؟</a>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div class="card-body">
                  <div class="row gy-3">
                    <!-- Dropdown options -->
                    <div class="col-xl-6">
                      <small class="text-light fw-semibold">گزینه‌ها: از <code>data-bs-offset</code> یا <code>data-bs-reference</code> برای تغییر موقعیت منوی کشویی استفاده کنید.</small>
                      <div class="demo-inline-spacing">
                        ...
                        <div class="btn-group">
                          <button type="button" class="btn btn-primary">مرجع</button>
                    ...
                    <!-- Auto close behavior -->
                    <div class="col-xl-6">
                      <small class="text-light fw-semibold">رفتار بسته شدن خودکار</small>
                      <div class="demo-inline-spacing">
                        <div class="btn-group">
                          ...
                          <ul class="dropdown-menu" aria-labelledby="defaultDropdown">
                            <li><a class="dropdown-item" href="javascript:void(0)">آیتم منو</a></li>
                            <li><a class="dropdown-item" href="javascript:void(0)">آیتم منو</a></li>
                            <li><a class="dropdown-item" href="javascript:void(0)">آیتم منو</a></li>
                          </ul>
                        </div>
