...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>ورودی‌های پایه - فرم‌ها | فرست - قالب مدیریت بوت‌استرپ</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">فرم‌ها /</span> ورودی‌های پایه
              </h4>

              <div class="row">
                <div class="col-md-6">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">پیش‌فرض</h5>
                    <div class="card-body">
                      <div>
                        <label for="defaultFormControlInput" class="form-label">نام</label>
                        <input type="text" class="form-control" id="defaultFormControlInput" placeholder="جان اسنو" aria-describedby="defaultFormControlHelp">
                ...
                <div class="col-md-6">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">برچسب شناور</h5>
                    <div class="card-body">
                      <div class="form-floating">
                        <input type="text" class="form-control" id="floatingInput" placeholder="جان اسنو" aria-describedby="floatingInputHelp">
                ...
                <div class="col-md-6">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">کنترل های فرم</h5>
                    <div class="card-body">
                      <div class="mb-3">
                      ...
                      <div class="mb-3">
                        <label for="exampleFormControlReadOnlyInput1" class="form-label">فقط خواندنی</label>
                        <input class="form-control" type="text" id="exampleFormControlReadOnlyInput1" placeholder="ورودی فقط خواندنی ..." readonly>
                      </div>
                      <div class="mb-3">
                        <label for="exampleFormControlReadOnlyInputPlain1" class="form-label">فقط خواندنی ساده</label>
                        <input type="text" readonly class="form-control-plaintext" id="exampleFormControlReadOnlyInputPlain1" value="email@example.com">
                      </div>
                      <div class="mb-3">
                        <label for="exampleFormControlSelect1" class="form-label">نمونه انتخاب</label>
                      ...
                      <div class="mb-3">
                        <label for="exampleDataList" class="form-label">نمونه لیست داده</label>
                      ...
                      <div class="mb-3">
                        <label for="exampleFormControlSelect2" class="form-label">نمونه چند انتخابی</label>
                      ...
                      <div>
                        <label for="exampleFormControlTextarea1" class="form-label">ناحیه متنی نمونه</label>
                ...
                <div class="col-md-6">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">اندازه ورودی</h5>
                    <div class="card-body">
                      <small class="text-light fw-semibold">ورودی متن</small>

                      <div class="mt-2 mb-3">
                        <label for="largeInput" class="form-label">ورودی بزرگ</label>
                        <input id="largeInput" class="form-control form-control-lg" type="text" placeholder=".form-control-lg">
                      </div>
                      <div class="mb-3">
                        <label for="defaultInput" class="form-label">ورودی پیش‌فرض</label>
                        <input id="defaultInput" class="form-control" type="text" placeholder="ورودی پیش‌فرض">
                      </div>
                      <div>
                        <label for="smallInput" class="form-label">ورودی کوچک</label>
                        <input id="smallInput" class="form-control form-control-sm" type="text" placeholder=".form-control-sm">
                      </div>
                    </div>
                    <hr class="m-0">
                    <div class="card-body">
                      <small class="text-light fw-semibold">ورودی انتخابی</small>
                      <div class="mt-2 mb-3">
                        <label for="largeSelect" class="form-label">انتخاب بزرگ</label>
                      ...
                      <div class="mb-3">
                        <label for="defaultSelect" class="form-label">انتخاب پیش فرض</label>
                      ...
                      <div>
                        <label for="smallSelect" class="form-label">انتخاب کوچک</label>
                    ...
                    <hr class="m-0">
                    <div class="card-body">
                      <small class="text-light fw-semibold">شکل ورودی</small>
                      <div class="mt-2">
                        <label for="roundedInput" class="form-label">ورودی گرد</label>
                        <input id="roundedInput" class="form-control rounded-pill" type="text" placeholder="ورودی پیش‌فرض">
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-xl-6">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">چک‌باکس‌ها و رادیوها</h5>
                    <!-- Checkboxes and Radios -->
                    <div class="row row-bordered g-0">
                      <div class="col-md p-4">
                        <small class="text-light fw-semibold">چک‌باکس‌ها</small>
                        <div class="form-check mt-3">
                          <input class="form-check-input" type="checkbox" value="" id="defaultCheck1">
                          <label class="form-check-label" for="defaultCheck1"> انتخاب نشده </label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="checkbox" value="" id="defaultCheck2" checked>
                          <label class="form-check-label" for="defaultCheck2"> نامشخص </label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="checkbox" value="" id="defaultCheck3" checked>
                          <label class="form-check-label" for="defaultCheck3"> انتخاب شده </label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="checkbox" value="" id="disabledCheck1" disabled>
                          <label class="form-check-label" for="disabledCheck1"> انتخاب نشده غیرفعال </label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="checkbox" value="" id="disabledCheck2" disabled checked>
                          <label class="form-check-label" for="disabledCheck2"> انتخاب شده غیرفعال </label>
                        </div>
                      </div>
                      <div class="col-md p-4">
                        <small class="text-light fw-semibold">رادیوها</small>
                        <div class="form-check mt-3">
                          <input name="default-radio-1" class="form-check-input" type="radio" value="" id="defaultRadio1">
                          <label class="form-check-label" for="defaultRadio1"> انتخاب نشده </label>
                        </div>
                        <div class="form-check">
                          <input name="default-radio-1" class="form-check-input" type="radio" value="" id="defaultRadio2" checked>
                          <label class="form-check-label" for="defaultRadio2"> انتخاب شده </label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="radio" value="" id="disabledRadio1" disabled>
                          <label class="form-check-label" for="disabledRadio1"> انتخاب نشده غیرفعال </label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="radio" value="" id="disabledRadio2" disabled checked>
                          <label class="form-check-label" for="disabledRadio2"> انتخاب شده غیرفعال </label>
                        </div>
                      </div>
                    </div>
                    <hr class="m-0">
                    ...
                    <div class="row row-bordered g-0">
                      <div class="col-md p-4">
                        <small class="text-light fw-semibold d-block">چک‌باکس‌های درون‌خطی</small>
                      ...
                      <div class="col-md p-4">
                        <small class="text-light fw-semibold d-block">رادیوهای درون‌خطی</small>
                        <div class="form-check form-check-inline mt-3">
                    ...
                    <div class="row row-bordered g-0">
                      <div class="col-md p-4">
                        <small class="text-light fw-semibold d-block">رنگ‌های چک‌باکس‌ها</small>
                  ...
                  <!-- Switches -->
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">سوئیچ‌ها</h5>
                    <div class="card-body">
                      <div class="form-check form-switch mb-2">
                        <input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault">
                        <label class="form-check-label" for="flexSwitchCheckDefault">ورودی چک‌باکس سوئیچ پیش‌فرض</label>
                      </div>
                      <div class="form-check form-switch mb-2">
                        <input class="form-check-input" type="checkbox" id="flexSwitchCheckChecked" checked>
                        <label class="form-check-label" for="flexSwitchCheckChecked">ورودی چک‌باکس سوئیچ انتخاب شده</label>
                      </div>
                      <div class="form-check form-switch mb-2">
                        <input class="form-check-input" type="checkbox" id="flexSwitchCheckDisabled" disabled>
                        <label class="form-check-label" for="flexSwitchCheckDisabled">ورودی چک‌باکس سوئیچ غیرفعال</label>
                      </div>
                      <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" id="flexSwitchCheckCheckedDisabled" checked disabled>
                        <label class="form-check-label" for="flexSwitchCheckCheckedDisabled">ورودی چک‌باکس سوئیچ انتخاب شده غیرفعال</label>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="card mb-4 mb-xl-0">
                    <h5 class="card-header heading-color">بازه</h5>
                    <div class="card-body">
                      <div class="mb-3">
                        <label for="formRange1" class="form-label">نمونه بازه</label>
                        <input type="range" class="form-range" id="formRange1">
                      </div>
                      <div class="mb-3">
                        <label for="disabledRange" class="form-label">بازه غیرفعال</label>
                        <input type="range" class="form-range" id="disabledRange" disabled>
                      </div>
                      <div class="mb-3">
                        <label for="formRange2" class="form-label">حداقل و حداکثر</label>
                        <input type="range" class="form-range" min="0" max="5" id="formRange2">
                      </div>
                      <div>
                        <label for="formRange3" class="form-label">قدم‌ها</label>
                ...
                <div class="col-xl-6">
                  <!-- HTML5 Inputs -->
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">ورودی‌های HTML5</h5>
                    <div class="card-body">
                      <div class="mb-3 row">
                        <label for="html5-text-input" class="col-md-2 col-form-label">متن</label>
                        <div class="col-md-10">
                          <input class="form-control" type="text" value="فرست" id="html5-text-input">
                        </div>
                      </div>
                      <div class="mb-3 row">
                        <label for="html5-search-input" class="col-md-2 col-form-label">جستجو</label>
                        <div class="col-md-10">
                          <input class="form-control" type="search" value="جستجو ..." id="html5-search-input">
                        </div>
                      </div>
                      <div class="mb-3 row">
                        <label for="html5-email-input" class="col-md-2 col-form-label">ایمیل</label>
                        <div class="col-md-10">
                          <input class="form-control" type="email" value="john@example.com" id="html5-email-input">
                        </div>
                      </div>
                      <div class="mb-3 row">
                        <label for="html5-url-input" class="col-md-2 col-form-label">آدرس URL</label>
                        <div class="col-md-10">
                          <input class="form-control" type="url" value="https://www.rtl-theme.com" id="html5-url-input">
                        </div>
                      </div>
                      <div class="mb-3 row">
                        <label for="html5-tel-input" class="col-md-2 col-form-label">تلفن</label>
                        <div class="col-md-10">
                          <input class="form-control text-start" type="tel" value="90-(164)-188-556" id="html5-tel-input" dir="ltr">
                        </div>
                      </div>
                      <div class="mb-3 row">
                        <label for="html5-password-input" class="col-md-2 col-form-label">رمز عبور</label>
                        <div class="col-md-10">
                          <input class="form-control text-start" type="password" dir="ltr" value="password" id="html5-password-input">
                        </div>
                      </div>
                      <div class="mb-3 row">
                        <label for="html5-number-input" class="col-md-2 col-form-label">شماره</label>
                        <div class="col-md-10">
                          <input class="form-control" type="number" value="18" id="html5-number-input">
                        </div>
                      </div>
                      <div class="mb-3 row">
                        <label for="html5-datetime-local-input" class="col-md-2 col-form-label">تاریخ و زمان</label>
                        <div class="col-md-10">
                          <input class="form-control" type="datetime-local" value="2021-06-18T12:30:00" id="html5-datetime-local-input">
                        </div>
                      </div>
                      <div class="mb-3 row">
                        <label for="html5-date-input" class="col-md-2 col-form-label">تاریخ</label>
                        <div class="col-md-10">
                          <input class="form-control" type="date" value="2021-06-18" id="html5-date-input">
                        </div>
                      </div>
                      <div class="mb-3 row">
                        <label for="html5-month-input" class="col-md-2 col-form-label">ماه</label>
                        <div class="col-md-10">
                          <input class="form-control" type="month" value="2021-06" id="html5-month-input">
                        </div>
                      </div>
                      <div class="mb-3 row">
                        <label for="html5-week-input" class="col-md-2 col-form-label">هفته</label>
                        <div class="col-md-10">
                          <input class="form-control" type="week" value="2021-W25" id="html5-week-input">
                        </div>
                      </div>
                      <div class="mb-3 row">
                        <label for="html5-time-input" class="col-md-2 col-form-label">زمان</label>
                        <div class="col-md-10">
                          <input class="form-control" type="time" value="12:30:00" id="html5-time-input">
                        </div>
                      </div>
                      <div class="mb-3 row">
                        <label for="html5-color-input" class="col-md-2 col-form-label">رنگ</label>
                        <div class="col-md-10">
                          <input class="form-control" type="color" value="#666EE8" id="html5-color-input">
                        </div>
                      </div>
                      <div class="row">
                        <label for="html5-range" class="col-md-2 col-form-label">بازه</label>
                        <div class="col-md-10">
                  ...
                  <!-- File input -->
                  <div class="card">
                    <h5 class="card-header heading-color">ورودی فایل</h5>
                    <div class="card-body">
                      <div class="mb-3">
                        <label for="formFile" class="form-label">نمونه ورودی فایل پیش‌فرض</label>
                      ...
                      <div>
                        <label for="formFileDisabled" class="form-label">نمونه ورودی فایل غیرفعال</label>
