...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>کشیدن و رها کردن - رابط کاربری توسعه یافته | فرست - قالب مدیریت بوت‌استرپ</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">رابط کاربری توسعه یافته /</span> کشیدن و رها کردن
              </h4>
              ...
              <div class="row mb-4">
                <div class="col-12">
                  <div class="card">
                    <h5 class="card-header heading-color">تصاویر</h5>
                    <div class="card-body">
                      <div class="d-flex flex-wrap mb-3 gap-2" id="image-list-1">
                        <img class="rounded-circle drag-item cursor-move" src="../../assets/img/avatars/1.png" alt="آواتار" height="50" width="50">
                        <img class="rounded-circle drag-item cursor-move" src="../../assets/img/avatars/2.png" alt="آواتار" height="50" width="50">
                        <img class="rounded-circle drag-item cursor-move" src="../../assets/img/avatars/3.png" alt="آواتار" height="50" width="50">
                        <img class="rounded-circle drag-item cursor-move" src="../../assets/img/avatars/4.png" alt="آواتار" height="50" width="50">
                        <img class="rounded-circle drag-item cursor-move" src="../../assets/img/avatars/5.png" alt="آواتار" height="50" width="50">
                        <img class="rounded-circle drag-item cursor-move" src="../../assets/img/avatars/6.png" alt="آواتار" height="50" width="50">
                      </div>
                      <div class="d-flex flex-wrap gap-2" id="image-list-2">
                        <img class="rounded-circle drag-item cursor-move" src="../../assets/img/avatars/7.png" alt="آواتار" height="50" width="50">
                        <img class="rounded-circle drag-item cursor-move" src="../../assets/img/avatars/8.png" alt="آواتار" height="50" width="50">
                        <img class="rounded-circle drag-item cursor-move" src="../../assets/img/avatars/9.png" alt="آواتار" height="50" width="50">
                        <img class="rounded-circle drag-item cursor-move" src="../../assets/img/avatars/10.png" alt="آواتار" height="50" width="50">
                        <img class="rounded-circle drag-item cursor-move" src="../../assets/img/avatars/11.png" alt="آواتار" height="50" width="50">
                        <img class="rounded-circle drag-item cursor-move" src="../../assets/img/avatars/12.png" alt="آواتار" height="50" width="50">
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="row mb-4">
                <div class="col-12">
                  <div class="card">
                    <h5 class="card-header heading-color">چند لیست</h5>
                    <div class="card-body">
                      <div class="row">
                        <div class="col-md-6 col-12 mb-md-0 mb-4">
                          ...
                          <ul class="list-group list-group-flush" id="pending-tasks">
                            <li class="list-group-item drag-item cursor-move d-flex justify-content-between align-items-center">
                              ...
                              <img class="rounded-circle" src="../../assets/img/avatars/1.png" alt="آواتار" height="32" width="32">
                            </li>
                            <li class="list-group-item drag-item cursor-move d-flex justify-content-between align-items-center">
                              <span>پاسخ به ایمیل ها.</span>
                              <img class="rounded-circle" src="../../assets/img/avatars/2.png" alt="آواتار" height="32" width="32">
                            </li>
                            <li class="list-group-item drag-item cursor-move d-flex justify-content-between align-items-center">
                              <span>نوشتن پست بلاگ.</span>
                              <img class="rounded-circle" src="../../assets/img/avatars/3.png" alt="آواتار" height="32" width="32">
                            </li>
                            <li class="list-group-item drag-item cursor-move d-flex justify-content-between align-items-center">
                              <span>به‌روزرسانی بسته‌ها.</span>
                              <img class="rounded-circle" src="../../assets/img/avatars/4.png" alt="آواتار" height="32" width="32">
                            </li>
                            <li class="list-group-item drag-item cursor-move d-flex justify-content-between align-items-center">
                              <span>طرح جدید بلاگ.</span>
                              <img class="rounded-circle" src="../../assets/img/avatars/5.png" alt="آواتار" height="32" width="32">
                            </li>
                          </ul>
                        </div>
                        <div class="col-md-6 col-12 mb-md-0 mb-4">
                          ...
                          <ul class="list-group list-group-flush" id="completed-tasks">
                            <li class="list-group-item drag-item cursor-move d-flex justify-content-between align-items-center">
                              <span>مجموعه آیکن جدید برای برنامه iOS.</span>
                              <img class="rounded-circle" src="../../assets/img/avatars/1.png" alt="آواتار" height="32" width="32">
                            </li>
                            <li class="list-group-item drag-item cursor-move d-flex justify-content-between align-items-center">
                              <span> اصلاح و ثبت ایرادات اعتبارسنجی.</span>
                              <img class="rounded-circle" src="../../assets/img/avatars/2.png" alt="آواتار" height="32" width="32">
                            </li>
                            <li class="list-group-item drag-item cursor-move d-flex justify-content-between align-items-center">
                              <span> کمک به برنامه نویسان برای توسعه کدهای HTML.</span>
                              <img class="rounded-circle" src="../../assets/img/avatars/3.png" alt="آواتار" height="32" width="32">
                            </li>
                            <li class="list-group-item drag-item cursor-move d-flex justify-content-between align-items-center">
                              <span>خرید آنتی ویروس.</span>
                              <img class="rounded-circle" src="../../assets/img/avatars/4.png" alt="آواتار" height="32" width="32">
                            </li>
                            <li class="list-group-item drag-item cursor-move d-flex justify-content-between align-items-center">
                              <span>پاسخ به تیکت‌های پشتیبانی.</span>
                              <img class="rounded-circle" src="../../assets/img/avatars/5.png" alt="آواتار" height="32" width="32">
                            </li>
                          </ul>
                        </div>
              ...
              <div class="row mb-4">
                <div class="col-sm-12">
                  <div class="card">
                    <h5 class="card-header heading-color">تکثیر کردن</h5>
                    <div class="card-body">
                      <div class="row">
                        <div class="col-md-6 col-12 mb-md-0 mb-4">
                          <p>وظایف در انتظار</p>
              ...
              <div class="row">
                <div class="col-sm-12">
                  <div class="card">
                    <h5 class="card-header heading-color">دست‌گیره</h5>
                    <div class="card-body">
                      <div class="row">
                        <div class="col-md-6 col-12 mb-md-0 mb-4">
                          <p>وظایف در انتظار</p>
                        ...
                        <div class="col-md-6 col-12 mb-md-0 mb-4">
                          ...
                          <ul class="list-group list-group-flush" id="handle-list-2">
                            ...
                            <li class="list-group-item lh-1 d-flex justify-content-between align-items-center">
                              <span class="d-flex justify-content-between align-items-center">
                                <i class="drag-handle cursor-move bx bx-menu align-text-bottom me-2"></i>
                                <span>راهنمایی توسعه دهندگان وب برای کدنویسی HTML</span>
                              </span>
                              <img class="rounded-circle" src="../../assets/img/avatars/3.png" alt="آواتار" height="32" width="32">
                            </li>
                            <li class="list-group-item lh-1 d-flex justify-content-between align-items-center">
