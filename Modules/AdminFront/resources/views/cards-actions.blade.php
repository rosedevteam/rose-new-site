...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>عمل‌های کارت‌ها - المان‌های رابط کاربری | فرست - قالب مدیریت بوت‌استرپ</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">المان‌های رابط کاربری /</span> عمل‌های کارت‌ها
              </h4>
              ...
              <div class="card card-action mb-5">
                ...
                <div class="card-header">
                  <div class="card-action-title">عمل‌های کارت‌ها</div>
                  ...
                  <table class="table table-hover">
                    ...
                    <tbody class="table-border-bottom-0">
                      <tr>
                        ...
                        <td>توسط عمل collapse محتوای کارت را جمع کنید.</td>
                      </tr>
                      <tr>
                        <td>تازه‌سازی محتوا</td>
                        <td class="text-center">
                          <i class="tf-icons bx bx-rotate-left scaleX-n1-rtl"></i>
                        </td>
                        <td>توسط عمل refresh محتوای کارت را تازه‌سازی کنید.</td>
                      </tr>
                      <tr>
                        <td>گسترش کارت</td>
                        <td class="text-center">
                        ...
                        <td>توسط عمل expand کارت خود را گسترده کنید.</td>
                      </tr>
                      <tr>
                        <td>حذف کارت</td>
                        <td class="text-center">
                        ...
                        <td>توسط عمل remove کارت را از صفحه حذف کنید.</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
              ...
              <h6 class="pb-1 mb-4 text-muted">نمونه‌ها</h6>
              <p>
                از کلاس <code>.card-action</code> به همراه <code>.card</code> برای ایجاد عمل کارت استفاده کنید. از
                <code>.card-action-title</code> برای عنوان کارت دارای عمل و <code>.card-action-element</code> برای دربرگرفتن آیکن‌های عمل‌ها استفاده کنید.
              </p>
              <div class="row mb-5">
                <div class="col-md">
                  <div class="card card-action mb-4">
                    <div class="card-header">
                      <div class="card-action-title">کارت قابل جمع شدن</div>
                      <div class="card-action-element">
                        <ul class="list-inline mb-0">
                          <li class="list-inline-item">
                            <a href="javascript:void(0);" class="card-collapsible"><i class="tf-icons bx bx-chevron-up"></i></a>
                    ...
                    <div class="collapse show">
                      <div class="card-body pt-0">
                        <p class="card-text">
                          برای ایجاد یک کارت جمع شونده، از کلاس <code>.card-collapsible</code> به همراه آیتم عمل استفاده کنید. برای نمایش محتوای جمع شونده به صورت پیش‌فرض از کلاس <code>.show</code> به همراه <code>.collapse</code> استفاده کنید.
                        </p>
                        <p class="card-text">
                          بر روی <i class="tf-icons bx bx-chevron-up"></i> برای مشاهده جمع شدن کارت در عمل کلیک کنید.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-md">
                  <div class="card card-action mb-4">
                    <div class="card-alert"></div>
                    <div class="card-header">
                      <div class="card-action-title">تازه‌سازی محتوا</div>
                      <div class="card-action-element">
                        <ul class="list-inline mb-0">
                          <li class="list-inline-item">
                            <a href="javascript:void(0);" class="card-reload"><i class="tf-icons bx bx-rotate-left scaleX-n1-rtl"></i></a>
                    ...
                    <div class="card-body">
                      <p class="card-text">
                        برای ایجاد یک کارت دارای عمل تازه‌سازی، از کلاس <code>.card-reload</code> به همراه آیتم عمل استفاده کنید. از کلاس
                        <code>.card-alert</code> برای نمایش پیام پاسخ سفارشی استفاده کنید.
                      </p>
                      <p class="card-text">
                        بر روی <i class="tf-icons bx bx-rotate-left scaleX-n1-rtl"></i> برای مشاهده تازه‌سازی محتوای کارت در عمل کلیک کنید.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md">
                  <div class="card card-action mb-4">
                    <div class="card-header">
                      <div class="card-action-title">گسترش کارت</div>
                      <div class="card-action-element">
                        <ul class="list-inline mb-0">
                          <li class="list-inline-item">
                            <a href="javascript:void(0);" class="card-expand"><i class="tf-icons bx bx-fullscreen"></i></a>
                    ...
                    <div class="card-body">
                      <p class="card-text">
                        برای ایجاد یک کارت دارای عمل گسترش (تمام‌صفحه)، از کلاس <code>.card-expand</code> به همراه آیتم عمل استفاده کنید. از دکمه <kbd>ESC</kbd> برای خروج از حالت تمام‌صفحه استفاده کنید.
                      </p>
                      <p class="card-text">
                        بر روی <i class="tf-icons bx bx-fullscreen"></i> برای مشاهده گسترش کارت در عمل استفاده کنید.
                      </p>
                    </div>
                  </div>
                </div>
                <div class="col-md">
                  <div class="card card-action mb-4">
                    <div class="card-alert"></div>
                    <div class="card-header">
                      <div class="card-action-title">حذف کارت</div>
                      <div class="card-action-element">
                        <ul class="list-inline mb-0">
                          <li class="list-inline-item">
                            <a href="javascript:void(0);" class="card-close"><i class="tf-icons bx bx-x"></i></a>
                    ...
                    <div class="card-body">
                      <p class="card-text">
                        برای ایجاد یک کارت دارای عمل حذف، از کلاس <code>.card-close</code> به همراه آیتم عمل استفاده کنید.
                      </p>
                      <br>
                      <p class="card-text">
                        بر روی <i class="tf-icons bx bx-x"></i> برای مشاهده حذف کارت در عمل کلیک کنید.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <!-- Header elements -->
              <h5 class="pb-1 mb-4 secondary-font">المان‌های هدر</h5>
              <div class="row mb-5">
                <div class="col-md">
                  <div class="card mb-4">
                    <div class="card-header header-elements">
                      <span class="me-2">سرتیتر کارت</span>
                      <div class="card-header-elements ms-auto">
                        <span class="badge bg-primary rounded-pill">جدید</span>
                      </div>
                    </div>
                    <div class="card-body">
                      <p class="card-text">نمونه سرتیتر کارت با نشان.</p>
                    </div>
                  </div>
                </div>
                <div class="col-md">
                  <div class="card mb-4">
                    <div class="card-body">
                      <div class="card-title header-elements">
                        <h5 class="m-0 me-2">عنوان کارت</h5>
                        <div class="card-title-elements ms-auto">
                          <span class="badge bg-label-primary rounded-pill">10</span>
                        </div>
                      </div>
                      <p class="card-text">نمونه عنوان کارت با نشان.</p>
                    </div>
                  </div>
                </div>
                <div class="w-100"></div>
                    ...
                    <div class="card-header header-elements">
                      ...
                      <div class="card-header-elements ms-auto">
                        <button type="button" class="btn btn-xs btn-primary">
                          <span class="tf-icon bx bx-plus bx-xs me-1"></span>دکمه
                        </button>
                      </div>
                    </div>
                    <div class="card-body">
                      <p class="card-text">نمونه سرتیتر کارت با دکمه کوچک.</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md">
                  <div class="card mb-4">
                    <div class="card-body">
                      ...
                      <p class="card-text">نمونه عنوان کارت با دکمه آیکن کوچک.</p>
                    </div>
                  </div>
                </div>
                <div class="w-100"></div>
                ...
                <div class="col-md">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <p class="card-text">نمونه سرتیتر کارت با جعبه ورودی جستجو.</p>
                    </div>
                  </div>
                </div>
                <div class="col-md">
                  <div class="card mb-4">
                    <div class="card-body">
                      ...
                      <p class="card-text">نمونه عنوان کارت با سوئیچ.</p>
                    </div>
                  </div>
                </div>
                <div class="w-100"></div>
                <div class="col-md">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <p class="card-text">نمونه سرتیتر کارت با متن.</p>
                    </div>
                  </div>
                </div>
                <div class="col-md">
                  <div class="card mb-4">
                    <div class="card-body">
                      ...
                      <p class="card-text">نمونه عنوان کارت با متن.</p>
                    </div>
                  </div>
                </div>
                <div class="w-100"></div>
                  ...
                  <div class="card mb-4">
                    <div class="card-header header-elements">
                      ...
                      <div class="card-header-elements">
                        <span class="badge bg-danger rounded-pill">سلام!</span>
                      </div>
                      <div class="card-header-elements ms-auto">
                        <div class="btn-group">
                    ...
                    <div class="card-body">
                      <p class="card-text">نمونه سرتیتر کارت با نشان و منوی کشویی.</p>
                    </div>
                  </div>
                </div>
                <div class="col-md">
                    ...
                    <div class="card-body">
                      <div class="card-title header-elements">
                        ...
                        <div class="card-title-elements">
                          <label class="switch switch-primary switch-sm me-0">
                            <input type="checkbox" class="switch-input">
                            <span class="switch-toggle-slider top-0">
                              <span class="switch-on"></span>
                              <span class="switch-off"></span>
                            </span>
                          </label>
                        ...
                        <div class="card-title-elements ms-auto">
                          ...
                          <button type="button" class="btn btn-sm btn-primary">برو</button>
                        </div>
                      </div>
                      <p class="card-text">نمونه عنوان کارت با سوئیچ، جعبه انتخاب و دکمه.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <!-- Draggable Cards -->
              <h5 class="pb-1 mb-4 secondary-font">کارت‌های قابل کشیدن</h5>
              <div class="row gy-4" id="sortable-4">
                <div class="col-md-6 col-xl-4">
                  <div class="card bg-primary text-white">
                    <div class="card-header cursor-move primary-font">منو درگ کن!</div>
                    <div class="card-body">
                      <h4 class="card-title text-white">عنوان کارت اولیه</h4>
                ...
                <div class="col-md-6 col-xl-4">
                  <div class="card bg-secondary text-white">
                    <div class="card-header cursor-move primary-font">منو درگ کن!</div>
                    <div class="card-body">
                      <h4 class="card-title text-white">عنوان کارت ثانویه</h4>
                      <p class="card-text">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده</p>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 col-xl-4">
                  <div class="card bg-success text-white">
                    <div class="card-header cursor-move primary-font">منو درگ کن!</div>
                    <div class="card-body">
                      <h4 class="card-title text-white">عنوان کارت موفقیت</h4>
                      <p class="card-text">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده</p>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 col-xl-4">
                  <div class="card bg-danger text-white">
                    <div class="card-header cursor-move primary-font">منو درگ کن!</div>
                    <div class="card-body">
                      <h4 class="card-title text-white">عنوان کارت اخطار</h4>
                      <p class="card-text">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده</p>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 col-xl-4">
                  <div class="card bg-warning text-white">
                    <div class="card-header cursor-move primary-font">منو درگ کن!</div>
                    <div class="card-body">
                      <h4 class="card-title text-white">عنوان کارت هشدار</h4>
                      <p class="card-text">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده</p>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 col-xl-4">
                  <div class="card bg-info text-white">
                    <div class="card-header cursor-move primary-font">منو درگ کن!</div>
                    <div class="card-body">
                      <h4 class="card-title text-white">عنوان کارت اطلاعات</h4>
                      <p class="card-text">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده</p>
                    </div>
                  </div>
                </div>
