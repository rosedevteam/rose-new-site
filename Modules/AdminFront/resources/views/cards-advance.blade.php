...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>کارت‌های پیشرفته - المان‌های رابط کاربری | فرست - قالب مدیریت بوت‌استرپ</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">المان‌های رابط کاربری /</span> کارت‌های پیشرفته
              </h4>
              ...
              <div class="row">
                ...
                <div class="col-md-6 col-lg-4 mb-4 order-0">
                  <div class="card h-100">
                    <div class="card-header">
                      <h3 class="card-title mb-2">تبریک می‌گوییم تونی!</h3>
                      <span class="d-block mb-4 text-nowrap primary-font">بهترین فروشنده ماه</span>
                    </div>
                    <div class="card-body">
                      <div class="row align-items-end">
                        <div class="col-6">
                          <h1 class="display-6 text-primary mb-2 pt-3 pb-2">890 تومان</h1>
                          <small class="d-block mb-3 lh-1-85">شما امروز 57% فروش <br>بیشتری داشتید.</small>

                          <a href="javascript:;" class="btn btn-sm btn-primary">مشاهده فروش‌ها</a>
                        </div>
                ...
                <div class="col-md-6 col-lg-4 col-xl-4 mb-4 order-0">
                  <div class="card h-100">
                    <div class="card-header d-flex align-items-center justify-content-between">
                      <h5 class="card-title mb-0">آخرین به‌روزرسانی</h5>
                    ...
                    <div class="card-body pb-3">
                      <ul class="p-0 m-0">
                        <li class="d-flex align-items-center mb-3">
                          ...
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                              ...
                              <small class="text-muted">2K محصول جدید</small>
                            </div>
                        ...
                        <li class="d-flex align-items-center mb-3">
                          ...
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                              ...
                              <small class="text-muted">39K فروش جدید</small>
                            </div>
                        ...
                        <li class="d-flex align-items-center mb-3">
                          ...
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                              <p class="mb-0">کل درآمد</p>
                              <small class="text-muted">43K درآمد جدید</small>
                            </div>
                ...
                <div class="col-md-6 col-lg-4 col-xl-4 mb-4 order-0">
                  <div class="card h-100">
                    <div class="card-header d-flex align-items-center justify-content-between">
                      <h5 class="card-title m-0 me-2">تاریخ</h5>
                      <div class="dropdown primary-font">
                      ...
                      <table class="table table-borderless mb-2 lh-inherit">
                        <tbody>
                          <tr>
                            <td class="pt-0">
                              <div class="d-flex justify-content-start align-items-center">
                                <img src="../../assets/img/icons/payments/visa-light.png" alt="visa" width="44" class="me-2" data-app-light-img="icons/payments/visa-light.png" data-app-dark-img="icons/payments/visa-dark.png">
                                <div class="d-flex flex-column">
                                  <p class="mb-0">*8490</p>
                                  <small class="text-muted text-nowrap">کارت اعتباری</small>
                                </div>
                              </div>
                            </td>
                            <td class="pt-0">
                              <h6 class="mb-0">ارسال شده</h6>
                            </td>
                            <td class="pt-0">
                          ...
                          <tr>
                            <td>
                              <div class="d-flex justify-content-start align-items-center">
                                <img src="../../assets/img/icons/payments/paypal-light.png" alt="paypal" width="44" class="me-2" data-app-light-img="icons/payments/paypal-light.png" data-app-dark-img="icons/payments/paypal-dark.png">
                                <div class="d-flex flex-column">
                                  <p class="mb-0">*6345</p>
                                  <small class="text-muted text-nowrap">پی‌پال</small>
                                </div>
                              </div>
                            </td>
                            <td>
                              <h6 class="mb-0">دریافت شده</h6>
                            </td>
                            <td>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex justify-content-start align-items-center">
                                <img src="../../assets/img/icons/payments/amazon-light.png" alt="amazon" width="44" class="me-2" data-app-light-img="icons/payments/amazon-light.png" data-app-dark-img="icons/payments/amazon-dark.png">
                                <div class="d-flex flex-column">
                                  <p class="mb-0">آمازون</p>
                                  <small class="text-muted text-nowrap">کیف پول</small>
                                </div>
                              </div>
                            </td>
                            <td>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex justify-content-start align-items-center">
                                <img src="../../assets/img/icons/payments/master-light.png" alt="mastercard" width="44" class="me-2" data-app-light-img="icons/payments/master-light.png" data-app-dark-img="icons/payments/master-dark.png">
                                <div class="d-flex flex-column">
                                  <p class="mb-0">*6792</p>
                                  <small class="text-muted text-nowrap">کارت Debit</small>
                                </div>
                              </div>
                            </td>
                            <td>
                ...
                <!-- Activity Timeline -->
                <div class="col-md-6 col-lg-5 mb-4 mb-md-0 mb-lg-4 order-3 order-lg-0">
                  <div class="card h-100">
                ...
                <!-- Activity -->
                <div class="col-md-6 col-xl-4 col-xxl-3 mb-4 mb-xxl-0 order-1 order-lg-0">
                  <div class="card h-100">
                    <div class="card-header">
                ...
                <!-- Sales -->
                <div class="col-md-6 col-xl-4 col-xxl-3 mb-4 mb-xxl-0 order-2 order-lg-0">
                  <div class="card h-100">
                ...
                <!-- Top Referrals -->
                <div class="col-md-6 col-xl-4 col-xxl-3 mb-xxl-0 mb-4 mb-lg-0 mb-xl-4 mb-xxl-0 order-2 order-lg-0">
                  <div class="card">
                    <div class="card-header">
                      <h5 class="card-title mb-0">برترین ارجاعات</h5>
                    </div>
                    <div class="table-responsive">
                      <table class="table table-borderless mb-1 lh-inherit">
                        <thead class="border-bottom">
                          <tr>
                            <th class="pt-0">منبع</th>
                            <th class="pt-0">کاربران</th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                ...
                                <div class="">
                                  <p class="mb-0 text-nowrap">ترافیک داخلی</p>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                ...
                                <div class="">
                                  <p class="mb-0 text-nowrap">ترافیک مستقیم</p>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                ...
                                <div class="">
                                  <p class="mb-0 text-nowrap">ترافیک جستجو</p>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                ...
                                <div class="">
                                  <p class="mb-0 text-nowrap">ترافیک اجتماعی</p>
                ...
                <div class="col-md-6 col-xl-4 col-xxl-3 order-3 order-lg-0">
                  <div class="card h-100">
                    <div class="card-header">
                      <h5 class="card-title mb-3">کل کاربران</h5>
                      <h1 class="display-6 fw-normal mb-0 primary-font">8,634,820</h1>
                    </div>
                    <div class="card-body">
                      <span class="d-inline-block lh-1-85 mb-2">فعالیت کنونی</span>
                      ...
                      <ul class="p-0 m-0 lh-1-85">
                        <li class="mb-2 d-flex justify-content-between">
                          <div class="d-flex align-items-center me-3">
                            <span class="badge badge-dot bg-success me-2"></span> ایران
                          </div>
                        ...
                        <li class="mb-2 d-flex justify-content-between">
                          <div class="d-flex align-items-center me-3">
                            <span class="badge badge-dot bg-danger me-2"></span> فرانسه
                          </div>
                          <div class="d-flex gap-3">
                            <span>25.7k</span>
                        ...
                        <li class="mb-2 d-flex justify-content-between">
                          <div class="d-flex align-items-center me-3">
                            <span class="badge badge-dot bg-info me-2"></span> ایتالیا
                          </div>
                          <div class="d-flex gap-3">
                            <span>11.5k</span>
                        ...
                        <li class="mb-2 d-flex justify-content-between">
                          <div class="d-flex align-items-center me-3">
                            <span class="badge badge-dot bg-primary me-2"></span> چین
                          </div>
                          <div class="d-flex gap-3">
                            <span>48.5k</span>
                        ...
                        <li class="d-flex justify-content-between">
                          <div class="d-flex align-items-center me-3">
                            <span class="badge badge-dot bg-warning me-2"></span> هندوستان
                          </div>
                          <div class="d-flex gap-3">
                            <span>22.1k</span>
