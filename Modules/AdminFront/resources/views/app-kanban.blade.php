...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>تخته وظایف - برنامه‌ها | فرست - قالب مدیریت بوت‌استرپ</title>
                ...
                <div class="row">
                  <div class="col-12">
                    <form class="kanban-add-new-board">
                      ...
                      <input type="text" class="form-control w-px-250 kanban-add-board-input mb-2 d-none" placeholder="افزودن عنوان تخته" id="kanban-add-board-input" required>
                      ...
                      <div class="tab-pane fade show active" id="tab-update" role="tabpanel">
                        <form>
                          ...
                          <div class="mb-3">
                            ...
                            <input type="text" id="due-date" class="form-control" placeholder="تاریخ سررسید را وارد کنید">
                          </div>
                          <div class="mb-3">
                            <label class="form-label" for="label"> برچسب</label>
                            <select class="select2 select2-label form-select" id="label">
                              <option data-color="bg-label-success" value="UX">تجربه کاربری</option>
                              <option data-color="bg-label-warning" value="Images">تصاویر</option>
                              <option data-color="bg-label-info" value="Info">اطلاعات</option>
                          ...
                          <div class="mb-3">
                            <label class="form-label">اختصاص دادن</label>
                      ...
                      <div class="tab-pane fade" id="tab-activity" role="tabpanel">
                        <div class="media mb-4 d-flex align-items-start">
                          <div class="avatar me-2 flex-shrink-0 mt-1">
                            <span class="avatar-initial bg-label-success rounded-circle">اج</span>
                          </div>
                          <div class="media-body">
                            <p class="mb-0"><span class="fw-semibold">جردن</span> تخته را ترک کرد.</p>
                            <small class="text-muted">امروز 11:00 ق.ظ</small>
                          </div>
                        </div>
                        <div class="media mb-4 d-flex align-items-start">
                          <div class="avatar me-2 flex-shrink-0 mt-1">
                          ...
                          <div class="media-body">
                            <p class="mb-0">
                              <span class="fw-semibold">دایانا</span> نام برد از
                              <span class="text-primary">@bruce</span> در یک دیدگاه.
                            </p>
                            <small class="text-muted">امروز 10:20 ق.ظ</small>
                          </div>
                        </div>
                        <div class="media mb-4 d-flex align-items-start">
                          <div class="avatar me-2 flex-shrink-0 mt-1">
                          ...
                          <div class="media-body">
                            <p class="mb-0">
                              <span class="fw-semibold">مارتین</span> وظیفه نقشه‌ها و نمودارها را به تخته انجام شده منتقل کرد.
                            </p>
                            <small class="text-muted">امروز 10:00 ق.ظ</small>
                          </div>
                        </div>
                        <div class="media mb-4 d-flex align-items-start">
                          <div class="avatar me-2 flex-shrink-0 mt-1">
                          ...
                          <div class="media-body">
                            <p class="mb-0"><span class="fw-semibold">بری</span> در وظیفه بررسی برنامه دیدگاه نوشت.</p>
                            <small class="text-muted">امروز 8:32 ق.ظ</small>
                          </div>
                        </div>
                        <div class="media mb-4 d-flex align-items-start">
                          <div class="avatar me-2 flex-shrink-0 mt-1">
                            <span class="avatar-initial bg-label-secondary rounded-circle">ب‌و</span>
                          </div>
                          <div class="media-body">
                            <p class="mb-0"><span class="fw-semibold">بروس</span> به وظیفه بررسی کد اختصاص داده شد.</p>
                            <small class="text-muted">امروز 8:30 ق.ظ</small>
                          </div>
                        </div>
                        <div class="media mb-4 d-flex align-items-start">
                          <div class="avatar me-2 flex-shrink-0 mt-1">
                            <span class="avatar-initial bg-label-danger rounded-circle">ک‌ج</span>
                          </div>
                          <div class="media-body">
                            <p class="mb-0">
                              <span class="fw-semibold">کلارک</span> وظیفه تحقیق UX را اختصاص داد به
                              <span class="text-primary">@martian</span>
                            </p>
                            <small class="text-muted">امروز 8:00 ق.ظ</small>
                          </div>
                        </div>
                        <div class="media mb-4 d-flex align-items-start">
                          <div class="avatar me-2 flex-shrink-0 mt-1">
                          ...
                          <div class="media-body">
                            <p class="mb-0">
                              <span class="fw-semibold">ریموند</span> منتقل کرد وظیفه
                              <span class="fw-semibold">فرم‌ها و جدول‌ها</span> را از در حال پیشرفت به انجام شده.
                            </p>
                            <small class="text-muted">امروز 7:45 ق.ظ</small>
                          </div>
                        </div>
                        <div class="media mb-4 d-flex align-items-start">
                          <div class="avatar me-2 flex-shrink-0 mt-1">
                          ...
                          <div class="media-body">
                            <p class="mb-0">
                              <span class="fw-semibold">بری</span> تمامی وظایف اختصاص داده شده به او را تمام کرد.
                            </p>
                            <small class="text-muted">امروز 7:17 ق.ظ</small>
                          </div>
                        </div>
                        <div class="media mb-4 d-flex align-items-start">
                          <div class="avatar me-2 flex-shrink-0 mt-1">
                          ...
                          <div class="media-body">
                            <p class="mb-0"><span class="fw-semibold">جردن</span> یک وظیفه برای به روز رسانی تصاویر اضافه کرد.</p>
                            <small class="text-muted">امروز 7:00 ق.ظ</small>
                          </div>
                        </div>
                        <div class="media mb-4 d-flex align-items-start">
                          <div class="avatar me-2 flex-shrink-0 mt-1">
                          ...
                          <div class="media-body">
                            <p class="mb-0">
                              <span class="fw-semibold">دایانا</span> منتقل کرد وظیفه
                              <span class="fw-semibold">سوالات متداول UX</span> را از تخته در حال پیشرفت به انجام شده.
                            </p>
                            <small class="text-muted">امروز 7:00 ق.ظ</small>
                          </div>
                        </div>
                        <div class="media mb-4 d-flex align-items-start">
                          ...
                          <div class="media-body">
                            <p class="mb-0">
                              <span class="fw-semibold">کلارک</span> یک تخته جدید ایجاد کرد با نام
                              <span class="fw-semibold">انجام شده</span>.
                            </p>
                            <small class="text-muted">دیروز 3:00 ب.ظ</small>
                          </div>
                        </div>
                        <div class="media d-flex align-items-center">
                          ...
                          <div class="media-body">
                            <p class="mb-0"><span class="fw-semibold">بروس</span> یک وظیفه جدید در تخته در حال پیشرفت اضافه کرد.</p>
                            <small class="text-muted">دیروز 12:00 ب.ظ</small>
                          </div>
                        </div>
                      </div>
                    </div>
