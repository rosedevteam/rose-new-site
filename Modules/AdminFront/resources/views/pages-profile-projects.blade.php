...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>پروفایل کاربر - پروژه‌ها | فرست - قالب مدیریت بوت‌استرپ</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">پروفایل کاربر /</span> پروژه‌ها
              </h4>
              ...
              <div class="row">
                <div class="col-md-12">
                  <ul class="nav nav-pills flex-column flex-sm-row mb-4">
                    <li class="nav-item">
                      <a class="nav-link" href="pages-profile-user.html"><i class="bx bx-user me-1"></i> پروفایل</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="pages-profile-teams.html"><i class="bx bx-group me-1"></i> تیم‌ها</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link active my-1 my-md-0" href="javascript:void(0);"><i class="bx bx-grid-alt me-1"></i> پروژه‌ها</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <div class="card-header primary-font">
                      <div class="d-flex align-items-start">
                        <div class="d-flex align-items-start">
                          ...
                          <div class="me-2">
                            <h5 class="mb-1"><a href="javascript:;" class="h5 stretched-link">بنرهای اجتماعی</a></h5>
                            <div class="client-info d-flex align-items-center text-nowrap">
                              <h6 class="mb-0 me-1">مشتری:</h6>
                              <span>بیل گیتس</span>
                            </div>
                          </div>
                        </div>
                        <div class="ms-auto">
                          <div class="dropdown zindex-2">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                              <li><a class="dropdown-item" href="javascript:void(0);">تغییر نام پروژه</a></li>
                              ...
                              <li><a class="dropdown-item text-danger" href="javascript:void(0);">ترک پروژه</a></li>
                            </ul>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="card-body">
                      <div class="d-flex align-items-center flex-wrap">
                        <div class="bg-lighter p-2 rounded me-auto mb-3">
                          <h6 class="mb-1">24.8k تومان <span class="text-body fw-normal">/ 18.2k تومان</span></h6>
                          <span>کل بودجه</span>
                        </div>
                        <div class="text-end mb-3">
                          <h6 class="mb-1">تاریخ شروع: <span class="text-body fw-normal">1401/2/21</span></h6>
                          <h6 class="mb-1">مهلت تحویل: <span class="text-body fw-normal">1402/2/22</span></h6>
                        </div>
                      </div>
                      <p class="mb-0">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده</p>
                    </div>
                    <div class="card-body border-top">
                      <div class="d-flex align-items-center mb-3">
                        <h6 class="mb-1">تمام ساعت‌ها: <span class="text-body fw-normal">380/244</span></h6>
                        <span class="badge bg-label-success ms-auto">28 روز باقی مانده</span>
                      </div>
                      <div class="d-flex justify-content-between align-items-center mb-2">
                        <small>وظیفه: 290/344</small>
                        <small>95% تکمیل شده</small>
                      </div>
                      ...
                      <div class="d-flex align-items-center">
                        <div class="d-flex align-items-center">
                          <ul class="list-unstyled d-flex align-items-center avatar-group mb-0 zindex-2">
                            ...
                            <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" title="بری الن" class="avatar avatar-sm pull-up me-2">
                              <img class="rounded-circle" src="../../assets/img/avatars/6.png" alt="آواتار">
                            </li>
                            <li><small>280 عضو</small></li>
                          </ul>
                        </div>
                        <div class="ms-auto">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                  <div class="card">
                    <div class="card-header primary-font">
                      <div class="d-flex align-items-start">
                        <div class="d-flex align-items-start">
                          ...
                          <div class="me-2">
                            <h5 class="mb-1"><a href="javascript:;" class="h5 stretched-link">قالب مدیریت</a></h5>
                            <div class="client-info d-flex align-items-center text-nowrap">
                              <h6 class="mb-0 me-1">مشتری:</h6>
                              <span>لیونل مسی</span>
                            </div>
                    ...
                    <div class="card-body">
                      <div class="d-flex align-items-center flex-wrap">
                        <div class="bg-lighter p-2 rounded me-auto mb-3">
                          <h6 class="mb-1">2.4k تومان <span class="text-body fw-normal">/ 1.8k تومان</span></h6>
                          <span>کل بودجه</span>
                        </div>
                        <div class="text-end mb-3">
                          <h6 class="mb-1">تاریخ شروع: <span class="text-body fw-normal">1399/8/21</span></h6>
                          <h6 class="mb-1">مهلت تحویل: <span class="text-body fw-normal">1401/6/22</span></h6>
                        </div>
                      </div>
                      <p class="mb-0">
                    ...
                    <div class="card-body border-top">
                      <div class="d-flex align-items-center mb-3">
                        <h6 class="mb-1">تمام ساعت‌ها: <span class="text-body fw-normal">98/135</span></h6>
                        <span class="badge bg-label-warning ms-auto">15 روز باقی مانده</span>
                      </div>
                      <div class="d-flex justify-content-between align-items-center mb-2">
                        <small>وظیفه: 12/90</small>
                        <small>42% تکمیل شده</small>
                      </div>
                      <div class="progress mb-3" style="height: 8px">
                      ...
                      <div class="d-flex align-items-center">
                        <div class="d-flex align-items-center">
                          <ul class="list-unstyled d-flex align-items-center avatar-group mb-0 zindex-2">
                            ...
                            <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" title="کریس رونالدو" class="avatar avatar-sm pull-up me-2">
                              <img class="rounded-circle" src="../../assets/img/avatars/16.png" alt="آواتار">
                            </li>
                            <li><small>1.1k عضو</small></li>
                          </ul>
                        </div>
                        <div class="ms-auto">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                  <div class="card">
                    <div class="card-header primary-font">
                      <div class="d-flex align-items-start">
                        <div class="d-flex align-items-start">
                          ...
                          <div class="me-2">
                            <h5 class="mb-1"><a href="javascript:;" class="h5 stretched-link">طراحی برنامه</a></h5>
                            <div class="client-info d-flex align-items-center text-nowrap">
                              <h6 class="mb-0 me-1">مشتری:</h6>
                    ...
                    <div class="card-body">
                      <div class="d-flex align-items-center flex-wrap">
                        <div class="bg-lighter p-2 rounded me-auto mb-3">
                          <h6 class="mb-1">980 تومان <span class="text-body fw-normal">/ 420 تومان</span></h6>
                          <span>کل بودجه</span>
                        </div>
                        <div class="text-end mb-3">
                          <h6 class="mb-1">تاریخ شروع: <span class="text-body fw-normal">1400/7/21</span></h6>
                          <h6 class="mb-1">مهلت تحویل: <span class="text-body fw-normal">1401/10/21</span></h6>
                        </div>
                      </div>
                      <p class="mb-0">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده</p>
                    </div>
                    <div class="card-body border-top">
                      <div class="d-flex align-items-center mb-3">
                        <h6 class="mb-1">تمام ساعت‌ها: <span class="text-body fw-normal">880/421</span></h6>
                        <span class="badge bg-label-danger ms-auto">45 روز باقی مانده</span>
                      </div>
                      <div class="d-flex justify-content-between align-items-center mb-2">
                        <small>وظیفه: 22/140</small>
                        <small>68% تکمیل شده</small>
                      </div>
                      <div class="progress mb-3" style="height: 8px">
                      ...
                      <div class="d-flex align-items-center">
                        <div class="d-flex align-items-center">
                          <ul class="list-unstyled d-flex align-items-center avatar-group mb-0 zindex-2">
                            ...
                            <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" title="دیوید بکهام" class="avatar avatar-sm pull-up me-2">
                              <img class="rounded-circle" src="../../assets/img/avatars/7.png" alt="آواتار">
                            </li>
                            <li><small>458 عضو</small></li>
                          </ul>
                        </div>
                        <div class="ms-auto">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                  <div class="card">
                    <div class="card-header primary-font">
                      <div class="d-flex align-items-start">
                        <div class="d-flex align-items-start">
                          ...
                          <div class="me-2">
                            <h5 class="mb-1"><a href="javascript:;" class="h5 stretched-link">طراحی وب سایت</a></h5>
                            <div class="client-info d-flex align-items-center text-nowrap">
                              <h6 class="mb-0 me-1">مشتری:</h6>
                              <span>اولیور کوئین</span>
                            </div>
                          </div>
                        </div>
                        <div class="ms-auto">
                    ...
                    <div class="card-body">
                      <div class="d-flex align-items-center flex-wrap">
                        <div class="bg-lighter p-2 rounded me-auto mb-3">
                          <h6 class="mb-1">8.5k تومان <span class="text-body fw-normal">/ 2.43k تومان</span></h6>
                          <span>کل بودجه</span>
                        </div>
                        <div class="text-end mb-3">
                          <h6 class="mb-1">تاریخ شروع: <span class="text-body fw-normal">1400/2/19</span></h6>
                          <h6 class="mb-1">مهلت تحویل: <span class="text-body fw-normal">1402/9/22</span></h6>
                        </div>
                      </div>
                      <p class="mb-0">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از</p>
                    </div>
                    <div class="card-body border-top">
                      <div class="d-flex align-items-center mb-3">
                        <h6 class="mb-1">تمام ساعت‌ها: <span class="text-body fw-normal">1.2k/820</span></h6>
                        <span class="badge bg-label-warning ms-auto">126 روز باقی مانده</span>
                      </div>
                      <div class="d-flex justify-content-between align-items-center mb-2">
                        <small>وظیفه: 237/420</small>
                        <small>72% تکمیل شده</small>
                      </div>
                      <div class="progress mb-3" style="height: 8px">
                      ...
                      <div class="d-flex align-items-center">
                        <div class="d-flex align-items-center">
                          <ul class="list-unstyled d-flex align-items-center avatar-group mb-0 zindex-2">
                            ...
                            <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" title="امیلیا کلارک" class="avatar avatar-sm pull-up me-2">
                              <img class="rounded-circle" src="../../assets/img/avatars/12.png" alt="آواتار">
                            </li>
                            <li><small>137 عضو</small></li>
                          </ul>
                        </div>
                        <div class="ms-auto">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                  <div class="card">
                    <div class="card-header primary-font">
                      <div class="d-flex align-items-start">
                        <div class="d-flex align-items-start">
                          ...
                          <div class="me-2">
                            <h5 class="mb-1"><a href="javascript:;" class="h5 stretched-link">لورم ایپسوم متن</a></h5>
                            <div class="client-info d-flex align-items-center text-nowrap">
                              <h6 class="mb-0 me-1">مشتری:</h6>
                    ...
                    <div class="card-body">
                      <div class="d-flex align-items-center flex-wrap">
                        <div class="bg-lighter p-2 rounded me-auto mb-3">
                          <h6 class="mb-1">52.7k تومان <span class="text-body fw-normal">/ 28.4k تومان</span></h6>
                          <span>کل بودجه</span>
                        </div>
                        <div class="text-end mb-3">
                          <h6 class="mb-1">تاریخ شروع: <span class="text-body fw-normal">1400/12/20</span></h6>
                          <h6 class="mb-1">مهلت تحویل: <span class="text-body fw-normal">1401/12/21</span></h6>
                        </div>
                      </div>
                      <p class="mb-0">
                    ...
                    <div class="card-body border-top">
                      <div class="d-flex align-items-center mb-3">
                        <h6 class="mb-1">تمام ساعت‌ها: <span class="text-body fw-normal">142/420</span></h6>
                        <span class="badge bg-label-danger ms-auto">5 روز باقی مانده</span>
                      </div>
                      <div class="d-flex justify-content-between align-items-center mb-2">
                        <small>وظیفه: 29/285</small>
                        <small>35% تکمیل شده</small>
                      </div>
                      <div class="progress mb-3" style="height: 8px">
                      ...
                      <div class="d-flex align-items-center">
                        <div class="d-flex align-items-center">
                          <ul class="list-unstyled d-flex align-items-center avatar-group mb-0 zindex-2">
                            ...
                            <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" title="تامی مرلین" class="avatar avatar-sm pull-up me-2">
                              <img class="rounded-circle" src="../../assets/img/avatars/15.png" alt="آواتار">
                            </li>
                            <li><small>82 عضو</small></li>
                          </ul>
                        </div>
                        <div class="ms-auto">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                  <div class="card">
                    <div class="card-header primary-font">
                      <div class="d-flex align-items-start">
                        <div class="d-flex align-items-start">
                          ...
                          <div class="me-2">
                            <h5 class="mb-1"><a href="javascript:;" class="h5 stretched-link">طراحی لوگو</a></h5>
                            <div class="client-info d-flex align-items-center text-nowrap">
                              <h6 class="mb-0 me-1">مشتری:</h6>
                              <span>دیوید بکهام</span>
                            </div>
                          </div>
                        </div>
                        <div class="ms-auto">
                    ...
                    <div class="card-body">
                      <div class="d-flex align-items-center flex-wrap">
                        <div class="bg-lighter p-2 rounded me-auto mb-3">
                          <h6 class="mb-1">1.3k تومان <span class="text-body fw-normal">/ 655 تومان</span></h6>
                          <span>کل بودجه</span>
                        </div>
                        <div class="text-end mb-3">
                          <h6 class="mb-1">تاریخ شروع: <span class="text-body fw-normal">1399/8/21</span></h6>
                          <h6 class="mb-1">مهلت تحویل: <span class="text-body fw-normal">1402/11/21</span></h6>
                        </div>
                      </div>
                      <p class="mb-0">
                        لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک
                    ...
                    <div class="card-body border-top">
                      <div class="d-flex align-items-center mb-3">
                        <h6 class="mb-1">تمام ساعت‌ها: <span class="text-body fw-normal">580/445</span></h6>
                        <span class="badge bg-label-success ms-auto">4 روز باقی مانده</span>
                      </div>
                      <div class="d-flex justify-content-between align-items-center mb-2">
                        <small>وظیفه: 290/290</small>
                        <small>100% تکمیل شده</small>
                      </div>
                      <div class="progress mb-3" style="height: 8px">
                      ...
                      <div class="d-flex align-items-center">
                        <div class="d-flex align-items-center">
                          <ul class="list-unstyled d-flex align-items-center avatar-group mb-0 zindex-2">
                            ...
                            <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" title="روبرتو کارلوس" class="avatar avatar-sm pull-up me-2">
                              <img class="rounded-circle" src="../../assets/img/avatars/15.png" alt="آواتار">
                            </li>
                            <li><small>16 عضو</small></li>
                          </ul>
                        </div>
                        <div class="ms-auto">
