              ...
              <div class="row">
                <div class="col-md-12">
                  <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    <li class="nav-item">
                      <a class="nav-link" href="pages-account-settings-account.html"><i class="bx bx-user me-1"></i> حساب</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link active my-1 my-md-0" href="javascript:void(0);"><i class="bx bx-lock-alt me-1"></i> امنیت</a>
                    </li>
                    <li class="nav-item">
                      ...
                      <form id="formAccountSettings" method="POST" onsubmit="return false">
                        <div class="row">
                          <div class="mb-3 col-md-6 form-password-toggle">
                            ...
                            <div class="input-group input-group-merge">
                              <input class="form-control text-start" type="password" dir="ltr" name="currentPassword" id="currentPassword" placeholder="············">
                        ...
                        <div class="row">
                          <div class="mb-3 col-md-6 form-password-toggle">
                            ...
                            <div class="input-group input-group-merge">
                              <input class="form-control text-start" type="password" dir="ltr" id="newPassword" name="newPassword" placeholder="············">
                              <span class="input-group-text cursor-pointer"><i class="bx bx-hide"></i></span>
                            </div>
                          </div>
                          ...
                          <div class="mb-3 col-md-6 form-password-toggle">
                            ...
                            <div class="input-group input-group-merge">
                              <input class="form-control text-start" type="password" dir="ltr" name="confirmPassword" id="confirmPassword" placeholder="············">
                              <span class="input-group-text cursor-pointer"><i class="bx bx-hide"></i></span>
                            </div>
                          </div>
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      ...
                      <p class="w-75">
                        احراز هویت دو مرحله‌ای یک لایه امنیتی بیشتر با الزام به وارد کردن بیش از یک رمز عبور برای ورود به حساب شما اضافه میکند.
                        <a href="javascript:void(0);">آشنایی بیشتر.</a>
                      </p>
                    ...
                    <div class="modal-dialog modal-simple modal-enable-otp modal-dialog-centered">
                      <div class="modal-content p-3 p-md-5">
                        <div class="modal-body">
                          ...
                          <p>
                            شماره موبایل خود را به همراه کد کشور وارد کنید و ما یک کد تایید برای شما ارسال خواهیم کرد.
                          </p>
                  ...
                  <!-- Create an API key -->
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">ایجاد یک کلید API</h5>
                    <div class="row">
                          ...
                          <form id="formAccountSettingsApiKey" method="POST" onsubmit="return false">
                            <div class="row">
                              <div class="mb-3 col-12">
                                <label for="apiAccess" class="form-label">نوع کلید API که می‌خواهید ایجاد کنید را انتخاب کنید</label>
                                <select id="apiAccess" class="select2 form-select">
                                  <option value="">انتخاب نوع کلید</option>
                                  <option value="full">کنترل کامل</option>
                                  <option value="modify">ویرایش</option>
                                  <option value="read-execute">خواندن و اجرا</option>
                                  <option value="folders">لیست کردن محتویات پوشه</option>
                                  <option value="read">فقط خواندنی</option>
                                  <option value="read-write">خواندن و نوشتن</option>
                                </select>
                              </div>
                              <div class="mb-3 col-12">
                                <label for="apiKey" class="form-label">نام کلید API را وارد کنید</label>
                                <input type="text" class="form-control" id="apiKey" name="apiKey" placeholder="کلید سرور 1">
                              </div>
                              <div class="col-12">
                                <button type="submit" class="btn btn-primary me-2 d-grid w-100">ایجاد کلید</button>
                              </div>
                            </div>
                          </form>
                        </div>
                      ...
                      <div class="col-md-7 order-md-1 order-0">
                        <div class="text-center mt-md-n5 pt-md-2 mx-3 mx-md-0">
                          <img src="../../assets/img/illustrations/boy-working-light.png" class="img-fluid" alt="Api Key Image" width="300" data-app-light-img="illustrations/boy-working-light.png" data-app-dark-img="illustrations/boy-working-dark.png">
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <!-- API Key List & Access -->
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">لیست کلید API و دسترسی</h5>
                    <div class="card-body">
                      <p>
                        یک کلید API یک رشته رمزگذاری شده ساده است که یک برنامه را بدون هیچ گونه اصلی شناسایی می کند. آنها برای دسترسی به داده های عمومی به صورت ناشناس مفید هستند و برای مرتبط کردن درخواست های API با پروژه شما برای سهمیه و صورتحساب استفاده می شوند.
                      </p>
                      <div class="row">
                        <div class="col-md-12">
                          <div class="bg-lighter rounded p-3 mb-3 position-relative">
                            <div class="dropdown api-key-actions">
                              ...
                              <div class="dropdown-menu dropdown-menu-end">
                                <a href="javascript:;" class="dropdown-item"><i class="bx bx-pencil me-2"></i>ویرایش</a>
                                <a href="javascript:;" class="dropdown-item"><i class="bx bx-trash me-2"></i>حذف</a>
                              </div>
                            </div>
                            <div class="d-flex align-items-center flex-wrap mb-3">
                              <h4 class="mb-0 me-3">کلید سرور 1</h4>
                            ...
                            <span class="lh-1-85">ایجاد شده در 28 فروردین 1401, 18:20 GMT+4:10</span>
                          </div>
                          <div class="bg-lighter rounded p-3 position-relative mb-3">
                            ...
                            <div class="d-flex align-items-center flex-wrap mb-3">
                              <h4 class="mb-0 me-3">کلید سرور 2</h4>
                              <span class="badge bg-label-primary">فقط خواندنی</span>
                            </div>
                            <div class="d-flex align-items-center mb-2 lh-1-85">
                              <span class="fw-semibold me-3">bb98e571-a2e2-4de8-90a9-2e231b5e99</span>
                              <span class="text-muted cursor-pointer"><i class="bx bx-copy"></i></span>
                            </div>
                            <span class="lh-1-85">ایجاد شده در 12 اردیبهشت 1401, 10:30 GMT+2:30</span>
                          </div>
                          <div class="bg-lighter rounded p-3 position-relative">
                            ...
                            <div class="d-flex align-items-center flex-wrap mb-3">
                              <h4 class="mb-0 me-3">کلید سرور 3</h4>
                              <span class="badge bg-label-primary">دسترسی کامل</span>
                            </div>
                            <div class="d-flex align-items-center mb-2 lh-1-85">
                            ...
                            <span class="lh-1-85">ایجاد شده در 28 اردیبهشت 1401, 12:21 GMT+4:10</span>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="table-responsive">
                      <table class="table border-top">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td class="text-truncate">
                              <i class="bx bxl-apple me-3"></i> <span class="fw-semibold">سافاری روی آیفون</span>
                            </td>
