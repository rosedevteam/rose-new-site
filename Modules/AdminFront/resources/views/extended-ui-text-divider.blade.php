...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>جداکننده متن - رابط کاربری توسعه یافته | فرست - قالب مدیریت بوت‌استرپ</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">رابط کاربری توسعه یافته /</span> جداکننده متن
              </h4>
              ...
              <div class="row">
                ...
                <div class="col-md-12 mb-4">
                  <div class="card">
                    ...
                    <div class="card-body">
                      <div class="divider">
                        <div class="divider-text">متن</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-12 mb-4">
                  <div class="card">
                    <h5 class="card-header heading-color">تراز</h5>
                    <div class="card-body">
                      <div class="divider text-start">
                        <div class="divider-text">شروع</div>
                      </div>
                      <div class="divider text-start-center">
                        <div class="divider-text">شروع-وسط</div>
                      </div>
                      <div class="divider">
                        <div class="divider-text">وسط (پیش‌فرض)</div>
                      </div>
                      <div class="divider text-end-center">
                        <div class="divider-text">پایان-وسط</div>
                      </div>
                      <div class="divider text-end">
                        <div class="divider-text">پایان</div>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      <div class="divider divider-primary">
                        <div class="divider-text">اولیه</div>
                      </div>
                      <div class="divider divider-success">
                        <div class="divider-text">موفقیت</div>
                      </div>
                      <div class="divider divider-danger">
                        <div class="divider-text">اخطار</div>
                      </div>
                      <div class="divider divider-warning">
                        <div class="divider-text">هشدار</div>
                      </div>
                      <div class="divider divider-info">
                        <div class="divider-text">اطلاعات</div>
                      </div>
                      <div class="divider divider-dark">
                        <div class="divider-text">تیره</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-12 mb-4">
                  <div class="card">
                    <h5 class="card-header heading-color">آیکن‌ها</h5>
                    <div class="card-body">
                      <div class="divider text-start">
                ...
                <div class="col-md-12">
                  <div class="card">
                    <h5 class="card-header heading-color">طرح ها</h5>
                    <div class="card-body">
                      <div class="divider">
                        <div class="divider-text">خط صاف (پیش‌فرض)</div>
                      </div>
                      <div class="divider divider-dotted">
                        <div class="divider-text">نقطه‌چین</div>
                      </div>
                      <div class="divider divider-dashed">
                        <div class="divider-text">خط‌چین</div>
                      </div>
                    </div>
                  </div>
                </div>
