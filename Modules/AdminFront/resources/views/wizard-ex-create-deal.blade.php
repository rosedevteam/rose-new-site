...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>ایجاد معامله - نمونه‌های چند مرحله‌ای | فرست - قالب مدیریت بوت‌استرپ</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">نمونه‌های چند مرحله‌ای /</span> ایجاد معامله
              </h4>
                ...
                <div class="bs-stepper-header">
                  <div class="step" data-target="#deal-type">
                    <button type="button" class="step-trigger">
                      ...
                      <span class="bs-stepper-label">
                        <span class="bs-stepper-title">نوع معامله</span>
                        <span class="bs-stepper-subtitle">نوع معامله را انتخاب کنید</span>
                      </span>
                    </button>
                  </div>
                  <div class="line"></div>
                  <div class="step" data-target="#deal-details">
                    <button type="button" class="step-trigger">
                      ...
                      <span class="bs-stepper-label">
                        <span class="bs-stepper-title">جزئیات معامله</span>
                        <span class="bs-stepper-subtitle">جزئیات معامله را وارد کنید</span>
                      </span>
                    </button>
                  </div>
                  <div class="line"></div>
                  <div class="step" data-target="#deal-usage">
                    <button type="button" class="step-trigger">
                      ...
                      <span class="bs-stepper-label">
                        <span class="bs-stepper-title">کاربرد معامله</span>
                        <span class="bs-stepper-subtitle">محدودیت‌ها و پیشنهادها</span>
                      </span>
                    </button>
                  </div>
                  <div class="line"></div>
                  <div class="step" data-target="#review-complete">
                    <button type="button" class="step-trigger">
                      ...
                      <span class="bs-stepper-label">
                        <span class="bs-stepper-title">بررسی و تکمیل</span>
                        <span class="bs-stepper-subtitle">یک معامله ایجاد کنید!</span>
                      </span>
                    </button>
                  </div>
                </div>
                <div class="bs-stepper-content">
                  <form id="wizard-create-deal-form" onsubmit="return false">
                    ...
                    <div id="deal-type" class="content">
                      <div class="row g-3">
                        <div class="col-12">
                          <img src="../../assets/img/illustrations/shopping-girl-light.png" class="img-fluid w-100 border rounded-2" alt="shopping girl" data-app-light-img="illustrations/shopping-girl-light.png" data-app-dark-img="illustrations/shopping-girl-dark.png">
                        </div>
                        <div class="col-12">
                          <div class="row">
                              ...
                              <div class="form-check custom-option custom-option-icon">
                                <label class="form-check-label custom-option-content" for="customRadioPercentage">
                                  <span class="custom-option-body">
                                    <i class="bx bx-purchase-tag"></i>
                                    <span class="custom-option-title my-2">درصد</span>
                                    <small class="d-block lh-2">معامله ای ایجاد کنید که در آن پیشنهاد، از مقداری % تخفیف (برای مثال 5 درصد تخفیف) در کل استفاده می کند.</small>
                                  </span>
                              ...
                              <div class="form-check custom-option custom-option-icon">
                                <label class="form-check-label custom-option-content" for="customRadioFlat">
                                  <span class="custom-option-body">
                                    ...
                                    <span class="custom-option-title my-2"> مقدار ثابت </span>
                                    <small class="d-block lh-2">معامله ای ایجاد کنید که در آن پیشنهاد، از تخفیف یکسان (برای مثال 50 هزار تومان تخفیف) در کل استفاده می کند.</small>
                                  </span>
                              ...
                              <div class="form-check custom-option custom-option-icon">
                                <label class="form-check-label custom-option-content" for="customRadioPrime">
                                  <span class="custom-option-body">
                                    ...
                                    <span class="custom-option-title my-2"> عضو ویژه </span>
                                    <small class="d-block lh-2">یک معامله مختص فقط اعضای ویژه برای تشویق اعضای ویژه برای خرید از سایت ایجاد کنید.</small>
                                  </span>
                        ...
                        <div class="col-sm-6">
                          <label class="form-label" for="dealAmount">تخفیف</label>
                          ...
                          <div id="dealAmountHelp" class="form-text">درصد تخفیف را وارد کنید. 10 = 10%</div>
                        </div>
                        <div class="col-sm-6">
                          <label class="form-label" for="dealRegion">منطقه</label>
                          <select id="dealRegion" name="dealRegion" class="select2 form-select" multiple aria-describedby="dealRegionHelp">
                            <option disabled value="">منطقه هدف را انتخاب کنید</option>
                          ...
                          <div id="dealRegionHelp" class="form-text">مناطق مورد نظر را برای معامله انتخاب کنید.</div>
                        </div>
                    ...
                    <div id="deal-details" class="content">
                      <div class="row g-3">
                        <div class="col-sm-6">
                          <label class="form-label" for="dealTitle">عنوان معامله</label>
                          <input type="text" id="dealTitle" name="dealTitle" class="form-control" placeholder="تخفیف جمعه سیاه، 25% تخفیف">
                        </div>
                        <div class="col-sm-6">
                          <label class="form-label" for="dealCode">کد معامله</label>
                          <input type="text" id="dealCode" name="dealCode" class="form-control" placeholder="25PEROFF">
                        </div>
                        <div class="col-sm-6">
                          <label class="form-label" for="dealDescription">شرح معامله</label>
                          <textarea id="dealDescription" name="dealDescription" class="form-control" rows="5" placeholder="تخفیف اعمال شده به همه محصولات مخصوص جمعه سیاه"></textarea>
                        </div>
                        <div class="col-sm-6">
                          <div class="row">
                            <div class="col-12 mb-3">
                              <label class="form-label" for="dealOfferedItem">آیتم‌های پیشنهاد شده</label>
                              <select class="select2" id="dealOfferedItem" name="dealOfferedItem" multiple>
                                <option disabled value="">انتخاب آیتم‌های پیشنهاد شده</option>
                                <option value="65328">لورم ایپسوم متن ساختگی با تولید</option>
                                <option value="25612">لورم ایپسوم متن ساختگی با تولید</option>
                                <option value="65454">لورم ایپسوم متن ساختگی با تولید</option>
                                <option value="12365">لورم ایپسوم متن ساختگی با تولید</option>
                                <option value="85466">لورم ایپسوم متن ساختگی</option>
                                <option value="98564">لورم ایپسوم متن ساختگی با تولید</option>
                              </select>
                            </div>
                            <div class="col-12">
                              <label class="form-label" for="dealCartCondition">شرط سبد</label>
                              <select class="form-select" id="dealCartCondition" name="dealCartCondition">
                                <option disabled value="">انتخاب شرط سبد</option>
                                <option value="all">سبد باید شامل تمامی موارد انتخاب شده باشد</option>
                                <option value="any">سبد باید شامل یک یا بیشتر از موارد انتخاب شده باشد</option>
                              </select>
                            </div>
                          </div>
                        </div>
                        <div class="col-sm-6">
                          <label for="dealDuration" class="form-label">مدت زمان معامله</label>
                          <input type="text" id="dealDuration" name="dealDuration" class="form-control" placeholder="YYYY/MM/DD تا YYYY/MM/DD">
                        </div>
                        <div class="col-sm-6">
                          <label class="form-label">اطلاع رسانی به کاربران</label>
                          <div class="row">
                            <div class="col mt-2">
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="dealNotifyEmail" name="dealNotifyEmail" value="email">
                                <label class="form-check-label" for="dealNotifyEmail">ایمیل</label>
                              </div>
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="dealNotifySMS" name="dealNotifySMS" value="sms">
                                <label class="form-check-label" for="dealNotifySMS">پیامک</label>
                              </div>
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="dealNotifyPush" name="dealNotifyPush" value="push">
                                <label class="form-check-label" for="dealNotifyPush">اعلان Push</label>
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div id="deal-usage" class="content">
                      <div class="row g-3">
                        <div class="col-sm-6">
                          <label class="form-label" for="dealUserType">نوع کاربر</label>
                          <select id="dealUserType" name="dealUserType" class="form-select">
                            <option selected disabled value="">انتخاب نوع کاربر</option>
                            <option value="all">همه</option>
                            <option value="registered">ثبت نام کرده</option>
                            <option value="unregistered">ثبت نام نکرده</option>
                            <option value="prime-members">اعضای ویژه</option>
                          </select>
                        </div>
                        <div class="col-sm-6">
                          <label class="form-label" for="dealMaxUsers">حداکثر کاربران</label>
                          <input type="number" id="dealMaxUsers" name="dealMaxUsers" class="form-control" placeholder="500">
                        </div>
                        <div class="col-sm-6">
                          <label class="form-label" for="dealMinimumCartAmount">حداقل مقدار سبد</label>
                          <input type="number" id="dealMinimumCartAmount" name="dealMinimumCartAmount" class="form-control" placeholder="990,000 تومان">
                        </div>
                        <div class="col-sm-6">
                          <label class="form-label" for="dealPromotionalFee">هزینه تبلیغاتی</label>
                          <input type="number" id="dealPromotionalFee" name="dealPromotionalFee" class="form-control" placeholder="90,000 تومان">
                        </div>
                        <div class="col-sm-6">
                          <label class="form-label" for="dealPaymentMethod">نحوه پرداخت</label>
                          <select id="dealPaymentMethod" name="dealPaymentMethod" class="form-select">
                            <option selected disabled value="">انتخاب نحوه پرداخت</option>
                            <option value="any">همه</option>
                            <option value="credit-card">کارت اعتباری</option>
                            <option value="net-banking">انتقال بانکی</option>
                            <option value="wallet">کیف پول</option>
                          </select>
                        </div>
                        <div class="col-sm-6">
                          <label class="form-label" for="dealStatus">وضعیت معامله</label>
                          <select id="dealStatus" name="dealStatus" class="form-select">
                            <option selected disabled value="">انتخاب وضعیت</option>
                            <option value="active">فعال</option>
                            <option value="inactive">غیرفعال</option>
                            <option value="suspend">معلق</option>
                            <option value="abandon">رها شده</option>
                          </select>
                        </div>
                        <div class="col-lg-12">
                          <label class="switch">
                            ...
                            <span class="switch-label"> محدود کردن این تخفیف به یکبار استفاده برای هر مشتری؟</span>
                          </label>
                        </div>
                        <div class="col-12 d-flex justify-content-between">
                          <button class="btn btn-primary btn-prev">
                    ...
                    <div id="review-complete" class="content">
                      <div class="row g-3">
                        <div class="col-lg-6">
                          <div class="row">
                            <div class="col-12 mb-0">
                              <h3 class="secondary-font">تقریبا تمام شد!</h3>
                              <p>جزئیات معامله خود را تایید کرده و ثبت کنید تا ایجاد شود.</p>
                            </div>
                            <div class="col-12 mb-0">
                              <table class="table table-borderless lh-2">
                                <tbody>
                                  <tr>
                                    <td class="ps-0 align-top text-nowrap py-1"><strong>نوع معامله</strong></td>
                                    <td class="px-0 py-1">درصد</td>
                                  </tr>
                                  <tr>
                                    <td class="ps-0 align-top text-nowrap py-1"><strong>مقدار</strong></td>
                                    <td class="px-0 py-1">25%</td>
                                  </tr>
                                  <tr>
                                    <td class="ps-0 align-top text-nowrap py-1"><strong>کد معامله</strong></td>
                                    <td class="px-0 py-1">
                                      <div class="badge bg-label-warning">25PEROFF</div>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td class="ps-0 align-top text-nowrap py-1"><strong>عنوان معامله</strong></td>
                                    <td class="px-0 py-1">فروش جمعه سیاه، 25% تخفیف</td>
                                  </tr>
                                  <tr>
                                    <td class="ps-0 align-top text-nowrap py-1"><strong>مدت زمان معامله</strong></td>
                                    <td class="px-0 py-1">
                                      <span class="fw-semibold">1401/7/14</span> تا
                                      <span class="fw-semibold">1401/7/30</span>
                                    </td>
                                  </tr>
                                </tbody>
                              </table>
                        ...
                        <div class="col-lg-6 d-flex align-items-center justify-content-center">
                          <img src="../../assets/img/illustrations/boy-deal-review-light.png" class="img-fluid w-px-300 p-4" alt="shopping girl" data-app-light-img="illustrations/boy-deal-review-light.png" data-app-dark-img="illustrations/boy-deal-review-dark.png">
                        </div>
                        <div class="col-12 d-flex justify-content-between">
                          <button class="btn btn-primary btn-prev">
                            <i class="bx bx-chevron-left bx-sm ms-sm-n2"></i>
                          ...
                          <button class="btn btn-success btn-submit btn-next">ثبت</button>
                        </div>
                      </div>
                    </div>
                  </form>
