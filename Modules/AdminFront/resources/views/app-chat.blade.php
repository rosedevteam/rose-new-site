...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>گفتگو - برنامه‌ها | فرست - قالب مدیریت بوت‌استرپ</title>
                    ...
                    <div class="sidebar-header py-3 px-4 border-bottom">
                      <div class="d-flex align-items-center">
                        <div class="flex-shrink-0 avatar avatar-online me-3" data-bs-toggle="sidebar" data-overlay="app-overlay-ex" data-target="#app-chat-sidebar-left">
                          <img class="user-avatar rounded-circle cursor-pointer" src="../../assets/img/avatars/1.png" alt="آواتار">
                        </div>
                        ...
                        <li class="chat-contact-list-item">
                          <a class="d-flex align-items-center">
                            ...
                            <div class="chat-contact-info flex-grow-1 ms-3">
                              ...
                              <p class="chat-contact-status text-truncate mb-0 text-muted">توسعه دهنده رابط کاربری</p>
                            </div>
                          </a>
                        </li>
                        <li class="chat-contact-list-item">
                        ...
                        <li class="chat-contact-list-item">
                          <a class="d-flex align-items-center">
                            ...
                            <div class="chat-contact-info flex-grow-1 ms-3">
                              ...
                              <p class="chat-contact-status text-truncate mb-0 text-muted">توسعه دهنده پنل مدیریت</p>
                            </div>
                          </a>
                        </li>
                      </ul>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                          <div class="d-flex overflow-hidden align-items-center">
                            ...
                            <div class="flex-shrink-0 avatar">
                              <img src="../../assets/img/avatars/2.png" alt="آواتار" class="rounded-circle" data-bs-toggle="sidebar" data-overlay data-target="#app-chat-sidebar-right">
                            </div>
                            <div class="chat-contact-info flex-grow-1 ms-3">
