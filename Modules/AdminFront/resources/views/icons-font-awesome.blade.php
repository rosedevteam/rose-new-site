...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>Font Awesome - آیکن‌ها | فرست - قالب مدیریت بوت‌استرپ</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">آیکن‌ها /</span> FontAwesome
              </h4>

              <p>
                می‌توانید لیست کامل آیکن ها را در لینک مقابل مشاهده کنید
                <a href="https://fontawesome.com/v6/search?m=free" target="_blank">https://fontawesome.com</a>
              </p>
              ...
              <div class="d-flex flex-wrap justify-content-center" id="icons-container">
                ...
                <div class="card icon-card cursor-pointer text-center mb-4 mx-2">
                  <div class="card-body">
                    ...
                    <p class="icon-name text-capitalize text-truncate mb-0">آمبولانس</p>
                  </div>
                </div>
                <div class="card icon-card cursor-pointer text-center mb-4 mx-2">
                  <div class="card-body">
              ...
              <div class="d-flex justify-content-center mx-auto gap-3">
                <a href="https://fontawesome.com/v6/search?m=free" target="_blank" class="btn btn-primary">مشاهده همه آیکن‌ها</a>
