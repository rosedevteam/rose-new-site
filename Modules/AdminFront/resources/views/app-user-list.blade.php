                  ...
                  <div class="offcanvas-body mx-0 flex-grow-0">
                    <form class="add-new-user pt-0" id="addNewUserForm" onsubmit="return false">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" id="add-user-email" class="form-control text-start" placeholder="john.doe@example.com" aria-label="john.doe@example.com" name="userEmail" dir="ltr">
                      </div>
                      <div class="mb-3">
                        <label class="form-label" for="add-user-contact">تماس</label>
                        <input type="text" id="add-user-contact" class="form-control phone-mask text-start" placeholder="+1 (609) 988-44-11" aria-label="+1 (609) 988-44-11" name="userContact" dir="ltr">
                      </div>
                      <div class="mb-3">
