...
<html lang="fa" class="light-style customizer-hide" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>بازنشانی رمز عبور کاور - صفحات | فرست - قالب مدیریت بوت‌استرپ</title>
      ...
      <div class="authentication-inner row m-0">
        ...
        <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center">
          <div class="flex-row text-center mx-auto">
            <img src="../../assets/img/pages/reset-password-light.png" alt="Auth Cover Bg color" width="520" class="img-fluid authentication-cover-img" data-app-light-img="pages/reset-password-light.png" data-app-dark-img="pages/reset-password-dark.png">
            <div class="mx-auto">
              <h3>یک رمز عبور جدید تنظیم کنید</h3>
              <p>
                شما می‌توانید رمز عبور خود را به دلایل <br>
                امنیتی تغییر داده و یا در صورت فراموشی بازنشانی کنید.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="d-flex col-12 col-lg-5 col-xl-4 align-items-center authentication-bg p-4 p-sm-5">
          <div class="w-px-400 mx-auto">
            ...
            <!-- /Logo -->
            <h4 class="mb-3 secondary-font">بازنشانی رمز عبور</h4>
            <p class="mb-4">برای <span class="fw-bold">john.doe@email.com</span></p>
