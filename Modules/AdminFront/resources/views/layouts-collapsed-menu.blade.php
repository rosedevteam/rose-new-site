<!DOCTYPE html>
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed layout-menu-collapsed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no, minimum-scale=1.0, maximum-scale=1.0">

    <title>منوی جمع شده - طرح‌ها | فرست - قالب مدیریت بوت‌استرپ</title>
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="layout-demo-wrapper">
                ...
                <div class="layout-demo-info">
                  <h4 class="secondary-font">طرح منوی جمع شده</h4>
                  <div class="alert alert-primary mt-4" role="alert">
                    <strong>مهم:</strong> اگر localStorage را فعال کرده باشید در این صورت منو (ناوبری) با مقدار localStorage همگام خواهد شد.
                  </div>
                </div>
              </div>
              <!--/ Layout Demo -->
