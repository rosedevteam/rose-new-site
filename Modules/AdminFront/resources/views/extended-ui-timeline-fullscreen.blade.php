...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>خط زمانی تمام‌صفحه - رابط کاربری توسعه یافته | فرست - قالب مدیریت بوت‌استرپ</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-2">
                <span class="text-muted fw-light">رابط کاربری توسعه یافته /</span> خط زمانی تمام‌صفحه
              </h4>
                ...
                <div class="col-12">
                  <ul class="timeline timeline-center mt-5 mb-0">
                    <li class="timeline-item mb-md-4 mb-5">
                      ...
                      <div class="timeline-event card p-0" data-aos="fade-right">
                        <div class="card-header d-flex justify-content-between align-items-center flex-wrap">
                          <h6 class="card-title mb-0 mt-n1">طراحی رابط کاربری</h6>
                          <div class="meta primary-font mt-n1">
                            <span class="badge rounded-pill bg-label-primary">طراحی</span>
                            <span class="badge rounded-pill bg-label-success">دیدار</span>
                          </div>
                        </div>
                        <div class="card-body">
                          <p class="mb-2">
                          ...
                          <div class="d-flex justify-content-between align-items-center flex-wrap">
                            <div>
                              <p class="text-muted mb-2">شرکت کنندگان</p>
                        ...
                        <div class="timeline-event-time">1 فروردین</div>
                      </div>
                    </li>
                    <li class="timeline-item mb-md-4 mb-5">
                      ...
                      <div class="timeline-event card p-0" data-aos="fade-left">
                        <div class="card-header"><h6 class="mb-0 mt-n1">گزارش نظرسنجی</h6></div>
                        <div class="card-body">
                          <div class="d-flex flex-wrap mb-4">
                            ...
                            <span>این وظیفه اختصاص یافته به <strong>سارا</strong></span>
                          </div>
                        ...
                        <div class="timeline-event-time">2 فروردین</div>
                      </div>
                    </li>
                    <li class="timeline-item mb-md-4 mb-5">
                      ...
                      <div class="timeline-event card p-0" data-aos="fade-right">
                        <div class="card-header"><h6 class="mb-0 mt-n1">گزارشات مالی</h6></div>

                        <div class="card-body">
                          <p class="mb-2 pb-1">برای خواندن گزارشات مالی روی دکمه زیر کلیک کنید.</p>
                          ...
                          <div class="collapse" id="collapseExample">
                            <ul class="list-group list-group-flush mt-3">
                              <li class="list-group-item d-flex justify-content-between flex-wrap">
                                <span>سود سال گذشته : <strong>$20000</strong></span>
                                <i class="bx bx-share-alt cursor-pointer"></i>
                              </li>
                              <li class="list-group-item d-flex justify-content-between flex-wrap">
                                <span> سود امسال : <strong>$25000</strong></span>
                                <i class="bx bx-share-alt cursor-pointer"></i>
                              </li>
                              <li class="list-group-item d-flex justify-content-between flex-wrap">
                                <span> کمیسیون سال گذشته : <strong>$5000</strong></span>
                                <i class="bx bx-share-alt cursor-pointer"></i>
                              </li>
                              <li class="list-group-item d-flex justify-content-between flex-wrap">
                                <span> کمیسیون امسال : <strong>$7000</strong></span>
                                <i class="bx bx-share-alt cursor-pointer"></i>
                              </li>
                              <li class="list-group-item d-flex justify-content-between flex-wrap">
                                <span> موجودی کل امسال : <strong>$70000</strong></span>
                                <i class="bx bx-share-alt cursor-pointer"></i>
                              </li>
                            </ul>
                          </div>
                        </div>
                        <div class="timeline-event-time">5 فروردین</div>
                      </div>
                    </li>
                    <li class="timeline-item mb-md-4 mb-5">
                      ...
                      <div class="timeline-event card p-0" data-aos="fade-left">
                        <div class="card-header"><h6 class="mb-0 mt-n1">اسنک</h6></div>
                        <div class="card-body">
                          <div class="d-flex flex-sm-row flex-column">
                            <img src="../../assets/img/elements/13.jpg" class="rounded me-3 mb-sm-0 mb-2" alt="doughnut" height="64" width="64">
                            <div>
                              <h6 class="mb-2">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم</h6>
                              <p class="mb-2">
                                لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی <a href="javascript:void(0)">بیشتر بخوانید</a>
                              </p>
                              <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                  <strong>5,000 تومان</strong>
                                </div>
                              </div>
                            </div>
                          </div>
                        </div>
                        <div class="timeline-event-time">10 فروردین</div>
                      </div>
                    </li>
                    <li class="timeline-item mb-md-4 mb-5 timeline-item-right">
                      ...
                      <div class="timeline-event card p-0" data-aos="fade-left">
                        <div class="card-header border-0 d-flex justify-content-between align-items-center">
                          <h6 class="card-title mb-0 mt-n1">
                            <i class="bx bx-map"></i>
                            <span class="align-middle">مکان</span>
                          </h6>
                          <span class="badge rounded-pill bg-label-danger primary-font">بالا</span>
                        </div>
                        ...
                        <div class="timeline-event-time">12 فروردین</div>
                      </div>
                    </li>
                    <li class="timeline-item mb-md-4 mb-5 timeline-item-left">
                      ...
                      <div class="timeline-event card p-0" data-aos="fade-right">
                        <div class="card-header border-0 d-flex justify-content-between align-items-center">
                          <h6 class="card-title mb-0 mt-n1">برنامه باشگاه</h6>
                          <span class="text-muted primary-font mt-n1">5:00 - 6:10 ق.ظ</span>
                        </div>
                        <div class="card-body pb-0 lh-1-85">
                          ...
                          <div class="location">
                            <i class="bx bx-map"></i>
                            <span class="align-middle">باشگاه بدنسازان</span>
                          </div>
                        </div>
                        <div class="card-footer d-flex justify-content-between">
                          <div class="tags">
                            <span class="badge rounded-pill bg-label-danger">باشگاه</span>
                            <span class="badge rounded-pill bg-label-info">قدرت</span>
                          </div>
                          <div>
                            <i class="bx bx-dots-vertical-rounded cursor-pointer"></i>
                          </div>
                        </div>
                        <div class="timeline-event-time">15 فروردین</div>
                      </div>
                    </li>
                    <li class="timeline-item mb-md-4 mb-5">
                      <span class="timeline-indicator timeline-indicator-success" data-aos="zoom-in" data-aos-delay="200">
                    ...
                    <li class="timeline-item mb-md-4 mb-5">
                      ...
                      <div class="timeline-event card p-0" data-aos="fade-left">
                        <div class="card-header border-0 d-flex justify-content-between align-items-center">
                          <h6 class="card-title mb-0 mt-n1">
                            <span class="align-middle">اوبونتو سرور</span>
                          </h6>
                          <span class="badge rounded-pill bg-label-danger primary-font mt-n1">غیرفعال</span>
                        </div>
                        <div class="card-body pb-0">
                          <ul class="list-group list-group-flush">
                        ...
                        <div class="timeline-event-time">20 فروردین</div>
                      </div>
                    </li>
                    <li class="timeline-item">
                      ...
                      <div class="timeline-event card p-0" data-aos="fade-right">
                        <div class="card-header border-0 d-flex justify-content-between align-items-center">
                          <h6 class="card-title mb-0 mt-n1"><span class="align-middle">فروشگاه آنلاین</span></h6>
                          <i class="bx bx-dots-vertical-rounded cursor-pointer mt-n1"></i>
                        </div>
                        <div class="card-body pb-3 pt-0">
                          ...
                          <div class="d-flex flex-wrap flex-sm-row flex-column">
                            <div class="mb-sm-0 mb-3 me-5">
                              <p class="text-muted mb-2">توسعه دهندگان</p>
                              <div class="d-flex align-items-center">
                                <div class="avatar avatar-xs me-2">
                                  <span class="avatar-initial rounded-circle bg-label-primary">آ</span>
                                </div>
                                <div class="avatar avatar-xs me-2">
                                  <span class="avatar-initial rounded-circle bg-label-success">ب</span>
                                </div>
                                <div class="avatar avatar-xs">
                                  <span class="avatar-initial rounded-circle bg-label-danger">ص</span>
                                </div>
                              </div>
                            </div>
                            <div class="mb-sm-0 mb-3 me-5">
                              <p class="text-muted mb-2">فرصت نهایی</p>
                              <p class="mb-0">20 خرداد 1403</p>
                            </div>
                            <div>
                              <p class="text-muted mb-2">بودجه</p>
                              <p class="mb-0">5,000,000 تومان</p>
                            </div>
                          </div>
                        </div>
                        <div class="timeline-event-time">25 فروردین</div>
                      </div>
                    </li>
                  </ul>
                </div>
