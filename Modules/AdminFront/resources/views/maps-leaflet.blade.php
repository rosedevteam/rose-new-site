...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>Leaflet - نقشه‌ها | فرست - قالب مدیریت بوت‌استرپ</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4"><span class="text-muted fw-light">نقشه‌ها /</span> Leaflet</h4>

              <div class="row">
                <!-- Basic -->
                <div class="col-12">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">نقشه پایه</h5>
                    <div class="card-body">
                ...
                <div class="col-12">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">نشانگر دایره و چندضلعی</h5>
                    <div class="card-body">
                ...
                <div class="col-12">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">نشانگر قابل کشیدن با پاپ‌آپ</h5>
                    <div class="card-body">
                ...
                <div class="col-12">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">مکان کاربر</h5>
                    <div class="card-body">
                ...
                <div class="col-12">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">آیکن‌های سفارشی</h5>
                    <div class="card-body">
                ...
                <div class="col-12">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">GeoJson</h5>
                    <div class="card-body">
                ...
                <div class="col-12">
                  <div class="card">
                    <h5 class="card-header heading-color">کنترل لایه</h5>
                    <div class="card-body">
