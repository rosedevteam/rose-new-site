...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>نوار ناوبری محتوا + نوار کناری | فرست - قالب مدیریت بوت‌استرپ</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl d-flex align-items-stretch flex-grow-1 p-0">
              <div class="flex-shrink-1 flex-grow-0 w-px-350 border-end container-p-x container-p-y">
                <div class="layout-example-sidebar layout-example-content-inner">نوار کناری</div>
              </div>
              ...
              <div class="flex-shrink-1 flex-grow-1 container-p-x container-p-y">
                ...
                <div class="layout-demo-wrapper">
                  ...
                  <div class="layout-demo-info">
                    <h4 class="secondary-font">طرح نوار ناوبری محتوا + نوار کناری</h4>
