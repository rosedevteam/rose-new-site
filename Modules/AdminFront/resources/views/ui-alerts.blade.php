...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>هشدارها - المان‌های رابط کاربری | فرست - قالب مدیریت بوت‌استرپ</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">المان‌های رابط کاربری /</span> هشدارها
              </h4>
              <div class="row mb-4">
                <!-- Basic Alerts -->
                <div class="col-md mb-4 mb-md-0">
                  <div class="card">
                    <h5 class="card-header heading-color">هشدارهای پایه</h5>
                    <div class="card-body">
                      <div class="alert alert-primary" role="alert">این یک هشدار اولیه است - بررسی کنید!</div>

                      <div class="alert alert-secondary" role="alert">این یک هشدار ثانویه است - بررسی کنید!</div>

                      <div class="alert alert-success" role="alert">این یک هشدار موفقیت است - بررسی کنید!</div>

                      <div class="alert alert-danger" role="alert">این یک هشدار خطر است - بررسی کنید!</div>

                      <div class="alert alert-warning" role="alert">این یک هشدار اخطار است - بررسی کنید!</div>

                      <div class="alert alert-info" role="alert">این یک هشدار اطلاعات است - بررسی کنید!</div>

                      <div class="alert alert-dark mb-0" role="alert">این یک هشدار تیره است - بررسی کنید!</div>
                    </div>
                  </div>
                </div>
                <!--/ Basic Alerts -->
                ...
                <div class="col-md">
                  <div class="card">
                    <h5 class="card-header heading-color">هشدارهای قابل رد کردن</h5>
                    <div class="card-body">
                      ...
                      <div class="alert alert-secondary alert-dismissible d-flex align-items-center" role="alert">
                        ...
                        این یک هشدار ثانویه قابل رد کردن است - بررسی کنید!
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                      </div>

                      <div class="alert alert-success alert-dismissible d-flex align-items-center" role="alert">
                        <i class="bx bx-xs bx-desktop me-2"></i>
                        این یک هشدار موفقیت قابل رد کردن است - بررسی کنید!
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                      </div>
              ...
              <div class="row mb-4">
                ...
                <div class="col-md mb-4 mb-md-0">
                  <div class="card">
                    <h5 class="card-header heading-color">هشدار با سرتیتر</h5>
                    <div class="card-body">
                      <div class="alert alert-primary" role="alert">
                        <h6 class="alert-heading mb-1">اولیه!</h6>
                        <span>این یک هشدار اولیه است - بررسی کنید!</span>
                      </div>

                      <div class="alert alert-secondary" role="alert">
                        <h6 class="alert-heading mb-1">ثانویه!</h6>
                        <span>این یک هشدار ثانویه است - بررسی کنید!</span>
                      </div>

                      <div class="alert alert-success" role="alert">
                        <h6 class="alert-heading mb-1">موفقیت!</h6>
                        <span>این یک هشدار موفقیت است - بررسی کنید!</span>
                      </div>

                      <div class="alert alert-danger" role="alert">
                        <h6 class="alert-heading mb-1">خطر!</h6>
                        این یک هشدار خطر است - بررسی کنید!
                      </div>

                      <div class="alert alert-warning" role="alert">
                        <h6 class="alert-heading mb-1">هشدار!</h6>
                        <span>این یک هشدار اخطار است - بررسی کنید!</span>
                      </div>

                      <div class="alert alert-info" role="alert">
                        <h6 class="alert-heading mb-1">اطلاعات!</h6>
                        <span>این یک هشدار اطلاعات است - بررسی کنید!</span>
                      </div>

                      <div class="alert alert-dark mb-0" role="alert">
                        <h6 class="alert-heading mb-1">تیره!</h6>
                        <span>این یک هشدار تیره است - بررسی کنید!</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md">
                  <div class="card">
                    <h5 class="card-header heading-color">هشدارهای دارای آیکن با سرتیتر</h5>
                    <div class="card-body">
                      <div class="alert alert-primary alert-dismissible" role="alert">
                        <h6 class="alert-heading mb-1"><i class="bx bx-xs bx-command me-2"></i>اولیه!</h6>
                        <span>این یک هشدار اولیه قابل رد کردن است - بررسی کنید!</span>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                      </div>

                      <div class="alert alert-secondary alert-dismissible" role="alert">
                        <h6 class="alert-heading mb-1">
                          <i class="bx bx-xs bx-envelope me-2"></i>ثانویه!
                        </h6>
                        <span>این یک هشدار ثانویه قابل رد کردن است - بررسی کنید!</span>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                      </div>
                      ...
                      <div class="alert alert-danger alert-dismissible" role="alert">
                        <h6 class="alert-heading mb-1"><i class="bx bx-xs bx-store me-2"></i>خطر!</h6>
                        <span>این یک هشدار خطر قابل رد کردن است - بررسی کنید!</span>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                      </div>

                      <div class="alert alert-warning alert-dismissible" role="alert">
                        <h6 class="alert-heading mb-1"><i class="bx bx-xs bx-wallet me-2"></i>هشدار!</h6>
                        <span>این یک هشدار اخطار قابل رد کردن است - بررسی کنید!</span>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                      </div>

                      <div class="alert alert-info alert-dismissible" role="alert">
                        <h6 class="alert-heading mb-1"><i class="bx bx-xs bx-detail me-2"></i>اطلاعات!</h6>
                        <span>این یک هشدار اطلاعات قابل رد کردن است - بررسی کنید!</span>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                      </div>

                      <div class="alert alert-dark alert-dismissible mb-0" role="alert">
                        <h6 class="alert-heading mb-1"><i class="bx bx-xs bx-save me-2"></i>تیره!</h6>
                        <span>این یک هشدار تیره قابل رد کردن است - بررسی کنید!</span>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                      </div>
                    </div>
                  </div>
              ...
              <div class="row">
                ...
                <div class="col-md mb-4 mb-md-0">
                  <div class="card">
                    <h5 class="card-header heading-color">هشدارهای پررنگ</h5>
                    <div class="card-body">
                      <div class="alert alert-solid-primary" role="alert">
                        این یک هشدار اولیه پررنگ است - بررسی کنید!
                      </div>

                      <div class="alert alert-solid-secondary" role="alert">
                        این یک هشدار ثانویه پررنگ است - بررسی کنید!
                      </div>

                      <div class="alert alert-solid-success" role="alert">
                        این یک هشدار موفقیت پررنگ است - بررسی کنید!
                      </div>

                      <div class="alert alert-solid-danger" role="alert">
                        این یک هشدار خطر پررنگ است - بررسی کنید!
                      </div>

                      <div class="alert alert-solid-warning" role="alert">
                        این یک هشدار اخطار پررنگ است - بررسی کنید!
                      </div>

                      <div class="alert alert-solid-info" role="alert">این یک هشدار اطلاعات پررنگ است - بررسی کنید!</div>

                      <div class="alert alert-solid-dark mb-0" role="alert">
                        این یک هشدار تیره پررنگ است - بررسی کنید!
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md">
                  <div class="card">
                    <h5 class="card-header heading-color">هشدارهای پررنگ با آیکن</h5>
                    <div class="card-body">
                      ...
                      <div class="alert alert-solid-info alert-dismissible d-flex align-items-center" role="alert">
                        <i class="bx bx-xs bx-detail me-2"></i>
                        این یک هشدار اطلاعات پررنگ است - بررسی کنید!
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                      </div>
