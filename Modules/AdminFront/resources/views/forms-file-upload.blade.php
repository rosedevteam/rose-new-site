...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>ارسال فایل - فرم‌ها | فرست - قالب مدیریت بوت‌استرپ</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4"><span class="text-muted fw-light">فرم‌ها /</span> ارسال فایل</h4>
              ...
              <div class="row">
                    ...
                    <div class="card-body">
                      <form action="/upload" class="dropzone needsclick" id="dropzone-basic">
                        <div class="dz-message needsclick">
                          ...
                          <span class="note needsclick">(این تنها یک ناحیه رها کردن نمونه است. فایل های انتخاب شده واقعا ارسال <strong>نمی‌شوند</strong>.)</span>
                        </div>
                        <div class="fallback">
                ...
                <div class="col-12">
                  <div class="card">
                    <h5 class="card-header heading-color">چندگانه</h5>
                    <div class="card-body">
