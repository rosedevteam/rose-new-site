...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>تب‌ها و سربرگ‌ها - المان‌های رابط کاربری | فرست - قالب مدیریت بوت‌استرپ</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">المان‌های رابط کاربری /</span> تب‌ها و سربرگ‌ها
              </h4>

              <!-- Tabs -->
              <h5 class="py-3 my-4 secondary-font">تب ها</h5>

              <div class="row">
                <div class="col-xl-6">
                  <h6 class="text-muted">پایه</h6>
                ...
                <div class="col-xl-6">
                  ...
                  <div class="nav-align-left mb-4">
                    <ul class="nav nav-tabs" role="tablist">
                      ...
                      <li class="nav-item">
                        <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs-left-profile" aria-controls="navs-left-profile" aria-selected="false">
                          پروفایل
                        </button>
                      </li>
                      <li class="nav-item">
                        <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs-left-messages" aria-controls="navs-left-messages" aria-selected="false">
                          پیام ها
                        </button>
                      </li>
                    </ul>
                ...
                <div class="col-xl-6">
                  <h6 class="text-muted">داخل کارت‌ها</h6>
                  <div class="card shadow-none text-center border mb-3">
                    <div class="card-header border-bottom">
                      <ul class="nav nav-tabs card-header-tabs primary-font" role="tablist">
                        <li class="nav-item">
                          <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab" data-bs-target="#navs-within-card-active" aria-controls="navs-within-card-active" aria-selected="true">
                            فعال
                          </button>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-content">
                      <div class="tab-pane fade show active" id="navs-within-card-active" role="tabpanel">
                        <h4 class="card-title primary-font">عنوان مخصوص فعال</h4>
                      ...
                      <div class="tab-pane fade" id="navs-within-card-link" role="tabpanel">
                        <h4 class="card-title primary-font">عنوان مخصوص لینک</h4>
                        <p class="card-text">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده</p>
              ...
              <!-- Pills -->
              <h5 class="py-3 my-4 secondary-font">قرص ها</h5>
              ...
              <div class="row">
                ...
                <div class="col-xl-6">
                  <h6 class="text-muted">قرص‌های پر شده</h6>
                  <div class="nav-align-top mb-4">
                  ...
                  <div class="card mb-4">
                    <div class="nav-align-left">
                      <ul class="nav nav-pills border-end p-4" role="tablist">
                        ...
                        <li class="nav-item">
                          <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs-pills-left-profile" aria-controls="navs-pills-left-profile" aria-selected="false">
                            پروفایل
                          </button>
                        </li>
                        <li class="nav-item">
                          <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs-pills-left-messages" aria-controls="navs-pills-left-messages" aria-selected="false">
                            پیام ها
                          </button>
                        </li>
                      </ul>
                  ...
                  <div class="card text-center mb-3">
                    <div class="card-header border-bottom primary-font">
                      <ul class="nav nav-pills" role="tablist">
                        ...
                        <li class="nav-item">
                          <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs-pills-within-card-link" aria-controls="navs-pills-within-card-link" aria-selected="false">
                            لینک
                          </button>
                        </li>
                        <li class="nav-item">
              ...
              <!-- Line Tabs -->
              <h5 class="py-3 my-4">تب‌های خطی</h5>
              ...
              <div class="row">
                <div class="col-xl-6">
                  ...
                  <div class="nav-align-top mb-4">
                    <ul class="nav nav-tabs tabs-line" role="tablist">
                      ...
                      <li class="nav-item">
                        <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs-tabs-line-top-messages" aria-controls="navs-tabs-line-top-messages" aria-selected="false">
                          پیام ها
                        </button>
                      </li>
                    </ul>
                ...
                <div class="col-xl-6">
                  <h6 class="text-muted">تب‌های خطی پر شده</h6>
                  <div class="nav-align-top mb-4">
                    <ul class="nav nav-tabs tabs-line nav-fill" role="tablist">
                      <li class="nav-item">
                        <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab" data-bs-target="#navs-tabs-line-justified-home" aria-controls="navs-tabs-line-justified-home" aria-selected="true">
                          <i class="tf-icons bx bx-home me-1"></i> خانه
                          <span class="badge rounded-pill badge-center h-px-20 w-px-20 bg-label-danger ms-1">3</span>
                        </button>
                      </li>
                      <li class="nav-item">
                        <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs-tabs-line-justified-profile" aria-controls="navs-tabs-line-justified-profile" aria-selected="false">
                          <i class="tf-icons bx bx-user me-1"></i> پروفایل
                        </button>
                      </li>
                      <li class="nav-item">
                        <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs-tabs-line-justified-messages" aria-controls="navs-tabs-line-justified-messages" aria-selected="false">
                          <i class="tf-icons bx bx-message-square me-1"></i> پیام ها
                        </button>
                      </li>
                    </ul>
                  ...
                  <div class="card mb-4">
                    <div class="nav-align-left">
                      <ul class="nav nav-tabs tabs-line border-end" role="tablist">
                        <li class="nav-item">
                          <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab" data-bs-target="#navs-tabs-line-left-home" aria-controls="navs-tabs-line-left-home" aria-selected="true">
                            خانه
                          </button>
                        </li>
                        <li class="nav-item">
                          <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs-tabs-line-left-profile" aria-controls="navs-tabs-line-left-profile" aria-selected="false">
                            پروفایل
                          </button>
                        </li>
                        <li class="nav-item">
                          <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs-tabs-line-left-messages" aria-controls="navs-tabs-line-left-messages" aria-selected="false">
                            پیام ها
                          </button>
                        </li>
                      </ul>
                ...
                <div class="col-xl-6">
                  ...
                  <div class="card text-center">
                    <ul class="nav nav-tabs tabs-line" role="tablist">
                      ...
                      <li class="nav-item">
                        <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs-tabs-line-card-link" aria-controls="navs-tabs-line-card-link" aria-selected="false">
                          لینک
                        </button>
                      </li>
                      <li class="nav-item">
