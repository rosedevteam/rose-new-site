...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>تایپوگرافی - المان‌های رابط کاربری | فرست - قالب مدیریت بوت‌استرپ</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4">تایپوگرافی</h4>

              <div class="row">
                <!-- Headings -->
                <div class="col-lg">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">تیتر ها</h5>
                    <table class="table table-borderless">
                      <tbody>
                        <tr>
                          <td class="align-middle"><small class="text-light fw-semibold">سرتیتر 1</small></td>
                          <td class="py-3">
                            <h1 class="mb-0">عنوان سرصفحه بوت استرپ</h1>
                          </td>
                        </tr>
                        <tr>
                          <td class="align-middle"><small class="text-light fw-semibold">سرتیتر 2</small></td>
                          <td class="py-3">
                            <h2 class="mb-0">عنوان سرصفحه بوت استرپ</h2>
                          </td>
                        </tr>
                        <tr>
                          <td><small class="text-light fw-semibold">سرتیتر 3</small></td>
                          <td class="py-3">
                            <h3 class="mb-0">عنوان سرصفحه بوت استرپ</h3>
                          </td>
                        </tr>
                        <tr>
                          <td><small class="text-light fw-semibold">سرتیتر 4</small></td>
                          <td class="py-3">
                            <h4 class="mb-0">عنوان سرصفحه بوت استرپ</h4>
                          </td>
                        </tr>
                        <tr>
                          <td><small class="text-light fw-semibold">سرتیتر 5</small></td>
                          <td class="py-3">
                            <h5 class="mb-0">عنوان سرصفحه بوت استرپ</h5>
                          </td>
                        </tr>
                        <tr>
                          <td><small class="text-light fw-semibold">سرتیتر 6</small></td>
                          <td class="py-3">
                            <h6 class="mb-0">عنوان سرصفحه بوت استرپ</h6>
                          </td>
                        </tr>
                      </tbody>
                    </table>
                ...
                <div class="col-lg">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">سفارشی سازی سرتیتر ها <small class="text-muted ms-1">پیش‌فرض</small></h5>
                    <table class="table table-borderless">
                      <tbody>
                        <tr>
                          <td class="align-middle"><small class="text-light fw-semibold">سرتیتر 1</small></td>
                          <td class="py-3">
                            <h1 class="mb-0">بوت‌استرپ <small class="text-muted">عنوان</small></h1>
                          </td>
                        </tr>
                        <tr>
                          <td class="align-middle"><small class="text-light fw-semibold">سرتیتر 2</small></td>
                          <td class="py-3">
                            <h2 class="mb-0">بوت‌استرپ <small class="text-muted">عنوان</small></h2>
                          </td>
                        </tr>
                        <tr>
                          <td><small class="text-light fw-semibold">سرتیتر 3</small></td>
                          <td class="py-3">
                            <h3 class="mb-0">بوت‌استرپ <small class="text-muted">عنوان</small></h3>
                          </td>
                        </tr>
                        <tr>
                          <td><small class="text-light fw-semibold">سرتیتر 4</small></td>
                          <td class="py-3">
                            <h4 class="mb-0">بوت‌استرپ <small class="text-muted">عنوان</small></h4>
                          </td>
                        </tr>
                        <tr>
                          <td><small class="text-light fw-semibold">سرتیتر 5</small></td>
                          <td class="py-3">
                            <h5 class="mb-0">بوت‌استرپ <small class="text-muted">عنوان</small></h5>
                          </td>
                        </tr>
                        <tr>
                          <td><small class="text-light fw-semibold">سرتیتر 6</small></td>
                          <td class="py-3">
                            <h6 class="mb-0">بوت‌استرپ <small class="text-muted">عنوان</small></h6>
                          </td>
                        </tr>
                      </tbody>
                    </table>
              ...
              <div class="row">
                ...
                <div class="col-lg">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">نمایش سرتیتر ها</h5>
                    <table class="table table-borderless">
                      <tbody>
                        <tr>
                          <td class="align-middle"><small class="text-light fw-semibold">نمایش 1</small></td>
                          <td class="py-3">
                            <h1 class="display-1 mb-0">نمایش 1</h1>
                          </td>
                        </tr>
                        <tr>
                          <td class="align-middle"><small class="text-light fw-semibold">نمایش 2</small></td>
                          <td class="py-3">
                            <h1 class="display-2 mb-0">نمایش 2</h1>
                          </td>
                        </tr>
                        <tr>
                          <td class="align-middle"><small class="text-light fw-semibold">نمایش 3</small></td>
                          <td class="py-3">
                            <h1 class="display-3 mb-0">نمایش 3</h1>
                          </td>
                        </tr>
                        <tr>
                          <td class="align-middle"><small class="text-light fw-semibold">نمایش 4</small></td>
                          <td class="py-3">
                            <h1 class="display-4 mb-0">نمایش 4</h1>
                          </td>
                        </tr>
                        <tr>
                          <td class="align-middle"><small class="text-light fw-semibold">نمایش 5</small></td>
                          <td class="py-3">
                            <h1 class="display-5 mb-0">نمایش 5</h1>
                          </td>
                        </tr>
                        <tr>
                          <td class="align-middle"><small class="text-light fw-semibold">نمایش 6</small></td>
                          <td class="py-3">
                            <h1 class="display-6 mb-0">نمایش 6</h1>
                          </td>
                        </tr>
                      </tbody>
                    </table>
                ...
                <div class="col-lg">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">پاراگراف</h5>
                    <table class="table table-borderless">
                      <tbody>
                        <tr>
                          <td class="align-middle"><small class="text-light fw-semibold">پاراگراف</small></td>
                          <td class="py-3">
                            <p class="mb-0">
                        ...
                        <tr>
                          <td class="align-middle"><small class="text-light fw-semibold">متن اصلی</small></td>
                          <td class="py-4">
                            <p class="lead mb-0">
                        ...
                        <tr>
                          <td class="align-middle"><small class="text-light fw-semibold">متن کمرنگ</small></td>
                          <td class="py-3">
              ...
              <div class="row">
                ...
                <div class="col">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">المان‌های متنی درون خطی</h5>
                    <div class="card-body">
                      <table class="table table-borderless">
                        <tbody>
                          <tr>
                            <td class="align-middle"><small class="text-light fw-semibold">برجسته کردن متن</small></td>
                            <td class="py-3">
                              <p class="mb-0">میتوانید از تگ mark استفاده کنید برای <mark>برجسته کردن</mark> متن.</p>
                            </td>
                          </tr>
                          <tr>
                            <td class="align-middle"><small class="text-light fw-semibold">متن حذف شده</small></td>
                            <td class="py-3">
                              <p class="mb-0"><del>این سطر به عنوان متن حذف شده در نظر گرفته می شود.</del></p>
                            </td>
                          </tr>
                          <tr>
                            <td><small class="text-light fw-semibold">دیگر درست نیست</small></td>
                            <td class="py-3">
                              <p class="mb-0"><s>این سطر به عنوان متنی که دیگر درست نیست در نظر گرفته می شود.</s></p>
                            </td>
                          </tr>
                          <tr>
                            <td><small class="text-light fw-semibold">اضافه</small></td>
                            <td class="py-3">
                              <p class="mb-0">
                                <ins>این سطر به عنوان متن اضافه شده به سند در نظر گرفته می شود.</ins>
                              </p>
                            </td>
                          </tr>
                          <tr>
                            <td><small class="text-light fw-semibold">زیرخط دار</small></td>
                            <td class="py-3">
                              <p class="mb-0"><u>این سطر به صورت زیرخط دار نمایش داده می شود.</u></p>
                            </td>
                          </tr>
                          <tr>
                            <td><small class="text-light fw-semibold">مناسب چاپ</small></td>
                            <td class="py-3">
                              <p class="mb-0"><small>این سطر به عنوان متن مناسب برای چاپ در نظر گرفته می شود.</small></p>
                            </td>
                          </tr>
                          <tr>
                            <td><small class="text-light fw-semibold">متن ضخیم</small></td>
                            <td class="py-3">
                              <p class="mb-0"><strong>این سطر به صورت ضخیم نمایش داده می شود.</strong></p>
                            </td>
                          </tr>
                          <tr>
                            <td><small class="text-light fw-semibold">متن کج</small></td>
                            <td class="py-3">
                              <p class="mb-0"><em>این سطر به صورت کج نمایش داده می شود.</em></p>
                            </td>
                          </tr>
                          <tr>
                            <td><small class="text-light fw-semibold">اختصارات</small></td>
                            <td>
              ...
              <div class="row">
                ...
                <div class="col-lg">
                  <div class="card mb-4 mb-lg-0">
                    <div class="card-header"><h5 class="mb-0">نقل قول</h5></div>
                    <div class="card-body">
                    ...
                    <hr class="m-0">
                    <div class="card-body">
                      <small class="text-light fw-semibold">نامگذاری یک منبع</small>
                      <figure class="mt-2">
                        <blockquote class="blockquote">
                          <p class="mb-0">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ</p>
                        </blockquote>
                        <figcaption class="blockquote-footer">
                          یک فرد مشهور در <cite title="Source Title">عنوان منبع</cite>
                        </figcaption>
                      </figure>
                    </div>
                    <hr class="m-0">
                    <div class="card-body">
                      <small class="text-light fw-semibold">تراز وسط</small>
                    ...
                    <hr class="m-0">
                    <div class="card-body">
                      <small class="text-light fw-semibold">تراز چپ</small>
                ...
                <div class="col-lg">
                  <div class="card">
                    ...
                    <div class="card-body">
                      <small class="text-light fw-semibold">بدون سبک</small>
                      <ul class="list-unstyled mt-3 lh-2">
                    ...
                    <hr class="m-0">
                    <div class="card-body">
                      <small class="text-light fw-semibold">درون‌خطی</small>
                      <ul class="list-inline mt-3 lh-2">
                    ...
                    <hr class="m-0">
                    <div class="card-body">
                      <small class="text-light fw-semibold">تراز لیست توصیف</small>
                      <dl class="row mt-3">
