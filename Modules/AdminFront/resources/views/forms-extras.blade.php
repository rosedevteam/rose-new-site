...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>موارد بیشتر - فرم‌ها | فرست - قالب مدیریت بوت‌استرپ</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4"><span class="text-muted fw-light">فرم‌ها /</span> موارد بیشتر</h4>

              <div class="row">
                <!-- Autosize -->
                <div class="col-12">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">اندازه خودکار</h5>
                    <div class="card-body">
                ...
                <div class="col-12">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">ماسک ورودی CleaveJS</h5>
                    <div class="card-body">
                      <div class="row">
                        <!-- Credit Card -->
                        <div class="col-xl-4 col-md-6 col-sm-12 mb-4">
                          <label class="form-label" for="creditCardMask">کارت اعتباری</label>
                        ...
                        <!-- Phone Number -->
                        <div class="col-xl-4 col-md-6 col-sm-12 mb-4">
                          <label class="form-label" for="phone-number-mask">شماره تلفن</label>
                          <div class="input-group">
                            <input type="text" id="phone-number-mask" class="form-control phone-number-mask text-start" placeholder="202 555 0111" dir="ltr">
                            <span class="input-group-text">IR (+98)</span>
                          </div>
                        </div>
                        <!-- Date -->
                        <div class="col-xl-4 col-md-6 col-sm-12 mb-4">
                          <label class="form-label" for="date-mask">تاریخ</label>
                          <input type="text" id="date-mask" class="form-control date-mask text-start" placeholder="YYYY/MM/DD" dir="ltr">
                        </div>
                        <!-- Time -->
                        <div class="col-xl-4 col-md-6 col-sm-12 mb-4">
                          <label class="form-label" for="time-mask">زمان</label>
                          <input type="text" id="time-mask" class="form-control time-mask text-start" placeholder="hh:mm:ss" dir="ltr">
                        </div>
                        <!-- Numeral Formatting -->
                        <div class="col-xl-4 col-md-6 col-sm-12 mb-4">
                          <label class="form-label" for="numeral-mask">قالب‌بندی اعداد</label>
                          <input type="text" id="numeral-mask" class="form-control numeral-mask text-start" placeholder="عدد وارد کنید" dir="ltr">
                        </div>
                        <!-- Blocks -->
                        <div class="col-xl-4 col-md-6 col-sm-12 mb-4">
                          <label class="form-label" for="block-mask">بلوک‌ها</label>
                          <input type="text" id="block-mask" class="form-control block-mask text-start" placeholder="Blocks [4, 3, 3]" dir="ltr">
                        </div>
                        <!-- Delimiters -->
                        <div class="col-xl-4 col-md-6 col-sm-12 mb-4 mb-xl-0">
                          <label class="form-label" for="delimiter-mask">جداکننده‌ها</label>
                          <input type="text" id="delimiter-mask" class="form-control delimiter-mask text-start" placeholder="جدا کننده: '.'" dir="ltr">
                        </div>
                        <!-- Custom Delimiters -->
                        <div class="col-xl-4 col-md-6 col-sm-12 mb-4 mb-xl-0">
                          <label class="form-label" for="custom-delimiter-mask">جداکننده‌های سفارشی</label>
                          <input type="text" id="custom-delimiter-mask" class="form-control custom-delimiter-mask text-start" placeholder="جدا کننده: ['.', '.', '-']" dir="ltr">
                        </div>
                        <!-- Prefix -->
                        <div class="col-xl-4 col-md-6 col-sm-12">
                          <label class="form-label" for="prefix-mask">پیشوند</label>
                          <input type="text" id="prefix-mask" class="form-control prefix-mask text-start" dir="ltr">
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-12">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">حداکثر طول Bootstrap</h5>
                    <div class="card-body">
                      <div class="row">
                        <div class="col-12 mb-4">
                          <label class="form-label" for="bootstrap-maxlength-example1">ورودی</label>
                          <input type="text" id="bootstrap-maxlength-example1" class="form-control bootstrap-maxlength-example" maxlength="25">
                        </div>
                        <div class="col-12">
                          <label class="form-label" for="bootstrap-maxlength-example2">ناحیه متنی</label>
                          ...
                          <div data-repeater-item>
                            <div class="row">
                              <div class="mb-3 col-lg-6 col-xl-3 col-12 mb-0">
                                ...
                                <input type="text" id="form-repeater-1-1" class="form-control text-start" placeholder="john.doe" dir="ltr">
                              </div>
                              <div class="mb-3 col-lg-6 col-xl-3 col-12 mb-0">
                                <label class="form-label" for="form-repeater-1-2">رمز عبور</label>
                                <input type="password" id="form-repeater-1-2" class="form-control text-start" placeholder="············" dir="ltr">
                              </div>
                              <div class="mb-3 col-lg-6 col-xl-2 col-12 mb-0">
                                <label class="form-label" for="form-repeater-1-3">جنسیت</label>
                              ...
                              <div class="mb-3 col-lg-6 col-xl-2 col-12 mb-0">
                                <label class="form-label" for="form-repeater-1-4">تخصص</label>
