...
<html lang="fa" class="light-style customizer-hide" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>غیر مجاز - صفحات | فرست - قالب مدیریت بوت‌استرپ</title>
  ...
  <body>
    ...
    <div class="container-xxl container-p-y">
      <div class="misc-wrapper">
        ...
        <div class="mt-5">
          <img src="../../assets/img/illustrations/girl-hacking-site-light.png" alt="page-misc-not-authorized-light" width="450" class="img-fluid" data-app-light-img="illustrations/girl-hacking-site-light.png" data-app-dark-img="illustrations/girl-hacking-site-dark.png">
        </div>
      </div>
    </div>
    <!-- /Not Authorized -->
