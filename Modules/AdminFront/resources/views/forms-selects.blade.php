...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>انتخاب‌ها و برچسب‌ها - فرم‌ها | فرست - قالب مدیریت بوت‌استرپ</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">فرم‌ها /</span> انتخاب‌ها و برچسب‌ها
              </h4>
              ...
              <div class="row">
                ...
                <div class="col-12">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">انتخاب‌های Select2</h5>
                    <div class="card-body">
                      <div class="row">
                        <!-- Basic -->
                        <div class="col-md-6 mb-4">
                          <label for="select2Basic" class="form-label">پایه</label>
                        ...
                        <!-- Multiple -->
                        <div class="col-md-6 mb-4">
                          <label for="select2Multiple" class="form-label">چندگانه</label>
                        ...
                        <!-- Disabled -->
                        <div class="col-md-6 mb-4">
                          <label for="select2Disabled" class="form-label">غیرفعال</label>
                        ...
                        <!-- Icons -->
                        <div class="col-md-6 mb-4">
                          <label for="select2Icons" class="form-label">آیکن‌ها</label>
                          <select id="select2Icons" class="select2-icons form-select">
                            <optgroup label="خدمات">
                              <option value="wordpress2" data-icon="bx bxl-wordpress" selected>وردپرس</option>
                            ...
                            <optgroup label="نوع فایل">
                              ...
                              <option value="facebook" data-icon="bx bxl-facebook">فیسبوک</option>
                            </optgroup>
                            <optgroup label="مرورگرها">
                              <option value="chrome" data-icon="bx bxl-chrome">کروم</option>
                              <option value="firefox" data-icon="bx bxl-firefox">فایرفاکس</option>
                              <option value="safari" data-icon="bx bxl-edge">اج</option>
                              <option value="opera" data-icon="bx bxl-opera">اوپرا</option>
                        ...
                        <!-- Primary -->
                        <div class="col-md-6 mb-4">
                          <label for="select2Primary" class="form-label">اولیه</label>
                        ...
                        <!-- Success -->
                        <div class="col-md-6 mb-4">
                          <label for="select2Success" class="form-label">موفقیت</label>
                        ...
                        <!-- Info -->
                        <div class="col-md-6 mb-4">
                          <label for="select2Info" class="form-label">اطلاعات</label>
                        ...
                        <!-- Warning -->
                        <div class="col-md-6 mb-4">
                          <label for="select2Warning" class="form-label">هشدار</label>
                        ...
                        <div class="col-md-6 mb-4 mb-md-0">
                          <label for="select2Danger" class="form-label">اخطار</label>
                        ...
                        <!-- Dark -->
                        <div class="col-md-6">
                          <label for="select2Dark" class="form-label">تیره</label>
                ...
                <div class="col-12">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">برچسب‌های Tagify</h5>
                    <div class="card-body">
                      <div class="row">
                        <!-- Basic -->
                        <div class="col-md-6 mb-4">
                          <label for="TagifyBasic" class="form-label">پایه</label>
                          <input id="TagifyBasic" class="form-control" name="TagifyBasic" value="برچسب 1, برچسب 2, برچسب 3">
                        </div>
                        <!-- Readonly Mode -->
                        <div class="col-md-6 mb-4">
                          <label for="TagifyReadonly" class="form-label">فقط خواندنی</label>
                          <input id="TagifyReadonly" class="form-control" readonly value="برچسب 1, برچسب 2, برچسب 3">
                        </div>
                        <!-- Custom Suggestions: Inline -->
                        <div class="col-md-6 mb-4">
                          <label for="TagifyCustomInlineSuggestion" class="form-label">پیشنهادهای درون‌خطی سفارشی</label>
                          <input id="TagifyCustomInlineSuggestion" name="TagifyCustomInlineSuggestion" class="form-control" placeholder="انتخاب تکنولوژی" value="css, html, javascript">
                        </div>
                        <!-- Custom Suggestions: List -->
                        <div class="col-md-6 mb-4">
                          <label for="TagifyCustomListSuggestion" class="form-label">پیشنهادهای لیستی سفارشی</label>
                          <input id="TagifyCustomListSuggestion" name="TagifyCustomListSuggestion" class="form-control" placeholder="انتخاب تکنولوژی" value="css, html, php">
                        </div>
                        <!-- Users List -->
                        <div class="col-md-6 mb-4">
                          <label for="TagifyUserList" class="form-label">لیست کاربران</label>
                          <input id="TagifyUserList" name="TagifyUserList" class="form-control" value="abatisse2@nih.gov, Justinian Hattersley">
                        </div>
                        <!-- Email -->
                        <div class="col-md-6 mb-4">
                          <label for="TagifyEmailList" class="form-label d-block">لیست ایمیل</label>
                          <input id="TagifyEmailList" class="tagify-email-list" value="some56.name@website.com">
                          <button type="button" class="btn rounded-pill btn-icon btn-sm btn-label-primary">
                ...
                <div class="col-12">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">پیشنهادهای Typeahead</h5>
                    <div class="card-body">
                      <div class="row">
                        <!-- Basic -->
                        <div class="col-md-6 mb-4">
                          <label for="TypeaheadBasic" class="form-label">پایه</label>
                          <input id="TypeaheadBasic" class="form-control typeahead" type="text" autocomplete="off" placeholder="ایالت‌های آمریکا را وارد کنید">
                        </div>
                        <!-- Bloodhound -->
                        <div class="col-md-6 mb-4">
                          <label for="TypeaheadBloodHound" class="form-label">BloodHound (موتور پیشنهاد)</label>
                          <input id="TypeaheadBloodHound" class="form-control typeahead-bloodhound" type="text" autocomplete="off" placeholder="ایالت‌های آمریکا را وارد کنید">
                        </div>
                        <!-- Prefetch -->
                        <div class="col-md-6 mb-4">
                          <label for="TypeaheadPrefetch" class="form-label">پیش واکشی</label>
                          <input id="TypeaheadPrefetch" class="form-control typeahead-prefetch" type="text" autocomplete="off" placeholder="ایالت‌های آمریکا را وارد کنید">
                        </div>
                        <!-- Default Suggestions -->
                        <div class="col-md-6 mb-4">
                          <label for="TypeaheadSuggestions" class="form-label">پیشنهادهای پیش‌فرض</label>
                          <input id="TypeaheadSuggestions" class="form-control typeahead-default-suggestions" type="text" autocomplete="off">
                        </div>
                        <!-- Custom Template -->
                        <div class="col-md-6 mb-4 mb-md-0">
                          <label for="TypeaheadCustom" class="form-label">قالب سفارشی</label>
                          <input id="TypeaheadCustom" class="form-control typeahead-custom-template" type="text" autocomplete="off" placeholder="برای برنده اسکار جستجو کنید">
                        </div>
                        <!-- Multiple Datasets -->
                        <div class="col-md-6">
                          <label for="TypeaheadMultipleDataset" class="form-label">مجموعه داده های چندگانه</label>
                ...
                <div class="col-12">
                  <div class="card">
                    <h5 class="card-header heading-color">انتخاب بوت‌استرپ</h5>
                    <div class="card-body">
                      <div class="row">
                        <!-- Basic -->
                        <div class="col-md-6 mb-4">
                          <label for="selectpickerBasic" class="form-label">پایه</label>
                          <select id="selectpickerBasic" class="selectpicker w-100" data-style="btn-default">
                            <option>راکی</option>
                            <option>انتقام جویان</option>
                            <option>پدرخوانده</option>
                          </select>
                        </div>
                        <!-- Group -->
                        <div class="col-md-6 mb-4">
                          <label for="selectpickerGroups" class="form-label">گروه‌ها</label>
                          <select id="selectpickerGroups" class="selectpicker w-100" data-style="btn-default">
                            <optgroup label="فیلم‌ها">
                              <option>راکی</option>
                              <option>انتقام جویان</option>
                              <option>پدرخوانده</option>
                            </optgroup>
                            <optgroup label="سریال‌ها">
                        ...
                        <!-- Multiple -->
                        <div class="col-md-6 mb-4">
                          <label for="selectpickerMultiple" class="form-label">چندگانه</label>
                        ...
                        <!-- Live Search -->
                        <div class="col-md-6 mb-4">
                          <label for="selectpickerLiveSearch" class="form-label">جستجوی زنده</label>
                          <select id="selectpickerLiveSearch" class="selectpicker w-100" data-style="btn-default" data-live-search="true">
                            <option data-tokens="ketchup mustard">هات داگ، سیب زمینی و نوشابه</option>
                            <option data-tokens="mustard">برگر، شیک و یک لبخند</option>
                            <option data-tokens="frosting">شکر، ادویه و همه چیزهای خوب</option>
                          </select>
                        </div>
                        <!-- Icons -->
                        <div class="col-md-6 mb-4">
                          <label for="selectpickerIcons" class="form-label">آیکن‌ها</label>
                          <select class="selectpicker w-100 show-tick" id="selectpickerIcons" data-icon-base="bx" data-tick-icon="bx-check" data-style="btn-default">
                            <option data-icon="bx bxl-instagram">اینستاگرام</option>
                            <option data-icon="bx bxl-pinterest-alt">پینترست</option>
                            <option data-icon="bx bxl-twitch">توئیچ</option>
                          </select>
                        </div>
                        <!-- Subtext -->
                        <div class="col-md-6 mb-4">
                          <label for="selectpickerSubtext" class="form-label">زیرمتن</label>
                        ...
                        <!-- Selection Limit -->
                        <div class="col-md-6 mb-4">
                          <label for="selectpickerSelection" class="form-label">محدودیت انتخاب</label>
                        ...
                        <!-- Select / Deselect All -->
                        <div class="col-md-6 mb-4">
                          <label for="selectpickerSelectDeselect" class="form-label">انتخاب / عدم انتخاب همه</label>
                        ...
                        <!-- Divider -->
                        <div class="col-md-6 mb-4">
                          <label for="selectpickerDivider" class="form-label">جداکننده</label>
                          <select id="selectpickerDivider" class="selectpicker w-100" data-style="btn-default">
                            <option>راکی</option>
                            <option data-divider="true">جداکننده</option>
                            <option>انتقام جویان</option>
                            <option>پدرخوانده</option>
                          </select>
                        </div>
                        <!-- Header -->
                        <div class="col-md-6 mb-4">
                          <label for="selectpickerHeader" class="form-label">سرتیتر</label>
                          <select id="selectpickerHeader" class="selectpicker w-100" data-style="btn-default" data-header="یک فیلم انتخاب کنید">
                            <option>راکی</option>
                            <option>انتقام جویان</option>
                            <option>پدرخوانده</option>
                          </select>
                        ...
                        <!-- Disabled -->
                        <div class="col-md-6 mb-4 mb-md-0">
                          <label for="selectpickerDisabled" class="form-label">غیرفعال</label>
                        ...
                        <!-- Disabled Options -->
                        <div class="col-md-6">
                          <label for="selectpickerDisabledOptions" class="form-label">گزینه‌های غیرفعال</label>
                          <select id="selectpickerDisabledOptions" class="selectpicker w-100" data-style="btn-default">
                            <option>راکی</option>
                            <option disabled>انتقام جویان</option>
                            <option>پدرخوانده</option>
                          </select>
                        </div>
                      </div>
