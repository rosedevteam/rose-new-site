...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>گروه‌های ورودی - فرم‌ها | فرست - قالب مدیریت بوت‌استرپ</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">فرم‌ها /</span> گروه‌های ورودی
              </h4>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">پایه</h5>
                    <div class="card-body demo-vertical-spacing demo-only-element">
                      <div class="input-group">
                        <span class="input-group-text" id="basic-addon11">@</span>
                        <input type="text" class="form-control text-start" placeholder="نام کاربری" dir="ltr" aria-label="Username" aria-describedby="basic-addon11">
                      </div>

                      <div class="form-password-toggle">
                        <label class="form-label" for="basic-default-password12">رمز عبور</label>
                        <div class="input-group">
                          <input type="password" class="form-control text-start" id="basic-default-password12" placeholder="············" dir="ltr" aria-describedby="basic-default-password2">
                          <span id="basic-default-password2" class="input-group-text cursor-pointer"><i class="bx bx-hide"></i></span>
                        </div>
                      </div>

                      <div class="input-group">
                        <span class="input-group-text" id="basic-addon13" dir="ltr">@example.com</span>
                        <input type="text" class="form-control text-start" placeholder="نام کاربری گیرنده" aria-label="Recipient's username" aria-describedby="basic-addon13" dir="ltr">
                      </div>

                      <div class="input-group">
                        <input type="text" class="form-control" placeholder="URL" id="basic-url1" aria-describedby="basic-addon14" dir="ltr">
                        <span class="input-group-text" id="basic-addon14" dir="ltr">https://example.com/users/</span>
                      </div>

                      <div class="input-group">
                        <span class="input-group-text" dir="ltr">.00</span>
                        <input type="number" class="form-control text-start" placeholder="مقدار" aria-label="Amount (to the nearest dollar)">
                        <span class="input-group-text">تومان</span>
                      </div>

                      <div class="input-group">
                        <span class="input-group-text">با ناحیه متنی</span>
                        <textarea class="form-control" aria-label="With textarea" placeholder="دیدگاه"></textarea>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">ادغام شده</h5>
                    <div class="card-body demo-vertical-spacing demo-only-element">
                      <div class="input-group input-group-merge">
                        <span class="input-group-text" id="basic-addon-search31"><i class="bx bx-search"></i></span>
                        <input type="text" class="form-control" placeholder="جستجو ..." aria-label="Search..." aria-describedby="basic-addon-search31">
                      </div>

                      <div class="form-password-toggle">
                        <label class="form-label" for="basic-default-password32">رمز عبور</label>
                        <div class="input-group input-group-merge">
                          <input type="password" class="form-control text-start" id="basic-default-password32" placeholder="············" aria-describedby="basic-default-password" dir="ltr">
                          <span class="input-group-text cursor-pointer" id="basic-default-password"><i class="bx bx-hide"></i></span>
                        </div>
                      </div>

                      <div class="input-group input-group-merge">
                        <span class="input-group-text" id="basic-addon33" dir="ltr">@example.com</span>
                        <input type="text" class="form-control text-start" placeholder="نام کاربری گیرنده" aria-label="Recipient's username" aria-describedby="basic-addon33" dir="ltr">
                      </div>

                      <div class="input-group input-group-merge">
                        <input type="text" class="form-control" id="basic-url3" aria-describedby="basic-addon34" dir="ltr">
                        <span class="input-group-text" id="basic-addon34" dir="ltr">https://example.com/users/</span>
                      </div>
                ...
                <div class="col-md-6">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">اندازه‌ها</h5>
                    <div class="card-body demo-vertical-spacing demo-only-element">
                      <div class="input-group input-group-lg">
                        <span class="input-group-text">@</span>
                        <input type="text" class="form-control text-start" placeholder="نام کاربری" dir="ltr">
                      </div>
                ...
                <div class="col-md-6">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">افزونه‌های چک‌باکس و رادیو</h5>
                    <div class="card-body demo-vertical-spacing demo-only-element">
                      <div class="input-group">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">ورودی‌ها و افزونه‌های چندگانه</h5>

                    <div class="card-body demo-vertical-spacing demo-only-element">
                      <small class="text-light fw-semibold d-block">ورودی‌های چندگانه</small>
                      <div class="input-group">
                      ...
                      <small class="text-light fw-semibold d-block pt-3">افزونه‌های چندگانه</small>
                      <div class="input-group">
                        <span class="input-group-text">تومان</span>
                ...
                <div class="col-md-6">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">گفتار به نوشتار</h5>
                    <div class="card-body demo-vertical-spacing demo-only-element">
                      <small class="text-light fw-semibold d-block">گروه ورودی</small>

                      <div class="input-group input-group-merge speech-to-text">
                        <input type="text" class="form-control" placeholder="صحبت کنید" aria-describedby="text-to-speech-addon">
                        <span class="input-group-text" id="text-to-speech-addon">
                          <i class="bx bx-microphone cursor-pointer text-to-speech-toggle"></i>
                        </span>
                      </div>

                      <small class="text-light fw-semibold d-block pt-3">ناحیه متنی</small>

                      <div class="input-group input-group-merge speech-to-text">
                        <textarea class="form-control" placeholder="صحبت کنید" rows="2"></textarea>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">دکمه با منوهای کشویی و افزونه‌ها</h5>
                    <div class="card-body demo-vertical-spacing demo-only-element">
                      <small class="text-light fw-semibold d-block">افزونه های دکمه‌ای</small>
                      <div class="input-group">
                        <button class="btn btn-outline-primary" type="button" id="button-addon1">دکمه</button>
                        <input type="text" class="form-control" placeholder="" aria-label="Example text with button addon" aria-describedby="button-addon1">
                      </div>

                      <div class="input-group">
                        <input type="text" class="form-control" placeholder="نام کاربری گیرنده" aria-label="Recipient's username" aria-describedby="button-addon2">
                        <button class="btn btn-outline-primary" type="button" id="button-addon2">دکمه</button>
                      </div>

                      <div class="input-group">
                        <button class="btn btn-outline-primary" type="button">دکمه</button>
                        <button class="btn btn-outline-primary" type="button">دکمه</button>
                        <input type="text" class="form-control" placeholder="" aria-label="Example text with two button addons">
                      </div>

                      <div class="input-group">
                        <input type="text" class="form-control" placeholder="نام کاربری گیرنده" aria-label="Recipient's username with two button addons">
                        <button class="btn btn-outline-primary" type="button">دکمه</button>
                        <button class="btn btn-outline-primary" type="button">دکمه</button>
                      </div>

                      <small class="text-light fw-semibold d-block pt-3">دکمه با منوهای کشویی</small>
                      <div class="input-group">
                        ...
                        <ul class="dropdown-menu">
                          ...
                          <li><a class="dropdown-item" href="javascript:void(0);">لینک جدا شده</a></li>
                        </ul>
                      ...
                      <div class="input-group">
                        ...
                        <ul class="dropdown-menu">
                          <li><a class="dropdown-item" href="javascript:void(0);">لورم ایپسوم متن</a></li>
                          <li><a class="dropdown-item" href="javascript:void(0);">لورم ایپسوم متن ساختگی</a></li>
                          <li><a class="dropdown-item" href="javascript:void(0);">یک عمل دیگر</a></li>
                          <li>
                            <hr class="dropdown-divider">
                          </li>
                ...
                <div class="col-md-6">
                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="card mb-4">
                        <h5 class="card-header heading-color">دکمه‌های جدا شده</h5>
                        <div class="card-body demo-vertical-spacing demo-only-element">
                          <div class="input-group">
                            <button type="button" class="btn btn-outline-primary">عمل</button>
                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="card mb-4">
                        <h5 class="card-header heading-color">انتخاب سفارشی</h5>
                        <div class="card-body demo-vertical-spacing demo-only-element">
                          <div class="input-group">
              ...
              <div class="row">
                <div class="col-12">
                  <div class="card">
                    <h5 class="card-header heading-color">ورودی فایل سفارشی</h5>
                    <div class="card-body demo-vertical-spacing demo-only-element">
                      <div class="input-group">
                      ...
                      <div class="input-group">
                        <button class="btn btn-outline-primary" type="button" id="inputGroupFileAddon03">دکمه</button>
                        <input type="file" class="form-control" id="inputGroupFile03" aria-describedby="inputGroupFileAddon03" aria-label="Upload">
                      </div>

                      <div class="input-group">
                        <input type="file" class="form-control" id="inputGroupFile04" aria-describedby="inputGroupFileAddon04" aria-label="Upload">
                        <button class="btn btn-outline-primary" type="button" id="inputGroupFileAddon04">دکمه</button>
                      </div>
                    </div>
                  </div>
                </div>
