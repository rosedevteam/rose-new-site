...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>چند مرحله‌ای شماره دار - فرم‌ها | فرست - قالب مدیریت بوت‌استرپ</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">فرم چند مرحله‌ای /</span> شماره دار
              </h4>
              <!-- Default -->
              <div class="row">
                <div class="col-12">
                  <h5 class="secondary-font">پیش‌فرض</h5>
                </div>

                <!-- Default Wizard -->
                <div class="col-12 mb-4">
                  <small class="text-light fw-semibold lh-2">پایه</small>
                    ...
                    <div class="bs-stepper-content">
                      <form onsubmit="return false">
                        ...
                        <div id="account-details" class="content">
                          ...
                          <div class="row g-3">
                            <div class="col-sm-6">
                              ...
                              <input type="text" id="username" class="form-control text-start" placeholder="johndoe" dir="ltr">
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="email">ایمیل</label>
                              <input type="email" id="email" class="form-control text-start" placeholder="john.doe@email.com" aria-label="john.doe@email.com" dir="ltr">
                            </div>
                            <div class="col-sm-6 form-password-toggle">
                              <label class="form-label" for="password">رمز عبور</label>
                              <div class="input-group input-group-merge">
                                <input type="password" id="password" class="form-control text-start" placeholder="············" dir="ltr" aria-describedby="password2">
                            ...
                            <div class="col-sm-6 form-password-toggle">
                              ...
                              <div class="input-group input-group-merge">
                                <input type="password" id="confirm-password" class="form-control text-start" placeholder="············" dir="ltr" aria-describedby="confirm-password2">
                        ...
                        <div id="personal-info" class="content">
                          ...
                          <div class="row g-3">
                            <div class="col-sm-6">
                              ...
                              <input type="text" id="first-name" class="form-control" placeholder="جان">
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="last-name">نام خانوادگی</label>
                              <input type="text" id="last-name" class="form-control" placeholder="اسنو">
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div id="social-links" class="content">
                          ...
                          <div class="row g-3">
                            <div class="col-sm-6">
                              <label class="form-label" for="twitter">توییتر</label>
                              <input type="text" id="twitter" class="form-control text-start" dir="ltr" placeholder="https://twitter.com/abc">
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="facebook">فیسبوک</label>
                              <input type="text" id="facebook" class="form-control text-start" dir="ltr" placeholder="https://facebook.com/abc">
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="google">گوگل+</label>
                              <input type="text" id="google" class="form-control text-start" dir="ltr" placeholder="https://plus.google.com/abc">
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="linkedin">لینکدین</label>
                              <input type="text" id="linkedin" class="form-control text-start" dir="ltr" placeholder="https://linkedin.com/abc">
                            </div>
                            <div class="col-12 d-flex justify-content-between">
                              <button class="btn btn-primary btn-prev">
                                <i class="bx bx-chevron-left bx-sm ms-sm-n2"></i>
                ...
                <!-- Validation Wizard -->
                <div class="col-12 mb-4">
                  <small class="text-light fw-semibold lh-2">اعتبارسنجی</small>
                  <div id="wizard-validation" class="bs-stepper mt-2">
                    <div class="bs-stepper-header">
                      <div class="step" data-target="#account-details-validation">
                        <button type="button" class="step-trigger">
                          <span class="bs-stepper-circle">1</span>
                          <span class="bs-stepper-label">جزئیات حساب</span>
                        </button>
                      </div>
                      <div class="line"></div>
                      <div class="step" data-target="#personal-info-validation">
                        <button type="button" class="step-trigger">
                          <span class="bs-stepper-circle">2</span>
                          <span class="bs-stepper-label">اطلاعات شخصی</span>
                        </button>
                      </div>
                      <div class="line"></div>
                      <div class="step" data-target="#social-links-validation">
                        <button type="button" class="step-trigger">
                          <span class="bs-stepper-circle">3</span>
                          <span class="bs-stepper-label">شبکه های اجتماعی</span>
                        </button>
                      </div>
                    </div>
                    <div class="bs-stepper-content">
                      <form id="wizard-validation-form" onsubmit="return false">
                        ...
                        <div id="account-details-validation" class="content">
                          ...
                          <div class="row g-3">
                            <div class="col-sm-6">
                              <label class="form-label" for="formValidationUsername">نام کاربری</label>
                              <input type="text" name="formValidationUsername" id="formValidationUsername" class="form-control text-start" placeholder="johndoe" dir="ltr">
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="formValidationEmail">ایمیل</label>
                              <input type="email" name="formValidationEmail" id="formValidationEmail" class="form-control text-start" placeholder="john.doe@email.com" aria-label="john.doe@email.com" dir="ltr">
                            </div>
                            <div class="col-sm-6 form-password-toggle">
                              <label class="form-label" for="formValidationPass">رمز عبور</label>
                              <div class="input-group input-group-merge">
                                <input type="password" id="formValidationPass" name="formValidationPass" class="form-control text-start" placeholder="············" aria-describedby="formValidationPass2" dir="ltr">
                                <span class="input-group-text cursor-pointer" id="formValidationPass2"><i class="bx bx-hide"></i></span>
                              </div>
                            </div>
                            <div class="col-sm-6 form-password-toggle">
                              <label class="form-label" for="formValidationConfirmPass">تایید رمز عبور</label>
                              <div class="input-group input-group-merge">
                                <input type="password" id="formValidationConfirmPass" name="formValidationConfirmPass" class="form-control text-start" placeholder="············" aria-describedby="formValidationConfirmPass2" dir="ltr">
                        ...
                        <div id="personal-info-validation" class="content">
                          ...
                          <div class="row g-3">
                            <div class="col-sm-6">
                              <label class="form-label" for="formValidationFirstName">نام</label>
                              <input type="text" id="formValidationFirstName" name="formValidationFirstName" class="form-control" placeholder="جان">
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="formValidationLastName">نام خانوادگی</label>
                              <input type="text" id="formValidationLastName" name="formValidationLastName" class="form-control" placeholder="اسنو">
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="formValidationCountry">کشور</label>
                            ...
                            <div class="col-sm-6">
                              <label class="form-label" for="formValidationLanguage">زبان</label>
                        ...
                        <div id="social-links-validation" class="content">
                          ...
                          <div class="row g-3">
                            <div class="col-sm-6">
                              <label class="form-label" for="formValidationTwitter">توییتر</label>
                              <input type="text" name="formValidationTwitter" id="formValidationTwitter" class="form-control text-start" dir="ltr" placeholder="https://twitter.com/abc">
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="formValidationFacebook">فیسبوک</label>
                              <input type="text" name="formValidationFacebook" id="formValidationFacebook" class="form-control text-start" dir="ltr" placeholder="https://facebook.com/abc">
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="formValidationGoogle">گوگل+</label>
                              <input type="text" name="formValidationGoogle" id="formValidationGoogle" class="form-control text-start" dir="ltr" placeholder="https://plus.google.com/abc">
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="formValidationLinkedIn">لینکدین</label>
                              <input type="text" name="formValidationLinkedIn" id="formValidationLinkedIn" class="form-control text-start" dir="ltr" placeholder="https://linkedin.com/abc">
                            </div>
                            <div class="col-12 d-flex justify-content-between">
                              <button class="btn btn-primary btn-prev">
                                <i class="bx bx-chevron-left bx-sm ms-sm-n2"></i>
                              ...
                              <button class="btn btn-success btn-next btn-submit">ثبت</button>
                            </div>
                          </div>
                        </div>
                      </form>
                ...
                <!-- Vertical Wizard -->
                <div class="col-12 mb-4">
                  <small class="text-light fw-semibold lh-2">عمودی</small>
                    ...
                    <div class="bs-stepper-content">
                      <form onsubmit="return false">
                        ...
                        <div id="account-details-1" class="content">
                          ...
                          <div class="row g-3">
                            <div class="col-sm-6">
                              <label class="form-label" for="username-vertical">نام کاربری</label>
                              <input type="text" id="username-vertical" class="form-control text-start" placeholder="johndoe" dir="ltr">
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="email-vertical">ایمیل</label>
                              <input type="email" id="email-vertical" class="form-control text-start" placeholder="john.doe@email.com" aria-label="john.doe@email.com" dir="ltr">
                            </div>
                            <div class="col-sm-6 form-password-toggle">
                              <label class="form-label" for="password-vertical">رمز عبور</label>
                              <div class="input-group input-group-merge">
                                <input type="password" id="password-vertical" class="form-control text-start" placeholder="············" dir="ltr" aria-describedby="password2-vertical">
                                <span class="input-group-text cursor-pointer" id="password2-vertical"><i class="bx bx-hide"></i></span>
                              </div>
                            </div>
                            <div class="col-sm-6 form-password-toggle">
                              <label class="form-label" for="confirm-password-vertical">تایید رمز عبور</label>
                              <div class="input-group input-group-merge">
                                <input type="password" id="confirm-password-vertical" class="form-control text-start" placeholder="············" dir="ltr" aria-describedby="confirm-password-vertical2">
                        ...
                        <div id="personal-info-1" class="content">
                          ...
                          <div class="row g-3">
                            <div class="col-sm-6">
                              <label class="form-label" for="first-name-vertical">نام</label>
                              <input type="text" id="first-name-vertical" class="form-control" placeholder="جان">
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="last-name-vertical">نام خانوادگی</label>
                              <input type="text" id="last-name-vertical" class="form-control" placeholder="اسنو">
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="country-vertical">کشور</label>
                            ...
                            <div class="col-sm-6">
                              <label class="form-label" for="language-vertical">زبان</label>
                        ...
                        <div id="social-links-1" class="content">
                          ...
                          <div class="row g-3">
                            <div class="col-sm-6">
                              <label class="form-label" for="twitter-vertical">توییتر</label>
                              <input type="text" id="twitter-vertical" class="form-control text-start" dir="ltr" placeholder="https://twitter.com/abc">
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="facebook-vertical">فیسبوک</label>
                              <input type="text" id="facebook-vertical" class="form-control text-start" dir="ltr" placeholder="https://facebook.com/abc">
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="google-vertical">گوگل+</label>
                              <input type="text" id="google-vertical" class="form-control text-start" dir="ltr" placeholder="https://plus.google.com/abc">
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="linkedin-vertical">لینکدین</label>
                              <input type="text" id="linkedin-vertical" class="form-control text-start" dir="ltr" placeholder="https://linkedin.com/abc">
                            </div>
                            <div class="col-12 d-flex justify-content-between">
                              <button class="btn btn-primary btn-prev">
                                <i class="bx bx-chevron-left bx-sm ms-sm-n2"></i>
              ...
              <div class="row">
                <div class="col-12">
                  <h5 class="secondary-font">مدرن</h5>
                </div>

                <!-- Modern Wizard -->
                <div class="col-12 mb-4">
                  <small class="text-light fw-semibold mt-2 lh-2">پایه</small>
                    ...
                    <div class="bs-stepper-content">
                      <form onsubmit="return false">
                        ...
                        <div id="account-details-modern" class="content">
                          ...
                          <div class="row g-3">
                            <div class="col-sm-6">
                              <label class="form-label" for="username-modern">نام کاربری</label>
                              <input type="text" id="username-modern" class="form-control text-start" placeholder="johndoe" dir="ltr">
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="email-modern">ایمیل</label>
                              <input type="email" id="email-modern" class="form-control text-start" placeholder="john.doe@email.com" aria-label="john.doe@email.com" dir="ltr">
                            </div>
                            <div class="col-sm-6 form-password-toggle">
                              <label class="form-label" for="password-modern">رمز عبور</label>
                              <div class="input-group input-group-merge">
                                <input type="password" id="password-modern" class="form-control text-start" placeholder="············" dir="ltr" aria-describedby="password2-modern">
                                <span class="input-group-text cursor-pointer" id="password2-modern"><i class="bx bx-hide"></i></span>
                              </div>
                            </div>
                            <div class="col-sm-6 form-password-toggle">
                              <label class="form-label" for="confirm-password-modern">تایید رمز عبور</label>
                              <div class="input-group input-group-merge">
                                <input type="password" id="confirm-password-modern" class="form-control text-start" placeholder="············" dir="ltr" aria-describedby="confirm-password-modern2">
                        ...
                        <div id="personal-info-modern" class="content">
                          ...
                          <div class="row g-3">
                            <div class="col-sm-6">
                              <label class="form-label" for="first-name-modern">نام</label>
                              <input type="text" id="first-name-modern" class="form-control" placeholder="جان">
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="last-name-modern">نام خانوادگی</label>
                              <input type="text" id="last-name-modern" class="form-control" placeholder="اسنو">
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="country-modern">کشور</label>
                            ...
                            <div class="col-sm-6">
                              <label class="form-label" for="language-modern">زبان</label>
                        ...
                        <div id="social-links-modern" class="content">
                          ...
                          <div class="row g-3">
                            <div class="col-sm-6">
                              <label class="form-label" for="twitter-modern">توییتر</label>
                              <input type="text" id="twitter-modern" class="form-control text-start" dir="ltr" placeholder="https://twitter.com/abc">
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="facebook-modern">فیسبوک</label>
                              <input type="text" id="facebook-modern" class="form-control text-start" dir="ltr" placeholder="https://facebook.com/abc">
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="google-modern">گوگل+</label>
                              <input type="text" id="google-modern" class="form-control text-start" dir="ltr" placeholder="https://plus.google.com/abc">
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="linkedin-modern">لینکدین</label>
                              <input type="text" id="linkedin-modern" class="form-control text-start" dir="ltr" placeholder="https://linkedin.com/abc">
                            </div>
                            <div class="col-12 d-flex justify-content-between">
                              <button class="btn btn-primary btn-prev">
                                <i class="bx bx-chevron-left bx-sm ms-sm-n2"></i>
                      ...
                      <form onsubmit="return false">
                        ...
                        <div id="account-details-modern-vertical" class="content">
                          ...
                          <div class="row g-3">
                            <div class="col-sm-6">
                              ...
                              <input type="text" id="username-modern-vertical" class="form-control text-start" placeholder="johndoe" dir="ltr">
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="email-modern-vertical">ایمیل</label>
                              <input type="email" id="email-modern-vertical" class="form-control text-start" placeholder="john.doe@email.com" aria-label="john.doe@email.com" dir="ltr">
                            </div>
                            <div class="col-sm-6 form-password-toggle">
                              <label class="form-label" for="password-modern-vertical">رمز عبور</label>
                              <div class="input-group input-group-merge">
                                <input type="password" id="password-modern-vertical" class="form-control text-start" placeholder="············" dir="ltr" aria-describedby="password2-modern-vertical">
                                <span class="input-group-text cursor-pointer" id="password2-modern-vertical"><i class="bx bx-hide"></i></span>
                              </div>
                            </div>
                            <div class="col-sm-6 form-password-toggle">
                              <label class="form-label" for="confirm-password-modern-vertical">تایید رمز عبور</label>
                              <div class="input-group input-group-merge">
                                <input type="password" id="confirm-password-modern-vertical" class="form-control text-start" placeholder="············" dir="ltr" aria-describedby="confirm-password-modern-vertical2">
                        ...
                        <div id="personal-info-modern-vertical" class="content">
                          ...
                          <div class="row g-3">
                            ...
                            <div class="col-sm-6">
                              <label class="form-label" for="country-modern-vertical">کشور</label>
                            ...
                            <div class="col-sm-6">
                              <label class="form-label" for="language-modern-vertical">زبان</label>
                        ...
                        <div id="social-links-modern-vertical" class="content">
                          ...
                          <div class="row g-3">
                            <div class="col-sm-6">
                              <label class="form-label" for="twitter-modern-vertical">توییتر</label>
                              <input type="text" id="twitter-modern-vertical" class="form-control text-start" dir="ltr" placeholder="https://twitter.com/abc">
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="facebook-modern-vertical">فیسبوک</label>
                              <input type="text" id="facebook-modern-vertical" class="form-control text-start" dir="ltr" placeholder="https://facebook.com/abc">
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="google-modern-vertical">گوگل+</label>
                              <input type="text" id="google-modern-vertical" class="form-control text-start" dir="ltr" placeholder="https://plus.google.com/abc">
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="linkedin-modern-vertical">لینکدین</label>
                              <input type="text" id="linkedin-modern-vertical" class="form-control text-start" dir="ltr" placeholder="https://linkedin.com/abc">
                            </div>
                            <div class="col-12 d-flex justify-content-between">
                              <button class="btn btn-primary btn-prev">
                                <i class="bx bx-chevron-left bx-sm ms-sm-n2"></i>
