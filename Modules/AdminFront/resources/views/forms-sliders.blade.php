...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>اسلایدرها - فرم‌ها | فرست - قالب مدیریت بوت‌استرپ</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="row">
                ...
                <div class="col-12">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      ...
                      <small class="text-light fw-semibold">دستگیره‌ها</small>
                      <div id="slider-handles" class="mt-4 mb-5"></div>
                      <small class="text-light fw-semibold">چفت شدن بین قدم‌ها</small>
                ...
                <div class="col-12">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">رفتار</h5>
                    <div class="card-body">
                      <small class="text-light fw-semibold">ضربه زدن</small>
                      <div id="slider-tap" class="mt-4 mb-5"></div>

                      <small class="text-light fw-semibold">کشیدن</small>
                      <div id="slider-drag" class="mt-4 mb-5"></div>

                      <small class="text-light fw-semibold">کشیدن ثابت</small>
                      <div id="slider-fixed-drag" class="mt-4 mb-5"></div>

                      <small class="text-light fw-semibold">گزینه‌های ترکیبی</small>
                      <div id="slider-combined-options" class="mt-4 mb-5"></div>

                      <small class="text-light fw-semibold">هاور</small>
                      <div id="slider-hover" class="mt-4 mb-2"></div>
                      <small>مقدار هاور شده: <span id="slider-val">null</span></small>
                    </div>
                  </div>
                </div>
                <!-- /Behaviour -->
                ...
                <div class="col-12">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">مقیاس و درجه‌ها</h5>
                ...
                <div class="col-12">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">رنگ ها</h5>
                    <div class="card-body pb-5">
                      <small class="text-light fw-semibold">اولیه</small>
                      <div class="noUi-primary mt-4 mb-5" id="slider-primary"></div>
                      <small class="text-light fw-semibold">موفقیت</small>
                      <div class="noUi-success mt-4 mb-5" id="slider-success"></div>
                      <small class="text-light fw-semibold">اخطار</small>
                      <div class="noUi-danger mt-4 mb-5" id="slider-danger"></div>
                      <small class="text-light fw-semibold">هشدار</small>
                      <div class="noUi-warning mt-4 mb-5" id="slider-warning"></div>
                      <small class="text-light fw-semibold">اطلاعات</small>
                ...
                <div class="col-12">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">پویا</h5>
                    <div class="card-body">
              ...
              <div class="row">
                <div class="col-xl-3 col-md-6 col-12">
                  <div class="card mb-xl-0 mb-4">
                    <h5 class="card-header heading-color">عمودی پیش‌فرض</h5>
                    <div class="card-body">
                ...
                <div class="col-xl-3 col-md-6 col-12">
                  <div class="card mb-xl-0 mb-4">
                    <h5 class="card-header heading-color">عمودی اتصال بالا</h5>
                    <div class="card-body">
                ...
                <div class="col-xl-3 col-md-6 mb-md-0 mb-4 col-12">
                  <div class="card">
                    <h5 class="card-header heading-color">عمودی تولتیپ</h5>
                    <div class="card-body">
                ...
                <div class="col-xl-3 col-md-6 col-12">
                  <div class="card">
                    <h5 class="card-header heading-color">عمودی محدود</h5>
                    <div class="card-body">
