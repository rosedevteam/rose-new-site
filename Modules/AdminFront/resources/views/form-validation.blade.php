...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>اعتبارسنجی - فرم‌ها | فرست - قالب مدیریت بوت‌استرپ</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4"><span class="text-muted fw-light">فرم‌ها /</span> اعتبارسنجی</h4>
              <div class="row mb-4">
                <!-- Browser Default -->
                <div class="col-md mb-4 mb-md-0">
                  <div class="card">
                    <h5 class="card-header heading-color">پیش‌فرض مرورگر</h5>
                    <div class="card-body">
                      <form class="browser-default-validation">
                        <div class="mb-3">
                          <label class="form-label" for="basic-default-name">نام</label>
                          <input type="text" class="form-control" id="basic-default-name" placeholder="جان اسنو" required>
                        </div>
                        <div class="mb-3">
                          <label class="form-label" for="basic-default-email">ایمیل</label>
                          <input type="email" id="basic-default-email" class="form-control text-start" placeholder="john.doe@email.com" dir="ltr" required>
                        </div>
                        <div class="mb-3 form-password-toggle">
                          <label class="form-label" for="basic-default-password">رمز عبور</label>
                          <div class="input-group input-group-merge">
                            <input type="password" id="basic-default-password" class="form-control text-start" placeholder="············" dir="ltr" aria-describedby="basic-default-password3" required>
                            <span class="input-group-text cursor-pointer" id="basic-default-password3"><i class="bx bx-hide"></i></span>
                          </div>
                        </div>
                        <div class="mb-3">
                          <label class="form-label" for="basic-default-country">کشور</label>
                          <select class="form-select" id="basic-default-country" required>
                            <option value="">انتخاب کشور</option>
                            <option value="usa">ایران</option>
                        ...
                        <div class="mb-3">
                          <label class="form-label" for="basic-default-dob">تاریخ تولد</label>
                          <input type="text" class="form-control flatpickr-validation" id="basic-default-dob" required>
                        </div>
                        <div class="mb-3">
                          <label class="form-label" for="basic-default-upload-file">تصویر پروفایل</label>
                        ...
                        <div class="mb-3">
                          ...
                          <div class="form-check form-check-inline">
                            ...
                            <label class="form-check-label" for="basic-default-radio-male">مرد</label>
                          </div>
                          <div class="form-check form-check-inline">
                            <input type="radio" id="basic-default-radio-female" name="basic-default-radio" class="form-check-input" required>
                            <label class="form-check-label" for="basic-default-radio-female">زن</label>
                          </div>
                        </div>
                        <div class="mb-3">
                          <label class="form-label" for="basic-default-bio">بیوگرافی</label>
                        ...
                        <div class="mb-3">
                          <div class="form-check">
                            ...
                            <label class="form-check-label" for="basic-default-checkbox">موافقت با قوانین و مقررات</label>
                          </div>
                        </div>
                        <div class="mb-3">
                          <label class="switch switch-primary">
                            ...
                            <span class="switch-label">دریافت ایمیل‌های مرتبط</span>
                          </label>
                        </div>
                        <div class="row">
                          <div class="col-12">
                ...
                <div class="col-md">
                  <div class="card">
                    <h5 class="card-header heading-color">اعتبارسنجی بوت‌استرپ</h5>
                    <div class="card-body">
                      <form class="needs-validation" novalidate>
                        <div class="mb-3">
                          <label class="form-label" for="bs-validation-name">نام</label>
                          <input type="text" class="form-control" id="bs-validation-name" placeholder="جان اسنو" required>
                          <div class="valid-feedback">صحیح است!</div>
                          <div class="invalid-feedback">لطفا نام خود را وارد کنید.</div>
                        </div>
                        <div class="mb-3">
                          <label class="form-label" for="bs-validation-email">ایمیل</label>
                          <input type="email" id="bs-validation-email" class="form-control text-start" placeholder="john.doe@email.com" dir="ltr" aria-label="john.doe" required>
                          <div class="valid-feedback">صحیح است!</div>
                          <div class="invalid-feedback">لطفا یک ایمیل معتبر وارد کنید.</div>
                        </div>
                        <div class="mb-3 form-password-toggle">
                          <label class="form-label" for="bs-validation-password">رمز عبور</label>
                          <div class="input-group input-group-merge">
                            <input type="password" id="bs-validation-password" class="form-control text-start" placeholder="············" dir="ltr" required>
                            <span class="input-group-text cursor-pointer" id="basic-default-password4"><i class="bx bx-hide"></i></span>
                          </div>
                          <div class="valid-feedback">صحیح است!</div>
                          <div class="invalid-feedback">لطفا رمز عبور خود را وارد کنید.</div>
                        </div>
                        <div class="mb-3">
                          <label class="form-label" for="bs-validation-country">کشور</label>
                          ...
                          <div class="valid-feedback">صحیح است!</div>
                          <div class="invalid-feedback">لطفا کشور خود را انتخاب کنید.</div>
                        </div>
                        <div class="mb-3">
                          <label class="form-label" for="bs-validation-dob">تاریخ تولد</label>
                          <input type="text" class="form-control flatpickr-validation" id="bs-validation-dob" required>
                          <div class="valid-feedback">صحیح است!</div>
                          <div class="invalid-feedback">لطفا تاریخ تولد خود را وارد کنید.</div>
                        </div>
                        <div class="mb-3">
                          <label class="form-label" for="bs-validation-upload-file">تصویر پروفایل</label>
                        ...
                        <div class="mb-3">
                          ...
                          <div class="form-check form-check-inline">
                            ...
                            <label class="form-check-label" for="bs-validation-radio-male">مرد</label>
                          </div>
                          <div class="form-check form-check-inline">
                            <input type="radio" id="bs-validation-radio-female" name="bs-validation-radio" class="form-check-input" required>
                            <label class="form-check-label" for="bs-validation-radio-female">زن</label>
                          </div>
                        </div>
                        <div class="mb-3">
                          <label class="form-label" for="bs-validation-bio">بیوگرافی</label>
                        ...
                        <div class="mb-3">
                          <div class="form-check">
                            ...
                            <label class="form-check-label" for="bs-validation-checkbox">موافقت با قوانین و مقررات</label>
                            <div class="invalid-feedback">شما باید قبل از ثبت با قوانین موافقت کنید.</div>
                          </div>
                        </div>
                        <div class="mb-3">
                          <label class="switch switch-primary">
              ...
              <div class="row">
                ...
                <div class="col-12">
                  <div class="card">
                    <h5 class="card-header heading-color">اعتبارسنجی فرم</h5>
                    <div class="card-body">
                      <form id="formValidationExamples" class="row g-3">
                        ...
                        <div class="col-md-6">
                          <label class="form-label" for="formValidationName">نام کامل</label>
                          <input type="text" id="formValidationName" class="form-control" placeholder="جان اسنو" name="formValidationName">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                          <div class="form-password-toggle">
                            ...
                            <div class="input-group input-group-merge">
                              <input class="form-control text-start" type="password" dir="ltr" id="formValidationPass" name="formValidationPass" placeholder="············" aria-describedby="multicol-password2">
                        ...
                        <div class="col-md-6">
                          <div class="form-password-toggle">
                            ...
                            <div class="input-group input-group-merge">
                              <input class="form-control text-start" type="password" dir="ltr" id="formValidationConfirmPass" name="formValidationConfirmPass" placeholder="············" aria-describedby="multicol-confirm-password2">
                        ...
                        <div class="col-12">
                          <h6 class="mt-4 fw-normal">2. اطلاعات شخصی</h6>
                          <hr class="mt-0 mb-2">
                        </div>

                        <div class="col-md-6">
                          <label for="formValidationFile" class="form-label">تصویر پروفایل</label>
                          <input class="form-control" type="file" id="formValidationFile" name="formValidationFile">
                        </div>
                        <div class="col-md-6">
                          <label class="form-label" for="formValidationDob">تاریخ تولد</label>
                          <input type="text" class="form-control flatpickr-validation" name="formValidationDob" id="formValidationDob" required>
                        </div>

                        <div class="col-md-6">
                          <label class="form-label" for="formValidationSelect2">کشور</label>
                        ...
                        <div class="col-md-6">
                          ...
                          <select class="selectpicker hobbies-select w-100" id="formValidationHobbies" data-style="btn-default" data-icon-base="bx" data-tick-icon="bx-check text-white" name="formValidationHobbies" multiple>
                            <option>ورزشی</option>
                            <option>فیلم ها</option>
                            <option>کتاب ها</option>
                          </select>
                        </div>

                        <div class="col-md-6">
                          <label class="form-label" for="formValidationBio">بیوگرافی</label>
                          <textarea class="form-control" id="formValidationBio" name="formValidationBio" rows="2"></textarea>
                        </div>
                        <div class="col-md-6">
                          <label class="d-block form-label">جنسیت</label>
                          <div class="form-check form-check-inline custom">
                            ...
                            <label class="form-check-label" for="formValidationGender">مرد</label>
                          </div>
                          <div class="form-check form-check-inline custom">
                            <input type="radio" id="formValidationGender2" name="formValidationGender" class="form-check-input">
                            <label class="form-check-label" for="formValidationGender2">زن</label>
                          </div>
                        </div>
                        ...
                        <div class="col-12">
                          <h6 class="mt-4 fw-normal">3. پلن خود را انتخاب کنید</h6>
                          <hr class="mt-0">
                              ...
                              <div class="form-check custom-option custom-option-icon">
                                <label class="form-check-label custom-option-content" for="basicPlanMain1">
                                  <span class="custom-option-body">
                                    ...
                                    <span class="custom-option-title mt-2 mb-1"> برای شروع </span>
                                    <small> 5 گیگابایت فضا و 1 عضو تیم دریافت کنید. </small>
                                  </span>
                              ...
                              <div class="form-check custom-option custom-option-icon">
                                <label class="form-check-label custom-option-content" for="basicPlanMain2">
                                  <span class="custom-option-body">
                                    ...
                                    <span class="custom-option-title mt-2 mb-1"> شخصی </span>
                                    <small> 15 گیگابایت فضا و 5 عضو تیم دریافت کنید. </small>
                                  </span>
                              ...
                              <div class="form-check custom-option custom-option-icon">
                                <label class="form-check-label custom-option-content" for="basicPlanMain3">
                                  <span class="custom-option-body">
                                    ...
                                    <span class="custom-option-title mt-2 mb-1"> ویژه </span>
                                    <small> 25 گیگابایت فضا و 15 عضو تیم دریافت کنید. </small>
                                  </span>
                        ...
                        <div class="col-12">
                          <div class="form-check">
                            ...
                            <label class="form-check-label" for="formValidationCheckbox">موافقت با قوانین و مقررات</label>
                          </div>
                        </div>
                        <div class="col-12">
                          <button type="submit" name="submitButton" class="btn btn-primary">ثبت</button>
                        </div>
                      </form>
                    </div>
                  </div>
