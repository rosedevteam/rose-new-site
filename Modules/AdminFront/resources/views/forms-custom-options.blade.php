...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>گزینه‌های سفارشی - فرم‌ها | فرست - قالب مدیریت بوت‌استرپ</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">فرم‌ها /</span> گزینه‌های سفارشی
              </h4>
              ...
              <div class="row gy-4">
                ...
                <div class="col-xl-6">
                  <div class="card">
                    <h5 class="card-header heading-color">رادیوهای پایه</h5>
                    <div class="card-body">
                      <div class="row">
                          ...
                          <div class="form-check custom-option custom-option-basic">
                            <label class="form-check-label custom-option-content" for="customRadioTemp1">
                              ...
                              <span class="custom-option-header">
                                <span class="h6 mb-0">پایه</span>
                                <span>رایگان</span>
                              </span>
                              <span class="custom-option-body">
                                <small>دریافت 1 پروژه با 1 عضو تیم.</small>
                              </span>
                            </label>
                          </div>
                        </div>
                        <div class="col-md">
                          <div class="form-check custom-option custom-option-basic">
                            <label class="form-check-label custom-option-content" for="customRadioTemp2">
                              ...
                              <span class="custom-option-header">
                                <span class="h6 mb-0">ویژه</span>
                                <span>5,000 تومان</span>
                              </span>
                              <span class="custom-option-body">
                                <small>دریافت 5 پروژه با 5 عضو تیم.</small>
                              </span>
                            </label>
                          </div>
                        </div>
                ...
                <div class="col-xl-6">
                  <div class="card">
                    <h5 class="card-header heading-color">چک‌باکس‌های پایه</h5>
                    <div class="card-body">
                      <div class="row">
                        <div class="col-md mb-md-0 mb-2">
                          <div class="form-check custom-option custom-option-basic">
                            <label class="form-check-label custom-option-content" for="customCheckTemp3">
                              ...
                              <span class="custom-option-header">
                                <span class="h6 mb-0">تخفیف</span>
                                <span>20%</span>
                              </span>
                              <span class="custom-option-body">
                                <small class="option-text">لورم ایپسوم متن ساختگی با تولید سادگی</small>
                              </span>
                            </label>
                          </div>
                        </div>
                        <div class="col-md">
                          <div class="form-check custom-option custom-option-basic">
                            <label class="form-check-label custom-option-content" for="customCheckTemp4">
                              ...
                              <span class="custom-option-header">
                                <span class="h6 mb-0">به‌روزرسانی‌ها</span>
                                <span>رایگان</span>
                              </span>
                              <span class="custom-option-body">
                                <small>لورم ایپسوم متن ساختگی با تولید سادگی</small>
                              </span>
                            </label>
                          </div>
                        </div>
                ...
                <div class="col-xl-6">
                  <div class="card">
                    <h5 class="card-header heading-color">گزینه‌های رادیویی سفارشی با آیکن</h5>
                    <div class="card-body">
                      <div class="row">
                        <div class="col-md mb-md-0 mb-2">
                          <div class="form-check custom-option custom-option-icon">
                            <label class="form-check-label custom-option-content" for="customRadioIcon1">
                              <span class="custom-option-body">
                                ...
                                <span class="custom-option-title my-2">برای شروع</span>
                                <small class="d-block"> لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت</small>
                              </span>
                          ...
                          <div class="form-check custom-option custom-option-icon">
                            <label class="form-check-label custom-option-content" for="customRadioIcon2">
                              <span class="custom-option-body">
                                ...
                                <span class="custom-option-title my-2"> شخصی </span>
                                <small class="d-block"> لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت </small>
                              </span>
                          ...
                          <div class="form-check custom-option custom-option-icon">
                            <label class="form-check-label custom-option-content" for="customRadioIcon3">
                              <span class="custom-option-body">
                                ...
                                <span class="custom-option-title my-2"> سازمان </span>
                                <small class="d-block">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت</small>
                              </span>
                ...
                <div class="col-xl-6">
                  <div class="card">
                    <h5 class="card-header heading-color">گزینه‌های چک‌باکس سفارشی با آیکن</h5>
                    <div class="card-body">
                      <div class="row">
                        <div class="col-md mb-md-0 mb-2">
                          <div class="form-check custom-option custom-option-icon">
                            <label class="form-check-label custom-option-content" for="customCheckboxIcon1">
                              <span class="custom-option-body">
                                ...
                                <span class="custom-option-title my-2"> پشتیبان گیری </span>
                                <small class="d-block"> لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت </small>
                              </span>
                          ...
                          <div class="form-check custom-option custom-option-icon">
                            <label class="form-check-label custom-option-content" for="customCheckboxIcon2">
                              <span class="custom-option-body">
                                ...
                                <span class="custom-option-title my-2"> رمزنگاری </span>
                                <small class="d-block"> لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت </small>
                              </span>
                          ...
                          <div class="form-check custom-option custom-option-icon">
                            <label class="form-check-label custom-option-content" for="customCheckboxIcon3">
                              <span class="custom-option-body">
                                ...
                                <span class="custom-option-title my-2"> قفل سایت </span>
                                <small class="d-block"> لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت </small>
                              </span>
                ...
                <div class="col-xl-6">
                  <div class="card">
                    <h5 class="card-header heading-color">گزینه‌های رادیویی سفارشی با آیکن‌های SVG</h5>
                    <div class="card-body">
                      <div class="row">
                        <div class="col-md mb-md-0 mb-2">
                          <div class="form-check custom-option custom-option-icon">
                            <label class="form-check-label custom-option-content" for="customRadioSvg1">
                              <span class="custom-option-body">
                                ...
                                <span class="custom-option-title mb-2"> طراحی </span>
                                <small class="d-block">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت</small>
                              </span>
                          ...
                          <div class="form-check custom-option custom-option-icon">
                            <label class="form-check-label custom-option-content" for="customRadioSvg2">
                              <span class="custom-option-body">
                                ...
                                <span class="custom-option-title mb-2"> توسعه </span>
                                <small class="d-block"> لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت </small>
                              </span>
                          ...
                          <div class="form-check custom-option custom-option-icon">
                            <label class="form-check-label custom-option-content" for="customRadioSvg3">
                              <span class="custom-option-body">
                                ...
                                <span class="custom-option-title mb-2"> برنامه بومی </span>
                                <small class="d-block">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت</small>
                              </span>
                ...
                <div class="col-xl-6">
                  <div class="card">
                    <h5 class="card-header heading-color">گزینه‌های چک‌باکس سفارشی با آیکن‌های SVG</h5>
                    <div class="card-body">
                      <div class="row">
                        <div class="col-md mb-md-0 mb-2">
                          <div class="form-check custom-option custom-option-icon">
                            <label class="form-check-label custom-option-content" for="customCheckboxSvg1">
                              <span class="custom-option-body">
                                <img src="../../assets/img/icons/unicons/chart.png" class="w-px-40 mb-2" alt="chart">
                                <span class="custom-option-title mb-2"> طراحی </span>
                                <small class="d-block">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت</small>
                              </span>
                        ...
                        <div class="col-md mb-md-0 mb-2">
                          <div class="form-check custom-option custom-option-icon">
                            <label class="form-check-label custom-option-content" for="customCheckboxSvg2">
                              <span class="custom-option-body">
                                <img src="../../assets/img/icons/unicons/cc-warning.png" class="w-px-40 mb-2" alt="cc-warning">
                                <span class="custom-option-title mb-2"> توسعه </span>
                                <small class="d-block">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت</small>
                              </span>
                ...
                <div class="col-xl-6">
                  <div class="card">
                    <h5 class="card-header heading-color">گزینه‌های رادیویی سفارشی با تصویر</h5>
                    <div class="card-body">
                      <div class="row">
                        <div class="col-md mb-md-0 mb-2">
                ...
                <div class="col-xl-6">
                  <div class="card">
                    <h5 class="card-header heading-color">گزینه‌های چک‌باکس سفارشی با تصویر</h5>
                    <div class="card-body">
                      <div class="row">
                        <div class="col-md mb-md-0 mb-2">
