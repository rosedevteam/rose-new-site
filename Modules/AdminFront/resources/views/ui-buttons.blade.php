...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>دکمه‌ها - المان‌های رابط کاربری | فرست - قالب مدیریت بوت‌استرپ</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">المان‌های رابط کاربری /</span>
                دکمه‌ها
              </h4>
              ...
              <div class="row">
                ...
                <div class="col-12">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">دکمه‌های پایه</h5>
                    <div class="card-body">
                      <small class="text-light fw-semibold">پیش‌فرض</small>
                    ...
                    <hr class="m-0">
                    <div class="card-body">
                      <small class="text-light fw-semibold">گرد</small>
                      <div class="demo-inline-spacing">
                        <button type="button" class="btn rounded-pill btn-primary">اولیه</button>
                        <button type="button" class="btn rounded-pill btn-secondary">ثانویه</button>
                        <button type="button" class="btn rounded-pill btn-success">موفقیت</button>
                        <button type="button" class="btn rounded-pill btn-danger">اخطار</button>
                        <button type="button" class="btn rounded-pill btn-warning">هشدار</button>
                        <button type="button" class="btn rounded-pill btn-info">اطلاعات</button>
                        <button type="button" class="btn rounded-pill btn-dark">تیره</button>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-12">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">دکمه‌های برچسب</h5>
                    <div class="card-body">
                      <small class="text-light fw-semibold">پیش‌فرض</small>
                      <div class="demo-inline-spacing">
                        <button type="button" class="btn btn-label-primary">اولیه</button>
                        <button type="button" class="btn btn-label-secondary">ثانویه</button>
                        <button type="button" class="btn btn-label-success">موفقیت</button>
                        <button type="button" class="btn btn-label-danger">اخطار</button>
                        <button type="button" class="btn btn-label-warning">هشدار</button>
                        <button type="button" class="btn btn-label-info">اطلاعات</button>
                        <button type="button" class="btn btn-label-dark">تیره</button>
                      </div>
                    </div>
                    <hr class="m-0">
                    <div class="card-body">
                      <small class="text-light fw-semibold">گرد</small>
                      <div class="demo-inline-spacing">
                        <button type="button" class="btn rounded-pill btn-label-primary">اولیه</button>
                        <button type="button" class="btn rounded-pill btn-label-secondary">ثانویه</button>
                        <button type="button" class="btn rounded-pill btn-label-success">موفقیت</button>
                        <button type="button" class="btn rounded-pill btn-label-danger">اخطار</button>
                        <button type="button" class="btn rounded-pill btn-label-warning">هشدار</button>
                        <button type="button" class="btn rounded-pill btn-label-info">اطلاعات</button>
                        <button type="button" class="btn rounded-pill btn-label-dark">تیره</button>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-12">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">دکمه های دور خط دار</h5>
                    <div class="card-body">
                      <small class="text-light fw-semibold">پیش‌فرض</small>
                      <div class="demo-inline-spacing">
                        ...
                        <button type="button" class="btn btn-outline-danger">اخطار</button>
                    ...
                    <div class="card-body">
                      <small class="text-light fw-semibold">گرد</small>
                      <div class="demo-inline-spacing">
                        <button type="button" class="btn rounded-pill btn-outline-primary">اولیه</button>
                        <button type="button" class="btn rounded-pill btn-outline-secondary">ثانویه</button>
                        <button type="button" class="btn rounded-pill btn-outline-success">موفقیت</button>
                        <button type="button" class="btn rounded-pill btn-outline-danger">اخطار</button>
                        <button type="button" class="btn rounded-pill btn-outline-warning">هشدار</button>
                        <button type="button" class="btn rounded-pill btn-outline-info">اطلاعات</button>
                        <button type="button" class="btn rounded-pill btn-outline-dark">تیره</button>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-12">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">دکمه دارای آیکن</h5>
                    <div class="card-body">
                      <div class="row gy-3">
                        <div class="col-lg-4">
                          <small class="text-light fw-semibold">پایه</small>
                          <div class="demo-inline-spacing">
                            <button type="button" class="btn btn-primary">
                              <span class="tf-icons bx bx-pie-chart-alt me-1"></span>اولیه
                            </button>
                            <button type="button" class="btn btn-secondary">
                              <span class="tf-icons bx bx-bell me-1"></span>ثانویه
                            </button>
                          </div>
                          <div class="demo-inline-spacing">
                        ...
                        <div class="col-lg-4">
                          <small class="text-light fw-semibold">برچسب</small>
                          <div class="demo-inline-spacing">
                        ...
                        <div class="col-lg-4">
                          <small class="text-light fw-semibold">دورخط دار</small>
                          <div class="demo-inline-spacing">
                ...
                <div class="col-12">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">دکمه‌های اجتماعی</h5>
                    <div class="card-body">
                      <div class="row gy-3">
                        <div class="col-lg-4">
                          <small class="text-light fw-semibold">پایه</small>
                          <div class="demo-inline-spacing">
                            <button type="button" class="btn btn-facebook">
                              <i class="tf-icons bx bxl-facebook me-1"></i>فیسبوک
                            </button>
                            <button type="button" class="btn btn-twitter">
                              <i class="tf-icons bx bxl-twitter me-1"></i>توییتر
                            </button>
                          </div>
                          <div class="demo-inline-spacing">
                            <button type="button" class="btn rounded-pill btn-google-plus">
                              <i class="tf-icons bx bxl-google-plus me-1"></i>گوگل+
                            </button>
                            <button type="button" class="btn rounded-pill btn-instagram">
                              <i class="tf-icons bx bxl-instagram me-1"></i>اینستاگرام
                            </button>
                          </div>
                        </div>
                        <div class="col-lg-4">
                          ...
                          <div class="demo-inline-spacing">
                            <button type="button" class="btn btn-label-linkedin">
                              <i class="tf-icons bx bxl-linkedin me-1"></i>لینکدین
                            </button>
                            <button type="button" class="btn btn-label-github">
                              <i class="tf-icons bx bxl-github me-1"></i>گیت هاب
                            </button>
                          </div>
                          <div class="demo-inline-spacing">
                            <button type="button" class="btn rounded-pill btn-label-pinterest">
                              <i class="tf-icons bx bxl-pinterest me-1"></i>پینترست
                            </button>
                            <button type="button" class="btn rounded-pill btn-label-slack">
                              <i class="tf-icons bx bxl-slack me-1"></i>اسلک
                            </button>
                          </div>
                        </div>
                        <div class="col-lg-4">
                          ...
                          <div class="demo-inline-spacing">
                            <button type="button" class="btn btn-outline-dribbble">
                              <i class="tf-icons bx bxl-dribbble me-1"></i>دریبل
                            </button>
                            <button type="button" class="btn btn-outline-reddit">
                              <i class="tf-icons bx bxl-reddit me-1"></i>لورم ایپسوم
                            </button>
                          </div>
                          <div class="demo-inline-spacing">
                            <button type="button" class="btn rounded-pill btn-outline-youtube">
                              <i class="tf-icons bx bxl-youtube me-1"></i>یوتیوب
                            </button>
                    ...
                    <div class="card-body">
                      <div class="row gy-3">
                        <div class="col-lg-4">
                          <small class="text-light fw-semibold">آیکن‌های پایه</small>
                          <div class="demo-inline-spacing">
                        ...
                        <div class="col-lg-4">
                          <small class="text-light fw-semibold">آیکن‌های برچسب</small>
                          <div class="demo-inline-spacing">
                ...
                <div class="col-12">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">گزینه‌های دکمه</h5>
                    <div class="card-body">
                      <small class="text-light fw-semibold">اندازه‌ها</small>
                      <div class="demo-inline-spacing">
                        <button type="button" class="btn btn-xl btn-primary">دکمه xl</button>
                        <button type="button" class="btn btn-lg btn-primary">دکمه lg</button>
                        <button type="button" class="btn btn-primary">دکمه</button>
                        <button type="button" class="btn btn-sm btn-primary">دکمه sm</button>
                        <button type="button" class="btn btn-xs btn-primary">دکمه xs</button>
                      </div>
                    </div>
                    <hr class="m-0">
                    <div class="card-body">
                      <small class="text-light fw-semibold">وضعیت دکمه‌ها</small>
                      <div class="demo-inline-spacing">
                        <button type="button" class="btn btn-primary">معمولی</button>
                        <button type="button" class="btn btn-primary active">فعال</button>
                        <button type="button" class="btn btn-primary" disabled>غیرفعال</button>
                      </div>
                    </div>
                    <hr class="m-0">
                    <div class="card-body">
                      <small class="text-light fw-semibold">دکمه‌های بلوکی</small>
                      <div class="row mt-3">
                        <div class="d-grid gap-2 col-lg-6 mx-auto">
                          <button class="btn btn-primary btn-lg" type="button">دکمه</button>
                          <button class="btn btn-secondary btn-lg" type="button">دکمه</button>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-12">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">افزونه‌های دکمه‌ها</h5>
                    <div class="card-body">
                      <div class="row gy-3">
                        <div class="col-xl-3">
                          <div class="text-light small fw-semibold">تغییر وضعیت ها</div>
                          <div class="demo-vertical-spacing">
                            ...
                            <button type="button" class="btn btn-primary d-block" disabled data-bs-toggle="button">
                              دکمه تغییر وضعیت غیرفعال
                            </button>
                          </div>
                        </div>
                        <div class="col-xl-3">
                          <div class="text-light small fw-semibold">دکمه‌های تغییر وضعیت چک‌باکس</div>
                          <div class="demo-vertical-spacing">
                            <div class="d-block">
                              <input type="checkbox" class="btn-check" id="btn-check">
                              <label class="btn btn-primary" for="btn-check">تغییر وضعیت تکی</label>
                            </div>
                            <div class="d-block">
                              <input type="checkbox" class="btn-check" id="btn-check-2" checked>
                              <label class="btn btn-primary" for="btn-check-2">انتخاب شده</label>
                            </div>
                            <div class="d-block">
                              <input type="checkbox" class="btn-check" id="btn-check-3" checked>
                              <label class="btn btn-primary" for="btn-check-3">انتخاب شده</label>
                            </div>
                          </div>
                        </div>
                        <div class="col-xl-6">
                          <div class="text-light small fw-semibold">چک‌باکس و رادیو</div>
                          ...
                          <div class="demo-vertical-spacing">
                            ...
                            <div class="btn-group" role="group" aria-label="Basic checkbox toggle button group">
                              ...
                              <label class="btn btn-outline-primary" for="btncheck1">چک‌باکس 1 (از قبل انتخاب شده)</label>
                ...
                <div class="col-12">
                  <div class="card">
                    <h5 class="card-header heading-color">گروه دکمه</h5>
                    <div class="card-body">
                      <div class="row g-4">
                        ...
                        <div class="col-md-6 col-lg-4">
                          ...
                          <div class="mt-3">
                            <div class="btn-group" role="group" aria-label="Basic example">
                              <button type="button" class="btn btn-label-secondary">راست</button>
                              <button type="button" class="btn btn-label-secondary">وسط</button>
                              <button type="button" class="btn btn-label-secondary">چپ</button>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6 col-lg-4">
                    ...
                    <div class="card-body">
                      <div class="row">
                        <div class="col-xl-6 mb-xl-0 mb-3">
                          <small class="text-light fw-semibold">نوار ابزار دکمه</small>
                        ...
                        <div class="col-xl-6">
                          <small class="text-light fw-semibold">دکمه‌های تودرتو</small>
                          <div class="mt-3">
                            <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                              ...
                              <div class="btn-group" role="group">
                                ...
                                <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                  <a class="dropdown-item" href="javascript:void(0);">لینک منوی کشویی</a>
                                  <a class="dropdown-item" href="javascript:void(0);">لینک منوی کشویی</a>
                                </div>
                              </div>
                            </div>
