          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">جدول‌های داده /</span> افزودنی‌ها
              </h4>

              <!-- Scrollable -->
              <div class="card">
                <h5 class="card-header heading-color">جدول قابل اسکرول</h5>
              ...
              <!-- Fixed Header -->
              <div class="card">
                <h5 class="card-header heading-color">سرتیتر ثابت</h5>
              ...
              <!-- Fixed Columns -->
              <div class="card">
                <h5 class="card-header heading-color">ستون‌های ثابت</h5>
                <div class="card-datatable text-nowrap">
              ...
              <!-- Select -->
              <div class="card">
                <h5 class="card-header heading-color">انتخاب</h5>
