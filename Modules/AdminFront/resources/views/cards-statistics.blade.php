...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>کارت‌های آماری - المان‌های رابط کاربری | فرست - قالب مدیریت بوت‌استرپ</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">المان‌های رابط کاربری /</span> کارت‌های آماری
              </h4>
              <!-- Cards with few info -->
              <div class="row">
              ...
              <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-4">
                  <div class="card h-100">
                    <div class="card-header">
                      <h5 class="card-title mb-0">گزارش سود</h5>
                    </div>
                  ...
                  <div class="card h-100">
                    ...
                    <div class="card-body d-flex align-items-end justify-content-between">
                      <div class="d-flex align-items-end justify-content-between align-items-center gap-3 w-100">
                        <div class="d-flex align-content-center">
                          <div class="chart-report mt-n1" data-color="primary" data-series="65"></div>
                          <div class="chart-info ms-2">
                            <h5 class="mb-1 lh-inherit">28k تومان</h5>
                            <small class="text-muted">1400</small>
                          </div>
                        </div>
                        <div class="d-flex align-content-center">
                          <div class="chart-report mt-n1" data-color="success" data-series="85"></div>
                          <div class="chart-info ms-2">
                            <h5 class="mb-1 lh-inherit">82k تومان</h5>
                            <small class="text-muted">1401</small>
                          </div>
                        </div>
                      </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-4">
                  <div class="card h-100">
                    <div class="card-header pb-2">
                      <h5 class="card-title mb-0">بازدیدها</h5>
                    </div>
                    <div class="card-body pb-2">
                      <div class="d-flex justify-content-between align-items-center gap-3">
                        <div>
                ...
                <div class="col-xl-2 col-lg-2 col-md-4 col-sm-4 col-6 mb-4">
                  <div class="card">
                    <div class="card-body text-center">
                      ...
                      <span class="d-block mb-1 text-nowrap">پست‌های جدید</span>
                      <h2 class="mb-n3">48</h2>
                    </div>
                  </div>
                </div>
                <div class="col-xl-2 col-lg-2 col-md-4 col-sm-4 col-6 mb-4">
                  <div class="card">
                    <div class="card-body text-center">
                      ...
                      <span class="d-block mb-1 text-nowrap">فایل‌های پیوست</span>
                      <h2 class="mb-n3">17</h2>
                    </div>
                  </div>
                </div>
                <div class="col-xl-2 col-lg-2 col-md-4 col-sm-4 col-6 mb-4">
                  <div class="card">
                    <div class="card-body text-center">
                      ...
                      <span class="d-block mb-1 text-nowrap">دیدگاه‌ها</span>
                      <h2 class="mb-n3">29</h2>
                    </div>
                  </div>
                </div>
                <div class="col-xl-2 col-lg-2 col-md-4 col-sm-4 col-6 mb-4">
                  <div class="card">
                    <div class="card-body text-center">
                      ...
                      <span class="d-block mb-1 text-nowrap">فروش‌ها</span>
                      <h2 class="mb-n3">72</h2>
                    </div>
                  </div>
                </div>
                <div class="col-xl-2 col-lg-2 col-md-4 col-sm-4 col-6 mb-4">
                  <div class="card">
                    <div class="card-body text-center">
                      ...
                      <span class="d-block mb-1 text-nowrap">خرید</span>
                ...
                <div class="col-xl-2 col-lg-2 col-md-4 col-sm-4 col-6 mb-4">
                  <div class="card">
                    <div class="card-body text-center">
                      ...
                      <span class="d-block mb-1 text-nowrap">سفارش</span>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 mb-4 mb-lg-0">
                  <div class="card">
                    <div class="card-header d-flex align-items-start justify-content-between">
                      <div class="m-0 me-2">
                        <h5 class="card-title mb-0">ثبت نام ها</h5>
                        <small class="text-muted primary-font">ورود جدید در یک روز</small>
                      </div>
                      <div class="d-flex flex-row align-items-center gap-2 primary-font">
                  ...
                  <div class="card">
                    <div class="card-header d-flex align-items-start justify-content-between">
                      <div class="m-0 me-2">
                        ...
                        <small class="text-muted primary-font">مخارج در یک روز</small>
                      </div>
                      <div class="d-flex flex-row align-items-center gap-2 primary-font">
                  ...
                  <div class="card">
                    <div class="card-header d-flex align-items-start justify-content-between">
                      <div class="m-0 me-2">
                        ...
                        <small class="text-muted primary-font">تعداد کاربران در یک روز</small>
                      </div>
                      <div class="d-flex flex-row align-items-center gap-2 primary-font">
