          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">تنظیمات حساب / </span> اتصالات
              </h4>
              ...
              <div class="row">
                <div class="col-md-12">
                  <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    ...
                    <li class="nav-item">
                      <a class="nav-link active my-1 my-md-0" href="javascript:void(0);"><i class="bx bx-link-alt me-1"></i> اتصالات</a>
                    </li>
                  </ul>
                  <div class="row">
                    <div class="col-md-6 col-12 mb-md-0 mb-4">
                      <div class="card">
                        <div class="card-header"><h5 class="mb-0">حساب های متصل</h5></div>
                        <div class="card-body">
                          <p>محتوا را از حساب های متصل بر روی سایت خود نمایش دهید.</p>
                          <!-- Connections -->
                          <div class="d-flex align-items-center mb-3">
                            ...
                            <div class="flex-grow-1 row">
                              <div class="col-9 mb-sm-0 mb-2">
                                <h6 class="mb-0">گوگل</h6>
                                <span class="lh-1-85">تقویم و مخاطبین</span>
                              </div>
                              <div class="col-3 text-end">
                                <label class="switch me-0 mt-1">
                          ...
                          <div class="d-flex align-items-center mb-3">
                            ...
                            <div class="flex-grow-1 row">
                              <div class="col-9 mb-sm-0 mb-2">
                                <h6 class="mb-0">اسلک</h6>
                                <span class="lh-1-85">ارتباطات</span>
                              </div>
                              <div class="col-3 text-end">
                                <label class="switch me-0 mt-1">
                          ...
                          <div class="d-flex align-items-center mb-3">
                            ...
                            <div class="flex-grow-1 row">
                              <div class="col-9 mb-sm-0 mb-2">
                                <h6 class="mb-0">گیت هاب</h6>
                                <span class="lh-1-85">مخازن گیت خود را مدیریت کنید</span>
                              </div>
                              <div class="col-3 text-end">
                                <label class="switch me-0 mt-1">
                                  <input type="checkbox" class="switch-input" checked>
                          ...
                          <div class="d-flex align-items-center mb-3">
                            ...
                            <div class="flex-grow-1 row">
                              <div class="col-9 mb-sm-0 mb-2">
                                <h6 class="mb-0">میل چیمپ</h6>
                                <span class="lh-1-85">خدمات بازاریابی ایمیل</span>
                              </div>
                              <div class="col-3 text-end">
                                <label class="switch me-0 mt-1">
                                  <input type="checkbox" class="switch-input" checked>
                    ...
                    <div class="col-md-6 col-12">
                      <div class="card">
                        <div class="card-header"><h5 class="mb-0">حساب های اجتماعی</h5></div>
                        <div class="card-body">
                          <p>محتوا را از حساب های اجتماعی بر روی سایت خود نمایش دهید</p>
                          <!-- Social Accounts -->
                          <div class="d-flex align-items-center mb-3">
                            <div class="flex-shrink-0">
                            ...
                            <div class="flex-grow-1 row">
                              <div class="col-8 col-sm-7 mb-sm-0 mb-2">
                                ...
                                <span class="lh-1-85">متصل نشده</span>
                              </div>
                              <div class="col-4 col-sm-5 text-end">
                                <button type="button" class="mt-1 btn btn-icon btn-label-secondary">
                          ...
                          <div class="d-flex align-items-center mb-3">
                            ...
                            <div class="flex-grow-1 row">
                              <div class="col-8 col-sm-7 mb-sm-0 mb-2">
                                ...
                                <a class="lh-1-85" href="https://twitter.com/pixinvents" target="_blank">@PIXINVENT</a>
                              </div>
                              <div class="col-4 col-sm-5 text-end">
                                <button type="button" class="mt-1 btn btn-icon btn-label-danger">
                          ...
                          <div class="d-flex align-items-center mb-3">
                            ...
                            <div class="flex-grow-1 row">
                              <div class="col-8 col-sm-7 mb-sm-0 mb-2">
                                ...
                                <a class="lh-1-85" href="https://www.instagram.com/pixinvents/" target="_blank">@PIXINVENT</a>
                              </div>
                              <div class="col-4 col-sm-5 text-end">
                                <button type="button" class="mt-1 btn btn-icon btn-label-danger">
                                  <i class="bx bx-trash-alt"></i>
