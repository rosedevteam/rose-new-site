...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>دسته‌بندی‌های مرکز راهنمایی - صفحات | فرست - قالب مدیریت بوت‌استرپ</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">مرکز راهنمایی /</span> دسته‌بندی‌ها
              </h4>

              <div class="row">
                <!-- Categories -->
                <div class="col-xl-3 col-lg-4 col-md-4 mb-lg-0 mb-4">
                  <h5>تجارت الکترونیک</h5>
                  <div class="nav-align-left">
                    <ul class="nav nav-pills w-100 gap-1">
                      <li class="nav-item">
                        <button class="nav-link" data-bs-target="javascript:void(0);">راه اندازی</button>
                      </li>
                      <li class="nav-item">
                        <button class="nav-link active" data-bs-target="javascript:void(0);">آیتم‌ها و دسته‌بندی‌ها</button>
                      </li>
                      <li class="nav-item">
                        <button class="nav-link" data-bs-target="javascript:void(0);">پرداخت‌ها و تسویه حساب</button>
                      </li>
                      <li class="nav-item">
                        <button class="nav-link" data-bs-target="javascript:void(0);">تکمیل</button>
                      </li>
                      <li class="nav-item">
                        <button class="nav-link" data-bs-target="javascript:void(0);">مدیریت سفارشات</button>
                      </li>
                      <li class="nav-item">
                        <button class="nav-link" data-bs-target="javascript:void(0);">کوپن ها و سایر هدایا</button>
                      </li>
                      <li class="nav-item">
                        <button class="nav-link" data-bs-target="javascript:void(0);">ایمیل‌های فروشگاه</button>
                      </li>
                      <li class="nav-item">
                        <button class="nav-link" data-bs-target="javascript:void(0);">مالیات ها</button>
                      </li>
                    </ul>
                  </div>
                </div>
                    ...
                    <div class="card-body">
                      ...
                      <ul class="list-unstyled my-4">
                        ...
                        <li class="mb-3">
                          <a href="./pages-help-center-article.html" class="d-flex fw-semibold">
                            <i class="bx bx-chevron-right scaleX-n1-rtl text-muted bx-sm me-1"></i>
                            تغییر تم و فونت برنامه
                          </a>
                        </li>
                        <li class="mb-3">
                          <a href="./pages-help-center-article.html" class="d-flex fw-semibold">
                            <i class="bx bx-chevron-right scaleX-n1-rtl text-muted bx-sm me-1"></i>
                            محاسبه و پیگیری هزینه های مواد
                          </a>
                        </li>
                        <li class="mb-3">
                          <a href="./pages-help-center-article.html" class="d-flex fw-semibold">
                            <i class="bx bx-chevron-right scaleX-n1-rtl text-muted bx-sm me-1"></i>
                            ردیابی تجارت الکترونیک با google analytics
                          </a>
                        </li>
                        <li>
                          <a href="./pages-help-center-article.html" class="d-flex fw-semibold">
                            <i class="bx bx-chevron-right scaleX-n1-rtl text-muted bx-sm me-1"></i>
                            چند تا سایت میتونم داشته باشم؟ چگونه یکی را حذف کنم؟
                          </a>
                        </li>
                      </ul>
                      ...
                      <a class="btn btn-label-primary" href="./pages-help-center-landing.html">
                        ...
                        <span>بازگشت به مرکز راهنمایی</span>
                      </a>
                    </div>
                  </div>
                </div>
