...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>جدول‌ها - جدول‌های پایه | فرست - قالب مدیریت بوت‌استرپ</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">جدول‌ها /</span> جدول‌های پایه
              </h4>
                ...
                <div class="table-responsive text-nowrap">
                  <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                      <tr>
                        <td><i class="align-middle fab fa-angular fa-lg text-danger me-3"></i> <strong>پروژه انگولار</strong></td>
                        <td>استیو جابز</td>
                        <td>
                      ...
                      <tr>
                        <td>
                          <i class="align-middle fab fa-bootstrap fa-lg text-primary me-3"></i> <strong>پروژه بوت‌استرپ</strong>
                        </td>
                        <td>بیل گیتس</td>
                        <td>
                          <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
              ...
              <div class="card">
                <h5 class="card-header heading-color">جدول تاریک</h5>
                <div class="table-responsive text-nowrap">
              ...
              <div class="card">
                <h5 class="card-header heading-color">جدول با سرتیتر تیره</h5>
                <div class="table-responsive text-nowrap">
                  <table class="table">
              ...
              <div class="card">
                <h5 class="card-header heading-color">جدول با سرتیتر روشن</h5>
                <div class="table-responsive text-nowrap">
                  <table class="table">
              ...
              <div class="card">
                <h5 class="card-header heading-color">جدول با هدر و فوتر</h5>
                <div class="table-responsive text-nowrap">
                  <table class="table">
                    <thead>
                      <tr>
                    ...
                    <tfoot>
                      <tr>
                        <th class="rounded-start-bottom">پروژه</th>
                        <th>مشتری</th>
                        <th>کاربران</th>
                        <th>وضعیت</th>
                        <th class="rounded-end-bottom">عمل‌ها</th>
                      </tr>
                    </tfoot>
                  </table>
                </div>
              ...
              <div class="card">
                <h5 class="card-header heading-color">جدول با زیرنویس</h5>
                <div class="table-responsive text-nowrap">
                  <table class="table">
                    <caption class="ms-4">
                      لیست پروژه‌ها
              ...
              <!-- Striped Rows -->
              <div class="card">
                <h5 class="card-header heading-color">سطرهای راه راه</h5>
                <div class="table-responsive text-nowrap">
              ...
              <!-- Bordered Table -->
              <div class="card">
                <h5 class="card-header heading-color">جدول دور خط دار</h5>
                <div class="card-body">
                  <div class="table-responsive text-nowrap">
                    <table class="table table-bordered">
                      ...
                      <tbody class="table-border-bottom-0">
                        <tr>
                          <td>
                            <i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>پروژه انگولار</strong>
                          </td>
                          <td>استیو جابز</td>
                          <td>
                            <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                        ...
                        <tr>
                          <td><i class="fab fa-react fa-lg text-info me-3"></i> <strong>پروژه React</strong></td>
                          <td>بری الن</td>
                          <td>
                            <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                              <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" class="avatar avatar-xs pull-up" title="تونی استارک">
                        ...
                        <tr>
                          <td><i class="fab fa-vuejs fa-lg text-success me-3"></i> <strong>پروژه VueJs</strong></td>
                          <td>تونی استارک</td>
                          <td>
                            <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                              <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" class="avatar avatar-xs pull-up" title="تونی استارک">
                        ...
                        <tr>
                          <td>
                            <i class="fab fa-bootstrap fa-lg text-primary me-3"></i> <strong>پروژه بوت‌استرپ</strong>
                          </td>
                          <td>بیل گیتس</td>
                          <td>
                            <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
              ...
              <!-- Borderless Table -->
              <div class="card">
                <h5 class="card-header heading-color">جدول بدون خط</h5>
                <div class="table-responsive text-nowrap">
              ...
              <div class="card">
                <h5 class="card-header heading-color">سطر های قابل Hover</h5>
                <div class="table-responsive text-nowrap">
              ...
              <div class="card">
                <h5 class="card-header heading-color">جدول کوچک</h5>
                <div class="table-responsive text-nowrap">
              ...
              <div class="card">
                <h5 class="card-header heading-color">کلاس های کاربردی</h5>
                <div class="table-responsive text-nowrap">
                  <table class="table">
                    <thead>
                      <tr>
                    ...
                    <tbody class="table-border-bottom-0">
                      <tr class="table-default">
                        <td><i class="fab fa-sketch fa-lg text-warning me-3"></i> <strong>پروژه Sketch</strong></td>
                        <td>دیوید بکهام</td>
                        <td>
                          <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                            <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" class="avatar avatar-xs pull-up" title="تونی استارک">
                      ...
                      <tr class="table-warning">
                        <td><i class="fab fa-react fa-lg text-info me-3"></i> <strong>React سفارشی</strong></td>
                        <td>استیو راجرز</td>
                        <td>
                          <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                            <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" class="avatar avatar-xs pull-up" title="تونی استارک">
                      ...
                      <tr class="table-info">
                        <td>
                          <i class="fab fa-bootstrap fa-lg text-primary me-3"></i> <strong>جدیدترین بوت‌استرپ</strong>
                        </td>
                        <td>پیتر پارکر</td>
                        <td>
                          <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                      ...
                      <tr class="table-light">
                        <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>UI انگولار</strong></td>
                        <td>بروس وین</td>
                        <td>
                          <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                            <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" class="avatar avatar-xs pull-up" title="تونی استارک">
                      ...
                      <tr class="table-dark">
                        <td class="rounded-start-bottom">
                          <i class="fab fa-bootstrap fa-lg text-primary me-3"></i> <strong>رابط کاربری بوت‌استرپ</strong>
                        </td>
                        <td>بیل گیتس</td>
                        <td>
                          <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
              ...
              <!-- Table within card -->
              <h5 class="mb-4">جدول بدون کارت</h5>
              <div class="table-responsive text-nowrap">
              ...
              <!-- Responsive Table -->
              <div class="card">
                <h5 class="card-header heading-color">جدول واکنشگرا</h5>
                <div class="table-responsive text-nowrap">
                  <table class="table">
                    <thead>
