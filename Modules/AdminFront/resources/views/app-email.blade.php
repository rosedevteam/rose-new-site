...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>ایمیل - برنامه‌ها | فرست - قالب مدیریت بوت‌استرپ</title>
                    ...
                    <div class="col app-email-sidebar border-end flex-grow-0" id="app-email-sidebar">
                      ...
                      <div class="email-filters py-2">
                        ...
                        <ul class="email-filter-folders list-unstyled mb-4">
                          <li class="active d-flex mb-2 justify-content-between" data-target="inbox">
                          ...
                          <li class="d-flex mb-2" data-target="sent">
                            <a href="javascript:void(0);" class="d-flex flex-wrap align-items-center">
                              <i class="bx bx-paper-plane"></i>
                              <span class="align-middle ms-2">ارسال شده</span>
                            </a>
                          </li>
                          <li class="d-flex mb-2" data-target="draft">
                            <a href="javascript:void(0);" class="d-flex flex-wrap align-items-center">
                              <i class="bx bx-pencil"></i>
                              <span class="align-middle ms-2">پیش‌نویس</span>
                            </a>
                          </li>
                          <li class="d-flex mb-2 justify-content-between" data-target="starred">
                            <a href="javascript:void(0);" class="d-flex flex-wrap align-items-center">
                              <i class="bx bx-star"></i>
                              <span class="align-middle ms-2">ستاره دار</span>
                            </a>
                            <div class="badge bg-label-warning rounded-pill">10</div>
                          </li>
                          <li class="d-flex mb-2 align-items-center" data-target="spam">
                            <a href="javascript:void(0);" class="d-flex flex-wrap align-items-center">
                              <i class="bx bx-error-circle"></i>
                              <span class="align-middle ms-2">اسپم</span>
                            </a>
                          </li>
                        ...
                        <div class="email-filter-labels">
                          <small class="fw-normal text-uppercase text-muted m-4">برچسب ها</small>
                          <ul class="list-unstyled mb-0 mt-3">
                            <li class="mb-1" data-target="work">
                              <a href="javascript:void(0);">
                                <i class="badge badge-dot bg-success"></i>
                                <span class="align-middle ms-2">کارها</span>
                              </a>
                            </li>
                            <li class="mb-1" data-target="company">
                              <a href="javascript:void(0);">
                                <i class="badge badge-dot bg-primary"></i>
                                <span class="align-middle ms-2">شرکت</span>
                              </a>
                            </li>
                            <li class="mb-1" data-target="important">
                              <a href="javascript:void(0);">
                                <i class="badge badge-dot bg-info"></i>
                                <span class="align-middle ms-2">مهم</span>
                              </a>
                            </li>
                            <li class="mb-1" data-target="private">
                              <a href="javascript:void(0);">
                                <i class="badge badge-dot bg-danger"></i>
                                <span class="align-middle ms-2">شخصی</span>
                              </a>
                            </li>
                          </ul>
                        </div>
                          ...
                          <ul class="list-unstyled m-0">
                            <li class="email-list-item" data-starred="true" data-bs-toggle="sidebar" data-target="#app-email-view">
                              <div class="d-flex align-items-center">
                                ...
                                <img src="../../assets/img/avatars/1.png" alt="user-avatar" class="d-block flex-shrink-0 rounded-circle me-sm-3 me-0" height="32" width="32">
                            ...
                            <li class="email-list-item email-marked-read" data-sent="true" data-bs-toggle="sidebar" data-target="#app-email-view">
                              <div class="d-flex align-items-center">
                                ...
                                <i class="email-list-item-bookmark bx bx-star d-sm-inline-block d-none cursor-pointer ms-2 me-3"></i>
                                <img src="../../assets/img/avatars/2.png" alt="user-avatar" class="d-block flex-shrink-0 rounded-circle me-sm-3 me-0" height="32" width="32">
                                <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                            ...
                            <li class="email-list-item" data-draft="true" data-bs-toggle="sidebar" data-target="#app-email-view">
                              <div class="d-flex align-items-center">
                                ...
                                <div class="avatar avatar-sm d-block flex-shrink-0 me-sm-3 me-0">
                                  <span class="avatar-initial rounded-circle bg-label-success">ل‌ا</span>
                                </div>
                                <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                                  <span class="email-list-item-username me-2">لورم ایپسوم متن</span>
                                  <span class="email-list-item-subject d-xl-inline-block d-block">
                            ...
                            <li class="email-list-item email-marked-read" data-starred="true" data-bs-toggle="sidebar" data-target="#app-email-view">
                              <div class="d-flex align-items-center">
                                ...
                                <i class="email-list-item-bookmark bx bx-star d-sm-inline-block d-none cursor-pointer ms-2 me-3"></i>
                                <img src="../../assets/img/avatars/3.png" alt="user-avatar" class="d-block flex-shrink-0 rounded-circle me-sm-3 me-0" height="32" width="32">
                                <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                                  <span class="email-list-item-username me-2">لورم ایپسوم متن</span>
                                  <span class="email-list-item-subject d-xl-inline-block d-block">
                            ...
                            <li class="email-list-item email-marked-read" data-spam="true" data-bs-toggle="sidebar" data-target="#app-email-view">
                              <div class="d-flex align-items-center">
                                ...
                                <i class="email-list-item-bookmark bx bx-star d-sm-inline-block d-none cursor-pointer ms-2 me-3"></i>
                                <img src="../../assets/img/avatars/4.png" alt="user-avatar" class="d-block flex-shrink-0 rounded-circle me-sm-3 me-0" height="32" width="32">
                                <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                            ...
                            <li class="email-list-item" data-trash="true" data-bs-toggle="sidebar" data-target="#app-email-view">
                              <div class="d-flex align-items-center">
                                ...
                                <i class="email-list-item-bookmark bx bx-star d-sm-inline-block d-none cursor-pointer ms-2 me-3"></i>
                                <div class="avatar avatar-sm d-block flex-shrink-0 me-sm-3 me-0">
                                  <span class="avatar-initial rounded-circle bg-label-info">ل‌ا</span>
                                </div>
                                <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                                  <span class="email-list-item-username me-2">لورم ایپسوم متن</span>
                                  <span class="email-list-item-subject d-xl-inline-block d-block">
                            ...
                            <li class="email-list-item email-marked-read" data-draft="true" data-bs-toggle="sidebar" data-target="#app-email-view">
                              <div class="d-flex align-items-center">
                                ...
                                <i class="email-list-item-bookmark bx bx-star d-sm-inline-block d-none cursor-pointer ms-2 me-3"></i>
                                <img src="../../assets/img/avatars/5.png" alt="user-avatar" class="d-block flex-shrink-0 rounded-circle me-sm-3 me-0" height="32" width="32">
                                <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                                  <span class="email-list-item-username me-2">لورم ایپسوم متن</span>
                                  <span class="email-list-item-subject d-xl-inline-block d-block">
                                    لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از</span>
                            ...
                            <li class="email-list-item email-marked-read" data-starred="true" data-bs-toggle="sidebar" data-target="#app-email-view">
                              <div class="d-flex align-items-center">
                                ...
                                <i class="email-list-item-bookmark bx bx-star d-sm-inline-block d-none cursor-pointer ms-2 me-3"></i>
                                <img src="../../assets/img/avatars/6.png" alt="user-avatar" class="d-block flex-shrink-0 rounded-circle me-sm-3 me-0" height="32" width="32">
                                <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                                  <span class="email-list-item-username me-2">لورم ایپسوم متن</span>
                                  <span class="email-list-item-subject d-xl-inline-block d-block">
                                    لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با</span>
                            ...
                            <li class="email-list-item email-marked-read" data-spam="true" data-bs-toggle="sidebar" data-target="#app-email-view">
                              <div class="d-flex align-items-center">
                                ...
                                <i class="email-list-item-bookmark bx bx-star d-sm-inline-block d-none cursor-pointer ms-2 me-3"></i>
                                <div class="avatar avatar-sm d-block flex-shrink-0 me-sm-3 me-0">
                                  <span class="avatar-initial rounded-circle bg-label-danger">ل‌ا</span>
                                </div>
                                <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                                  <span class="email-list-item-username me-2">لورم ایپسوم</span>
                                  <span class="email-list-item-subject d-xl-inline-block d-block">
                            ...
                            <li class="email-list-item email-marked-read" data-trash="true" data-bs-toggle="sidebar" data-target="#app-email-view">
                              <div class="d-flex align-items-center">
                                ...
                                <i class="email-list-item-bookmark bx bx-star d-sm-inline-block d-none cursor-pointer ms-2 me-3"></i>
                                <img src="../../assets/img/avatars/9.png" alt="user-avatar" class="d-block flex-shrink-0 rounded-circle me-sm-3 me-0" height="32" width="32">
                                <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                      ...
                      <div class="app-email-view-content py-4">
                        ...
                        <div class="card email-card-prev mx-sm-4 mx-3 border shadow-none">
                          <div class="card-header d-flex justify-content-between align-items-center flex-wrap">
                            ...
                            <div class="d-flex">
                              <p class="mb-0 me-3 text-muted">20 خرداد 1402 - 08:30 ق.ظ</p>
                        ...
                        <div class="card email-card-last mx-sm-4 mx-3 mt-4 border shadow-none">
                          <div class="card-header d-flex justify-content-between align-items-center flex-wrap">
                            ...
                            <div class="d-flex align-items-center">
                              <p class="mb-0 me-3 text-muted">20 خرداد 1402 - 08:10 ق.ظ</p>
                              <i class="bx bx-paperclip cursor-pointer me-2 fs-4"></i>
                              <i class="email-list-item-bookmark bx bx-star cursor-pointer me-2 fs-4"></i>
                              <div class="dropdown me-3">
                        ...
                        <div class="email-reply card mt-4 mx-sm-4 mx-3 border shadow-none">
                          <h6 class="card-header border-0">پاسخ به تونی استارک</h6>
                          <div class="card-body pt-0 px-3">
                            ...
                            <div class="d-flex justify-content-end align-items-center">
                              <div class="cursor-pointer me-3">
                                ...
                                <span class="align-middle">پیوست ها</span>
                              </div>
