...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>ویرایش - صورتحساب | فرست - قالب مدیریت بوت‌استرپ</title>
                    ...
                    <div class="card-body">
                      <div class="row p-sm-3 p-0">
                        ...
                        <div class="col-md-6">
                          <dl class="row mb-2">
                            ...
                            <dt class="col-sm-6 mb-2 mb-sm-0 pt-1 text-md-end">
                              <span class="fw-normal">تاریخ سررسید:</span>
                            </dt>
                            <dd class="col-sm-6 d-flex justify-content-md-end">
                              <div class="w-px-150">
                      ...
                      <div class="row p-sm-3 p-0">
                        <div class="col-md-6 col-sm-5 col-12 mb-sm-0 mb-4">
                          ...
                          <p class="mb-1"><span class="d-inline-block" dir="ltr">718-986-6062</span></p>
                            ...
                            <div class="d-flex border rounded position-relative pe-0">
                              <div class="row w-100 m-0 p-3">
                                <div class="col-md-6 col-12 mb-md-0 mb-3 ps-md-0">
                                  <p class="mb-2 repeater-title">مورد</p>
                                  <select class="form-select item-details mb-2">
                                    <option value="App Design">طراحی برنامه</option>
                                    <option value="App Customization" selected>سفارشی‌سازی برنامه</option>
                                    <option value="ABC Template">قالب ABC</option>
                                    <option value="App Development">توسعه برنامه</option>
                                  </select>
                                  <textarea class="form-control" rows="2">
لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با</textarea>
                                </div>
                                <div class="col-md-3 col-12 mb-md-0 mb-3">
                                  <p class="mb-2 repeater-title">هزینه</p>
                                  <input type="number" class="form-control invoice-item-price mb-2" value="24" placeholder="24" min="12">
                                  <div>
                                    <span>تخفیف:</span>
                                    <span class="discount me-2">0%</span>
                                    <span class="tax-1 me-2" data-bs-toggle="tooltip" data-bs-placement="top" title="مالیات 1">0%</span>
                                    <span class="tax-2" data-bs-toggle="tooltip" data-bs-placement="top" title="مالیات 2">0%</span>
                                  </div>
                                </div>
                                ...
                                <div class="col-md-1 col-12 pe-0">
                                  <p class="mb-2 repeater-title">قیمت</p>
                                  <p class="mb-0 lh-inherit">24,000 تومان</p>
                                </div>
                              </div>
                              <div class="d-flex flex-column align-items-center justify-content-between border-start p-2">
                                ...
                                <div class="dropdown">
                                  ...
                                  <div class="dropdown-menu dropdown-menu-end w-px-300 p-3" aria-labelledby="dropdownMenuButton">
                                    <div class="row g-3">
                                      <div class="col-12">
                                        <label for="discountInput" class="form-label">تخفیف (%)</label>
                                        <input type="number" class="form-control" id="discountInput" min="0" max="100">
                                      </div>
                                      <div class="col-md-6">
                                        <label for="taxInput1" class="form-label">مالیات 1</label>
                                      ...
                                      <div class="col-md-6">
                                        <label for="taxInput2" class="form-label">مالیات 2</label>
                                    ...
                                    <button type="button" class="btn btn-label-primary btn-apply-changes">اعمال</button>
                                  </div>
                                </div>
                              </div>
                            </div>
                      ...
                      <div class="row py-sm-3">
                        <div class="col-md-6 mb-md-0 mb-3">
                          <div class="d-flex align-items-center mb-3">
                            <label for="salesperson" class="form-label me-5 fw-semibold">فروشنده:</label>
                            <input type="text" class="form-control" id="salesperson" placeholder="جان اسنو" value="جان اسنو">
                          </div>
                          <input type="text" class="form-control" id="invoiceMsg" placeholder="از کسب و کار شما متشکریم" value="از کسب و کار شما متشکریم">
                        </div>
                        <div class="col-md-6 d-flex justify-content-end">
                          <div class="invoice-calculations lh-2">
                            <div class="d-flex justify-content-between mb-2">
                              <span class="w-px-100">جمع جزء:</span>
                              <span class="fw-semibold">5,000,000 تومان</span>
                            </div>
                            <div class="d-flex justify-content-between mb-2">
                            ...
                            <div class="d-flex justify-content-between mb-2">
                              ...
                              <span class="fw-semibold">100,000 تومان</span>
                            </div>
                            <hr>
                            <div class="d-flex justify-content-between">
                              <span class="w-px-100">جمع کل:</span>
                              <span class="fw-semibold">5,100,000 تومان</span>
                            </div>
                          </div>
                        </div>
                      </div>
...
لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله</textarea>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="card mb-4">
                    <div class="card-body">
                      <button class="btn btn-primary d-grid w-100" data-bs-toggle="offcanvas" data-bs-target="#sendInvoiceOffcanvas">
                        <span class="d-flex align-items-center justify-content-center text-nowrap"><i class="bx bx-paper-plane bx-xs me-2"></i>ارسال صورتحساب</span>
                      </button>
                      <div class="d-flex my-3">
                        <a href="./app-invoice-preview.html" class="btn btn-label-secondary w-100 me-3">پیش‌نمایش</a>
                        <button type="button" class="btn btn-label-secondary w-100">ذخیره</button>
                      </div>
                      <button class="btn btn-primary d-grid w-100" data-bs-toggle="offcanvas" data-bs-target="#addPaymentOffcanvas">
                        <span class="d-flex align-items-center justify-content-center text-nowrap"><i class="bx bx-dollar bx-xs me-2"></i>افزودن پرداخت</span>
                      </button>
                    </div>
                  </div>
                  <div>
                    ...
                    <select class="form-select mb-4">
                      <option value="Bank Account">حساب بانکی</option>
                      <option value="Paypal">پی‌پال</option>
                      <option value="Card">کارت اعتباری</option>
                      <option value="UPI Transfer">انتقال UPI</option>
                    </select>
                    <div class="d-flex justify-content-between mb-2 lh-1-85">
                      <label for="payment-terms" class="mb-0">شرایط پرداخت</label>
                    ...
                    <div class="d-flex justify-content-between mb-2 lh-1-85">
                      <label for="client-notes" class="mb-0">یادداشت های مشتری</label>
                      <label class="switch switch-primary me-0">
                    ...
                    <div class="d-flex justify-content-between lh-1-85">
                      <label for="payment-stub" class="mb-0">خرد پرداخت</label>
                      <label class="switch switch-primary me-0">
                ...
                <div class="offcanvas-body flex-grow-1">
                  <form>
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control text-start" id="invoice-from" value="shelbyComapny@email.com" placeholder="company@email.com" dir="ltr">
                    </div>
                    <div class="mb-3">
                      <label for="invoice-to" class="form-label">به</label>
                      <input type="text" class="form-control text-start" id="invoice-to" value="qConsolidated@email.com" placeholder="company@email.com" dir="ltr">
                    </div>
                    <div class="mb-3">
