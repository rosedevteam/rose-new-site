...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>تولتیپ‌ها و پاپ‌اور‌ها - المان‌های رابط کاربری | فرست - قالب مدیریت بوت‌استرپ</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">المان‌های رابط کاربری /</span> تولتیپ‌ها و پاپ‌اورها
              </h4>

              <!-- Tooltips -->
              <div class="card mb-4">
                <h5 class="card-header heading-color">تولتیپ ها</h5>
                <div class="card-body">
                  <div class="text-light small fw-semibold">جهت ها</div>
                  <div class="row demo-vertical-spacing">
                    <div class="col">
                      <button type="button" class="btn btn-primary" data-bs-toggle="tooltip" data-bs-offset="0,4" data-bs-placement="right" data-bs-html="true" title="<i class='bx bx-trending-up bx-xs' ></i> <span>تولتیپ در چپ</span>">
                        چپ
                      </button>
                    </div>
                    <div class="col">
                      <button type="button" class="btn btn-primary" data-bs-toggle="tooltip" data-bs-offset="0,4" data-bs-placement="top" data-bs-html="true" title="<i class='bx bx-bell bx-xs' ></i> <span>تولتیپ در بالا</span>">
                        بالا
                      </button>
                    </div>
                    <div class="col">
                      <button type="button" class="btn btn-primary" data-bs-toggle="tooltip" data-bs-offset="0,4" data-bs-placement="bottom" data-bs-html="true" title="<i class='bx bx-heart bx-xs' ></i> <span>تولتیپ در پایین</span>">
                        پایین
                      </button>
                    </div>
                    <div class="col">
                      <button type="button" class="btn btn-primary" data-bs-toggle="tooltip" data-bs-offset="0,4" data-bs-placement="left" data-bs-html="true" title="<i class='bx bx-dollar bx-xs' ></i> <span>تولتیپ در راست</span>">
                        راست
                      </button>
                    </div>
                  </div>
                ...
                <hr class="m-0">
                <div class="card-body">
                  <div class="text-light small fw-semibold">پررنگ</div>

                  <div class="demo-inline-spacing">
                    <button type="button" class="btn btn-primary" data-bs-toggle="tooltip" data-bs-offset="0,8" data-bs-placement="top" data-bs-custom-class="tooltip-primary" title="تولتیپ اولیه">
                      اولیه
                    </button>
                    <button type="button" class="btn btn-secondary" data-bs-toggle="tooltip" data-bs-offset="0,8" data-bs-placement="top" data-bs-custom-class="tooltip-secondary" title="تولتیپ ثانویه">
                      ثانویه
                    </button>
                    <button type="button" class="btn btn-success" data-bs-toggle="tooltip" data-bs-offset="0,8" data-bs-placement="top" data-bs-custom-class="tooltip-success" title="تولتیپ موفقیت">
                      موفقیت
                    </button>
                    <button type="button" class="btn btn-danger" data-bs-toggle="tooltip" data-bs-offset="0,8" data-bs-placement="top" data-bs-custom-class="tooltip-danger" title="تولتیپ اخطار">
                      اخطار
                    </button>
                    <button type="button" class="btn btn-warning" data-bs-toggle="tooltip" data-bs-offset="0,8" data-bs-placement="top" data-bs-custom-class="tooltip-warning" title="تولتیپ هشدار">
                      هشدار
                    </button>
                    <button type="button" class="btn btn-info" data-bs-toggle="tooltip" data-bs-offset="0,8" data-bs-placement="top" data-bs-custom-class="tooltip-info" title="تولتیپ اطلاعات">
                      اطلاعات
                    </button>
                    <button type="button" class="btn btn-dark" data-bs-toggle="tooltip" data-bs-offset="0,8" data-bs-placement="top" data-bs-custom-class="tooltip-dark" title="تولتیپ تیره">
                      تیره
                    </button>
                  </div>
                </div>
              ...
              <!-- Popovers -->
              <div class="card">
                <h5 class="card-header heading-color">پاپ اور</h5>
                <div class="card-body">
                  <div class="text-light small fw-semibold">جهت ها</div>
                  <div class="row demo-vertical-spacing">
                    <div class="col">
                      <button type="button" class="btn btn-primary text-nowrap" data-bs-toggle="popover" data-bs-offset="0,14" data-bs-placement="right" data-bs-html="true" data-bs-content="<p>این یک پاپ‌اور زیباست، کمی محبت نشان دهید.</p> <div class='d-flex justify-content-between'><button type='button' class='btn btn-sm btn-label-secondary'>رد کردن</button><button type='button' class='btn btn-sm btn-primary'>اطلاعات بیشتر</button></div>" title="عنوان پاپ‌اور">
                        پاپ اور در چپ
                      </button>
                    </div>
                    <div class="col">
                      <button type="button" class="btn btn-primary text-nowrap" data-bs-toggle="popover" data-bs-offset="0,14" data-bs-placement="top" data-bs-html="true" data-bs-content="<p>این یک پاپ‌اور زیباست، کمی محبت نشان دهید.</p> <div class='d-flex justify-content-between'><button type='button' class='btn btn-sm btn-label-secondary'>رد کردن</button><button type='button' class='btn btn-sm btn-primary'>اطلاعات بیشتر</button></div>" title="عنوان پاپ‌اور">
                        پاپ اور در بالا
                      </button>
                    </div>
                    <div class="col">
                      <button type="button" class="btn btn-primary text-nowrap" data-bs-toggle="popover" data-bs-offset="0,14" data-bs-placement="bottom" data-bs-html="true" data-bs-content="<p>این یک پاپ‌اور زیباست، کمی محبت نشان دهید.</p> <div class='d-flex justify-content-between'><button type='button' class='btn btn-sm btn-label-secondary'>رد کردن</button><button type='button' class='btn btn-sm btn-primary'>اطلاعات بیشتر</button></div>" title="عنوان پاپ‌اور">
                        پاپ اور در پایین
                      </button>
                    </div>
                    <div class="col">
                      <button type="button" class="btn btn-primary text-nowrap" data-bs-toggle="popover" data-bs-offset="0,14" data-bs-placement="left" data-bs-html="true" data-bs-content="<p>این یک پاپ‌اور زیباست، کمی محبت نشان دهید.</p> <div class='d-flex justify-content-between'><button type='button' class='btn btn-sm btn-label-secondary'>رد کردن</button><button type='button' class='btn btn-sm btn-primary'>اطلاعات بیشتر</button></div>" title="عنوان پاپ‌اور">
                        پاپ اور در راست
                      </button>
                    </div>
                  </div>
                ...
                <div class="card-body">
                  ...
                  <div class="demo-inline-spacing">
                    <button type="button" class="btn btn-primary" data-bs-toggle="popover" data-bs-offset="0,14" data-bs-placement="right" data-bs-custom-class="popover-primary" data-bs-content="این یک پاپ‌اور زیباست، کمی محبت نشان دهید." title="عنوان پاپ‌اور">
                      اولیه
                    </button>
                    <button type="button" class="btn btn-secondary" data-bs-toggle="popover" data-bs-offset="0,14" data-bs-placement="right" data-bs-custom-class="popover-secondary" data-bs-content="این یک پاپ‌اور زیباست، کمی محبت نشان دهید." title="عنوان پاپ‌اور">
                      ثانویه
                    </button>
                    <button type="button" class="btn btn-success" data-bs-toggle="popover" data-bs-offset="0,14" data-bs-placement="top" data-bs-custom-class="popover-success" data-bs-content="این یک پاپ‌اور زیباست، کمی محبت نشان دهید." title="عنوان پاپ‌اور">
                      موفقیت
                    </button>
                    <button type="button" class="btn btn-danger" data-bs-toggle="popover" data-bs-offset="0,14" data-bs-placement="top" data-bs-custom-class="popover-danger" data-bs-content="این یک پاپ‌اور زیباست، کمی محبت نشان دهید." title="عنوان پاپ‌اور">
                      اخطار
                    </button>
                    <button type="button" class="btn btn-warning" data-bs-toggle="popover" data-bs-offset="0,14" data-bs-placement="left" data-bs-custom-class="popover-warning" data-bs-content="این یک پاپ‌اور زیباست، کمی محبت نشان دهید." title="عنوان پاپ‌اور">
                      هشدار
                    </button>
                    <button type="button" class="btn btn-info" data-bs-toggle="popover" data-bs-offset="0,14" data-bs-placement="bottom" data-bs-custom-class="popover-info" data-bs-content="این یک پاپ‌اور زیباست، کمی محبت نشان دهید." title="عنوان پاپ‌اور">
                      اطلاعات
                    </button>
                    <button type="button" class="btn btn-dark" data-bs-toggle="popover" data-bs-offset="0,14" data-bs-placement="top" data-bs-custom-class="popover-dark" data-bs-content="این یک پاپ‌اور زیباست، کمی محبت نشان دهید." title="عنوان پاپ‌اور">
                      تیره
                    </button>
                  </div>
                </div>
