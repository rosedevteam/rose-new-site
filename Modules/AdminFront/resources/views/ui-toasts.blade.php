...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>اعلان‌های Toast - المان‌های رابط کاربری | فرست - قالب مدیریت بوت‌استرپ</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">المان‌های رابط کاربری /</span> اعلان‌های Toast
              </h4>
              ...
              <div class="bs-toast toast toast-ex animate__animated my-2" role="alert" aria-live="assertive" aria-atomic="true" data-bs-delay="2000">
                <div class="toast-header">
                  ...
                  <div class="me-auto fw-semibold">بوت‌استرپ</div>
                  <small>11 دقیقه قبل</small>
                  <button type="button" class="btn-close" data-bs-dismiss="toast" aria-label="Close"></button>
                </div>
                <div class="toast-body">سلام دنیا! این یک پیام توست است.</div>
              </div>
              <!--/ Toast with Animation -->
              ...
              <div class="card mb-4">
                <h5 class="card-header heading-color">نمونه توست‌های بوت‌استرپ با انیمیشن</h5>
                <div class="card-body">
                  <div class="row gx-3 gy-2 align-items-center">
                    <div class="col-md-3">
                      <label class="form-label" for="selectType">نوع</label>
                      <select id="selectType" class="form-select color-dropdown">
                        <option value="bg-primary" selected>اولیه</option>
                        <option value="bg-secondary">ثانویه</option>
                        <option value="bg-success">موفقیت</option>
                        <option value="bg-danger">اخطار</option>
                        <option value="bg-warning">هشدار</option>
                        <option value="bg-info">اطلاعات</option>
                        <option value="bg-dark">تیره</option>
                      </select>
                    </div>
                    <div class="col-md-3">
                      <label class="form-label" for="selectAnimation">انیمیشن</label>
                    ...
                    <div class="col-md-3">
                      ...
                      <button id="showToastAnimation" class="btn btn-primary d-block">نمایش توست</button>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card mb-4">
                <h5 class="card-header heading-color">نمونه توست‌های بوت‌استرپ با مکان‌گیری</h5>
                <div class="card-body">
                  <div class="row gx-3 gy-2 align-items-center">
                    <div class="col-md-3">
                      <label class="form-label" for="selectTypeOpt">نوع</label>
                    ...
                    <div class="col-md-3">
                      <label class="form-label" for="selectPlacement">مکان</label>
                      <select class="form-select placement-dropdown" id="selectPlacement">
                        <option value="top-0 start-0">بالا راست</option>
                        <option value="top-0 start-50 translate-middle-x">بالا وسط</option>
                        <option value="top-0 end-0">بالا چپ</option>
                        <option value="top-50 start-0 translate-middle-y">مرکز راست</option>
                        <option value="top-50 start-50 translate-middle">مرکز وسط</option>
                        <option value="top-50 end-0 translate-middle-y">مرکز چپ</option>
                        <option value="bottom-0 start-0">پایین راست</option>
                        <option value="bottom-0 start-50 translate-middle-x">پایین وسط</option>
                        <option value="bottom-0 end-0">پایین چپ</option>
                      </select>
                    </div>
                    <div class="col-md-3">
                      <label class="form-label" for="showToastPlacement">&nbsp;</label>
                      <button id="showToastPlacement" class="btn btn-primary d-block">نمایش توست</button>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card mb-4">
                <h5 class="card-header heading-color">استایل‌های توست‌های بوت‌استرپ</h5>
                <div class="row g-0">
                  <div class="col-md-6 p-4">
                    <div class="text-light small fw-semibold mb-3">پیش‌فرض</div>
                  ...
                  <div class="col-md-6 ui-bg-overlay-container p-4">
                    ...
                    <div class="text-white small fw-semibold mb-3">نیمه شفاف</div>
              ...
              <!-- Toastr Demo -->
              <div class="card">
                <h5 class="card-header heading-color">توست‌های Toastr</h5>
                <div class="card-body">
                  <div class="row">
                    <div class="col-lg-6 col-xl-3">
                      <div class="mb-3">
                        <label class="form-label" for="title">عنوان</label>
                        <input id="title" type="text" class="form-control" placeholder="یک عنوان وارد کنید ...">
                      </div>
                      <div class="mb-3">
                        <label class="form-label" for="message">پیام</label>
                        <textarea class="form-control" id="message" rows="3" placeholder="یک پیام وارد کنید ..." spellcheck="false"></textarea>
                      </div>
                      <div class="mb-3">
                        <div class="form-check">
                          <input id="closeButton" class="form-check-input" type="checkbox" value="checked">
                          <label class="form-check-label" for="closeButton">دکمه بستن</label>
                        </div>
                        <div class="form-check">
                          <input id="addBehaviorOnToastClick" class="form-check-input" type="checkbox" value="checked">
                          <label class="form-check-label" for="addBehaviorOnToastClick">افزودن رفتار در هنگام کلیک توست</label>
                        </div>
                        <div class="form-check">
                          <input id="debugInfo" class="form-check-input" type="checkbox" value="checked">
                          <label class="form-check-label" for="debugInfo">اشکال‌زدایی</label>
                        </div>
                        <div class="form-check">
                          <input id="progressBar" class="form-check-input" type="checkbox" value="checked">
                          <label class="form-check-label" for="progressBar">نوار پیشرفت</label>
                        </div>
                        <div class="form-check">
                          <input id="preventDuplicates" class="form-check-input" type="checkbox" value="checked">
                          <label class="form-check-label" for="preventDuplicates">جلوگیری از تکرار</label>
                        </div>
                        <div class="form-check">
                          <input id="addClear" class="form-check-input" type="checkbox" value="checked">
                          <label class="form-check-label" for="addClear">یک دکمه برای اجبار به پاکسازی یک توست، بدون توجه به تمرکز، اضافه کنید.</label>
                        </div>
                        <div class="form-check">
                          <input id="newestOnTop" class="form-check-input" type="checkbox" value="checked">
                          <label class="form-check-label" for="newestOnTop">جدیدترین در بالا</label>
                        </div>
                      </div>
                    </div>
                    <div class="col-lg-6 col-xl-3">
                      <div class="mb-3" id="toastTypeGroup">
                        <label class="form-label">نوع توست</label>
                        <div class="form-check">
                          <input type="radio" id="successRadio" name="toastsRadio" class="form-check-input" checked value="success">
                          <label class="form-check-label" for="successRadio">موفقیت</label>
                        </div>
                        <div class="form-check">
                          <input type="radio" id="infoRadio" name="toastsRadio" class="form-check-input" value="info">
                          <label class="form-check-label" for="infoRadio">اطلاعات</label>
                        </div>
                        <div class="form-check">
                          <input type="radio" id="warningRadio" name="toastsRadio" class="form-check-input" value="warning">
                          <label class="form-check-label" for="warningRadio">هشدار</label>
                        </div>
                        <div class="form-check">
                          <input type="radio" id="errorRadio" name="toastsRadio" class="form-check-input" value="error">
                          <label class="form-check-label" for="errorRadio">خطا</label>
                        </div>
                      </div>
                    ...
                    <div class="col-lg-6 col-xl-3">
                      <div class="mb-3 kt-form__grou">
                        <label class="form-label" for="showDuration">مدت زمان نمایش</label>
                        <input id="showDuration" type="text" class="form-control" placeholder="ms" value="300">
                      </div>
                      <div class="mb-3 kt-form__grou">
                        <label class="form-label" for="hideDuration">مدت زمان پنهان کردن</label>
                        <input id="hideDuration" type="text" class="form-control" placeholder="ms" value="1000">
                      </div>
                      <div class="mb-3 kt-form__grou">
                        <label class="form-label" for="timeOut">تایم اوت</label>
                        <input id="timeOut" type="text" class="form-control" placeholder="ms" value="5000">
                      </div>
                      <div class="mb-3 kt-form__grou">
                        <label class="form-label" for="extendedTimeOut">تایم اوت تمدید شده</label>
                  ...
                  <a href="javascript:;" class="btn btn-primary mb-1" id="showtoast">نمایش توست</a>
                  <a href="javascript:;" class="btn btn-danger mb-1" id="cleartoasts">پاکسازی توست‌ها</a>
                  <a href="javascript:;" class="btn btn-danger mb-1" id="clearlasttoast">پاکسازی آخرین توست</a>
                </div>
              </div>
              <!--/ Toastr Demo -->
            </div>
