...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>نشان‌ها - المان‌های رابط کاربری | فرست - قالب مدیریت بوت‌استرپ</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">المان‌های رابط کاربری /</span> نشان‌ها
              </h4>
              ...
              <div class="row">
                ...
                <div class="col-lg">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">نشان‌های پایه</h5>
                    <div class="card-body">
                      <div class="text-light small fw-semibold">پیش‌فرض</div>
                      <div class="demo-inline-spacing">
                        <span class="badge bg-primary">اولیه</span>
                        <span class="badge bg-secondary">ثانویه</span>
                        <span class="badge bg-success">موفقیت</span>
                        <span class="badge bg-danger">اخطار</span>
                        <span class="badge bg-warning">هشدار</span>
                        <span class="badge bg-info">اطلاعات</span>
                        <span class="badge bg-dark">تیره</span>
                      </div>
                    </div>
                    <hr class="m-0">
                    <div class="card-body">
                      <div class="text-light small fw-semibold">قرص ها</div>

                      <div class="demo-inline-spacing">
                        <span class="badge rounded-pill bg-primary">اولیه</span>
                        <span class="badge rounded-pill bg-secondary">ثانویه</span>
                        <span class="badge rounded-pill bg-success">موفقیت</span>
                        <span class="badge rounded-pill bg-danger">اخطار</span>
                        <span class="badge rounded-pill bg-warning">هشدار</span>
                        <span class="badge rounded-pill bg-info">اطلاعات</span>
                        <span class="badge rounded-pill bg-dark">تیره</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-lg">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">نشان‌های برچسب</h5>
                    <div class="card-body">
                      <div class="text-light small fw-semibold">برچسب پیش‌فرض</div>
                    ...
                    <hr class="m-0">
                    <div class="card-body">
                      <div class="text-light small fw-semibold">برچسب قرص</div>

                      <div class="demo-inline-spacing">
                        <span class="badge rounded-pill bg-label-primary">اولیه</span>
                        <span class="badge rounded-pill bg-label-secondary">ثانویه</span>
                        <span class="badge rounded-pill bg-label-success">موفقیت</span>
                        <span class="badge rounded-pill bg-label-danger">اخطار</span>
                        <span class="badge rounded-pill bg-label-warning">هشدار</span>
                        <span class="badge rounded-pill bg-label-info">اطلاعات</span>
                        <span class="badge rounded-pill bg-label-dark">تیره</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="row">
                ...
                <div class="col-lg">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">دکمه با نشان</h5>
                    <div class="card-body">
                      <div class="row gy-4">
                        <div class="col-sm-4">
              ...
              <div class="row">
                ...
                <div class="col-12">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">طرح دایره و مربع نشان</h5>
                    <div class="card-body">
                      <div class="row gy-4">
                        <div class="col-md-6">
                          <h6>پایه</h6>
                          <div class="text-light small fw-semibold mb-2">پیش‌فرض</div>
                          <div class="demo-inline-spacing">
                            <p>
                ...
                <div class="col-12">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">نشان دایره و مربع با آیکن</h5>
                    <div class="card-body">
                      <div class="row gy-4">
                        <div class="col-md-6">
                          <h6>پایه</h6>
                ...
                <div class="col-12">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">اعلان‌ها</h5>
                ...
                <div class="col-12">
                  <div class="card">
                    <h5 class="card-header heading-color">طرح نقطه</h5>
                    <div class="card-body d-sm-flex d-block">
                      <div class="d-flex align-items-center lh-1-85 me-3 mb-2 mb-sm-0">
                        <span class="badge badge-dot bg-primary me-1"></span> اولیه
                      </div>
                      <div class="d-flex align-items-center lh-1-85 me-3 mb-2 mb-sm-0">
                        <span class="badge badge-dot bg-secondary me-1"></span> ثانویه
                      </div>
                      <div class="d-flex align-items-center lh-1-85 me-3 mb-2 mb-sm-0">
                        <span class="badge badge-dot bg-success me-1"></span> موفقیت
                      </div>
                      <div class="d-flex align-items-center lh-1-85 me-3 mb-2 mb-sm-0">
                        <span class="badge badge-dot bg-danger me-1"></span> اخطار
                      </div>
                      <div class="d-flex align-items-center lh-1-85 me-3 mb-2 mb-sm-0">
                        <span class="badge badge-dot bg-warning me-1"></span> هشدار
                      </div>
                      <div class="d-flex align-items-center lh-1-85 me-3 mb-2 mb-sm-0">
                        <span class="badge badge-dot bg-info me-1"></span> اطلاعات
                      </div>
                    </div>
                  </div>
                </div>
