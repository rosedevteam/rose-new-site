...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>هشدار SweetAlert2 - رابط کاربری توسعه یافته | فرست - قالب مدیریت بوت‌استرپ</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">رابط کاربری توسعه یافته /</span> هشدارهای SweetAlert2
              </h4>
              ...
              <div class="row">
                ...
                <div class="col-12 mb-4">
                  <div class="card">
                    <h5 class="card-header heading-color">نمونه‌های پایه</h5>
                    <div class="card-body">
                      <span class="lh-2">
                        هشدار SweetAlert به صورت خودکار خود را در مرکز صفحه قرار داده و چه در کامپیوتر دسکتاپ و چه در موبایل و تبلت به خوبی نمایش داده می شود. همچنین بسیار قابل سفارشی سازی است که میتوانید در زیر ببینید!
                      </span>
                      <div class="demo-inline-spacing">
                        <button type="button" class="btn btn-primary" id="basic-alert">پایه</button>
                        <button type="button" class="btn btn-primary" id="with-title">با عنوان</button>
                        <button type="button" class="btn btn-primary" id="footer-alert">با فوتر</button>
                ...
                <div class="col-12 mb-4">
                  <div class="card">
                    <h5 class="card-header heading-color">موقعیت</h5>
                    <div class="card-body">
                      <span class="lh-2">
                        شما می توانید موقعیت هشدار خود را توسط
                        <code>{position : top-start | top-end | bottom-start | bottom-end }</code>
                        در js مشخص کنید.
                      </span>
                      <div class="demo-inline-spacing">
                        <button class="btn btn-primary" id="position-top-start">بالا شروع</button>
                        <button class="btn btn-primary" id="position-top-end">بالا پایان</button>
                        <button class="btn btn-primary" id="position-bottom-start">پایین شروع</button>
                        <button class="btn btn-primary" id="position-bottom-end">پایین پایان</button>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-12 mb-4">
                  <div class="card">
                    <h5 class="card-header heading-color">انیمیشن‌ها</h5>
                    <div class="card-body">
                      <span class="lh-2">
                        از <code>popup</code> داخل پارامتر <code>showClass</code> برای افزودن انیمیشن به هشدار استفاده کنید.
                      </span>
                      <div class="demo-inline-spacing">
                        <button class="btn btn-primary" id="bounce-in-animation">پرش به داخل</button>
                        <button class="btn btn-primary" id="fade-in-animation">محو به داخل</button>
                        <button class="btn btn-primary" id="flip-x-animation">ورق به داخل</button>
                        <button class="btn btn-primary" id="tada-animation">تادا</button>
                        <button class="btn btn-primary" id="shake-animation">لرزیدن</button>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-12 mb-4">
                  <div class="card">
                    <h5 class="card-header heading-color">انواع</h5>
                    <div class="card-body">
                      <span class="lh-2"> از پارامتر <code>icon</code> برای ایجاد یک هشدار با نوع استفاده کنید. </span>
                      <div class="demo-inline-spacing">
                        <button type="button" class="btn btn-success" id="type-success">موفقیت</button>
                        <button type="button" class="btn btn-info" id="type-info">اطلاعات</button>
                        <button type="button" class="btn btn-warning" id="type-warning">هشدار</button>
                        <button type="button" class="btn btn-danger" id="type-error">خطا</button>
                        <button type="button" class="btn btn-secondary" id="type-question">سوال</button>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-12 mb-4">
                  <div class="card">
                    <h5 class="card-header heading-color">گزینه‌ها</h5>
                    <div class="card-body">
                      <div class="demo-inline-spacing">
                        <button type="button" class="btn btn-primary" id="custom-image">تصویر سفارشی</button>
                        <button type="button" class="btn btn-primary" id="auto-close">بسته شدن خودکار</button>
                        <button type="button" class="btn btn-primary" id="outside-click">کلیک در خارج</button>
                        <button type="button" class="btn btn-primary" id="progress-steps">قدم‌های پیشرفت</button>
                ...
                <div class="col-12">
                  <div class="card">
                    <h5 class="card-header heading-color">گزینه‌های تایید</h5>
                    <div class="card-body">
                      <div class="row g-2">
                        <div class="col-md-6 col-sm-12">
                          <p>عمل دکمه تایید</p>
                          <button type="button" class="btn btn-primary" id="confirm-text">هشدار</button>
                        </div>
                        <div class="col-md-6 col-sm-12">
                          <p>عمل دکمه تایید و انصراف</p>
                          <button type="button" class="btn btn-primary" id="confirm-color">هشدار</button>
                        </div>
                      </div>
                    </div>
                  </div>
