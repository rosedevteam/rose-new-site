...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>تنظیمات حساب - حساب | فرست - قالب مدیریت بوت‌استرپ</title>
                      ...
                      <form id="formAccountSettings" method="POST" onsubmit="return false">
                        <div class="row">
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <input type="text" class="form-control" id="organization" name="organization" value="مایکروسافت">
                          </div>
                          <div class="mb-3 col-md-6">
                            <label class="form-label" for="phoneNumber">شماره تلفن</label>
                            <div class="input-group input-group-merge">
                              <input type="text" id="phoneNumber" name="phoneNumber" class="form-control text-start" placeholder="202 555 0111" dir="ltr">
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <input type="text" class="form-control text-start" id="zipCode" name="zipCode" placeholder="231465" maxlength="6" dir="ltr">
                          </div>
                          <div class="mb-3 col-md-6">
