                ...
                <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
                  ...
                  <div class="card mb-4">
                    <div class="card-header">
                      <h5 class="card-title mb-3">تایید دو مرحله‌ای</h5>
                      <span class="card-subtitle">حساب خود را با یک قدم بیشتر امن کنید.</span>
                    </div>
                    <div class="card-body">
                      <h6>پیامک</h6>
                      <div class="d-flex justify-content-between border-bottom mb-4 pb-2">
                        <span class="d-inline-block" dir="ltr">+1 (968) 945-8832</span>
                      ...
                      <p class="mb-0">
                        ...
                        <a href="javascript:void(0);" class="text-body">آشنایی بیشتر.</a>
                      </p>
                    </div>
                  </div>
                  <!--/ Two-steps verification -->
                      ...
                      <table class="table border-top">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="text-truncate border-bottom-0">دوبی</td>
                            <td class="text-truncate border-bottom-0">21 فروردین 1401 - 12:22</td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
