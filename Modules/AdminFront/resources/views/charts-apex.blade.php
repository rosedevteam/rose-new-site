...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>Apex - نمودارها | فرست - قالب مدیریت بوت‌استرپ</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4"><span class="text-muted fw-light">نمودارها /</span> Apex</h4>
              ...
              <div class="row gy-4">
                ...
                <div class="col-12">
                  <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-md-center align-items-start">
                      <h5 class="card-title mb-0">علم داده</h5>
                      <div class="dropdown primary-font">
                ...
                <div class="col-12">
                  <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="card-title mb-0">داده‌های فناوری‌های نوین</h5>
                      <div class="btn-group d-none d-sm-flex primary-font" role="group" aria-label="radio toggle button group">
                        <input type="radio" class="btn-check" name="btnradio" id="dailyRadio" checked>
                        <label class="btn btn-outline-secondary" for="dailyRadio">روزانه</label>

                        <input type="radio" class="btn-check" name="btnradio" id="monthlyRadio">
                        <label class="btn btn-outline-secondary" for="monthlyRadio">ماهانه</label>

                        <input type="radio" class="btn-check" name="btnradio" id="yearlyRadio">
                        <label class="btn btn-outline-secondary" for="yearlyRadio">سالانه</label>
                      </div>
                    </div>
                    <div class="card-body">
                ...
                <div class="col-12">
                  <div class="card">
                    <div class="card-header d-flex justify-content-between">
                      <div>
                        <h5 class="card-title mb-1">موجودی</h5>
                        <small class="text-muted primary-font">شبکه‌های تجاری و سازمان‌ها</small>
                      </div>
                      <div class="d-sm-flex d-none align-items-center primary-font">
                        <h5 class="fw-bold mb-0 me-3">100,000 تومان</h5>
                ...
                <div class="col-md-6 col-12">
                  <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <div>
                        <p class="card-subtitle text-muted mb-1">موجودی</p>
                        <h5 class="card-title fw-bold mb-0 primary-font">74,382 تومان</h5>
                      </div>
                      <div class="dropdown primary-font">
                        <button type="button" class="btn dropdown-toggle px-0" data-bs-toggle="dropdown" aria-expanded="false">
                          <i class="bx bx-calendar"></i>
                ...
                <div class="col-md-6 col-12">
                  <div class="card">
                    <div class="card-header d-flex align-items-center justify-content-between">
                      <div>
                        <h5 class="card-title mb-1">قیمت‌های سهام‌ها</h5>
                        <p class="text-muted mb-0 primary-font">50,863 تومان</p>
                      </div>
                      <div class="dropdown primary-font">
                        <button type="button" class="btn dropdown-toggle px-0" data-bs-toggle="dropdown" aria-expanded="false">
                          <i class="bx bx-calendar"></i>
                ...
                <div class="col-md-6 col-12">
                  <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="card-title mb-0">وضعیت فروش روزانه</h5>
                      <div class="dropdown primary-font">
                ...
                <div class="col-md-6 col-12">
                  <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="card-title mb-0">مقایسه موبایل</h5>
                      <div class="dropdown primary-font">
                ...
                <div class="col-md-6 col-12">
                  <div class="card">
                    <div class="card-header d-flex align-items-center justify-content-between">
                      <div>
                        <h5 class="card-title mb-1">نسبت هزینه</h5>
                        <small class="text-muted primary-font">هزینه در دسته‌های مختلف</small>
                      </div>
                      <div class="dropdown d-none d-sm-flex primary-font">
                        <button type="button" class="btn dropdown-toggle px-0" data-bs-toggle="dropdown" aria-expanded="false">
                          <i class="bx bx-calendar"></i>
                        </button>
                        <ul class="dropdown-menu dropdown-menu-end">
