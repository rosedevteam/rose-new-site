...
<html lang="fa" class="light-style customizer-hide" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>فراموشی رمز عبور کاور - صفحات | فرست - قالب مدیریت بوت‌استرپ</title>
      ...
      <div class="authentication-inner row m-0">
        ...
        <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center">
          <div class="flex-row text-center mx-auto">
            <img src="../../assets/img/pages/forgot-password-light.png" alt="Auth Cover Bg color" width="520" class="img-fluid authentication-cover-img" data-app-light-img="pages/forgot-password-light.png" data-app-dark-img="pages/forgot-password-dark.png">
            <div class="mx-auto">
              <h3>نگران نباشید، ما دستورالعمل‌ها را برای شما ارسال خواهیم کرد</h3>
              <p>
                ما می‌توانیم به شما برای بازنشانی رمز عبور و اطلاعات امنیتی تان کمک کنیم. <br>
                ابتدا آدرس ایمیل خود را وارد کرده و روی ارسال لینک بازنشانی کلیک کنید.
              </p>
            </div>
          </div>
        </div>
