...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>فوتر - المان‌های رابط کاربری | فرست - قالب مدیریت بوت‌استرپ</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">المان‌های رابط کاربری /</span> فوتر
              </h4>

              <!-- Basic footer -->
              <section id="basic-footer">
                <h5 class="pb-1 mt-5 mb-4 secondary-font">فوتر پایه</h5>

                <footer class="lh-1-85 footer bg-light">
                  <div class="container-fluid d-flex flex-md-row flex-column justify-content-between align-items-md-center gap-1 container-p-x py-3">
                    <div>
                      <a href="https://demos.pixinvent.com/frest-html-admin-template/landing/" target="_blank" class="footer-text fw-semibold">فرست</a>
                      ©
                    </div>
                    <div>
                      <a href="https://themeforest.net/licenses/standard" class="footer-link me-4" target="_blank">لایسنس</a>
                      <a href="javascript:void(0)" class="footer-link me-4">راهنمایی</a>
                      <a href="javascript:void(0)" class="footer-link me-4">تماس</a>
                      <a href="javascript:void(0)" class="footer-link">قوانین و مقررات</a>
                    </div>
                  </div>
                </footer>
              </section>
              ...
              <section id="component-footer">
                <h5 class="pb-1 mb-4 secondary-font">فوتر با المان‌ها</h5>
                  ...
                  <div class="container-fluid d-flex flex-md-row flex-column justify-content-between align-items-md-center gap-1 container-p-x py-3">
                    ...
                    <div>
                      <div class="form-check form-control-sm footer-link me-3">
                        ...
                        <label class="form-check-label" for="customCheck2"> نمایش </label>
                      </div>
                      <div class="dropdown dropup footer-link me-3">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                          <a class="dropdown-item" href="javascript:void(0);"><i class="bx bx-dollar"></i> دلار</a>
                          <a class="dropdown-item" href="javascript:void(0);"><i class="bx bx-euro"></i> یورو</a>
                          <a class="dropdown-item" href="javascript:void(0);"><i class="bx bx-pound"></i> پوند</a>
                          <div class="dropdown-divider"></div>
                          <a class="dropdown-item" href="javascript:void(0);"><i class="bx bx-bitcoin"></i> بیت کوین</a>
                        </div>
                      </div>
                      <a href="javascript:void(0)" class="btn btn-sm btn-outline-danger"><i class="bx bx-log-out-circle me-1"></i>خروج</a>
                    </div>
                  </div>
                </footer>
              </section>
              ...
              <section id="color-footer">
                ...
                <footer class="lh-1-85 footer bg-primary mb-4">
                  <div class="container-fluid d-flex flex-md-row flex-column justify-content-between align-items-md-center gap-1 container-p-x py-3">
                    <div>
                      <a href="https://demos.pixinvent.com/frest-html-admin-template/landing/" target="_blank" class="footer-text fw-semibold">فرست</a>
                      ©
                ...
                <footer class="lh-1-85 footer bg-secondary mb-4">
                  <div class="container-fluid d-flex flex-md-row flex-column justify-content-between align-items-md-center gap-1 container-p-x py-3">
                    <div>
                      <a href="https://demos.pixinvent.com/frest-html-admin-template/landing/" target="_blank" class="footer-text fw-semibold">فرست</a>
                      ©
                ...
                <footer class="lh-1-85 footer bg-success mb-4">
                  <div class="container-fluid d-flex flex-md-row flex-column justify-content-between align-items-md-center gap-1 container-p-x py-3">
                    <div>
                      <a href="https://demos.pixinvent.com/frest-html-admin-template/landing/" target="_blank" class="footer-text fw-semibold">فرست</a>
                      ©
                ...
                <footer class="lh-1-85 footer bg-danger mb-4">
                  <div class="container-fluid d-flex flex-md-row flex-column justify-content-between align-items-md-center gap-1 container-p-x py-3">
                    <div>
                      <a href="https://demos.pixinvent.com/frest-html-admin-template/landing/" target="_blank" class="footer-text fw-semibold">فرست</a>
                      ©
                ...
                <footer class="lh-1-85 footer bg-warning mb-4">
                  <div class="container-fluid d-flex flex-md-row flex-column justify-content-between align-items-md-center gap-1 container-p-x py-3">
                    <div>
                      <a href="https://demos.pixinvent.com/frest-html-admin-template/landing/" target="_blank" class="footer-text fw-semibold">فرست</a>
                      ©
                ...
                <footer class="lh-1-85 footer bg-info mb-4">
                  <div class="container-fluid d-flex flex-md-row flex-column justify-content-between align-items-md-center gap-1 container-p-x py-3">
                    <div>
                      <a href="https://demos.pixinvent.com/frest-html-admin-template/landing/" target="_blank" class="footer-text fw-semibold">فرست</a>
                      ©
                ...
                <footer class="lh-1-85 footer bg-light mb-4">
                  <div class="container-fluid d-flex flex-md-row flex-column justify-content-between align-items-md-center gap-1 container-p-x py-3">
                    <div>
                      <a href="https://demos.pixinvent.com/frest-html-admin-template/landing/" target="_blank" class="footer-text fw-semibold">فرست</a>
                      ©
                ...
                <footer class="lh-1-85 footer bg-dark mb-4">
                  <div class="container-fluid d-flex flex-md-row flex-column justify-content-between align-items-md-center gap-1 container-p-x py-3">
                    <div>
                      <a href="https://demos.pixinvent.com/frest-html-admin-template/landing/" target="_blank" class="footer-text fw-semibold">فرست</a>
                      ©
                ...
                <footer class="lh-1-85 footer bg-footer-theme">
                  <div class="container-fluid d-flex flex-md-row flex-column justify-content-between align-items-md-center gap-1 container-p-x py-3">
                    <div>
                      <a href="https://demos.pixinvent.com/frest-html-admin-template/landing/" target="_blank" class="footer-text fw-semibold">فرست</a>
                      ©
              ...
              <section id="theme-footer">
                <h5 class="pb-1 mb-4 secondary-font">تم فوتر</h5>
              ...
              <section id="adv-footer">
                <h5 class="pb-1 mb-4 secondary-font">فوتر پیشرفته</h5>
                  ...
                  <div class="container-fluid container-p-x pt-5 pb-4">
                    <div class="row">
                      <div class="col-12 col-sm-6 col-md-3 mb-4 mb-sm-0">
                        <h4 class="mb-3">
                          <a href="https://demos.pixinvent.com/frest-html-admin-template/landing/" target="_blank" class="footer-text secondary-font">فرست
                          </a>
                        </h4>
                        <span>برای دنیایی بهتر آماده شوید</span>
                      ...
                      <div class="col-12 col-sm-6 col-md-3 mb-4 mb-md-0">
                        <h5 class="secondary-font">شرکت</h5>
                        <ul class="list-unstyled">
                          <li><a href="javascript:void(0)" class="footer-link d-block pb-2">درباره</a></li>
                          <li>
                            <a href="javascript:void(0)" class="footer-link d-block pb-2">حرفه <span class="badge bg-label-primary text-capitalize">ما استخدام می‌کنیم</span></a>
                          </li>
                          <li><a href="javascript:void(0)" class="footer-link d-block pb-2">بلاگ</a></li>
                          <li><a href="javascript:void(0)" class="footer-link d-block pb-2">مشتریان</a></li>
                          <li><a href="javascript:void(0)" class="footer-link d-block pb-2">استخدام کنید</a></li>
                          <li><a href="javascript:void(0)" class="footer-link d-block pb-2">سوالات متداول</a></li>
                        </ul>
                      </div>
                      <div class="col-12 col-sm-6 col-md-3 mb-4 mb-sm-0">
                        <h5 class="secondary-font">محصولات</h5>
                        <ul class="list-unstyled">
                          <li><a href="javascript:void(0)" class="footer-link d-block pb-2">قالب مدیریت</a></li>
                          <li>
                            <a href="javascript:void(0)" class="footer-link d-block pb-2">ابزار UI</a>
                          </li>
                          <li><a href="javascript:void(0)" class="footer-link d-block pb-2">راهنمای استایل</a></li>
                          <li><a href="javascript:void(0)" class="footer-link d-block pb-2">API</a></li>
                          <li><a href="javascript:void(0)" class="footer-link d-block pb-2">مستندات</a></li>
                          <li><a href="javascript:void(0)" class="footer-link d-block pb-2">تغییرات</a></li>
                        </ul>
                      </div>
                      <div class="col-12 col-sm-6 col-md-3">
                        <h5 class="secondary-font">ویژگی‌ها</h5>
                        <ul class="list-unstyled">
                          <li><a href="javascript:void(0)" class="footer-link d-block pb-2">برنامه‌های کاربردی</a></li>
                          <li>
                            <a href="javascript:void(0)" class="footer-link d-block pb-2">یکپارچه سازی</a>
                          </li>
                          <li><a href="javascript:void(0)" class="footer-link d-block pb-2">پشتیبانی</a></li>
                          <li><a href="javascript:void(0)" class="footer-link d-block pb-2">پیشنهادهای ویژه</a></li>
                          <li><a href="javascript:void(0)" class="footer-link d-block pb-2">صفحه ساز</a></li>
                          <li><a href="javascript:void(0)" class="footer-link d-block pb-2">پلن‌ها و قیمت‌گذاری</a></li>
                        </ul>
                      </div>
                    </div>
                  </div>
