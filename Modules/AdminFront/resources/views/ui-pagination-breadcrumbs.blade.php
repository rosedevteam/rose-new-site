...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>صفحه‌بندی و مسیرهای راهنما - المان‌های رابط کاربری | فرست - قالب مدیریت بوت‌استرپ</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">المان‌های رابط کاربری /</span> صفحه‌بندی و مسیرهای راهنما
              </h4>

              <div class="card mb-4">
                <h5 class="card-header heading-color">صفحه‌بندی</h5>
                <!-- Basic Pagination -->
                <div class="card-body">
              ...
              <!-- Pagination Sizes -->
              <div class="card mb-4">
                <h5 class="card-header heading-color">اندازه‌ها و تراز</h5>
                <div class="card-body">
                  <div class="row">
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-8">
                      <small class="text-light fw-semibold">ترازها</small>
                      <div class="demo-inline-spacing">
                        <nav aria-label="Page navigation">
                          <ul class="pagination">
                            <li class="page-item prev">
              ...
              <div class="card mb-4">
                <h5 class="card-header heading-color">گزینه‌های رنگ صفحه‌بندی</h5>
                <div class="card-body">
                  <div class="row">
                    <div class="col-lg-6">
                      <nav aria-label="Page navigation">
              ...
              <!-- Breadcrumb -->
              <div class="card">
                <h5 class="card-header heading-color">مسیرهای راهنما</h5>
                <div class="card-body">
                  <!-- Basic Breadcrumb -->
                  <nav aria-label="breadcrumb">
                    <ol class="lh-1-85 breadcrumb">
                      ...
                      <li class="breadcrumb-item">
                        <a href="javascript:void(0);">کتابخانه</a>
                      </li>
                      <li class="breadcrumb-item active">داده</li>
                    </ol>
                  </nav>
                  <!-- Basic Breadcrumb -->
