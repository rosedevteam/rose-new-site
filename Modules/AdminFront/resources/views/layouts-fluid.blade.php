...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>شناور - طرح‌ها | فرست - قالب مدیریت بوت‌استرپ</title>
            ...
            <div class="container-fluid flex-grow-1 container-p-y">
              ...
              <div class="layout-demo-wrapper">
                ...
                <div class="layout-demo-info">
                  <h4 class="secondary-font">طرح شناور</h4>
                  <p>طرح شناور یک <code>100% width</code> در هر نقطه شکست واکنش‌گرا تنظیم می‌کند.</p>
                </div>
              </div>
              <!--/ Layout Demo -->
            </div>
