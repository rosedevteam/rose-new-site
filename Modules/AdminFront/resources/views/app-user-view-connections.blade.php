          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">کاربر / نمایش /</span> اتصالات
              </h4>
              <div class="row gy-4">
                <!-- User Sidebar -->
                      ...
                      <div class="d-flex align-items-center mb-3">
                        ...
                        <div class="flex-grow-1 row">
                          <div class="col-9 mb-sm-0 mb-2">
                            ...
                            <small class="text-muted">تقویم و مخاطبین</small>
                          </div>
                      ...
                      <div class="d-flex align-items-center mb-3">
                        ...
                        <div class="flex-grow-1 row">
                          <div class="col-9 mb-sm-0 mb-2">
                            ...
                            <small class="text-muted">ارتباطات</small>
                          </div>
                          <div class="col-3 text-end">
                            <label class="switch me-0 mt-1">
                      ...
                      <div class="d-flex align-items-center mb-3">
                        ...
                        <div class="flex-grow-1 row">
                          <div class="col-9 mb-sm-0 mb-2">
                            ...
                            <small class="text-muted">مخازن گیت خود را مدیریت کنید</small>
                          </div>
                          <div class="col-3 text-end">
                            <label class="switch me-0 mt-1">
                              <input type="checkbox" class="switch-input" checked>
                      ...
                      <div class="d-flex align-items-center mb-3">
                        ...
                        <div class="flex-grow-1 row">
                          <div class="col-9 mb-sm-0 mb-2">
                            ...
                            <small class="text-muted">خدمات بازاریابی ایمیل</small>
                          </div>
                          <div class="col-3 text-end">
                            <label class="switch me-0 mt-1">
                              <input type="checkbox" class="switch-input" checked>
                      ...
                      <div class="d-flex align-items-center mb-3">
                        ...
                        <div class="flex-grow-1 row">
                          <div class="col-8 col-sm-7 mb-sm-0 mb-2">
                            ...
                            <small class="text-muted">متصل نشده</small>
                          </div>
                      ...
                      <div class="d-flex align-items-center mb-3">
                        ...
                        <div class="flex-grow-1 row">
                          <div class="col-8 col-sm-7 mb-sm-0 mb-2">
                            ...
                            <a href="https://twitter.com/pixinvents" class="small" target="_blank">@PIXINVENT</a>
                          </div>
                          <div class="col-4 col-sm-5 text-end">
