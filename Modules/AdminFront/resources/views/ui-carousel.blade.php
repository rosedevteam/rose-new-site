...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>گردونه - المان‌های رابط کاربری | فرست - قالب مدیریت بوت‌استرپ</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="row">
                <!-- Bootstrap carousel -->
                <div class="col-md">
                  <h5 class="my-4 secondary-font">گردونه بوت‌استرپ</h5>
                ...
                <div class="col-md">
                  <h5 class="my-4 secondary-font">گردونه محو شونده بوت‌استرپ (تیره)</h5>
              ...
              <h5 class="mt-4 mb-3 pt-2 secondary-font">گردونه Swiper</h5>
              <div class="row">
                <!-- Default -->
                <div class="col-md-6 mb-4">
                  <h6 class="text-muted mt-3">پیش‌فرض</h6>
                  <div class="swiper" id="swiper-default">
                    <div class="swiper-wrapper">
                      ...
                      <div class="swiper-slide" style="background-image: url(../../assets/img/elements/12.jpg)">
                        اسلاید 3
                      </div>
                      <div class="swiper-slide" style="background-image: url(../../assets/img/elements/7.jpg)">
                        اسلاید 4
                      </div>
                      <div class="swiper-slide" style="background-image: url(../../assets/img/elements/11.jpg)">
                        اسلاید 5
                      </div>
                    </div>
                  </div>
                ...
                <!-- With pagination -->
                <div class="col-md-6 mb-4">
                  <h6 class="text-muted mt-3">با صفحه‌بندی</h6>
                ...
                <!-- With progress -->
                <div class="col-md-6 mb-4">
                  <h6 class="text-muted mt-3">با پیشرفت</h6>
                ...
                <!-- With scrollbar -->
                <div class="col-md-6 mb-4">
                  <h6 class="text-muted mt-3">با نوار اسکرول</h6>
                ...
                <!-- Vertical -->
                <div class="col-md-6 mb-4">
                  <h6 class="text-muted mt-3">عمودی</h6>
                ...
                <!-- 3D cube effect -->
                <div class="col-md-6 mb-4">
                  <h6 class="text-muted mt-3">جلوه جعبه 3 بعدی</h6>
                ...
                <!-- 3D flip effect -->
                <div class="col-md-6 mb-4">
                  <h6 class="text-muted mt-3">جلوه چرخش 3 بعدی</h6>
                ...
                <!-- Gallery effect-->
                <div class="col-12">
                  <h6 class="text-muted mt-3">گالری تصاویر بندانگشتی</h6>
                  <div id="swiper-gallery">
                    <div class="swiper gallery-top">
                      <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide" style="background-image: url(../../assets/img/backgrounds/5.jpg)">
                          اسلاید 2
                        </div>
                        <div class="swiper-slide" style="background-image: url(../../assets/img/backgrounds/7.jpg)">
                          اسلاید 3
                        </div>
                        <div class="swiper-slide" style="background-image: url(../../assets/img/backgrounds/10.jpg)">
                          اسلاید 4
                        </div>
                        <div class="swiper-slide" style="background-image: url(../../assets/img/backgrounds/16.jpg)">
                          اسلاید 5
                        </div>
                      </div>
                      <!-- Add Arrows -->
