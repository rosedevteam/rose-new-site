...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>آواتار - رابط کاربری توسعه یافته | فرست - قالب مدیریت بوت‌استرپ</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">رابط کاربری توسعه یافته /</span> آواتار
              </h4>
              <div class="row">
                <div class="col-md-6">
                  <!-- Avatar Sizes -->
                ...
                <div class="col-md-6">
                  <!-- Avatar Initials -->
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">حروف اول</h5>
                    <div class="card-body">
                      <div class="d-flex align-items-center flex-wrap">
                        <div class="avatar avatar-xs me-2">
                          <span class="avatar-initial rounded-circle bg-primary">آب</span>
                        </div>
                        <div class="avatar avatar-sm me-2">
                          <span class="avatar-initial rounded-circle">آب</span>
                        </div>
                        <div class="avatar me-2">
                          <span class="avatar-initial rounded-circle bg-success">آب</span>
                        </div>
                        <div class="avatar avatar-md me-2">
                          <span class="avatar-initial rounded-circle bg-danger">آب</span>
                        </div>
                        <div class="avatar avatar-lg me-2">
                          <span class="avatar-initial rounded-circle bg-warning">آب</span>
                        </div>
                        <div class="avatar avatar-xl">
                          <span class="avatar-initial rounded-circle bg-info">آب</span>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">حروف اول برچسب</h5>
                    <div class="card-body">
                      <div class="d-flex align-items-center flex-wrap">
                        <div class="avatar avatar-xs me-2">
                          <span class="avatar-initial rounded-circle bg-label-primary">آب</span>
                        </div>
                        <div class="avatar avatar-sm me-2">
                          <span class="avatar-initial rounded-circle bg-label-secondary">آب</span>
                        </div>
                        <div class="avatar me-2">
                          <span class="avatar-initial rounded-circle bg-label-success">آب</span>
                        </div>
                        <div class="avatar avatar-md me-2">
                          <span class="avatar-initial rounded-circle bg-label-danger">آب</span>
                        </div>
                        <div class="avatar avatar-lg me-2">
                          <span class="avatar-initial rounded-circle bg-label-warning">آب</span>
                        </div>
                        <div class="avatar avatar-xl me-2">
                          <span class="avatar-initial rounded-circle bg-label-info">آب</span>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-md-6">
                  <!-- Avatar Shapes -->
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">شکل‌ها</h5>
                    <div class="card-body">
                      <div class="d-flex align-items-center my-3">
                        ...
                        <div class="avatar me-2">
                          <img src="../../assets/img/avatars/1.png" alt="آواتار" class="rounded">
                        </div>
                        <div class="avatar">
                ...
                <div class="col-md-6">
                  ...
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">نشانگر وضعیت</h5>
                    <div class="card-body">
                      <div class="d-flex align-items-center">
                ...
                <div class="col-md-6">
                  <!-- Avatar Status Indicator -->
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">آواتار برچسب با نشانگر وضعیت</h5>
                    <div class="card-body">
                      <div class="d-flex align-items-center">
                        <div class="avatar me-2 avatar-online">
                          <span class="avatar-initial rounded-circle bg-label-success">آب</span>
              ...
              <!-- Avatar Group -->
              <div class="card">
                <h5 class="card-header heading-color">گروه آواتار</h5>
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                      <small class="text-light fw-semibold">کشیدن به بالا</small>
                      <div class="d-flex align-items-center avatar-group my-3">
                        <div class="avatar">
                          <img src="../../assets/img/avatars/5.png" alt="آواتار" class="rounded-circle pull-up">
                        </div>
                        <div class="avatar">
                          <img src="../../assets/img/avatars/12.png" alt="آواتار" class="rounded-circle pull-up">
                        </div>
                        <div class="avatar">
                          <img src="../../assets/img/avatars/6.png" alt="آواتار" class="rounded-circle pull-up">
                        </div>
                        <div class="avatar">
                          <img src="../../assets/img/avatars/10.png" alt="آواتار" class="rounded-circle pull-up">
                        </div>
                      </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                      <small class="text-light fw-semibold">کشیدن به بالا با تولتیپ</small>
                      <ul class="list-unstyled m-0 d-flex align-items-center avatar-group my-3">
                        <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" title="تونی استارک" class="avatar pull-up">
                          <img class="rounded-circle" src="../../assets/img/avatars/5.png" alt="آواتار">
                        </li>
                        <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" title="استیو راجرز" class="avatar pull-up">
                          <img class="rounded-circle" src="../../assets/img/avatars/12.png" alt="آواتار">
                        </li>
                        <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" title="بری الن" class="avatar pull-up">
                          <img class="rounded-circle" src="../../assets/img/avatars/6.png" alt="آواتار">
                        </li>
                        <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" title="جسیکا آلبا" class="avatar pull-up">
                          <img class="rounded-circle" src="../../assets/img/avatars/10.png" alt="آواتار">
                        </li>
                      </ul>
                    </div>
                    <div class="col-md-3 col-sm-6">
                      <small class="text-light fw-semibold">آواتار با تعداد </small>
                      <div class="d-flex align-items-center avatar-group my-3">
                        <div class="avatar">
                          <img src="../../assets/img/avatars/5.png" alt="آواتار" class="rounded-circle pull-up">
                        </div>
                        ...
                        <div class="avatar">
                          <span class="avatar-initial rounded-circle pull-up bg-secondary" data-bs-toggle="tooltip" data-bs-placement="bottom" title="3 مورد بیشتر">+3</span>
                        </div>
                      </div>
                    </div>
                  </div>
