...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>سوالات متداول - صفحات | فرست - قالب مدیریت بوت‌استرپ</title>
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="col-lg-3 col-md-4 col-12 mb-md-0 mb-3">
                  <div class="d-flex justify-content-between flex-column mb-2 mb-md-0">
                    ...
                    <div class="d-none d-md-block">
                      <div class="mt-5">
                        <img src="../../assets/img/illustrations/boy-working-light.png" class="img-fluid scaleX-n1" alt="FAQ Image" data-app-light-img="illustrations/boy-working-light.png" data-app-dark-img="illustrations/boy-working-dark.png">
                      </div>
                    </div>
                  </div>
                </div>
                        ...
                        <div class="card accordion-item active">
                          <h2 class="accordion-header">
                            <button class="accordion-button" type="button" data-bs-toggle="collapse" aria-expanded="true" data-bs-target="#accordionPayment-1" aria-controls="accordionPayment-1">
                              چه زمانی برای سفارش من پرداخت می شود؟
                            </button>
                          </h2>
                        ...
                        <div class="card accordion-item">
                          ...
                          <div id="accordionPayment-3" class="accordion-collapse collapse">
                            <div class="accordion-body lh-2">
                              ...
                              <a href="javascript:void(0);">لورم ایپسوم متن</a> لورم ایپسوم متن ساختگی با تولید سادگی
                        ...
                        <div class="card accordion-item">
                          ...
                          <div id="accordionDelivery-4" class="accordion-collapse collapse">
                            <div class="accordion-body lh-2">
                              ...
                              <a href="javascript:void(0);">تیم پشتیبانی</a>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="card accordion-item">
                          ...
                          <div id="accordionCancellation-2" class="accordion-collapse collapse">
                            <div class="accordion-body lh-2">
                              ...
                              <a href="javascript:void(0);">تیم پشتیبانی</a>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="card accordion-item active">
                          ...
                          <div id="accordionOrders-1" class="accordion-collapse collapse show">
                            <div class="accordion-body lh-2">
                              ...
                              <p class="mb-0">
                                لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان <strong>1-000-000-000</strong>.
                              </p>
                            </div>
                          </div>
                        </div>
                          ...
                          <div id="accordionOrders-3" class="accordion-collapse collapse">
                            <div class="accordion-body lh-2">
                              <p>
                                ...
                                <a href="javascript:void(0);">لورم</a> لورم ایپسوم <strong>لورم ایپسوم</strong>.
                              </p>
                              <p class="mb-0">
                                لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت
                                <a href="javascript:void(0);">لورم</a> لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم
                              </p>
                            </div>
                          </div>
                        </div>
                      ...
                      <div id="accordionProduct" class="accordion accordion-header-primary">
                        ...
                        <div class="card accordion-item">
                          ...
                          <div id="accordionProduct-2" class="accordion-collapse collapse">
                            <div class="accordion-body lh-2">
                              لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و <a href="javascript:void(0);">لورم</a>.
                            </div>
                          </div>
                        </div>
              ...
              <div class="row mt-5">
                <div class="col-12 text-center mb-4">
                  ...
                  <p>
                    اگر سوالی را در سوالات متداول ما پیدا نمی کنید، همواره می توانید با ما تماس بگیرید. ما در اسرع وقت به شما پاسخ می دهیم.
                  </p>
                </div>
              </div>
              <div class="row text-center justify-content-center gap-sm-0 gap-3">
                <div class="col-sm-6">
                  <div class="py-3 rounded bg-faq-section text-center">
                    ...
                    <h4 class="mb-2"><a class="h4" href="tel:+(810)25482568" dir="ltr">+ (810) 2548 2568</a></h4>
