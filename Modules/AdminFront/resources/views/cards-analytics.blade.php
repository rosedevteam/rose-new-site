...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>کارت‌های تجزیه و تحلیل - المان‌های رابط کاربری | فرست - قالب مدیریت بوت‌استرپ</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">المان‌های رابط کاربری /</span> کارت‌های تجزیه و تحلیل
              </h4>
              ...
              <div class="row">
                    ...
                    <div class="col-sm-6 col-12 mb-4">
                      <div class="card h-100">
                        <div class="card-body text-center">
                          ...
                          <small class="text-muted">ارجاع 40%</small>
                      ...
                      <div class="card h-100">
                        <div class="card-header d-flex justify-content-between pb-3">
                          <div class="conversion-title">
                            <h5 class="card-title mb-0">تبدیل</h5>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12 mb-0 mb-sm-4 order-2 order-lg-0">
                  <div class="card h-100">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="card-title mb-0">نمودار Gauge</h5>
                      <div class="dropdown primary-font">
                    ...
                    <div class="card-body text-center">
                      <div id="timeSpentGaugeChart" class="mb-2"></div>
                      <small>در طول سال های 1400 و 1401، تغییرات عمیقی در چشم انداز فناوری رخ داده است. </small>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="card h-100">
                    <div class="row row-bordered m-0">
                      ...
                      <div class="col-md-4 col-12 px-0">
                        ...
                        <div class="card-body">
                          <h6 class="mt-0 mb-1">هفته قبل</h6>
