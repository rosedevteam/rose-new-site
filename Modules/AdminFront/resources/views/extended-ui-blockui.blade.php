...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>رابط کاربری بلوک - رابط کاربری توسعه یافته | فرست - قالب مدیریت بوت‌استرپ</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">رابط کاربری توسعه یافته /</span> رابط کاربری بلوک
              </h4>
              ...
              <div class="row">
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      ...
                      <div class="demo-inline-spacing">
                        <button class="btn btn-primary btn-section-block">پیش‌فرض</button>
                        <button class="btn btn-primary btn-section-block-overlay">رنگ لایه رویی</button>
                        <button class="btn btn-primary btn-section-block-spinner">چرخنده سفارشی</button>
                        <button class="btn btn-primary btn-section-block-custom">پیام سفارشی</button>
                        <button class="btn btn-primary btn-section-block-multiple">چند پیام</button>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-xl-6 col-12">
                  <div class="card mb-4" id="card-block">
                    <h5 class="card-header heading-color">بلوک کارت</h5>
                    <div class="card-body">
                      <p class="card-text">
                        لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد.
                      </p>
                      ...
                      <div class="block-ui-btn demo-inline-spacing">
                        <button class="btn btn-primary btn-card-block">پیش‌فرض</button>
                        <button class="btn btn-primary btn-card-block-overlay">رنگ لایه رویی</button>
                        <button class="btn btn-primary btn-card-block-spinner">چرخنده سفارشی</button>
                        <button class="btn btn-primary btn-card-block-custom">پیام سفارشی</button>
                        <button class="btn btn-primary btn-card-block-multiple">چند پیام</button>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-xl-6 col-12">
                  <div class="card mb-4" id="page-block">
                    <h5 class="card-header heading-color">بلوک صفحه</h5>
                    <div class="card-body">
                      <p class="card-text">
                        لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد.
                      </p>
                      ...
                      <div class="block-ui-btn demo-inline-spacing">
                        <button class="btn btn-primary btn-page-block">پیش‌فرض</button>
                        <button class="btn btn-primary btn-page-block-overlay">رنگ لایه رویی</button>
                        <button class="btn btn-primary btn-page-block-spinner">چرخنده سفارشی</button>
                        <button class="btn btn-primary btn-page-block-custom">پیام سفارشی</button>
                        <button class="btn btn-primary btn-page-block-multiple">چند پیام</button>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-xl-6 col-12">
                  <div class="card">
                    <h5 class="card-header heading-color">بلوک فرم</h5>
                    <div class="card-body">
                      <div class="p-2 form-block">
                        <div class="mb-3">
                          <label class="form-label" for="username">نام کاربری</label>
                          <input class="form-control text-start" type="text" id="username" placeholder="نام کاربری" dir="ltr">
                        </div>
                        <div class="mb-3">
                          <label class="form-label" for="email">ایمیل</label>
                          <input class="form-control text-start" type="email" id="email" placeholder="ایمیل" dir="ltr">
                        </div>
                        <div class="mb-3">
                          <label class="form-label" for="password">رمز عبور</label>
                          <input class="form-control text-start" type="password" id="password" placeholder="رمز عبور" dir="ltr">
                        </div>
                        <div class="mb-3 text-end">
                          <button class="btn btn-primary disabled me-sm-3 me-1">ثبت</button>
                          <button class="btn btn-label-secondary disabled">بازنشانی</button>
                        </div>
                      </div>
                      <div class="block-ui-btn demo-inline-spacing">
                        <button class="btn btn-primary btn-form-block">پیش‌فرض</button>
                        <button class="btn btn-primary btn-form-block-overlay">رنگ لایه رویی</button>
                        <button class="btn btn-primary btn-form-block-spinner">چرخنده سفارشی</button>
                        <button class="btn btn-primary btn-form-block-custom">پیام سفارشی</button>
                        <button class="btn btn-primary btn-form-block-multiple">چند پیام</button>
                      </div>
                    </div>
                  </div>
                </div>
