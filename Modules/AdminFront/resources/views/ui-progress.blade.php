...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>نوارهای پیشرفت - المان‌های رابط کاربری | فرست - قالب مدیریت بوت‌استرپ</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">المان‌های رابط کاربری /</span> نوارهای پیشرفت
              </h4>

              <!-- Options -->
              <div class="card mb-4">
                <h5 class="card-header heading-color">نوارهای پیشرفت</h5>
                <div class="card-body">
                ...
                <hr class="m-0">
                <div class="card-body">
                  <div class="text-light small fw-semibold">ارتفاع</div>
                  <div class="demo-vertical-spacing">
                ...
                <hr class="m-0">
                <div class="card-body">
                  <div class="text-light small fw-semibold">با برچسب</div>
                  <div class="demo-vertical-spacing">
                    <div class="progress">
              ...
              <!-- Backgrounds -->
              <div class="card mb-4">
                <h5 class="card-header heading-color">پس زمینه ها</h5>
                <div class="card-body">
              ...
              <!-- Striped -->
              <div class="card mb-4">
                <h5 class="card-header heading-color">راه راه</h5>
                <div class="card-body">
                  <div class="demo-vertical-spacing demo-only-element">
                    <div class="progress">
              ...
              <!-- Animated -->
              <div class="card mb-4">
                <h5 class="card-header heading-color">متحرک</h5>
                <div class="card-body">
                  <div class="demo-vertical-spacing demo-only-element">
                    <div class="progress">
              ...
              <!-- Multiple bars -->
              <div class="card mb-4">
                <h5 class="card-header heading-color">نوارهای چندگانه</h5>
                <div class="card-body">
                  <div class="text-light small fw-semibold mb-1 lh-2">پیش‌فرض</div>
                  ...
                  <div class="text-light small fw-semibold mb-1 lh-2">راه راه</div>
                  <div class="progress mb-3">
                  ...
                  <div class="text-light small fw-semibold mb-1 lh-2">متحرک</div>
                  <div class="progress">
              ...
              <!-- Stacked bars -->
              <div class="card">
                <h5 class="card-header heading-color">نوارهای انباشته</h5>
                <div class="card-body">
