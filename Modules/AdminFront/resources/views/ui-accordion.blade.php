...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>باز و بسته شونده - المان‌های رابط کاربری | فرست - قالب مدیریت بوت‌استرپ</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">المان‌های رابط کاربری /</span> باز و بسته شونده
              </h4>

              <!-- Accordion -->
              <h5 class="secondary-font">باز و بسته شونده</h5>
              <div class="row gy-4">
                <!-- Accordion Header Color -->
                <div class="col-md">
                  <small class="text-light fw-semibold">رنگ سرتیتر باز و بسته شونده</small>
                ...
                <!-- Accordion with Icon -->
                <div class="col-md">
                  <small class="text-light fw-semibold">باز و بسته شونده با آیکن (همیشه باز)</small>
              ...
              <!-- Accordion Basic -->
              <h5 class="secondary-font">باز و بسته شونده پایه</h5>
              <div class="row gy-4">
                <div class="col-md">
                  <small class="text-light fw-semibold">باز و بسته شونده پایه</small>
                  <div class="accordion mt-3" id="accordionExample">
                    <div class="card accordion-item active">
                      <h2 class="accordion-header" id="headingOne">
                        <button type="button" class="accordion-button" data-bs-toggle="collapse" data-bs-target="#accordionOne" aria-expanded="true" aria-controls="accordionOne">
                          آیتم باز و بسته شونده 1
                        </button>
                      </h2>
                ...
                <div class="col-md">
                  <small class="text-light fw-semibold">باز و بسته شونده بدون فلش</small>
