          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="card-body">
                      <form>
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="basic-default-name" placeholder="جان اسنو">
                          </div>
                        </div>
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-company">شرکت</label>
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="basic-default-company" placeholder="مایکروسافت">
                          </div>
                        </div>
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-email">ایمیل</label>
                          <div class="col-sm-10">
                        ...
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-phone">شماره تلفن</label>
                          <div class="col-sm-10">
                            <input type="text" id="basic-default-phone" class="form-control phone-mask text-start" placeholder="658 799 8941" aria-label="658 799 8941" aria-describedby="basic-default-phone" dir="ltr">
                          </div>
                        </div>
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-message">پیام</label>
                          <div class="col-sm-10">
                            <textarea id="basic-default-message" class="form-control" placeholder="متن پیام را اینجا بنویسید" aria-label="Hi, Do you have a moment to talk Joe?" aria-describedby="basic-icon-default-message2"></textarea>
                          </div>
                        </div>
                ...
                <div class="col-xxl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form>
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-icon-default-fullname">نام</label>
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                        ...
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-icon-default-company">شرکت</label>
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                        ...
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-icon-default-email">ایمیل</label>
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                        ...
                        <div class="row mb-3">
                          <label class="col-sm-2 form-label" for="basic-icon-default-phone">شماره تلفن</label>
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                        ...
                        <div class="row mb-3">
                          <label class="col-sm-2 form-label" for="basic-icon-default-message">پیام</label>
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
              ...
              <div class="row">
                ...
                <div class="col-xxl">
                  <div class="card mb-4">
                    ...
                    <form class="card-body">
                      <h6 class="mb-b fw-normal">1. جزئیات حساب</h6>
                      <div class="row mb-3">
                        <label class="col-sm-3 col-form-label" for="multicol-username">نام کاربری</label>
                        <div class="col-sm-9">
                          <input type="text" id="multicol-username" class="form-control text-start" placeholder="john.doe" dir="ltr">
                        </div>
                      </div>
                      <div class="row mb-3">
                        <label class="col-sm-3 col-form-label" for="multicol-email">ایمیل</label>
                        <div class="col-sm-9">
                          <div class="input-group input-group-merge">
                      ...
                      <div class="row form-password-toggle">
                        <label class="col-sm-3 col-form-label" for="multicol-password">رمز عبور</label>
                        <div class="col-sm-9">
                          <div class="input-group input-group-merge">
                      ...
                      <div class="row mb-3">
                        <label class="col-sm-3 col-form-label" for="multicol-full-name">نام کامل</label>
                        <div class="col-sm-9">
                          <input type="text" id="multicol-full-name" class="form-control" placeholder="جان اسنو">
                        </div>
                      </div>
                      <div class="row mb-3">
                        <label class="col-sm-3 col-form-label" for="multicol-country">کشور</label>
                        <div class="col-sm-9">
                      ...
                      <div class="row mb-3 select2-primary">
                        <label class="col-sm-3 col-form-label" for="multicol-language">زبان</label>
                        <div class="col-sm-9">
                      ...
                      <div class="row mb-3">
                        <label class="col-sm-3 col-form-label" for="multicol-birthdate">تاریخ تولد</label>
                        <div class="col-sm-9">
                          <input type="text" id="multicol-birthdate" class="form-control dob-picker" placeholder="YYYY/MM/DD">
                        </div>
                      </div>
                      <div class="row">
                        <label class="col-sm-3 col-form-label" for="multicol-phone">شماره تلفن</label>
                        <div class="col-sm-9">
                      ...
                      <div class="pt-4">
                        <div class="row justify-content-end">
                          <div class="col-sm-9">
                            <button type="submit" class="btn btn-primary me-sm-2 me-1">ثبت</button>
                ...
                <div class="col-xxl">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">تراز برچسب فرم</h5>
                    <form class="card-body">
                      <h6 class="mb-b fw-normal">1. جزئیات حساب</h6>
                      <div class="row mb-3">
                        <label class="col-sm-3 col-form-label text-sm-end" for="alignment-username">نام کاربری</label>
                        <div class="col-sm-9">
                          <input type="text" id="alignment-username" class="form-control text-start" placeholder="john.doe" dir="ltr">
                        </div>
                      </div>
                      <div class="row mb-3">
                        <label class="col-sm-3 col-form-label text-sm-end" for="alignment-email">ایمیل</label>
                        <div class="col-sm-9">
                          <div class="input-group input-group-merge">
                            <span class="input-group-text" id="alignment-email2" dir="ltr">@example.com</span>
                            <input type="text" id="alignment-email" class="form-control text-start" placeholder="john.doe" aria-label="john.doe" aria-describedby="alignment-email2" dir="ltr">
                          </div>
                        </div>
                      </div>
                      <div class="row mb-3 form-password-toggle">
                        <label class="col-sm-3 col-form-label text-sm-end" for="alignment-password">رمز عبور</label>
                        <div class="col-sm-9">
                          <div class="input-group input-group-merge">
                            <input type="password" id="alignment-password" class="form-control text-start" placeholder="············" dir="ltr" aria-describedby="alignment-password2">
                      ...
                      <h6 class="mb-3 fw-normal">2. اطلاعات شخصی</h6>
                      <div class="row mb-3">
                        <label class="col-sm-3 col-form-label text-sm-end" for="alignment-full-name">نام کامل</label>
                        <div class="col-sm-9">
                          <input type="text" id="alignment-full-name" class="form-control" placeholder="جان اسنو">
                        </div>
                      </div>
                      <div class="row mb-3">
                        <label class="col-sm-3 col-form-label text-sm-end" for="alignment-country">کشور</label>
                        <div class="col-sm-9">
                      ...
                      <div class="row mb-3 select2-primary">
                        <label class="col-sm-3 col-form-label text-sm-end" for="alignment-language">زبان</label>
                        <div class="col-sm-9">
                      ...
                      <div class="row mb-3">
                        <label class="col-sm-3 col-form-label text-sm-end" for="alignment-birthdate">تاریخ تولد</label>
                        <div class="col-sm-9">
                          <input type="text" id="alignment-birthdate" class="form-control dob-picker" placeholder="YYYY/MM/DD">
                        </div>
                      </div>
                      <div class="row">
                        <label class="col-sm-3 col-form-label text-sm-end" for="alignment-phone">شماره تلفن</label>
                        <div class="col-sm-9">
                          <input type="text" id="alignment-phone" class="form-control phone-mask text-start" placeholder="658 799 8941" dir="ltr" aria-label="658 799 8941">
                        </div>
                      </div>
                      <div class="pt-4">
                        <div class="row justify-content-end">
              ...
              <div class="row my-4">
                <div class="col">
                  <h6 class="secondary-font">بخش قابل جمع شدن</h6>
                      ...
                      <div id="collapseDeliveryAddress" class="accordion-collapse collapse show" aria-labelledby="headingDeliveryAddress" data-bs-parent="#collapsibleSection">
                        <div class="accordion-body">
                          <div class="row g-3">
                            <div class="col-md-6">
                              <div class="row">
                                <label class="col-sm-3 col-form-label text-sm-end" for="collapsible-fullname">نام کامل</label>
                                <div class="col-sm-9">
              ...
              <div class="row">
                <div class="col">
                  <h6 class="mt-4 secondary-font">فرم دارای سربرگ</h6>
                  <div class="card mb-3">
                      ...
                      <div class="tab-pane fade active show" id="form-tabs-personal" role="tabpanel">
                        <form>
                          <div class="row g-3">
                            <div class="col-md-6">
                              <div class="row">
                                <label class="col-sm-3 col-form-label text-sm-end" for="formtabs-first-name">نام</label>
                                <div class="col-sm-9">
                                  <input type="text" id="formtabs-first-name" class="form-control" placeholder="جان">
                                </div>
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="row">
                                <label class="col-sm-3 col-form-label text-sm-end" for="formtabs-last-name">نام خانوادگی</label>
                                <div class="col-sm-9">
                                  <input type="text" id="formtabs-last-name" class="form-control" placeholder="اسنو">
                                </div>
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="row">
                                <label class="col-sm-3 col-form-label text-sm-end" for="formtabs-country">کشور</label>
                                <div class="col-sm-9">
                            ...
                            <div class="col-md-6 select2-primary">
                              <div class="row">
                                <label class="col-sm-3 col-form-label text-sm-end" for="formtabs-language">زبان</label>
                                <div class="col-sm-9">
                            ...
                            <div class="col-md-6">
                              <div class="row">
                                <label class="col-sm-3 col-form-label text-sm-end" for="formtabs-birthdate">تاریخ تولد</label>
                                <div class="col-sm-9">
                            ...
                            <div class="col-md-6">
                              <div class="row">
                                <label class="col-sm-3 col-form-label text-sm-end" for="formtabs-phone">شماره تلفن</label>
                                <div class="col-sm-9">
                                  <input type="text" id="formtabs-phone" class="form-control phone-mask text-start" placeholder="658 799 8941" dir="ltr" aria-label="658 799 8941">
                                </div>
                              </div>
                            </div>
                          </div>
                      ...
                      <div class="tab-pane fade" id="form-tabs-account" role="tabpanel">
                        <form>
                          <div class="row g-3">
                            <div class="col-md-6">
                              <div class="row">
                                <label class="col-sm-3 col-form-label text-sm-end" for="formtabs-username">نام کاربری</label>
                                <div class="col-sm-9">
                                  <input type="text" id="formtabs-username" class="form-control text-start" placeholder="john.doe" dir="ltr">
                                </div>
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="row">
                                <label class="col-sm-3 col-form-label text-sm-end" for="formtabs-email">ایمیل</label>
                                <div class="col-sm-9">
                                  <div class="input-group input-group-merge">
                                    <span class="input-group-text" id="formtabs-email2" dir="ltr">@example.com</span>
                                    <input type="text" id="formtabs-email" class="form-control text-start" placeholder="john.doe" aria-label="john.doe" aria-describedby="formtabs-email2" dir="ltr">
                                  </div>
                                </div>
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="row form-password-toggle">
                                <label class="col-sm-3 col-form-label text-sm-end" for="formtabs-password">رمز عبور</label>
                                <div class="col-sm-9">
                                  <div class="input-group input-group-merge">
                                    <input type="password" id="formtabs-password" class="form-control text-start" placeholder="············" dir="ltr" aria-describedby="formtabs-password2">
                            ...
                            <div class="col-md-6">
                              <div class="row form-password-toggle">
                                <label class="col-sm-3 col-form-label text-sm-end" for="formtabs-confirm-password">تایید</label>
                                <div class="col-sm-9">
                                  <div class="input-group input-group-merge">
                                    <input type="password" id="formtabs-confirm-password" class="form-control text-start" placeholder="············" dir="ltr" aria-describedby="formtabs-confirm-password2">
                      ...
                      <div class="tab-pane fade" id="form-tabs-social" role="tabpanel">
                        <form>
                          <div class="row g-3">
                            <div class="col-md-6">
                              <div class="row">
                                <label class="col-sm-3 col-form-label text-sm-end" for="formtabs-twitter">توییتر</label>
                                <div class="col-sm-9">
                                  <input type="text" id="formtabs-twitter" class="form-control text-start" dir="ltr" placeholder="https://twitter.com/abc">
                                </div>
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="row">
                                <label class="col-sm-3 col-form-label text-sm-end" for="formtabs-facebook">فیسبوک</label>
                                <div class="col-sm-9">
                                  <input type="text" id="formtabs-facebook" class="form-control text-start" dir="ltr" placeholder="https://facebook.com/abc">
                                </div>
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="row">
                                <label class="col-sm-3 col-form-label text-sm-end" for="formtabs-google">گوگل+</label>
                                <div class="col-sm-9">
                                  <input type="text" id="formtabs-google" class="form-control text-start" dir="ltr" placeholder="https://plus.google.com/abc">
                                </div>
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="row">
                                <label class="col-sm-3 col-form-label text-sm-end" for="formtabs-linkedin">لینکدین</label>
                                <div class="col-sm-9">
                                  <input type="text" id="formtabs-linkedin" class="form-control text-start" dir="ltr" placeholder="https://linkedin.com/abc">
                                </div>
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="row">
                                <label class="col-sm-3 col-form-label text-sm-end" for="formtabs-instagram">اینستاگرام</label>
                                <div class="col-sm-9">
                                  <input type="text" id="formtabs-instagram" class="form-control text-start" dir="ltr" placeholder="https://instagram.com/abc">
                                </div>
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="row">
                                <label class="col-sm-3 col-form-label text-sm-end" for="formtabs-quora">کورا</label>
                                <div class="col-sm-9">
                                  <input type="text" id="formtabs-quora" class="form-control text-start" dir="ltr" placeholder="https://quora.com/abc">
                                </div>
                              </div>
                            </div>
                          </div>
              ...
              <!-- Form Alignment -->
              <div class="card">
                <h5 class="card-header heading-color">تراز فرم</h5>
                <div class="card-body">
                  <div class="d-flex align-items-center justify-content-center h-px-500">
                    <form class="w-px-500 border rounded p-3 p-md-5">
                      ...
                      <div class="row mb-3">
                        <label class="col-sm-3 col-form-label" for="form-alignment-username">نام کاربری</label>
                        <div class="col-sm-9">
                          <input type="text" id="form-alignment-username" class="form-control text-start" placeholder="john.doe" dir="ltr">
                        </div>
                      </div>

                      <div class="row mb-3 form-password-toggle">
                        <label class="col-sm-3 col-form-label" for="form-alignment-password">رمز عبور</label>
                        <div class="col-sm-9">
                          <div class="input-group input-group-merge">
                            <input type="password" id="form-alignment-password" class="form-control text-start" placeholder="············" dir="ltr" aria-describedby="form-alignment-password2">
                      ...
                      <div class="mb-3">
                        <label class="form-check m-0">
                          ...
                          <span class="form-check-label">به خاطر سپاری</span>
                        </label>
                      </div>
                      <div class="d-grid">
