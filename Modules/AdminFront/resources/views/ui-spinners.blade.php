...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>چرخنده‌ها - المان‌های رابط کاربری | فرست - قالب مدیریت بوت‌استرپ</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">المان‌های رابط کاربری /</span> چرخنده‌ها
              </h4>

              <!-- Style -->
              <div class="card mb-4">
                <h5 class="card-header heading-color">طرح</h5>
                <div class="card-body">
                  <div class="row gy-4">
                    <div class="col-md">
                      <div class="text-light small fw-semibold">خط</div>
                    ...
                    <div class="col-md">
                      <div class="text-light small fw-semibold">بزرگ شونده</div>
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <div class="row gy-4">
                    <!-- Large -->
                    <div class="col-md">
                      <div class="text-light small fw-semibold">بزرگ</div>
                      <div class="demo-inline-spacing">
                    ...
                    <!-- Medium -->
                    <div class="col-md">
                      <div class="text-light small fw-semibold">متوسط</div>
                      <div class="demo-inline-spacing">
                        <div class="spinner-border text-primary" role="status">
                          <span class="visually-hidden">در حال بارگذاری ...</span>
                        </div>
                    ...
                    <!-- Small -->
                    <div class="col-md">
                      <div class="text-light small fw-semibold">کوچک</div>
                      <div class="demo-inline-spacing">
              ...
              <!-- With Buttons -->
              <div class="card mb-4">
                <h5 class="card-header heading-color">با دکمه‌ها</h5>
                <div class="card-body">
                  <div class="demo-inline-spacing">
                    ...
                    <button class="btn btn-primary" type="button" disabled>
                      <span class="spinner-grow me-2" role="status" aria-hidden="true"></span>
                      در حال بارگذاری ...
                    </button>
                  </div>
                </div>
              ...
              <!-- SpinKit -->
              <div class="card">
                <h5 class="card-header heading-color">سایر طرح‌ها</h5>
