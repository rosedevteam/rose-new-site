...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>چند مرحله‌ای با آیکن - فرم‌ها | فرست - قالب مدیریت بوت‌استرپ</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4"><span class="text-muted fw-light">فرم چند مرحله‌ای /</span> آیکن‌ها</h4>
              ...
              <div class="row gy-4">
                ...
                <div class="col-12">
                  <small class="text-light fw-semibold lh-2">آیکن‌های پایه</small>
                    ...
                    <div class="bs-stepper-content">
                      <form onsubmit="return false">
                        ...
                        <div id="address" class="content">
                          <div class="content-header mb-3">
                            <h6 class="mb-1">آدرس</h6>
                            <small>آدرس خود را وارد کنید.</small>
                          </div>
                          <div class="row g-3">
                            <div class="col-sm-6">
                              <label class="form-label" for="address-input">آدرس</label>
                              <input type="text" class="form-control" id="address-input" placeholder="چهارراه آبرسان، فلکه دانشگاه">
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="landmark">نشان اختصاصی</label>
                              <input type="text" class="form-control" id="landmark" placeholder="برج بلور">
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="pincode">پین‌کد</label>
                              <input type="text" class="form-control text-start" id="pincode" placeholder="658921" dir="ltr">
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="city">شهر</label>
                              <input type="text" class="form-control" id="city" placeholder="تبریز">
                            </div>
                            <div class="col-12 d-flex justify-content-between">
                              <button class="btn btn-primary btn-prev">
                                <i class="bx bx-chevron-left bx-sm ms-sm-n2"></i>
                        ...
                        <div id="review-submit" class="content lh-2">
                          <p class="fw-semibold mb-2">حساب</p>
                          <ul class="list-unstyled">
                            <li>نام کاربری</li>
                            <li>example@email.com</li>
                          </ul>
                          <hr>
                          <p class="fw-semibold mb-2">اطلاعات شخصی</p>
                          <ul class="list-unstyled">
                            <li>نام</li>
                            <li>نام خانوادگی</li>
                            <li>کشور</li>
                          ...
                          <hr>
                          <p class="fw-semibold mb-2">آدرس</p>
                          <ul class="list-unstyled">
                            <li>آدرس</li>
                            <li>نشان اختصاصی</li>
                            <li>پین‌کد</li>
                          ...
                          <hr>
                          <p class="fw-semibold mb-2">شبکه های اجتماعی</p>
                          <ul class="list-unstyled">
                ...
                <div class="col-12">
                  <small class="text-light fw-semibold lh-2">آیکن‌های عمودی</small>
                    ...
                    <div class="bs-stepper-content">
                      <form onsubmit="return false">
                        ...
                        <div id="account-details-vertical" class="content">
                          ...
                          <div class="row g-3">
                            <div class="col-sm-6">
                              <label class="form-label" for="username1">نام کاربری</label>
                              <input type="text" id="username1" class="form-control text-start" placeholder="john.doe" dir="ltr">
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="email1">ایمیل</label>
                              <input type="text" id="email1" class="form-control text-start" placeholder="john.doe@email.com" aria-label="john.doe@email.com" dir="ltr">
                            </div>
                            <div class="col-sm-6 form-password-toggle">
                              <label class="form-label" for="password60">رمز عبور</label>
                              <div class="input-group input-group-merge">
                                <input type="password" id="password60" class="form-control text-start" placeholder="············" dir="ltr" aria-describedby="password6">
                                <span class="input-group-text cursor-pointer" id="password6"><i class="bx bx-hide"></i></span>
                              </div>
                            </div>
                            <div class="col-sm-6 form-password-toggle">
                              <label class="form-label" for="confirm-password61">تایید رمز عبور</label>
                              <div class="input-group input-group-merge">
                                <input type="password" id="confirm-password61" class="form-control text-start" placeholder="············" dir="ltr" aria-describedby="confirm-password7">
                        ...
                        <div id="personal-info-vertical" class="content">
                          ...
                          <div class="row g-3">
                            <div class="col-sm-6">
                              <label class="form-label" for="first-name1">نام</label>
                              <input type="text" id="first-name1" class="form-control" placeholder="جان">
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="last-name1">نام خانوادگی</label>
                              <input type="text" id="last-name1" class="form-control" placeholder="اسنو">
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="country1">کشور</label>
                            ...
                            <div class="col-sm-6">
                              <label class="form-label" for="language1">زبان</label>
                        ...
                        <div id="social-links-vertical" class="content">
                          ...
                          <div class="row g-3">
                            <div class="col-sm-6">
                              <label class="form-label" for="twitter1">توییتر</label>
                              <input type="text" id="twitter1" class="form-control text-start" dir="ltr" placeholder="https://twitter.com/abc">
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="facebook1">فیسبوک</label>
                              <input type="text" id="facebook1" class="form-control text-start" dir="ltr" placeholder="https://facebook.com/abc">
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="google1">گوگل+</label>
                              <input type="text" id="google1" class="form-control text-start" dir="ltr" placeholder="https://plus.google.com/abc">
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="linkedin1">لینکدین</label>
                              <input type="text" id="linkedin1" class="form-control text-start" dir="ltr" placeholder="https://linkedin.com/abc">
                            </div>
                            <div class="col-12 d-flex justify-content-between">
                              <button class="btn btn-primary btn-prev">
                                <i class="bx bx-chevron-left bx-sm ms-sm-n2"></i>
              ...
              <div class="row gy-4">
                ...
                <!-- Modern Icons Wizard -->
                <div class="col-12">
                  <small class="text-light fw-semibold lh-2">چند مرحله‌ای مدرن با آیکن</small>
                    ...
                    <div class="bs-stepper-content">
                      <form onsubmit="return false">
                        ...
                        <div id="account-details-modern" class="content">
                          ...
                          <div class="row g-3">
                            ...
                            <div class="col-sm-6 form-password-toggle">
                              ...
                              <div class="input-group input-group-merge">
                                <input type="password" id="confirm-password-modern" class="form-control text-start" placeholder="············" dir="ltr" aria-describedby="confirm-password2-modern">
                        ...
                        <div id="address-modern" class="content">
                          ...
                          <div class="row g-3">
                            <div class="col-sm-6">
                              <label class="form-label" for="address-modern-input">آدرس</label>
                              <input type="text" class="form-control" id="address-modern-input" placeholder="چهارراه آبرسان، فلکه دانشگاه">
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="landmark-modern">نشان اختصاصی</label>
                              <input type="text" class="form-control" id="landmark-modern" placeholder="برج بلور">
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="pincode-modern">پین‌کد</label>
                              <input type="text" class="form-control text-start" id="pincode-modern" placeholder="658921" dir="ltr">
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="city-modern">شهر</label>
                              <input type="text" class="form-control" id="city-modern" placeholder="تبریز">
                            </div>
                            <div class="col-12 d-flex justify-content-between">
                              <button class="btn btn-primary btn-prev">
                                <i class="bx bx-chevron-left bx-sm ms-sm-n2"></i>
                        ...
                        <!-- Review -->
                        <div id="review-submit-modern" class="content lh-2">
                          <p class="fw-semibold mb-2">حساب</p>
                          <ul class="list-unstyled">
                            <li>نام کاربری</li>
                            <li>example@email.com</li>
