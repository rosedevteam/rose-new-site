...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>نوار ناوبری محتوا - طرح‌ها | فرست - قالب مدیریت بوت‌استرپ</title>
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="layout-demo-wrapper">
                ...
                <div class="layout-demo-info">
                  <h4 class="secondary-font">طرح نوار ناوبری محتوا</h4>
                  <p>طرح پیش‌فرض قالب، نوار ناوبری در ناحیه محتوا.</p>
                </div>
              </div>
              <!--/ Layout Demo -->
            </div>
