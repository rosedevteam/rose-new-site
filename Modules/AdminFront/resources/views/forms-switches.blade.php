...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>سوئیچ‌ها - فرم‌ها | فرست - قالب مدیریت بوت‌استرپ</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4"><span class="text-muted fw-light">فرم‌ها /</span> سوئیچ‌ها</h4>

              <div class="row">
                <!-- Default switches -->
                <div class="col-12">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">سوئیچ‌های پیش‌فرض</h5>
                    <div class="card-body">
                      <div class="row gy-3">
                        <div class="col-sm-6">
                          ...
                          <label class="switch">
                            ...
                            <span class="switch-label">پیش‌فرض</span>
                          </label>
                        </div>
                        <div class="col-sm-6">
                          <div class="text-light small fw-semibold mb-3">مربع</div>
                          <label class="switch switch-square">
                            ...
                            <span class="switch-label">مربع</span>
                          </label>
                        </div>
                      </div>
                      <div class="row gy-3 mt-3">
                        <div class="col-sm-6">
                          <div class="text-light small fw-semibold mb-3">پیش‌فرض با آیکن</div>
                          <label class="switch">
                            <input type="checkbox" class="switch-input">
                            <span class="switch-toggle-slider">
                            ...
                            <span class="switch-label">با آیکن</span>
                          </label>
                        </div>
                        <div class="col-sm-6">
                          <div class="text-light small fw-semibold mb-3">مربع با آیکن</div>
                          <label class="switch switch-square">
                            <input type="checkbox" class="switch-input">
                            <span class="switch-toggle-slider">
                ...
                <div class="col-12">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">انواع پیش‌فرض</h5>
                    <div class="row row-bordered g-0">
                      <div class="col-xl-12 p-4 pt-0">
                        ...
                        <div class="demo-inline-spacing">
                          <label class="me-3 switch switch-primary">
                            ...
                            <span class="switch-label">اولیه</span>
                          </label>

                          <label class="me-3 switch switch-secondary">
                            <input type="checkbox" class="switch-input" checked>
                            <span class="switch-toggle-slider">
                              <span class="switch-on">
                                <i class="bx bx-check"></i>
                            ...
                            <span class="switch-label">ثانویه</span>
                          </label>
                          ...
                          <label class="me-3 switch switch-success">
                            ...
                            <span class="switch-label">موفقیت</span>
                          </label>

                          <label class="me-3 switch switch-danger">
                            <input type="checkbox" class="switch-input" checked>
                            <span class="switch-toggle-slider">
                              <span class="switch-on">
                                <i class="bx bx-check"></i>
                            ...
                            <span class="switch-label">اخطار</span>
                          </label>

                          <label class="me-3 switch switch-warning">
                            <input type="checkbox" class="switch-input" checked>
                            <span class="switch-toggle-slider">
                              <span class="switch-on">
                                <i class="bx bx-check"></i>
                            ...
                            <span class="switch-label">هشدار</span>
                          </label>

                          <label class="me-3 switch switch-info">
                            <input type="checkbox" class="switch-input" checked>
                            <span class="switch-toggle-slider">
                              <span class="switch-on">
                                <i class="bx bx-check"></i>
                            ...
                            <span class="switch-label">اطلاعات</span>
                          </label>

                          <label class="me-3 switch switch-dark">
                            <input type="checkbox" class="switch-input" checked>
                            <span class="switch-toggle-slider">
                              <span class="switch-on">
                                <i class="bx bx-check"></i>
                            ...
                            <span class="switch-label">تیره</span>
                          </label>
                        </div>
                      </div>
                    </div>
                ...
                <div class="col-12">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">اندازه</h5>
                    <div class="card-body">
                      <div class="row gy-3">
                        <div class="col-sm-6">
                          <div class="text-light small fw-semibold">پیش‌فرض</div>
                          <div class="demo-vertical-spacing">
                            <label class="switch switch-sm">
                              ...
                              <span class="switch-label">کوچک</span>
                            </label>
                            ...
                            <label class="switch switch-lg">
                              ...
                              <span class="switch-label">بزرگ</span>
                            </label>
                          </div>
                        </div>
                        <div class="col-sm-6">
                          <div class="text-light small fw-semibold">مربع</div>
                          <div class="demo-vertical-spacing">
                ...
                <div class="col-12">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">وضعیت‌ها</h5>
                    <div class="card-body">
                      <div class="row gy-3">
                        <div class="col-sm-6">
                          <div class="text-light small fw-semibold">غیرفعال</div>
                          <div class="demo-vertical-spacing">
                            <label class="switch">
                              ...
                              <span class="switch-label">پیش‌فرض - خاموش</span>
                            </label>
                            <br>
                            <label class="switch">
                              ...
                              <span class="switch-label">پیش‌فرض - روشن</span>
                            </label>
                          </div>
                        </div>
                        <div class="col-sm-6">
                          <div class="text-light small fw-semibold">وضعیت‌های اعتبارسنجی</div>
                          <div class="demo-vertical-spacing">
                            <label class="switch">
                              ...
                              <span class="switch-label">معتبر</span>
                            </label>
                            <div class="has-error">
                              <label class="switch">
                                ...
                                <span class="switch-label">نامعتبر</span>
                              </label>
                            </div>
                          </div>
                        </div>
                ...
                <div class="col-12">
                  <div class="card">
                    <h5 class="card-header heading-color">رادیوی انباشته</h5>
                    <div class="card-body">
                      <div class="row gy-3">
                        <div class="col-sm-6">
                          <div class="text-light small fw-semibold mb-3">پیش‌فرض</div>
                          <div class="switches-stacked">
                            <label class="switch">
                              ...
                              <span class="switch-label">گزینه 1</span>
                            </label>
                            ...
                            <label class="switch">
                              ...
                              <span class="switch-label">گزینه 2</span>
                            </label>
                            ...
                            <label class="switch">
                              ...
                              <span class="switch-label">گزینه 3</span>
                            </label>
                          </div>
                        </div>
                        <div class="col-sm-6">
