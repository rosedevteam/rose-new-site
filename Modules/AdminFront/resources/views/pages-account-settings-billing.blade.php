...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>تنظیمات حساب - صفحات | فرست - قالب مدیریت بوت‌استرپ</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">تنظیمات حساب /</span> صورتحساب‌ها و پلن‌ها
              </h4>
              ...
              <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card-body">
                      <div class="row">
                        <div class="col-md-6 mb-1">
                          <div class="mb-4">
                            <h6 class="fw-semibold mb-2">پلن کنونی شما استاندارد است</h6>
                            <p>یک شروع ساده برای همه</p>
                          </div>
                          <div class="mb-4">
                            <h6 class="fw-semibold mb-2">فعال تا 25 اردیبهشت 1401</h6>
                        ...
                        <div class="col-md-6 mb-1">
                          ...
                          <div class="plan-statistics">
                            ...
                            <p class="mt-2 mb-0">6 روز باقی مانده تا پلن شما نیازمند ارتقا باشد</p>
                          </div>
                        </div>
                        <div class="col-12">
                  ...
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">روش‌های پرداخت</h5>
                    <div class="card-body">
                      <div class="row">
                        <div class="col-md-6">
                          <form id="creditCardForm" class="row g-3" onsubmit="return false">
                            <div class="col-12">
                              <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="collapsible-payment-cc">کارت اعتباری/Debit/ATM</label>
                              </div>
                              <div class="form-check form-check-inline">
                            ...
                            <div class="col-12">
                              ...
                              <div class="input-group input-group-merge">
                                <input id="paymentCard" name="paymentCard" class="form-control credit-card-mask text-start" type="text" placeholder="1356 3215 6548 7898" dir="ltr" aria-describedby="paymentCard2">
                            ...
                            <div class="col-12 col-md-6">
                              ...
                              <input type="text" id="paymentName" class="form-control" placeholder="جان اسنو">
                            </div>
                            <div class="col-6 col-md-3">
                              <label class="form-label" for="paymentExpiryDate">تاریخ انقضا</label>
                              <input type="text" id="paymentExpiryDate" class="form-control expiry-date-mask text-start" placeholder="YY/MM" dir="ltr">
                            </div>
                            <div class="col-6 col-md-3">
                              <label class="form-label" for="paymentCvv">کد CVV</label>
                              <div class="input-group input-group-merge">
                                <input type="text" id="paymentCvv" class="form-control cvv-code-mask text-start" maxlength="4" placeholder="654" dir="ltr">
                                <span class="input-group-text cursor-pointer" id="paymentCvv2"><i class="bx bx-help-circle text-muted" data-bs-toggle="tooltip" data-bs-placement="top" title="شماره CVV کارت"></i></span>
                              </div>
                            </div>
                            <div class="col-12">
                              <label class="switch">
                            ...
                            <div class="col-12 mt-3">
                              <button type="submit" class="btn btn-primary me-sm-3 me-1">ذخیره تغییرات</button>
                              ...
                              <div class="d-flex justify-content-between flex-sm-row flex-column">
                                <div class="card-information me-2">
                                  ...
                                  <div class="d-flex align-items-center mb-1 flex-wrap gap-2">
                                    <h6 class="mb-0 me-2">استیو راجرز</h6>
                  ...
                  <div class="card mb-4">
                    <!-- Billing Address -->
                    <h5 class="card-header heading-color">آدرس صورتحساب</h5>
                    <div class="card-body">
                      <form id="formAccountSettings" onsubmit="return false">
                        <div class="row">
                          ...
                          <div class="mb-3 col-sm-6">
                            <label for="billingEmail" class="form-label">ایمیل صورتحساب</label>
                            <input class="form-control text-start" type="text" id="billingEmail" name="billingEmail" placeholder="john.doe@example.com" dir="ltr">
                          </div>
                          <div class="mb-3 col-sm-6">
                            <label for="taxId" class="form-label">شناسه مالیاتی</label>
                            <input type="text" id="taxId" name="taxId" class="form-control text-start" dir="ltr" placeholder="شناسه مالیاتی را وارد کنید">
                          </div>
                          <div class="mb-3 col-sm-6">
                            <label for="vatNumber" class="form-label">شماره VAT</label>
                            <input class="form-control text-start" type="text" id="vatNumber" name="vatNumber" dir="ltr" placeholder="شماره VAT را وارد کنید">
                          </div>
                          <div class="mb-3 col-sm-6">
                            <label for="mobileNumber" class="form-label">موبایل</label>
                            <div class="input-group input-group-merge">
                              <input class="form-control mobile-number text-start" type="text" id="mobileNumber" name="mobileNumber" placeholder="202 555 0111" dir="ltr">
                          ...
                          <div class="mb-3 col-12">
                            <label for="billingAddress" class="form-label">آدرس صورتحساب</label>
                            <input type="text" class="form-control" id="billingAddress" name="billingAddress" placeholder="آدرس قبض">
                          </div>
                          <div class="mb-3 col-sm-6">
                          ...
                          <div class="mb-3 col-sm-6">
                            ...
                            <input type="text" class="form-control zip-code text-start" id="zipCode" name="zipCode" dir="ltr" placeholder="231465" maxlength="6">
                          </div>
                        </div>
                        <div class="mt-2">
