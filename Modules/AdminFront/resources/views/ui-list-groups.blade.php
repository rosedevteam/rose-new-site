...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>گروه‌های لیست - المان‌های رابط کاربری | فرست - قالب مدیریت بوت‌استرپ</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">المان‌های رابط کاربری /</span> گروه‌های لیست
              </h4>

              <div class="card mb-4">
                <h5 class="card-header heading-color">گروه‌های لیست</h5>
                <div class="card-body">
                  <div class="row gy-4">
                    <!-- Basic List group -->
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                      <small class="text-light fw-semibold">با نشان‌ها و قرص‌ها</small>
                      <div class="demo-inline-spacing mt-3">
                        <ul class="list-group">
                          ...
                          <li class="list-group-item disabled">لورم ایپسوم متن ساختگی</li>
                          <li class="list-group-item d-flex justify-content-between align-items-center">
                            لورم ایپسوم متن ساختگی
                ...
                <div class="card-body">
                  <div class="row gy-4">
                    ...
                    <div class="col-lg-6">
                      <small class="text-light fw-semibold">بدون دور خط</small>
                      <div class="demo-inline-spacing mt-3">
                    ...
                    <!-- List group Icons -->
                    <div class="col-lg-6">
                      <small class="text-light fw-semibold">دارای آیکن</small>
                      <div class="demo-inline-spacing mt-3">
                        <ul class="list-group">
                ...
                <div class="card-body">
                  <div class="row gy-4">
                    <!-- List group Numbered -->
                    <div class="col-lg-6">
                      <small class="text-light fw-semibold">شماره دار</small>
                      <div class="demo-inline-spacing mt-3">
                    ...
                    <!-- List group checkbox -->
                    <div class="col-lg-6">
                      <small class="text-light fw-semibold">گروه لیست با چک‌باکس</small>
                      <div class="demo-inline-spacing mt-3">
                        <div class="list-group">
                ...
                <div class="card-body">
                  <div class="row gy-4">
                    ...
                    <div class="col-lg-6">
                      <small class="text-light fw-semibold">کلاس های کاربردی</small>
                      <div class="demo-inline-spacing mt-3">
                        <ul class="list-group">
                          <li class="list-group-item list-group-item-primary">آیتم گروه لیست اولیه</li>
                          <li class="list-group-item list-group-item-secondary">آیتم گروه لیست ثانویه</li>
                          <li class="list-group-item list-group-item-success">آیتم گروه لیست موفقیت</li>
                          <li class="list-group-item list-group-item-danger">آیتم گروه لیست اخطار</li>
                          <li class="list-group-item list-group-item-warning">آیتم گروه لیست هشدار</li>
                          <li class="list-group-item list-group-item-info">آیتم گروه لیست اطلاعات</li>
                          <li class="list-group-item list-group-item-dark">آیتم گروه لیست تیره</li>
                        </ul>
                      </div>
                    </div>
                    <!--/ Contextual List group -->
                      ...
                      <div class="demo-inline-spacing mt-3">
                        <div class="list-group">
                          ...
                          <a href="javascript:void(0);" class="list-group-item list-group-item-action flex-column align-items-start">
                            <div class="d-flex justify-content-between w-100">
                              <h6 class="mb-2">سرتیتر آیتم گروه لیست</h6>
                              <small class="text-muted mt-1 mt-sm-0 mb-1 mb-sm-0">3 روز قبل</small>
                            </div>
                            <p class="mb-1">
                          ...
                          <a href="javascript:void(0);" class="list-group-item list-group-item-action flex-column align-items-start">
                            ...
                            <small class="text-muted">لورم ایپسوم متن ساختگی با تولید</small>
                          </a>
                        </div>
                      </div>
                    </div>
              ...
              <div class="card mb-4">
                <h5 class="card-header heading-color">با جاوا اسکریپت</h5>
                <div class="card-body">
                  <div class="row gy-4">
                    <!-- Custom content with heading -->
                    <div class="col-lg-6">
                      <small class="text-light fw-semibold">عمودی</small>
                      <div class="mt-3">
                        <div class="row">
                          <div class="col-md-4 col-12 mb-3 mb-md-0">
                            <div class="list-group">
                              <a class="list-group-item list-group-item-action active" id="list-home-list" data-bs-toggle="list" href="#list-home">خانه</a>
                              <a class="list-group-item list-group-item-action" id="list-profile-list" data-bs-toggle="list" href="#list-profile">پروفایل</a>
                              <a class="list-group-item list-group-item-action" id="list-messages-list" data-bs-toggle="list" href="#list-messages">پیام ها</a>
                              <a class="list-group-item list-group-item-action" id="list-settings-list" data-bs-toggle="list" href="#list-settings">تنظیمات</a>
                            </div>
                          </div>
                          <div class="col-md-8 col-12">
                            <div class="tab-content p-0">
                              <div class="tab-pane fade lh-2 show active" id="list-home">
                                لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد. کتابهای زیادی در شصت و سه درصد گذشته، حال و آینده شناخت فراوان جامعه و متخصصان را می طلبد تا با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ پیشرو در زبان فارسی ایجاد
                              </div>
                              <div class="tab-pane fade lh-2" id="list-profile">
                                لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد. کتابهای زیادی در شصت و سه درصد گذشته، حال و آینده شناخت فراوان جامعه و متخصصان را می طلبد تا با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ پیشرو در زبان فارسی
                              </div>
                              <div class="tab-pane fade lh-2" id="list-messages">
                                لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد. کتابهای زیادی در شصت و سه درصد گذشته، حال و آینده شناخت فراوان جامعه و متخصصان را می طلبد تا با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ پیشرو در
                              </div>
                              <div class="tab-pane fade lh-2" id="list-settings">
                    ...
                    <div class="col-lg-6">
                      <small class="text-light fw-semibold">افقی</small>
                      <div class="demo-inline-spacing mt-3">
                        <div class="list-group list-group-horizontal-md text-md-center">
                          <a class="list-group-item list-group-item-action active" id="home-list-item" data-bs-toggle="list" href="#horizontal-home">خانه</a>
                          <a class="list-group-item list-group-item-action" id="profile-list-item" data-bs-toggle="list" href="#horizontal-profile">پروفایل</a>
                          <a class="list-group-item list-group-item-action" id="messages-list-item" data-bs-toggle="list" href="#horizontal-messages">پیام ها</a>
                          <a class="list-group-item list-group-item-action" id="settings-list-item" data-bs-toggle="list" href="#horizontal-settings">تنظیمات</a>
                        </div>
                        <div class="tab-content px-0 pt-2">
                          <div class="tab-pane fade lh-2 show active" id="horizontal-home">
                            لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد. کتابهای زیادی در شصت و سه درصد گذشته، حال و آینده شناخت فراوان جامعه و متخصصان را می طلبد تا با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ پیشرو در زبان فارسی ایجاد
                          </div>
                          <div class="tab-pane fade lh-2" id="horizontal-profile">
                            لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد. کتابهای زیادی در شصت و سه درصد گذشته، حال و آینده شناخت فراوان جامعه و متخصصان را می طلبد تا با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ پیشرو در زبان فارسی
                          </div>
                          <div class="tab-pane fade lh-2" id="horizontal-messages">
                            لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد. کتابهای زیادی در شصت و سه درصد گذشته، حال و آینده شناخت فراوان جامعه و متخصصان را می طلبد تا با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ پیشرو در
                          </div>
                          <div class="tab-pane fade lh-2" id="horizontal-settings">
                            لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد. کتابهای زیادی در شصت و سه درصد گذشته، حال و آینده شناخت فراوان جامعه و متخصصان را می طلبد تا با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ پیشرو در زبان فارسی ایجاد کرد.
                          </div>
                        </div>
                      </div>
              ...
              <div class="card">
                <h5 class="card-header heading-color">خط زمانی و اعلان</h5>
                <div class="card-body">
                  <div class="row">
                    <!-- Timeline Style -->
                    <div class="col-lg-6 p-4">
                      <small class="text-light fw-semibold">خط زمانی</small>
                      <div class="demo-inline-spacing mt-3">
                        <ul class="list-group list-group-timeline">
                          <li class="list-group-item list-group-timeline-primary">لورم ایپسوم متن ساختگی</li>
                          <li class="list-group-item list-group-timeline-success">لورم ایپسوم متن ساختگی</li>
                          <li class="list-group-item list-group-timeline-warning">لورم ایپسوم متن ساختگی</li>
                          <li class="list-group-item list-group-timeline-info">لورم ایپسوم متن ساختگی</li>
                          <li class="list-group-item list-group-timeline-danger">لورم ایپسوم متن ساختگی</li>
                        </ul>
                      </div>
                    </div>
                    <!--/ Timeline Style -->
                    <!-- Notification Style -->
                    <div class="col-lg-6 p-4">
                      <small class="text-light fw-semibold">اعلان</small>
                      <div class="demo-inline-spacing mt-3">
                        <div class="list-group">
                          <a href="javascript:void(0);" class="list-group-item list-group-item-action d-flex justify-content-between">
                            <div class="li-wrapper d-flex justify-content-start align-items-center">
                              <div class="avatar avatar-sm me-3">
                                <span class="avatar-initial rounded-circle bg-label-success">م</span>
                              </div>
                              <div class="list-content">
                                <h6 class="mb-1">سرتیتر آیتم گروه لیست</h6>
                                <small class="text-muted">لورم ایپسوم متن ساختگی با تولید</small>
                              </div>
                            </div>
                            <small>3 روز قبل</small>
                          ...
                          <a href="javascript:void(0);" class="list-group-item list-group-item-action d-flex justify-content-between">
                            <div class="li-wrapper d-flex justify-content-start align-items-center">
                              <div class="avatar avatar-sm me-3">
                                <span class="avatar-initial rounded-circle bg-label-danger">ب</span>
                              </div>
                              <div class="list-content">
                                <h6 class="mb-1">سرتیتر آیتم گروه لیست</h6>
                                <small class="text-muted">لورم ایپسوم متن ساختگی با تولید</small>
                            ...
                            <small>1 روز قبل</small>
                          </a>
                          <a href="javascript:void(0);" class="list-group-item list-group-item-action d-flex justify-content-between">
                            <div class="li-wrapper d-flex justify-content-start align-items-center">
                              <div class="avatar avatar-sm me-3">
                                <span class="avatar-initial rounded-circle bg-label-primary">و</span>
                              </div>
                              <div class="list-content">
                                <h6 class="mb-1">سرتیتر آیتم گروه لیست</h6>
                                <small class="text-muted">لورم ایپسوم متن ساختگی با تولید</small>
                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-12 col-lg-6 mb-4 mb-xl-0">
                      <small class="text-light fw-semibold">لیست کاربران</small>
                      <div class="demo-inline-spacing mt-3">
                        <div class="list-group">
                          ...
                          <div class="list-group-item list-group-item-action d-flex align-items-center cursor-pointer">
                            ...
                            <div class="w-100">
                              <div class="d-flex justify-content-between">
                                <div class="user-info">
                                  <h6 class="mb-1">لورم ایپسوم متن ساختگی با تولید</h6>
                                  <small class="text-muted">11 دقیقه</small>
                                  <div class="user-status">
                          ...
                          <div class="list-group-item list-group-item-action d-flex align-items-center cursor-pointer">
                            ...
                            <div class="w-100">
                              <div class="d-flex justify-content-between">
                                <div class="user-info">
                                  <h6 class="mb-1">لورم ایپسوم متن ساختگی با تولید سادگی</h6>
                            ...
                            <div class="w-100">
                              <div class="d-flex justify-content-between">
                                <div class="user-info">
                                  ...
                                  <small class="text-muted">15 دقیقه</small>
                                  <div class="user-status">
                    ...
                    <div class="col-12 col-lg-6">
                      <small class="text-light fw-semibold">پیشرفت</small>
                      <div class="demo-inline-spacing mt-3">
                        <div class="list-group">
                          <a href="javascript:void(0);" class="list-group-item list-group-item-action d-flex align-items-center p-3">
                            <div class="badge bg-primary rounded p-1 me-3">
                              <i class="bx bxl-bootstrap bx-sm text-white"></i>
                            </div>
                            <div class="w-100">
                              <h6 class="mb-2 mt-n1">لورم ایپسوم متن ساختگی با تولید سادگی</h6>
                          ...
                          <a href="javascript:void(0);" class="list-group-item list-group-item-action d-flex align-items-center p-3">
                            <div class="badge bg-success rounded p-1 me-3">
                              <i class="bx bxl-vuejs bx-sm text-white"></i>
                            </div>
                            <div class="w-100">
                              <h6 class="mb-2 mt-n1">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از</h6>
                              <div class="progress" style="height: 5px">
                          ...
                          <a href="javascript:void(0);" class="list-group-item list-group-item-action d-flex align-items-center p-3">
                            <div class="badge bg-danger rounded p-1 me-3">
                              <i class="bx bxl-angular bx-sm text-white"></i>
                            </div>
                            <div class="w-100">
                              <h6 class="mb-2 mt-n1">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت</h6>
                              <div class="progress" style="height: 5px">
                          ...
                          <a href="javascript:void(0);" class="list-group-item list-group-item-action d-flex align-items-center p-3">
                            <div class="badge bg-info rounded p-1 me-3">
                              <i class="bx bxl-react bx-sm text-white"></i>
                            </div>
                            <div class="w-100">
                              <h6 class="mb-2 mt-n1">سرتیتر آیتم گروه لیست</h6>
                              <div class="progress" style="height: 5px">
                          ...
                          <a href="javascript:void(0);" class="list-group-item list-group-item-action d-flex align-items-center p-3">
                            <div class="badge bg-warning rounded p-1 me-3">
                              <i class="bx bxl-redux bx-sm text-white"></i>
                            </div>
                            <div class="w-100">
                              <h6 class="mb-2 mt-n1">لورم ایپسوم متن ساختگی با تولید سادگی</h6>
                              <div class="progress" style="height: 5px">
