...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>متفرقه - رابط کاربری توسعه یافته | فرست - قالب مدیریت بوت‌استرپ</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">رابط کاربری توسعه یافته /</span> متفرقه
              </h4>
              ...
              <div class="row">
                ...
                <div class="col-12">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">کلیپ بورد</h5>
                    <div class="card-body">
                      <div class="row">
                        <div class="col-md-4 col-sm-12 pe-0 mb-md-0 mb-2">
                          <input class="form-control" id="clipboard-example" type="text" value="من رو کپی کن!">
                        </div>
                ...
                <div class="col-12">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">تایمر ایده‌آل</h5>
                    <div class="card-body">
                      <div class="row">
                        <div class="col-md-6 col-12 mb-md-0 mb-4">
                          <p>
                            کل صفحه -
                            <small>تایم‌اوت 5 ثانیه</small>
                          </p>
                          <div class="btn-group mb-3">
                            <button type="button" id="document-Pause" class="btn btn-primary btn-sm">مکث</button>
                            <button type="button" id="document-Resume" class="btn btn-primary btn-sm">ادامه</button>
                            <button type="button" id="document-Elapsed" class="btn btn-primary btn-sm">سپری شده</button>
                            <button type="button" id="document-Init" class="btn btn-primary btn-sm">شروع</button>
                            <button type="button" id="document-Destroy" class="btn btn-primary btn-sm">از بین بردن</button>
                          </div>
                        ...
                        <div class="col-md-6 col-12">
                          <p>
                            المان -
                            <small>تایم‌اوت 3 ثانیه</small>
                          </p>
                          <div class="btn-group mb-3">
                            <button type="button" id="element-Reset" class="btn btn-primary btn-sm">بازنشانی</button>
                            ...
                            <button type="button" id="element-State" class="btn btn-primary btn-sm">وضعیت</button>
                          </div>
                ...
                <div class="col-12">
                  <div class="card">
                    <h5 class="card-header heading-color">قالب‌بندی عددی Numeral JS</h5>
                    <div class="card-body">
                      <div class="table-responsive">
                        <table class="table">
                          <thead>
                            <tr>
                              <th class="border-top-0">ورودی</th>
