...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>نمای درختی - رابط کاربری توسعه یافته | فرست - قالب مدیریت بوت‌استرپ</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="fw-light text-muted">رابط کاربری توسعه یافته /</span> نمای درختی
              </h4>
              ...
              <div class="row">
                ...
                <div class="col-md-6 col-12">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">منوی راست کلیک</h5>
                    <div class="card-body">
                ...
                <div class="col-md-6 col-12">
                  <div class="card mb-4">
                    <h5 class="card-header heading-color">کشیدن و رها کردن</h5>
                    <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-md-6 col-12">
                  <div class="card mb-md-0 mb-4">
                    <h5 class="card-header heading-color">چک‌باکس‌ها</h5>
                    <div class="card-body">
                ...
                <div class="col-md-6 col-12">
                  <div class="card">
                    <h5 class="card-header heading-color">Ajax</h5>
                    <div class="card-body">
