...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>خارج از کادر - المان‌های رابط کاربری | فرست - قالب مدیریت بوت‌استرپ</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">المان‌های رابط کاربری /</span> خارج از کادر
              </h4>

              <div class="card mb-4">
                <h5 class="card-header heading-color">قرارگیری‌ها</h5>
                <div class="card-body">
                  <div class="row gy-3">
                    <!-- Default Offcanvas -->
                    <div class="col-lg-3 col-md-6">
                      <small class="text-light fw-semibold mb-3">شروع (پیش‌فرض)</small>
                      <div class="mt-3">
                        ...
                        <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasStart" aria-labelledby="offcanvasStartLabel">
                          <div class="offcanvas-header">
                            <h5 id="offcanvasStartLabel" class="offcanvas-title">خارج از کادر شروع</h5>
                          ...
                          <div class="offcanvas-body my-auto mx-0 flex-grow-0">
                            ...
                            <button type="button" class="btn btn-primary mb-2 d-grid w-100">ادامه</button>
                    ...
                    <!-- End Offcanvas -->
                    <div class="col-lg-3 col-md-6">
                      <small class="text-light fw-semibold mb-3">پایان</small>
                      <div class="mt-3">
                    ...
                    <!-- Top Offcanvas -->
                    <div class="col-lg-3 col-md-6">
                      <small class="text-light fw-semibold mb-3">بالا</small>
                      <div class="mt-3">
                        ...
                        <div class="offcanvas offcanvas-top" tabindex="-1" id="offcanvasTop" aria-labelledby="offcanvasTopLabel">
                          <div class="offcanvas-header">
                            <h5 id="offcanvasTopLabel" class="offcanvas-title">خارج از کادر بالا</h5>
                            <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                          </div>
                          <div class="offcanvas-body">
                            ...
                            <button type="button" class="btn btn-primary me-2">ادامه</button>
                    ...
                    <!-- Bottom Offcanvas -->
                    <div class="col-lg-3 col-md-6">
                      <small class="text-light fw-semibold mb-3">پایین</small>
                      <div class="mt-3">
                        ...
                        <div class="offcanvas offcanvas-bottom" tabindex="-1" id="offcanvasBottom" aria-labelledby="offcanvasBottomLabel">
                          <div class="offcanvas-header">
                            <h5 id="offcanvasBottomLabel" class="offcanvas-title">خارج از کادر پایین</h5>
                            <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                          </div>
                          <div class="offcanvas-body">
                            <p>
              ...
              <div class="card">
                <h5 class="card-header heading-color">پس زمینه</h5>
                <div class="card-body">
                  <div class="row gy-3">
                    <!-- Enable Body Scrolling Offcanvas -->
                    <div class="col-lg-4 col-md-6">
                      <small class="text-light fw-semibold mb-3">فعال کردن اسکرول بدنه</small>
                      <div class="mt-3">
                        ...
                        <div class="offcanvas offcanvas-end" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1" id="offcanvasScroll" aria-labelledby="offcanvasScrollLabel">
                          <div class="offcanvas-header">
                            <h5 id="offcanvasScrollLabel" class="offcanvas-title">خارج از کادر اسکرول</h5>
                            <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                          </div>
                          <div class="offcanvas-body my-auto mx-0 flex-grow-0">
                            <p class="text-center">
                    ...
                    <div class="col-lg-4 col-md-6">
                      <small class="text-light fw-semibold mb-3">فعال کردن پس‌زمینه (پیش‌فرض)</small>
                      <div class="mt-3">
                        ...
                        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasBackdrop" aria-labelledby="offcanvasBackdropLabel">
                          <div class="offcanvas-header">
                            <h5 id="offcanvasBackdropLabel" class="offcanvas-title">فعال کردن پس‌زمینه</h5>
                            <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                          </div>
                          <div class="offcanvas-body my-auto mx-0 flex-grow-0">
                            <p class="text-center">
                    ...
                    <div class="col-lg-4 col-md-6">
                      <small class="text-light fw-semibold mb-3">فعال کردن اسکرول و پس‌زمینه</small>
                      <div class="mt-3">
                        <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasBoth" aria-controls="offcanvasBoth">
                          فعال کردن اسکرول و پس‌زمینه
                        </button>
                        <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasBoth" aria-labelledby="offcanvasBothLabel">
                          <div class="offcanvas-header">
                            <h5 id="offcanvasBothLabel" class="offcanvas-title">فعال کردن اسکرول و پس‌زمینه</h5>
                            <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                          </div>
                          <div class="offcanvas-body my-auto mx-0 flex-grow-0">
                            <p class="text-center">
