...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>مقاله - صفحات | فرست - قالب مدیریت بوت‌استرپ</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">مرکز راهنمایی /</span> مقاله
              </h4>
                    ...
                    <div class="card-body">
                      ...
                      <div class="d-flex justify-content-between flex-wrap gap-3 my-4">
                        <div class="article-info">
                          <h6 class="mb-1">آیا این مقاله مفید بود؟</h6>
                          <p class="card-text">55 نفر این مقاله را مفید دانسته‌اند</p>
                        </div>
                        <h6>همچنان کمک نیاز دارید؟ <a href="javascript:void(0);">با ما تماس بگیرید</a></h6>
                      </div>
