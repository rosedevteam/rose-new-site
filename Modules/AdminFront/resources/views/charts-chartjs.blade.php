...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>Chart.js - نمودارها | فرست - قالب مدیریت بوت‌استرپ</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4"><span class="text-muted fw-light">نمودارها /</span> Chart.js</h4>
              ...
              <div class="row gy-4">
                  ...
                  <div class="card">
                    <div class="card-header header-elements">
                      <div class="d-flex flex-column">
                        ...
                        <h5 class="card-title fw-bold mb-0 primary-font">74,123 تومان</h5>
                      </div>
                      <div class="card-action-element ms-auto py-0">
                        <div class="dropdown">
                          <button type="button" class="btn dropdown-toggle px-0" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <div class="col-12">
                  <div class="card">
                    <div class="card-header header-elements">
                      <div>
                        <h5 class="card-title mb-1">آمار</h5>
                ...
                <div class="col-lg-6 col-12">
                  <div class="card">
                    <div class="card-header">
                      <h5 class="card-title mb-0">نمودار راداری</h5>
                    </div>
                    <div class="card-body">
                ...
                <div class="col-lg-6 col-12">
                  <div class="card">
                    <div class="card-header header-elements">
                      <h5 class="card-title mb-0">میانگین مهارت‌ها</h5>
                ...
                <div class="col-12">
                  <div class="card">
                    <div class="card-header header-elements">
                      <h5 class="card-title mb-0">نمودار حبابی</h5>
                      <div class="card-header-elements ms-auto py-0">
                ...
                <div class="col-lg-4 col-12">
                  <div class="card">
                    <h5 class="card-header heading-color">کاربر بر اساس دستگاه</h5>
                    <div class="card-body">
                      <canvas id="doughnutChart" class="chartjs mb-4" data-height="350"></canvas>
                      <ul class="doughnut-legend d-flex justify-content-around ps-0 mb-2 pt-1">
                        <li class="ct-series-0 d-flex flex-column">
                          <h5 class="mb-0 fw-bold">دسکتاپ</h5>
                        ...
                        <li class="ct-series-2 d-flex flex-column">
                          <h5 class="mb-0 fw-bold">موبایل</h5>
                ...
                <div class="col-lg-8 col-12">
                  <div class="card">
                    <div class="card-header flex-nowrap header-elements">
                      <h5 class="card-title mb-0">اطلاعات محصول جدید</h5>
