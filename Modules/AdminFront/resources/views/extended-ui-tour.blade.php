...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>تور - رابط کاربری توسعه یافته | فرست - قالب مدیریت بوت‌استرپ</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">رابط کاربری توسعه یافته /</span> تور
              </h4>

              <div class="row">
                <div class="col-12">
                  <div class="card tour-card">
                    <h5 class="card-header heading-color">تور</h5>
                    <div class="card-body">
                      <button class="btn btn-primary" id="shepherd-example">شروع تور</button>
                    </div>
                  </div>
                </div>
              </div>
