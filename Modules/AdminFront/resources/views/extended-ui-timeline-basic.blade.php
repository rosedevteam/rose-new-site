...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>خط زمانی پایه - رابط کاربری توسعه یافته | فرست - قالب مدیریت بوت‌استرپ</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">رابط کاربری توسعه یافته /</span> خط زمانی پایه
              </h4>
              ...
              <div class="row gy-4">
                    ...
                    <div class="card-body">
                      <ul class="timeline mt-3">
                        <li class="timeline-item timeline-item-transparent">
                          ...
                          <div class="timeline-event">
                            <div class="timeline-header border-bottom mb-3 mt-n1">
                              <h6 class="mb-1 mb-sm-2">سوار شدن به هواپیما</h6>
                              <small class="text-muted mt-1 mt-sm-0 mb-2 mb-sm-0">3 فروردین</small>
                            </div>
                            <div class="d-flex justify-content-between flex-wrap mb-2 lh-1-85">
                              <div>
                                <span>فرودگاه بین المللی، تبریز</span>
                                <i class="bx bx-right-arrow-alt scaleX-n1-rtl mx-3"></i>
                                <span>فرودگاه مهرآباد، تهران</span>
                              </div>
                              <div>
                                <span class="text-muted">6:30 ق.ظ</span>
                              </div>
                            </div>
                        ...
                        <li class="timeline-item timeline-item-transparent">
                          ...
                          <div class="timeline-event">
                            <div class="timeline-header mb-2 mb-sm-0 mt-n1">
                              <h6 class="mb-1">بررسی طراحی</h6>
                              <small class="text-muted mt-1 mt-sm-0 mb-1 mb-sm-0">4 فروردین</small>
                            </div>
                          ...
                          <div class="timeline-event">
                            <div class="d-flex flex-sm-row flex-column">
                              ...
                              <div>
                                <div class="timeline-header flex-wrap mb-2">
                                  <h6 class="mb-1 mb-sm-0">لورم ایپسوم متن ساختگی با</h6>
                                  <small class="text-muted mt-1 mt-sm-0 mb-1 mb-sm-0">5 فروردین</small>
                                </div>
                                <p>
                            ...
                            <div class="d-flex justify-content-between flex-wrap flex-sm-row flex-column text-sm-center">
                              <div class="customer mb-sm-0 mb-2">
                                <p class="mb-0">مشتری</p>
                                <span class="text-muted">استیو راجرز</span>
                              </div>
                        ...
                        <li class="timeline-item timeline-item-transparent">
                          ...
                          <div class="timeline-event">
                            <div class="timeline-header mb-2 mb-sm-0 mt-n1">
                              <h6 class="mb-1">زمان بندی مصاحبه</h6>
                              <small class="text-muted mt-1 mt-sm-0 mb-1 mb-sm-0">6 فروردین</small>
                            </div>
                            <p>
                            ...
                            <div class="d-flex justify-content-between flex-wrap gap-2">
                              <div class="d-flex flex-wrap align-items-center">
                                ...
                                <div>
                                  <p class="mb-0">امیلیا کلارک</p>
                                  <span class="text-muted">توسعه دهنده جاوا اسکریپت</span>
                                </div>
                              </div>
                        ...
                        <li class="timeline-item timeline-item-transparent">
                          ...
                          <div class="timeline-event">
                            <div class="timeline-header mt-n1">
                              <h6 class="mb-0">2 اعلان</h6>
                              <small class="text-muted mt-1 mt-sm-0 mb-1 mb-sm-0">7 فروردین</small>
                            </div>
                            <ul class="list-group list-group-flush">
                              <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap border-top-0 p-0">
                                <div class="d-flex flex-wrap align-items-center">
                                  ...
                                  <span>در پست شما نظر دادند.</span>
                                </div>
                                <button class="btn btn-primary btn-sm my-sm-0 my-3">نمایش</button>
                              </li>
                              <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap pb-0 px-0">
                                <div class="d-flex align-items-center">
                                  <img src="../../assets/img/avatars/4.png" class="rounded-circle me-3" alt="آواتار" height="24" width="24">
                                  <div class="user-info">
                                    <p class="my-0">دیوید به شما پاسخ داد</p>
                                    <span class="text-muted">30 دقیقه قبل</span>
                                  </div>
                                </div>
                                <h5 class="mb-0">20,000 تومان</h5>
                              </li>
                            </ul>
                          </div>
                        </li>
                ...
                <div class="col-xl-6">
                  <div class="card">
                    <h5 class="card-header heading-color">پیشرفته</h5>
                    <div class="card-body">
