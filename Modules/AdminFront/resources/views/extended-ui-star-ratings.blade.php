...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>امتیازدهی ستاره‌ای - رابط کاربری توسعه یافته | فرست - قالب مدیریت بوت‌استرپ</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">رابط کاربری توسعه یافته /</span> امتیازدهی ستاره‌ای
              </h4>
              <div class="row">
                <!-- Basic-->
                ...
                <div class="col-md-4 col-sm-6 col-12 mb-4">
                  <div class="card">
                    <h5 class="card-header heading-color">فقط خواندنی</h5>
                    <div class="card-body">
                ...
                <div class="col-md-4 col-sm-6 col-12 mb-4">
                  <div class="card">
                    <h5 class="card-header heading-color">SVG سفارشی</h5>
                    <div class="card-body">
                ...
                <div class="col-md-4 col-sm-6 col-12 mb-4">
                  <div class="card">
                    <h5 class="card-header heading-color">نیم ستاره</h5>
                    <div class="card-body">
                ...
                <div class="col-md-4 col-sm-6 col-12 mb-4">
                  <div class="card">
                    <h5 class="card-header heading-color">تمام ستاره</h5>
                    <div class="card-body">
                ...
                <div class="col-md-4 col-sm-6 col-12 mb-4">
                  <div class="card">
                    <h5 class="card-header heading-color">چند رنگ</h5>
                    <div class="card-body">
                ...
                <div class="col-xl-6 col-12 mb-xl-0 mb-4">
                  <div class="card">
                    <h5 class="card-header heading-color">رویدادها</h5>
                    <div class="card-body">
                      <div class="row gy-3">
                        <div class="col-md d-flex flex-column align-items-start mb-sm-0 mb-3">
                          <small class="text-light fw-semibold">رویداد onSet</small>
                          <div class="onset-event-ratings"></div>
                        </div>
                        <div class="col-md d-flex flex-column align-items-start">
                          <small class="text-light fw-semibold">رویداد onChange</small>
                ...
                <div class="col-xl-6 col-12">
                  <div class="card">
                    <h5 class="card-header heading-color">روش‌ها</h5>
                    <div class="card-body">
                      <div class="methods-ratings"></div>
                      <div class="demo-inline-spacing">
                        <button class="btn btn-primary btn-initialize">راه اندازی</button>
                        <button class="btn btn-danger btn-destroy">از بین بردن</button>
                        <button class="btn btn-success btn-get-rating">دریافت امتیاز</button>
                        <button class="btn btn-info btn-set-rating">تنظیم امتیاز به 1</button>
                      </div>
                    </div>
                  </div>
                </div>
