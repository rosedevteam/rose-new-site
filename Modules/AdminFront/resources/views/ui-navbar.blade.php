...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>نوار ناوبری - المان‌های رابط کاربری | فرست - قالب مدیریت بوت‌استرپ</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">المان‌های رابط کاربری /</span> نوار ناوبری
              </h4>

              <!-- Basic -->
              <h5 class="pb-1 mt-5 mb-4 secondary-font">نمونه</h5>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                      ...
                      <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                          ...
                          <li><a class="dropdown-item" href="javascript:void(0)">یک عمل دیگر</a></li>
                        </ul>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link disabled" href="javascript:void(0)" tabindex="-1">غیرفعال</a>
                      </li>
                    </ul>
              ...
              <!-- Supported content -->
              <h5 class="pb-1 mb-4 secondary-font">محتوای پشتیبانی شده</h5>
              <div class="mb-5">
                <h6 class="mt-2 mb-3 text-muted">متن</h6>
                  ...
                  <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbar-ex-2">
                      <div class="navbar-nav me-auto">
                        <a class="nav-item nav-link active" href="javascript:void(0)">خانه</a>
                        <a class="nav-item nav-link" href="javascript:void(0)">درباره</a>
                        <a class="nav-item nav-link" href="javascript:void(0)">تماس</a>
                      </div>

                      <span class="navbar-text d-block py-2 lh-1-85">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم</span>
                    </div>
                  </div>
                </nav>

                <h6 class="mt-4 mb-3 text-muted">گروه ورودی</h6>
                ...
                <h6 class="mt-4 mb-3 text-muted">دکمه</h6>
                <nav class="navbar navbar-example navbar-expand-lg bg-light">
                  <div class="container-fluid">
                    <a class="navbar-brand" href="javascript:void(0)">نوار ناوبری</a>
                    ...
                    <div class="collapse navbar-collapse" id="navbar-ex-3">
                      ...
                      <form onsubmit="return false">
                        <button class="btn btn-outline-primary mt-2 mt-lg-0" type="button">اکنون بخرید</button>
                      </form>
                    </div>
                  </div>
                </nav>
              ...
              <!-- Mega dropdown -->
              <h5 class="pb-1 mb-4 secondary-font">مگا منوی کشویی</h5>

              <div class="mb-5">
                <h6 class="mt-2 mb-3 text-muted">باز کردن هنگام کلیک</h6>
                  ...
                  <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbar-ex-14">
                      <ul class="navbar-nav me-auto">
                        <li class="nav-item dropdown">
                          <a class="nav-link dropdown-toggle" href="javascript:void(0);" data-bs-toggle="dropdown" aria-expanded="false">منوی کشویی</a>
                          <div class="dropdown-menu mb-1 mb-lg-0">
                            <a class="dropdown-item" href="javascript:void(0)">عمل</a>
                            <a class="dropdown-item" href="javascript:void(0)">عمل دیگر</a>
                            <a class="dropdown-item" href="javascript:void(0)">یک عمل دیگر</a>
                          </div>
                        </li>
                        <li class="nav-item mega-dropdown">
                          <a class="nav-link dropdown-toggle navbar-ex-14-mega-dropdown mega-dropdown" href="javascript:void(0);" aria-expanded="false" data-bs-toggle="mega-dropdown">مگامنو</a>
                          <div class="dropdown-menu px-3 py-0 mb-1 mb-lg-0">
                            <div class="row row-bordered">
                              <div class="col-sm-6 col-lg p-3">
                                <h6 class="m-2 fw-bold">برنامه‌ها</h6>
                                <ul class="nav flex-column lh-1-85">
                                  <li class="nav-item">
                                    <a class="nav-link mega-dropdown-link" href="javascript:void(0)"><i class="tf-icons bx bx-envelope"></i> ایمیل</a>
                                  </li>
                                  <li class="nav-item">
                                    <a class="nav-link mega-dropdown-link" href="javascript:void(0)"><i class="tf-icons bx bx-chat"></i> گفتگو</a>
                                  </li>
                                  <li class="nav-item">
                                    <a class="nav-link mega-dropdown-link" href="javascript:void(0)"><i class="tf-icons bx bx-task"></i> ToDo ها</a>
                                  </li>
                                  <li class="nav-item">
                                    <a class="nav-link mega-dropdown-link" href="javascript:void(0)"><i class="tf-icons bx bx-calendar"></i> تقویم</a>
                                  </li>
                                  <li class="nav-item">
                                    <a class="nav-link mega-dropdown-link disabled" href="javascript:void(0)" tabindex="-1"><i class="tf-icons bx bx-block"></i> غیرفعال</a>
                                  </li>
                                </ul>
                              </div>
                              <div class="col-sm-6 col-lg p-3">
                                <h6 class="m-2 fw-bold">لینک های مفید</h6>
                                <ul class="nav flex-column lh-1-85">
                                  <li class="nav-item">
                                    <a class="nav-link mega-dropdown-link" href="javascript:void(0)">لورم ایپسوم متن</a>
                                  </li>
                                  <li class="nav-item">
                                    <a class="nav-link mega-dropdown-link" href="javascript:void(0)">لورم ایپسوم متن</a>
                                  </li>
                                  ...
                                  <li class="nav-item">
                                    <a class="nav-link mega-dropdown-link" href="javascript:void(0)">لورم ایپسوم</a>
                                  </li>
                                  <li class="nav-item">
                                    <a class="nav-link mega-dropdown-link" href="javascript:void(0)">لورم ایپسوم متن ساختگی</a>
                                  </li>
                                </ul>
                              </div>
                              <div class="col-sm-6 col-lg p-3">
                                <h6 class="my-2 fw-bold">گروه لیست</h6>
                                <div class="list-group">
                                  <a href="javascript:void(0)" class="list-group-item list-group-item-action mega-dropdown-link">لورم ایپسوم متن ساختگی</a>
                                  <a href="javascript:void(0)" class="list-group-item list-group-item-action mega-dropdown-link">لورم ایپسوم متن ساختگی</a>
                                  <a href="javascript:void(0)" class="list-group-item list-group-item-action mega-dropdown-link">لورم ایپسوم متن ساختگی</a>
                                  <a href="javascript:void(0)" class="list-group-item list-group-item-action mega-dropdown-link">لورم ایپسوم متن</a>
                                  <a href="javascript:void(0)" class="list-group-item list-group-item-action mega-dropdown-link">لورم ایپسوم متن</a>
                                </div>
                              </div>
                              <div class="col-sm-6 col-lg p-3">
                                <form onsubmit="return false">
                                  <div class="mb-3">
                                    <label class="form-label" for="exampleDropdownFormEmail1">آدرس ایمیل</label>
                                    <input type="email" class="form-control" id="exampleDropdownFormEmail1" placeholder="email@example.com">
                                  </div>
                                  <div class="mb-3">
                                    <label class="form-label" for="exampleDropdownFormPassword1">رمز عبور</label>
                                    <input type="password" class="form-control" id="exampleDropdownFormPassword1" placeholder="رمز عبور">
                                  </div>
                                  <div class="mb-3">
                                    <div class="form-check">
                                      <input type="checkbox" class="form-check-input" id="dropdownCheck">
                                      <label class="form-check-label" for="dropdownCheck"> به خاطر سپاری </label>
                                    </div>
                                  </div>
                ...
                <h6 class="mt-4 mb-3 text-muted">باز کردن هنگام هاور</h6>
                <nav class="navbar navbar-example navbar-expand-lg bg-light" style="z-index: 20">
                  <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbar-ex-15">
                      <ul class="navbar-nav me-auto">
                        <li class="nav-item dropdown">
                          <a class="nav-link dropdown-toggle" href="javascript:void(0);" data-bs-toggle="dropdown" aria-expanded="false" data-trigger="hover">منوی کشویی</a>
                          <div class="dropdown-menu mb-1 mb-lg-0">
                            <a class="dropdown-item" href="javascript:void(0)">عمل</a>
                            <a class="dropdown-item" href="javascript:void(0)">عمل دیگر</a>
                            <a class="dropdown-item" href="javascript:void(0)">یک عمل دیگر</a>
                        ...
                        <li class="nav-item mega-dropdown">
                          <a href="javascript:void(0);" class="nav-link dropdown-toggle navbar-ex-15-mega-dropdown mega-dropdown" aria-expanded="false" data-bs-toggle="mega-dropdown" data-trigger="hover">مگامنو</a>
                          <div class="dropdown-menu px-3 py-0 mb-1 mb-lg-0">
                            <div class="row row-bordered">
                              <div class="col-sm-6 col-lg p-3">
                                <h6 class="m-2 fw-bold">برنامه‌ها</h6>
                              ...
                              <div class="col-sm-6 col-lg p-3">
                                <form onsubmit="return false">
                                  ...
                                  <div class="mb-3">
                                    ...
                                    <input type="password" class="form-control" id="exampleDropdownFormPassword2" placeholder="رمز عبور">
                                  </div>
                                  <div class="mb-3">
                                    <div class="form-check">
                                      <input type="checkbox" class="form-check-input" id="dropdownCheck1">
                                      <label class="form-check-label" for="dropdownCheck1"> به خاطر سپاری </label>
                                    </div>
                                  </div>
                                  <button type="submit" class="btn btn-primary">ورود</button>
                                </form>
              ...
              <!-- Color schemes -->
              <h5 class="pb-1 mb-4 secondary-font">رنگ‌بندی‌ها</h5>
              <div class="demo-vertical-spacing demo-only-element">
                <!-- Primary navbar -->
                <nav class="navbar navbar-expand-lg bg-primary">
                  <div class="container-fluid">
                    <a class="navbar-brand" href="javascript:void(0)">اولیه</a>
                    ...
                    <div class="collapse navbar-collapse" id="navbar-ex-7">
                      <div class="navbar-nav me-auto">
                        ...
                        <a class="nav-item nav-link" href="javascript:void(0)">درباره</a>
                        <a class="nav-item nav-link" href="javascript:void(0)">تماس</a>
                        <a class="nav-item nav-link disabled" href="javascript:void(0)">غیرفعال</a>
                      </div>
                      <ul class="navbar-nav ms-lg-auto">
                        <li class="nav-item">
                          <a class="nav-link" href="javascript:void(0);"><i class="tf-icons navbar-icon bx bx-user"></i> پروفایل</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" href="javascript:void(0);"><i class="tf-icons navbar-icon bx bx-cog"></i> تنظیمات</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" href="javascript:void(0);"><i class="tf-icons navbar-icon bx bx-lock-open-alt"></i> خروج</a>
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <nav class="navbar navbar-expand-lg bg-secondary">
                  <div class="container-fluid">
                    <a class="navbar-brand" href="javascript:void(0)">ثانویه</a>
                ...
                <nav class="navbar navbar-expand-lg bg-success">
                  <div class="container-fluid">
                    <a class="navbar-brand" href="javascript:void(0)">موفقیت</a>
                ...
                <nav class="navbar navbar-expand-lg bg-danger">
                  <div class="container-fluid">
                    <a class="navbar-brand" href="javascript:void(0)">اخطار</a>
                ...
                <nav class="navbar navbar-expand-lg bg-warning">
                  <div class="container-fluid">
                    <a class="navbar-brand" href="javascript:void(0)">هشدار</a>
                ...
                <nav class="navbar navbar-expand-lg bg-info">
                  <div class="container-fluid">
                    <a class="navbar-brand" href="javascript:void(0)">اطلاعات</a>
                ...
                <nav class="navbar navbar-expand-lg bg-dark">
                  <div class="container-fluid">
                    <a class="navbar-brand" href="javascript:void(0)">تیره</a>
                ...
                <nav class="navbar navbar-expand-lg bg-white">
                  <div class="container-fluid">
                    <a class="navbar-brand" href="javascript:void(0)">سفید</a>
                ...
                <!-- Theme navbar -->
                <h6 class="pt-4 text-muted">تم نوار ناوبری</h6>
