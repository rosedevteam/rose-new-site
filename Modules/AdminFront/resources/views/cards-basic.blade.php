...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>کارت‌های پایه - المان‌های رابط کاربری | فرست - قالب مدیریت بوت‌استرپ</title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">المان‌های رابط کاربری /</span> کارت‌های پایه
              </h4>
                ...
                <div class="col-md-6 col-lg-4 mb-3">
                  <div class="card h-100">
                    ...
                    <div class="card-body">
                      ...
                      <a href="javascript:void(0)" class="btn btn-outline-primary">گزینه نمایشی</a>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 col-lg-4 mb-3">
                  <div class="card h-100">
                    <div class="card-body">
                      <h5 class="card-title">عنوان کارت</h5>
                      <h6 class="card-subtitle text-muted">پشتیبانی از زیرعنوان کارت</h6>
                    </div>
                    ...
                    <div class="card-body">
                      ...
                      <a href="javascript:void(0);" class="card-link">لینک کارت</a>
                      <a href="javascript:void(0);" class="card-link">لینک دیگر</a>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 col-lg-4 mb-3">
              ...
              <!-- Content types -->
              <h5 class="pb-1 mb-4 secondary-font">انواع محتوا</h5>

              <div class="row mb-5">
                <div class="col-md-6 col-lg-4">
                  <h6 class="mt-2 text-muted">بدنه</h6>
                  <div class="card mb-4">
                    <div class="card-body">
                      <p class="card-text">
                  ...
                  <h6 class="mt-2 text-muted">عناوین، متن و لینک ها</h6>
                  <div class="card mb-4">
                    <div class="card-body">
                      <h5 class="card-title">عنوان کارت</h5>
                      <div class="card-subtitle text-muted mb-3">زیرعنوان کارت</div>
                      <p class="card-text">
                        لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها
                      </p>
                      <a href="javascript:void(0)" class="card-link">لینک کارت</a>
                  ...
                  <h6 class="mt-2 text-muted">گروه‌های لیست</h6>
                  <div class="card mb-4">
                    <ul class="list-group list-group-flush">
                      <li class="list-group-item">لورم ایپسوم متن</li>
                      <li class="list-group-item">لورم ایپسوم متن ساختگی با</li>
                      <li class="list-group-item">لورم ایپسوم متن ساختگی</li>
                    </ul>
                  </div>
                </div>
                <div class="col-md-6 col-lg-4">
                  <h6 class="mt-2 text-muted">تصاویر</h6>
                  <div class="card mb-4">
                ...
                <div class="col-md-6 col-lg-4">
                  <h6 class="mt-2 text-muted">سینک آشپزخانه</h6>
                  <div class="card">
                    <img class="card-img-top" src="../../assets/img/elements/7.jpg" alt="Card image cap">
                    <div class="card-body">
                      <h5 class="card-title">عنوان کارت</h5>
                      <p class="card-text">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت</p>
                    </div>
                    <ul class="list-group list-group-flush">
                      <li class="list-group-item">لورم ایپسوم متن</li>
                      <li class="list-group-item">لورم ایپسوم متن ساختگی</li>
              ...
              <h6 class="pb-1 mb-4 text-muted">هدر و فوتر</h6>
              <div class="row mb-5">
                <div class="col-md-6 col-lg-4 mb-3">
                  <div class="card">
                    <div class="card-header primary-font">ویژه</div>
                    <div class="card-body">
                      <h5 class="card-title">لورم ایپسوم متن ساختگی با</h5>
                      <p class="card-text">
                ...
                <div class="col-md-6 col-lg-4 mb-3">
                  <div class="card text-center">
                    ...
                    <div class="card-footer text-muted">2 روز قبل</div>
                  </div>
                </div>
              </div>
              <!--/ Content types -->
              ...
              <!-- Text alignment -->
              <h5 class="pb-1 mb-4 secondary-font">تراز متن</h5>
              <div class="row mb-5">
                <div class="col-md-6 col-lg-4">
                  <div class="card mb-3">
                    <div class="card-body">
              ...
              <!-- Navigation -->
              <h5 class="pb-1 mb-4 secondary-font">ناوبری</h5>
              <div class="row mb-5">
                <div class="col-md-6">
                  <div class="card text-center mb-3">
                    <div class="card-header border-bottom primary-font">
                      <ul class="nav nav-tabs card-header-tabs" role="tablist">
                        <li class="nav-item">
                          <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab" data-bs-target="#navs-tab-home" aria-controls="navs-tab-home" aria-selected="true">
                            خانه
                          </button>
                        </li>
                        <li class="nav-item">
                          <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs-tab-profile" aria-controls="navs-tab-profile" aria-selected="false">
                            پروفایل
                          </button>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-content">
                      <div class="tab-pane fade show active" id="navs-tab-home" role="tabpanel">
                        <h5 class="card-title">لورم ایپسوم متن ساختگی با</h5>
                        <p class="card-text">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده</p>
                        <a href="javascript:void(0);" class="btn btn-primary">رفتن به خانه</a>
                      </div>
                      <div class="tab-pane fade" id="navs-tab-profile" role="tabpanel">
                        <h5 class="card-title">لورم ایپسوم متن ساختگی با</h5>
                        <p class="card-text">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده</p>
                        <a href="javascript:void(0);" class="btn btn-primary">رفتن به پروفایل</a>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="card text-center">
                    <div class="card-header border-bottom py-2 primary-font">
                      <ul class="nav nav-pills" role="tablist">
                        <li class="nav-item">
                          <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab" data-bs-target="#navs-pills-tab-home" aria-controls="navs-pills-tab-home" aria-selected="true">
                            خانه
                          </button>
                        </li>
                        <li class="nav-item">
                          <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs-pills-tab-profile" aria-controls="navs-pills-tab-profile" aria-selected="false">
                            پروفایل
                          </button>
                        </li>
                        <li class="nav-item">
              ...
              <!-- Images -->
              <h5 class="pb-1 mb-4 secondary-font">تصاویر و لایه رویی</h5>
              <div class="row mb-5">
                ...
                <div class="col-md-6 col-xl-4">
                  <div class="card bg-dark border-0 text-white">
                    ...
                    <div class="card-img-overlay">
                      ...
                      <p class="card-text">آخرین به روز رسانی 3 دقیقه پیش</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <!-- Horizontal -->
              <h5 class="pb-1 mb-4 secondary-font">افقی</h5>
              <div class="row mb-5">
                <div class="col-md">
                  <div class="card mb-3">
                    <div class="row g-0">
                      ...
                      <div class="col-md-8">
                        <div class="card-body">
                          <h5 class="card-title mb-3">عنوان کارت</h5>
                          <p class="card-text">
                            لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در
                          </p>
                          <p class="card-text mb-n1"><small class="text-muted">آخرین به روز رسانی 3 دقیقه پیش</small></p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <!-- Style variation -->
              <h5 class="pb-1 mb-4 secondary-font">تنوع استایل</h5>
              <div class="row">
                <div class="col-md-6 col-xl-4">
                  <div class="card bg-primary text-white mb-3">
                    <div class="card-header primary-font">سرتیتر</div>
                    <div class="card-body">
                      <h5 class="card-title text-white">عنوان کارت اولیه</h5>
                      <p class="card-text">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده</p>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 col-xl-4">
                  <div class="card bg-secondary text-white mb-3">
                    <div class="card-header primary-font">سرتیتر</div>
                    <div class="card-body">
                      <h5 class="card-title text-white">عنوان کارت ثانویه</h5>
                      <p class="card-text">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده</p>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 col-xl-4">
                  <div class="card bg-success text-white mb-3">
                    <div class="card-header primary-font">سرتیتر</div>
                    <div class="card-body">
                      <h5 class="card-title text-white">عنوان کارت موفقیت</h5>
                      <p class="card-text">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده</p>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 col-xl-4">
                  <div class="card bg-danger text-white mb-3">
                    <div class="card-header primary-font">سرتیتر</div>
                    <div class="card-body">
                      <h5 class="card-title text-white">عنوان کارت اخطار</h5>
                      <p class="card-text">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده</p>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 col-xl-4">
                  <div class="card bg-warning text-white mb-3">
                    <div class="card-header primary-font">سرتیتر</div>
                    <div class="card-body">
                      <h5 class="card-title text-white">عنوان کارت هشدار</h5>
                      <p class="card-text">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده</p>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 col-xl-4">
                  <div class="card bg-info text-white mb-3">
                    <div class="card-header primary-font">سرتیتر</div>
                    <div class="card-body">
                      <h5 class="card-title text-white">عنوان کارت اطلاعات</h5>
                      <p class="card-text">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده</p>
                    </div>
                  </div>
                </div>
              ...
              <div class="row">
                ...
                <div class="col-md-6 col-xl-4">
                  <div class="card shadow-none bg-transparent border border-secondary mb-3">
                    <div class="card-body">
                      <h5 class="card-title">عنوان کارت ثانویه</h5>
                      <p class="card-text">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده</p>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 col-xl-4">
                  <div class="card shadow-none bg-transparent border border-success mb-3">
                    <div class="card-body">
                      <h5 class="card-title">عنوان کارت موفقیت</h5>
                      <p class="card-text">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده</p>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 col-xl-4">
                  <div class="card shadow-none bg-transparent border border-danger mb-3">
                    <div class="card-body">
                      <h5 class="card-title">عنوان کارت اخطار</h5>
                      <p class="card-text">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده</p>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 col-xl-4">
                  <div class="card shadow-none bg-transparent border border-warning mb-3">
                    <div class="card-body">
                      <h5 class="card-title">عنوان کارت هشدار</h5>
                      <p class="card-text">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده</p>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 col-xl-4">
                  <div class="card shadow-none bg-transparent border border-info mb-3">
                    <div class="card-body">
                      <h5 class="card-title">عنوان کارت اطلاعات</h5>
                      <p class="card-text">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده</p>
                    </div>
                  </div>
                </div>
              ...
              <!-- Card layout -->
              <h5 class="pb-1 my-5 secondary-font">طرح‌های کارت</h5>

              <!-- Card Groups -->
              <h6 class="pb-1 mb-4 text-muted">گروه‌های کارت</h6>
              ...
              <!-- Grid Card -->
              <h6 class="pb-1 mb-4 text-muted">توری کارت</h6>
              ...
              <!-- Masonry -->
              <h6 class="pb-1 mb-4 text-muted">کاشی</h6>
              <div class="row gy-4" data-masonry='{"percentPosition": true }'>
                <div class="col-sm-6 col-lg-4">
                  <div class="card">
                    <img class="card-img-top" src="../../assets/img/elements/5.jpg" alt="Card image cap">
                    <div class="card-body">
                      <h5 class="card-title">لورم ایپسوم متن ساختگی با تولید سادگی</h5>
                      <p class="card-text">
                        لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در
                      </p>
                    </div>
                ...
                <div class="col-sm-6 col-lg-4">
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <p class="card-text"><small class="text-muted">آخرین به روز رسانی 3 دقیقه پیش</small></p>
                    </div>
                  </div>
                </div>
                <div class="col-sm-6 col-lg-4">
