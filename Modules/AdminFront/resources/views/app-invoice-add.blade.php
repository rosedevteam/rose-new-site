...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>افزودن - صورتحساب | فرست - قالب مدیریت بوت‌استرپ</title>
                              ...
                              <div class="row w-100 m-0 p-3">
                                <div class="col-md-6 col-12 mb-md-0 mb-3 ps-md-0">
                                  ...
                                  <select class="form-select item-details mb-2">
                                    ...
                                    <option value="App Customization">سفارشی‌سازی برنامه</option>
                                    <option value="ABC Template">قالب ABC</option>
                                    <option value="App Development">توسعه برنامه</option>
                                  </select>
                                  <textarea class="form-control" rows="2" placeholder="اطلاعات مورد"></textarea>
                                </div>
                      ...
                      <div class="row py-sm-3">
                        <div class="col-md-6 mb-md-0 mb-3">
                          <div class="d-flex align-items-center mb-3">
                            ...
                            <input type="text" class="form-control" id="salesperson" placeholder="جان اسنو">
                          </div>
                          <input type="text" class="form-control" id="invoiceMsg" placeholder="از کسب و کار شما متشکریم">
                        </div>
                      ...
                      <div class="row">
                        <div class="col-12">
                          <div class="mb-3">
                            ...
                            <textarea class="form-control" rows="2" id="note" placeholder="یادداشت صورتحساب"></textarea>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div class="col-lg-3 col-12 invoice-actions">
                  <div class="card mb-4">
                    <div class="card-body">
                      ...
                      <a href="./app-invoice-preview.html" class="btn btn-label-secondary d-grid w-100 mb-3">پیش‌نمایش</a>
                      <button type="button" class="btn btn-label-secondary d-grid w-100">ذخیره</button>
                    </div>
                  </div>
                  <div>
