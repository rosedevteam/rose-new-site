...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>پروفایل کاربر - پروفایل | فرست - قالب مدیریت بوت‌استرپ</title>
              ...
              <div class="row">
                <div class="col-md-12">
                  <ul class="nav nav-pills flex-column flex-sm-row mb-4">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="pages-profile-projects.html"><i class="bx bx-grid-alt me-1"></i> پروژه‌ها</a>
                    </li>
                    <li class="nav-item">
                        ...
                        <li class="timeline-item timeline-item-transparent">
                          ...
                          <div class="timeline-event">
                            ...
                            <p class="mb-2">
                              ...
                              <img src="../../assets/img/avatars/4.png" class="rounded-circle ms-3" alt="آواتار" height="20" width="20">
                            </p>
                        ...
                        <div class="card-header align-items-center">
                          ...
                          <div class="card-action-element btn-pinned">
                            <div class="dropdown">
                              ...
                              <ul class="dropdown-menu dropdown-menu-end">
                                <li><a class="dropdown-item" href="javascript:void(0);">اشتراک گذاری اتصالات</a></li>
                                <li><a class="dropdown-item" href="javascript:void(0);">پیشنهاد ویرایش</a></li>
                                <li>
                                  <hr class="dropdown-divider">
                                </li>
                          ...
                          <ul class="list-unstyled mb-0">
                            <li class="mb-3">
                              <div class="d-flex align-items-start">
                                ...
                                <div class="ms-auto">
                                  <button class="mt-1 btn btn-label-primary p-1 btn-sm"><i class="bx bx-user"></i></button>
                                </div>
                              </div>
                            </li>
                            <li class="mb-3">
                              <div class="d-flex align-items-start">
                                ...
                                <div class="ms-auto">
                                  <button class="mt-1 btn btn-primary p-1 btn-sm"><i class="bx bx-user"></i></button>
                                </div>
                              </div>
                            </li>
                            <li class="mb-3">
                        ...
                        <div class="card-header align-items-center">
                          ...
                          <div class="card-action-element btn-pinned">
                            <div class="dropdown">
                              ...
                              <ul class="dropdown-menu dropdown-menu-end">
                                <li><a class="dropdown-item" href="javascript:void(0);">اشتراک گذاری تیم‌ها</a></li>
                                <li><a class="dropdown-item" href="javascript:void(0);">پیشنهاد ویرایش</a></li>
                                <li>
                                  <hr class="dropdown-divider">
                                </li>
                          ...
                          <ul class="list-unstyled mb-0">
                            <li class="mb-3">
                              <div class="d-flex align-items-start">
                                ...
                                <div class="ms-auto">
                                  <a href="javascript:;"><span class="mt-1 badge bg-label-danger">توسعه دهنده</span></a>
                                </div>
                              </div>
                            </li>
                            <li class="mb-3">
                              <div class="d-flex align-items-start">
                                ...
                                <div class="ms-auto">
                                  <a href="javascript:;"><span class="mt-1 badge bg-label-primary">پشتیبانی</span></a>
                                </div>
                              </div>
                            </li>
                            <li class="mb-3">
                              <div class="d-flex align-items-start">
                                ...
                                <div class="ms-auto">
                                  <a href="javascript:;"><span class="mt-1 badge bg-label-info">طراح</span></a>
                                </div>
                              </div>
                            </li>
                            <li class="mb-3">
                            ...
                            <li class="mb-3">
                              <div class="d-flex align-items-start">
                                <div class="d-flex align-items-center">
                                  <div class="avatar me-3">
                                    <img src="../../assets/img/icons/brands/twitter-label.png" alt="آواتار" class="rounded-circle">
                                  </div>
                                  <div class="me-w">
                                ...
                                <div class="ms-auto">
                                  <a href="javascript:;"><span class="mt-1 badge bg-label-secondary">بازاریابی</span></a>
                                </div>
                              </div>
                            </li>
                            <li class="text-center">
