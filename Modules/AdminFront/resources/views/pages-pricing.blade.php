...
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>قیمت‌گذاری - صفحات | فرست - قالب مدیریت بوت‌استرپ</title>
                      ...
                      <div class="col-xl mb-lg-0 lg-4">
                        <div class="card border shadow-none">
                          <div class="card-body">
                            ...
                            <a href="auth-register-basic.html" class="btn btn-label-primary d-grid w-100">شروع کنید</a>
                          </div>
                        </div>
                      </div>
                ...
                <div class="pricing-free-trial">
                  <div class="container">
                    <div class="position-relative">
                      <div class="d-flex justify-content-between flex-column flex-md-row align-items-center px-5 py-5 pb-md-0 pt-md-4">
                        <!-- image -->
                        <div class="text-center">
                          <img src="../../assets/img/illustrations/boy-working-light.png" class="img-fluid scaleX-n1" alt="Api Key Image" width="300" data-app-light-img="illustrations/boy-working-light.png" data-app-dark-img="illustrations/boy-working-dark.png">
                        </div>
                        <div class="text-center text-md-end mt-4 mt-md-3 pt-2 pt-md-0">
                          <h3 class="text-primary">هنوز قانع نشده‌اید؟ با یک نسخه آزمایشی 14 روزه رایگان شروع کنید!</h3>
                          <p class="fs-5">شما دسترسی کامل به تمام امکانات به مدت 14 روز دریافت خواهید کرد.</p>
                          <a href="auth-register-basic.html" class="btn btn-primary mt-3 my-md-5">شروع 14 روز آزمایش رایگان</a>
                        </div>
                      </div>
                    </div>
                  </div>
                          ...
                          <table class="table text-center mb-0">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td>
                                  <span class="badge bg-label-primary badge-sm text-uppercase">افزودنی موجود است</span>
                                </td>
                                <td>
                                  <i class="bx bx-check text-success bx-sm"></i>
                                </td>
                              ...
                              <tr>
                                ...
                                <td class="border-0">
                                  <a href="auth-register-basic.html" class="btn text-nowrap btn-label-primary">انتخاب پلن</a>
                                </td>
                                <td class="border-0">
                                  <a href="auth-register-basic.html" class="btn text-nowrap btn-primary">انتخاب پلن</a>
                                </td>
                                <td class="border-0">
                                  <a href="auth-register-basic.html" class="btn text-nowrap btn-label-primary">انتخاب پلن</a>
                                </td>
                  ...
                  <div class="container py-5 px-lg-5">
                    <div class="row mt-0 mt-md-4">
                      <div class="col-12 text-center mb-4">
                        ...
                        <p>اجازه بدهید به دستیابی به جواب متداول ترین سوالاتی که ممکن است داشته باشید کمک کنیم.</p>
                      </div>
                    </div>
                    <div class="row mx-0">
                      <div class="col-12">
                        <div id="faq" class="accordion accordion-header-primary">
                          ...
                          <div class="card accordion-item">
                            ...
                            <div id="faq-3" class="accordion-collapse collapse" data-bs-parent="#faq">
                              <div class="accordion-body lh-2">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ</div>
                            </div>
                          </div>
                          ...
                          <div class="card accordion-item mb-0 mb-md-4">
                            ...
                            <div id="faq-5" class="accordion-collapse collapse" data-bs-parent="#faq">
                              <div class="accordion-body lh-2">
                                لطفا <a href="javascript:void(0);">تماس</a> بگیرید با ما در صورت داشتن سوالی دیگر. ما آماده راهنمایی هستیم!
                              </div>
                            </div>
                          </div>
                        </div>
