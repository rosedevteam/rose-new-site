...
//            }
//            $children = $menu->children()->orderBy('order');
//            $active = $children->get()->where('is_active', true);
//            $inactive = $children->get()->where('is_active', false);
...
//            'slug' => 'bail|nullable|string',
//            'has_children' => 'bail|required|between:0,1',
//            'parent_id' => 'bail|nullable|string|exists:menus,id',
//        ]);
//        try {
//            $menu = Menu::create([
//                'name' => $data['name'],
...
//                'icon' => null,
//                'author_id' => auth()->id(),
//                'has_children' => $data['has_children'] == '1',
//                'order' => null,
