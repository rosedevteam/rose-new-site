...
@section('content')
        ...
        @if(!auth()->user()->referral)
            <div class="alert alert-danger rose-danger mb-5" role="alert">
                <p class="m-0">
                    ...
                    امکان دعوت از دوستان و دریافت امتیاز بعد از ثبت نام در اولین دوره
            ...
            <div class="col-md-9">
                <div class="panel-title-box d-flex align-items-center justify-content-between">
                    <h4 class="py-3 breadcrumb-wrapper mb-4">
                        <span class="text-muted fw-light">حساب کاربری /</span> رز کلاب
                    </h4>
                </div>
            </div>
            <div class="col-md-3">
            ...
            <div class="row row-eq-height align-items-center">
                <div class="col-md-8">
                    <div class=" flex-lg-row d-flex align-items-center card text-white"
                         style="text-align: justify; padding: 1.5rem;">

                        <div class="rose-hammasir-guid flex-md-column d-md-flex">
                            <div class="guid-inner p-3">
                                <h3 class="title text-muted">به دوستانت، موفقیت هدیه بده! </h3>
                                <p>با معرفی دوره مسیرثروت ساز به عزیزانتان و هم مسیر کردن آن ها در راه رسیدن به اهدافشان، امتیاز دریافت کنید.</p>

                                <div class="text-muted" style="
                                  font-size: 16px; font-weight: 800; line-height: 30px; word-wrap: break-word">
                                    نحوه عملکرد رز کلاب:
                                </div>
                                <div class="text-muted" style="width: 100%;  font-weight: 400; line-height: 27px; word-wrap: break-word">
                                    <p>
                                ...
                                <div class="mt-3 text-muted"
                                     style="width: 100%; font-size: 16px;  font-weight: 700; line-height: 30px; word-wrap: break-word">
                ...
                <div class="col-md-4">
                    <div class="referral-code-box mt-3 mt-lg-0">
                        <div class="d-flex justify-content-center">
                            <img src="/assets/front/images/gift-2.svg" alt="">
                        </div>
                        <br>
    ...
    <div class="panel-title-box d-flex justify-content-between flex-column flex-sm-row align-items-sm-center mt-5">
        <div class="mb-3 mb-sm-0">
            <h3 class="text-muted">دوستان خودت رو دعوت کن، تخفیف بگیر!</h3>
            <div class="d-flex align-items-center justify-content-between gap-2">
                <h2 class="text-muted">تبدیل امتیاز به کیف پول</h2>
...
<path d="M18 10V15" stroke="#737887" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
    ...
    <div class="panel-title-box d-flex justify-content-between flex-column flex-sm-row align-items-sm-center mt-5">
        <div class="mb-3 mb-sm-0">
            <h3 class="text-muted">جزئیات استفاده از کد معرف</h3>
            <h2 class="text-muted">هم مسیر های شما</h2>
        </div>
    </div>

    <div class="wallet-transactions score-logs card">
        <div class="items">
            @if(auth()->user()->scores->count())
                ...
                @endforeach
            @else
                <div class="alert alert-info" role="alert">در حال حاضر امتیازی دریافت نکرده اید</div>
            @endif
