                    ...
                    <div class="row row-bordered m-0">
                        ...
                        <div class="col-md-12 col-12 pe-0">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h5 class="card-title mb-0">گزارش فروش</h5>
                            </div>
                                ...
                                <ul class="list-unstyled m-0 pt-0">
                                    <li class="mb-4">
                                        <div class="d-flex align-items-center mb-2">
                                            ...
                                            <div>
                                                <p class="mb-0 text-muted text-nowrap">مجموع فروش</p>
...
@push('script')
    <script src="/assets/admin/js/reports/orders.js"></script>
@endpush
