                ...
                <div class="row row-bordered m-0">
                    ...
                    <div class="col-md-12 col-12 pe-0">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5 class="card-title mb-0">گزارش رزرو ها</h5>
                        </div>
                    ...
                    <div class="col-md-4 col-12 px-0">
                        <div class="card-body">
                            <h6 class="mt-1">تعداد کل تعداد کل </h6>
                            <ul class="list-unstyled m-0 pt-0">
                                <li class="mb-4">
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <div>
                                            <p class="mb-0 text-muted text-nowrap">تعداد کل رزرو ها</p>
                                            <small class="fw-semibold text-nowrap">
                                                {{number_format(\Modules\Reserve\Models\Reserve::all()->count())}}
                                                رزرو
                                            </small>
                                        </div>
                                    </div>
...
@push('script')
    <script src="/assets/admin/js/reports/reserves.js"></script>
@endpush
