                                ...
                                <ul class="list-unstyled m-0 pt-0">
                                    <li class="mb-4">
                                        <div class="d-flex align-items-center mb-2">
                                            ...
                                            <div>
                                                <p class="mb-0 text-muted text-nowrap">تعداد کل اعضا</p>
                                                <small class="fw-semibold text-nowrap">
                                                    {{number_format(\Modules\Subscription\Models\Telegram::where('is_deleted' , 0)->count())}}
                                                    عضو
                                                </small>
                                            </div>
                                        </div>
...
@push('script')
    <script src="/assets/admin/js/reports/tele.js"></script>
@endpush
